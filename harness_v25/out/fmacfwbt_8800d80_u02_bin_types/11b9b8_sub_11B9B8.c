...
extern uint32_t off_11BC04;
extern uint32_t off_11BBEC;
extern uint32_t dword_11BBF0;
extern uint32_t dword_11BC00;
extern uint32_t off_11BBF4;
...
int  sub_11B9B8(int a1)
{
  ...
  v1 = off_11BC04;
  v2 = (char *)off_11BBEC;
  v3 = *((uint32_t *)off_11BC04 + 4);
  v5 = *(uint32_t *)a1 + 38;
  *((uint32_t *)off_11BBEC + 18) = *(uint32_t *)v5;
  v6 = *(uint16_t *)(v5 + 4);
  v7 = *(uint32_t *)(v3 + 100);
  v8 = *(uint16_t *)(a1 + 18);
  ...
  *((uint32_t *)v2 + 6) = 0;
  ...
  v15 = (unsigned int *)(36 * *(uint8_t *)(*(uint32_t *)a1 + 35) + 8248 + dword_11BBF0);
  v36 = v11 << 9;
  v16 = v13 + 92;
  v17 = v13;
  v18 = 2621440;
