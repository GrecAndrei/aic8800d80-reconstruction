...
uint8_t * sub_1331D4(int a1, __int16 a2, unsigned int a3)
{
  int v4; // r3
  int v5; // r6
  int v6; // r0
...
LABEL_2:
  ...
  {
    v14 = (unsigned __int8 *)(*((uint8_t *)off_133644 + 374) & 1);
    v68 = v14;
LABEL_6:
  ...
  if ( (v13[374] & 6) != 0 )
  {
    ...
    if ( !*(uint8_t *)(a1 + 106) )
    {
      ...
      if ( v63
        && (*(uint32_t *)(dword_1337B0 + 696 * *(unsigned __int8 *)(a1 + 116) + 4) & 0x24) != 0
        && (v63[2] & 0x80u) == 0 )
      {
      ...
      {
        v73 = (uint8_t *)rf_bus_setup_n3a8(109, 0, 5, 2u);
...
LABEL_7:
  ...
  if ( *(unsigned __int8 *)(a1 + 464) != v67 )
    result = (uint8_t *)message_dispatch_c7ac(a1);
    ...
    do
    {
      if ( *(unsigned __int16 *)(a1 + 462) != v7 )
      {
        ...
        *((uint8_t *)v8 + 350) = v26;
        ...
        result = (uint8_t *)sub_13F2E0(v24, v27);
      }
...
LABEL_38:
      if ( *((unsigned __int8 *)v8 + 309) != v29 )
      {
        ...
        *((uint8_t *)v8 + 309) = v29;
        result = (uint8_t *)bt_chan_lookup(v39);
        *((uint8_t *)v8 + 350) |= 8u;
      }
LABEL_48:
