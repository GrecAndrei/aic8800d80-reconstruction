// sub_122830 @ 0x122830, size 392 bytes
int  sub_122830(int a1, int a2, int a3, int *a4)
{
  int v4; // r7
  int v5; // r11
  int v6; // r9
...
LABEL_8:
  ...
  v12 = off_1229BC;
  *(uint8_t *)(v7 + 141) = 1;
  if ( dword_1229C0 - v12[4] + *(uint32_t *)(v7 + 120) < 0 && !sub_1194CC(*(unsigned __int8 *)(v7 + 116), 0, 0) )
