...
extern uint32_t off_127F40;
extern uint32_t dword_127F44;
extern uint32_t off_127F54;
extern uint32_t dword_127F48;
...
int  sub_127D80(uint8_t *a1, int a2)
{
  ...
  if ( *a1 )
  {
    if ( v5 == 1 )
    {
      ...
      {
        v13 = *((uint8_t **)off_127F54 + 11);
        *((uint8_t *)off_127F54 + 88) &= ~4u;
        if ( v13 )
        {
