...
uint8_t * sub_131074(uint8_t *a1, int a2, int a3)
{
  ...
  if ( result )
  {
    ...
    if ( *(uint8_t *)(a3 + 164) )
    {
      ...
      {
        v5 = (unsigned __int8)((unsigned int)(((unsigned int)dword_131140
    ...
    else
    {
      ...
      else
      {
        v5 = v6 == 2484
           ? 14
           : (unsigned __int8)((unsigned int)(((unsigned int)dword_131140 * (unsigned uint64_t)(unsigned int)(v6 - 2407)) >> 32) >> 2);
        v7 = 1;
      }
    }
    v12[0] += 2;
