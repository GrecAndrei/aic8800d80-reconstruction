...
extern uint32_t off_10D3E8;
extern uint32_t dword_10D3F8;
extern uint32_t dword_10D3F4;
extern uint32_t off_10D3EC;
...
int  sub_10D26C(int a1, int a2, int a3)
{
  ...
  *(uint32_t *)(a2 + 32) = 0;
  ...
  {
    __disable_irq();
    *(uint32_t *)off_10D3EC = 1;
  }
  v6 = (int *)off_10D3F0;
  result = *(uint32_t *)off_10D3F0;
  v8 = *(uint32_t *)off_10D3F0 + 1;
  dword_40021000[16 * a3] |= 1u;
  *v6 = v8;
  while ( (dword_40021000[16 * a3] & 0x10000) == 0 )
    ;
  v9 = dword_10D3FC;
  v10 = *(uint32_t *)(dword_10D3FC + 4 * a3);
