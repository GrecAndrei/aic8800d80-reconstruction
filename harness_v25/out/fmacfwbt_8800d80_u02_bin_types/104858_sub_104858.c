...
extern uint32_t dword_104B84;
extern uint32_t dword_104B80;
extern uint32_t dword_104B88;
extern uint32_t dword_104B8C;
extern uint32_t dword_104B90;
...
int  sub_104858(int a1, int a2, uint32_t *a3, uint32_t *a4, int a5, int a6)
{
  ...
  v20 = ((int)((unsigned uint64_t)(dword_104B8C * (uint64_t)(0x2000 - v18)) >> 32) >> 9) - ((0x2000 - v18) >> 31);
  if ( a6 )
  {
    if ( v20 >= 5 )
      v20 = 5;
