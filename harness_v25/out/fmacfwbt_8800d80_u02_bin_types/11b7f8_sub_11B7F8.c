...
extern uint32_t off_11B8BC;
extern uint32_t off_11B8C0;
extern uint32_t off_11B8C4;
...
int  sub_11B7F8(int a1)
{
  ...
  {
    __disable_irq();
    *(uint32_t *)off_11B8BC = 1;
  }
  v4 = off_11B8C0;
  v5 = (int *)off_11B8C4;
  v6 = (char *)off_11B8C0 + 28 * a1;
  v7 = (uint8_t)v6[47];
  v8 = *(uint32_t *)off_11B8C4 + 1;
  *(uint32_t *)off_11B8C4 = v8;
  if ( v7 )
  {
    v9 = *((uint32_t *)v6 + 10);
    v6[47] = 0;
