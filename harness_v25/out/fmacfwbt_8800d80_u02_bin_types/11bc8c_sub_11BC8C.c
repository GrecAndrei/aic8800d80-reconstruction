...
extern uint32_t off_11BE0C;
extern uint32_t off_11BE10;
extern uint32_t dword_11BE14;

// sub_11BC8C @ 0x11bc8c, size 382 bytes
int  sub_11BC8C(int a1)
{
  uint32_t *v1; // r5
  int v2; // r6
  int v4; // r3
  ...
  if ( (v4 & 0x200000) != 0 )
  {
    v5 = off_11BE10;
    v6 = *(uint32_t *)(a1 + 68);
    if ( *(uint8_t *)(*(uint32_t *)off_11BE10 + 1) )
    {
      v7 = *(uint32_t *)(v6 + 88);
    }
    ...
    LODWORD(v9) = sub_11AD80(a1, (int)&v22);
    v8 = v22;
...
LABEL_25:
  ...
  {
LABEL_24:
    HIDWORD(v9) = *(uint8_t *)(*(uint32_t *)off_11BE10 + 1);
    goto LABEL_25;
  }
  v11 = *(uint32_t **)(a1 + 76);
...
LABEL_11:
    ...
    {
      v10 = (uint32_t *)(dword_11BE14 + 84 * v2);
      v10[1] = 0;
      v10[2] = 0;
      *v10 = v8;
      LODWORD(v9) = 84 * v2;
  ...
  if ( !v8[1] )
  {
    *(uint32_t *)(dword_11BE14 + 84 * v2) = v8;
    LODWORD(v9) = 84 * v2;
  }
  return v9;
}
