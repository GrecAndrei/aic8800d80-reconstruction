...
extern uint32_t dword_10B1AC;
extern uint32_t dword_10B1B4;
extern uint32_t dword_10B1D8;
extern uint32_t dword_10B190;
extern uint32_t off_10B194;
extern uint32_t dword_10B1B0;
extern uint32_t dword_10B1B8;
extern uint32_t off_10B198;
extern uint32_t dword_10B19C;
extern uint32_t dword_10B1A0;
extern uint32_t dword_10B1A4;
extern uint32_t dword_10B1C8;
extern uint32_t dword_10B280;
extern uint32_t dword_10B1CC;
extern uint32_t dword_10B1D0;
extern uint32_t dword_10B284;
extern uint32_t dword_10B1D4;
extern uint32_t dword_10B1A8;
