// sub_137744 @ 0x137744, size 1714 bytes
int  sub_137744(int a1)
{
  uint8_t *v1; // r11
  char v3; // r3
  char v4; // r1
  ...
  else if ( *((unsigned __int16 *)off_137B88 + 1926) != v142
         || (v9 = v143, *((unsigned __int16 *)off_137B88 + 1927) != v143)
         || (v10 = *((unsigned __int16 *)off_137B88 + 1928), v144 != v10) )
  {
    if ( !*((uint8_t *)off_137B78 + 408) || *((uint8_t *)off_137B88 + 3850) )
      return 0;
    v9 = v143;
    LOWORD(v10) = v144;
    v139 = 1;
  ...
  HIWORD(v148) = v10;
  HIWORD(v157) = 2 - (v11 & 1);
  v13 = sub_12DB40((unsigned __int8 *)(a1 + 48), v138, &v141);
  if ( v13 )
  {
    LOBYTE(v149) = v141;
    if ( v141 )
  ...
  if ( v138 )
  {
    ...
    while ( 1 )
    {
      ...
      while ( 1 )
      {
        ...
        v21 += v24 + 2;
        if ( sub_12DFF8(v22 + 2, 4) )
        {
          v16 = v23 + 4;
          v15 = sub_12E038(v25, v24);
          goto LABEL_13;
        }
        if ( v16 )
        {
          if ( v15 )
          {
            if ( !v14 )
            {
              v14 = sub_12DB40(v25, v24, &v145);
              if ( !v14 )
                goto LABEL_15;
            }
            goto LABEL_40;
          }
          v39 = sub_12E038(v25, v24);
          v15 = v39;
          if ( v14 )
          {
            if ( v39 )
...
LABEL_15:
      ...
      v18 = v135;
LABEL_17:
      v133 = (unsigned __int16)(v133 + (uint16_t)v132 - (uint16_t)v18 - v136);
      v132 = &v18[v136];
      if ( !v133 )
      {
LABEL_18:
  ...
  if ( !v139 && !sub_1372E0((unsigned __int8 *)&v149) )
  {
    if ( !v1[4029] )
      return 0;
    v27 = dword_137B74;
    ...
    while ( 1 )
    {
      ...
      if ( sub_1372E0((unsigned __int8 *)&v145) )
        break;
      if ( ++v28 >= (unsigned __int8)v1[4029] )
        return 0;
    }
  }
  v40 = sub_12DD88(v140, v138);
  if ( v40 )
  {
...
LABEL_54:
  ...
  v44 = sub_132418(*(unsigned __int8 *)(a1 + 6), *(unsigned __int16 *)(a1 + 4));
  v158 = v44;
LABEL_57:
  v46 = *(unsigned __int16 *)v44;
  if ( *(unsigned __int16 *)(a1 + 4) != v46 )
    *(uint16_t *)(a1 + 4) = v46;
  sub_137358(v140, v138, *(uint16_t *)(a1 + 46), (int)&v147);
  inited = fmac_init_context(&v142, 1);
  v48 = inited;
  if ( !inited )
    goto LABEL_78;
  v49 = *(uint8_t *)inited;
  ...
  if ( *(uint8_t *)inited )
  {
    if ( *(unsigned __int8 *)(inited + 8) != (unsigned __int8)v149 )
    {
      if ( *(uint8_t *)(inited + 8) && !(uint8_t)v149 )
      {
        LOBYTE(v50) = *(uint8_t *)(inited + 56);
        v51 = *(unsigned __int16 **)(inited + 44);
      }
      goto LABEL_63;
    }
    v87 = sub_1437AC(*(uint32_t *)(inited + 44), v158, 6);
...
LABEL_63:
  ...
  else
  {
    ...
    v75 = v149;
    v76 = v150;
    *(uint32_t *)inited = v147;
    *(uint32_t *)(inited + 4) = v74;
    *(uint32_t *)(inited + 8) = v75;
    *(uint32_t *)(inited + 12) = v76;
    v77 = v152;
    v78 = v153;
    v79 = v154;
    *(uint32_t *)(inited + 16) = v151;
    *(uint32_t *)(inited + 20) = v77;
    *(uint32_t *)(inited + 24) = v78;
    *(uint32_t *)(inited + 28) = v79;
    v80 = v156;
    v81 = v157;
    v82 = v158;
    *(uint32_t *)(inited + 32) = v155;
    *(uint32_t *)(inited + 36) = v80;
    *(uint32_t *)(inited + 40) = v81;
    *(uint32_t *)(inited + 44) = v82;
    v83 = v160;
    v84 = v161;
    *(uint32_t *)(inited + 48) = v159;
    *(uint32_t *)(inited + 52) = v83;
    *(uint32_t *)(inited + 56) = v84;
    *(uint8_t *)(inited + 56) = v50;
    *(uint32_t *)(inited + 44) = v51;
    ++*((uint16_t *)v1 + 2);
    *(uint8_t *)inited = 1;
    v85 = *((unsigned __int8 *)v51 + 2);
    if ( v85 <= 1 )
    {
      v63 = *(unsigned __int8 *)(inited + 8);
      if ( !*(uint8_t *)(inited + 8) )
      {
        if ( (**(uint16_t **)off_137DFC & 8) == 0 )
          goto LABEL_68;
        v64 = dword_137E00;
        goto LABEL_67;
      }
      v86 = *(uint16_t **)off_137DFC;
      ++*(uint16_t *)(dword_137DF8 + 2 * v85 + 4);
      if ( (*v86 & 8) == 0 )
        goto LABEL_68;
      goto LABEL_83;
    }
...
LABEL_68:
  ...
  *(uint8_t *)(v48 + 57) = 0;
  *(uint8_t *)(v48 + 58) = 0;
  v66 = (unsigned __int16 *)off_137B88;
  if ( v1[4029] )
  {
    v67 = off_137B88;
    while ( 2 )
    {
      ...
      if ( *((uint8_t *)v67 + 3906) )
      {
        ...
        if ( v69 <= 8 )
        {
          ...
          v146 = *(uint16_t *)(v48 + 6);
          v71 = (1 << v69) - 1;
          v72 = (unsigned __int16)(v146 ^ ((*(uint16_t *)(v48 + 6) + (v68 << 8)) ^ v146) & ((uint16_t)v71 << 8));
          v146 ^= ((*(uint16_t *)(v48 + 6) + (v68 << 8)) ^ v146) & (unsigned __int16)((uint16_t)v71 << 8);
          v73 = v66;
          do
          {
            if ( *((uint8_t *)v73 + 8)
          ...
          while ( v66 + 1920 != v73 );
          v100 = fmac_init_context((unsigned __int16 *)&v145, 1);
          if ( !v100 )
            break;
          v101 = *(uint32_t *)(v48 + 4);
          v102 = *(uint32_t *)(v48 + 8);
...
LABEL_77:
          ...
          *(uint8_t *)(*(unsigned __int8 *)(v48 + 8) + v100 + 9) = 0;
          sub_12ECB0(dword_137E04, v117, **(unsigned __int16 **)(v100 + 44), *(unsigned __int8 *)(v100 + 8), v100 + 9);
          ++v65;
          v67 += 2;
          if ( v65 < *((unsigned __int8 *)v66 + 4029) )
            continue;
...
LABEL_78:
  if ( v139 )
    return 0;
  message_dispatch_n94_cc48(a1, 4100, 13, 4);
  return 1;
}
