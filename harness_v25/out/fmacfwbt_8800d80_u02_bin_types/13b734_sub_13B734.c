...
extern uint32_t dword_13B990;
extern uint32_t dword_13B974;
extern uint32_t off_13B994;
extern uint32_t dword_13B980;
extern uint32_t dword_13B97C;
extern uint32_t off_13B978;
extern uint32_t dword_13B984;
extern uint32_t dword_13B98C;
extern uint32_t dword_13B988;

// sub_13B734 @ 0x13b734, size 576 bytes
int  sub_13B734(int a1, int a2, int a3, char a4, int16_t a5, int16_t a6, int a7)
{
  int v7; // r9
  int v8; // r7
  int v9; // r8
  ...
  v7 = dword_13B990;
  v8 = dword_13B974;
  v9 = *(uint8_t *)(dword_13B990 + 696 * a1 + 34);
  v10 = (int16_t **)off_13B994;
