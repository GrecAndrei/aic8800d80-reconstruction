...
int  sub_11F79C(int a1, int a2, int16_t a3, int16_t a4)
{
  uint32_t *v5; // r0
  uint32_t *v6; // r5
  unsigned int v7; // r3
  ...
  v5 = (uint32_t *)sub_11DDF0(1044, a4, a3, 0x48u);
  v6 = v5;
  switch ( *(uint32_t *)a2 )
  {
    case 0:
    ...
    case 1:
      ...
      *(uint32_t *)off_120658 = 0;
      ...
      ++*(uint32_t *)off_120664;
      sub_1158A4(v102);
      sub_1160FC(v237, dword_120668 + 28 * (int16_t)v237 + 12);
      if ( *v103 )
      {
        v104 = *v103 - 1;
...
LABEL_322:
    ...
    case 6:
      ...
      goto LABEL_21;
    case 7:
      sub_11F504(dword_11FFA8, *(uint8_t *)(a2 + 8));
      v48 = off_11FFB0;
    ...
    case 8:
      ...
      sub_10F170(v44);
      v45 = (uint8_t)sub_10F15C();
      v46 = sub_126E54();
      sub_126FD8(v45);
      if ( !v43 )
        sub_11F504(dword_120DC0, *((uint8_t *)off_120DBC + 4), *((char *)off_120DBC + 2));
      v47 = dword_11FFA4;
      *v6 = v45;
    ...
    case 0x11:
      ...
      *v6 = v50;
      ...
      goto LABEL_21;
    case 0x12:
      sub_11F504(dword_11FFB8, *(uint8_t *)(a2 + 8));
    ...
    case 0x14:
      ...
      {
        v150 = off_1209DC;
        sub_11F504(dword_1209E0, *(uint32_t *)off_1209DC);
      }
      *v6 = *v150;
      goto LABEL_21;
    case 0x15:
      ...
      if ( !v142 || (v143 = *(uint8_t *)(a2 + 8), !*(uint8_t *)(a2 + 8)) )
      {
        ...
        for ( i = 0; i != 3; ++i )
        {
          ...
          sub_10D654((uint8_t *)dword_120A00);
          v161 += 12;
        }
        v169 = dword_1209D0;
        v170 = dword_120A08;
      ...
      if ( v143 == 1 )
      {
        if ( v142 > 3 )
        {
          ...
          if ( v144 <= 2 )
          {
            ...
            v229 = dword_1212CC;
            sub_11F504(dword_1212C4, *(uint8_t *)(a2 + 9));
            v230 = a2 + 9;
...
LABEL_397:
            sub_10D654((uint8_t *)dword_1212C0);
            goto LABEL_233;
          }
LABEL_383:
...
LABEL_385:
            ...
            v223 = dword_1212CC;
            sub_11F504(dword_1212B8, *(uint8_t *)(a2 + 9));
            v224 = a2 + 9;
...
LABEL_269:
    ...
    case 0x1E:
      if ( sub_12645C() )
        sub_11F504(dword_120DA8, *(uint8_t *)off_120DA4);
...
LABEL_59:
    ...
    case 0x50:
      ...
      if ( *(uint32_t *)(a2 + 4) != 2 )
      {
        sub_11F504(dword_120D88, *(uint32_t *)(a2 + 4));
        goto LABEL_21;
      }
      if ( !*(uint8_t *)(a2 + 8) )
        goto LABEL_21;
...
LABEL_163:
    ...
    case 0x61:
      ...
      {
        sub_11F504(dword_120DB4, *(uint32_t *)off_120318 << 6);
      }
      else
      {
        v93 = *(uint32_t *)(a2 + 4);
        *v5 = 0xFFFF;
        ...
        else
        {
          ...
          {
            sub_11F504(dword_120D98, (uint16_t)v244, WORD1(v244), WORD2(v244), HIWORD(v244), v245);
