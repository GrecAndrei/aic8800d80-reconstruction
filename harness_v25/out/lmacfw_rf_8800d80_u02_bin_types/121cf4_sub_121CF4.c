...
LABEL_11:
  ...
  *(uint32_t *)off_121E24 = a2;
  if ( a3 )
    goto LABEL_11;
LABEL_3:
  v6 = (int *)off_121E28;
  v7 = off_121E2C;
  v8 = *(uint32_t *)off_121E28;
  *(uint32_t *)off_121E2C = *(uint32_t *)off_121E28;
  if ( a1 <= 0x17 )
  {
    switch ( a1 )
    {
      ...
      default:
        ...
        if ( a1 != 9 )
          goto LABEL_28;
        sub_10D654((uint8_t *)(dword_121E38 + (v8 & 7)));
