...
unsigned int * rf_level_apply_n_4ec(int a1)
{
  ...
  if ( a1 )
  {
    if ( a1 != 1 )
    {
      ...
      *(uint32_t *)rf_level_apply_n_207 = *(uint32_t *)rf_level_apply_n_20c & 0xFFFFBFFF;
      *v5 |= 0x80000000;
      *v6 |= 0x8000u;
      if ( a1 == 3 )
      {
          ...
          if ( v3 == 1 )
          {
            ...
            *result &= ~0x80000000;
            ...
            else if ( v4 == 2472 )
            {
              ...
              v48 = dword_126D54;
              *(uint32_t *)off_126D2C = rf_level_apply_n_88;
              REG_4034_2088 = v48;
            }
          }
          else
        ...
        else
        {
          ...
          *result &= ~0x80000000;
          ...
          else if ( v4 == 2472 )
          {
            ...
            v20 = dword_126C18;
            *(uint32_t *)rf_level_apply_n_1f4 = rf_level_apply_n_1c4;
            REG_4034_2088 = v20;
          }
        }
      }
      else
      {
        ...
        *(uint32_t *)rf_level_apply_n_1fc &= ~0x80000000;
        *v7 &= ~0x80000000;
        if ( v3 )
        {
          if ( v3 == 1 )
          {
            ...
            *(uint32_t *)rf_level_apply_n_1f4 = dword_126C38;
            *v31 = v32;
          }
        }
        else
        {
          ...
          *(uint32_t *)rf_level_apply_n_1f4 = dword_126BEC;
          *v8 = v9;
        }
      }
...
LABEL_10:
    ...
    if ( !*(uint8_t *)rf_level_apply_n_1b4 && *(uint32_t *)off_126C28 )
    {
      ...
      *(uint32_t *)rf_level_apply_n_200 |= 0x4000u;
      *v26 |= 0x10000u;
