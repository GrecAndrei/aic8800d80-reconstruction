// fwstruct annotate: 12c218_sub_12C218.c
// sub_12C218 @ 0x12c218, size 402 bytes
int __fastcall sub_12C218(int result, int a2, int a3, int a4)
{
  int v4; // r1
  int v5; // r4
  int v6; // r3
  ...
  *((_DWORD *)off_12C3AC + 1) = v5;
  if ( v6 )
    result = sub_12D32C(0x1000000);
  if ( (dword_12C3B8 & v5) != 0 )
    result = sub_12D32C(0x800000);
  if ( (v5 & 4) != 0 )
    result = sub_12B764();
  if ( (v5 & 8) != 0 )
