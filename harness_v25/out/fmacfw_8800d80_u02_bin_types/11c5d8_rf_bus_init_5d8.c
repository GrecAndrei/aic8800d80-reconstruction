// rf_bus_init_5d8 @ 0x11c5d8, size 748 bytes
// Doc: rf_bus_init_5d8 [rf]: Initialize the RF bus interface
// rf_bus_init_5d8 [rf]: Initialize the RF bus interface
int  rf_bus_init_5d8(int a1, int a2)
{
      ...
      if ( !--v9 )
      {
        ...
        if ( (v11 & 0x60) != 0x20 )
        {
          if ( (v11 & 0x20) == 0 )
          {
            v15 = dword_11C8E0;
            v16 = 84 * v5;
            rf_bus_mark_n100_d2d0(84 * v5 + 28 + dword_11C8E0);
            sub_11A2D0(v3);
            *(uint32_t *)(a1 + 68) = 0;
            goto LABEL_18;
          }
LABEL_7:
          ...
          *(uint32_t *)(a1 + 68) = 0;
          ...
          if ( v2[199] )
            goto LABEL_19;
LABEL_8:
          fmac_flag_read_a0(v2[190], (int)v12, v13, v14);
          rf_bus_mark_n100_d2d0(v16 + 12 + v15);
          if ( *(uint16_t *)(a1 + 4) )
...
LABEL_22:
    v15 = dword_11C8E0;
    rf_bus_mark_n100_d2d0(84 * (__int16)v5 + 28 + dword_11C8E0);
    sub_11A2D0(v3);
    *(uint32_t *)(a1 + 68) = 0;
  }
LABEL_12:
  ...
  if ( BYTE1(v7) <= 4u )
  {
    ...
    else
    {
      if ( *(uint16_t *)(a1 + 4) )
      {
        ...
        {
          v38 = *(uint32_t *)(dword_11C8D0 + 696 * *(unsigned __int8 *)(a1 + 29) + 340);
          if ( **(__int16 **)off_11C8CC < 0 && !*(uint32_t *)(dword_11C8D0 + 696 * *(unsigned __int8 *)(a1 + 29) + 340) )
          {
            v39 = v26;
