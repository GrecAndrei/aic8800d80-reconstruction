...
int  sub_11B84C(int a1)
{
  ...
  if ( (v4 & 0x200000) != 0 )
  {
    v5 = off_11B9D0;
    v6 = *(uint32_t *)(a1 + 68);
    if ( *(uint8_t *)(*(uint32_t *)off_11B9D0 + 1) )
    {
      v7 = *(uint32_t *)(v6 + 88);
    }
...
LABEL_25:
  ...
  {
LABEL_24:
    HIDWORD(v9) = *(unsigned __int8 *)(*(uint32_t *)off_11B9D0 + 1);
    goto LABEL_25;
  }
  v11 = *(uint32_t **)(a1 + 76);
...
LABEL_11:
    ...
    {
      v10 = (uint32_t *)(dword_11B9D4 + 84 * v2);
      v10[1] = 0;
      v10[2] = 0;
      *v10 = v8;
      LODWORD(v9) = 84 * v2;
  ...
  if ( !v8[1] )
  {
    *(uint32_t *)(dword_11B9D4 + 84 * v2) = v8;
    LODWORD(v9) = 84 * v2;
  }
  return v9;
}
