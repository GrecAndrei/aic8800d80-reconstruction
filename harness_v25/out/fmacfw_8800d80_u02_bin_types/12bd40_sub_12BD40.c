...
int sub_12BD40()
{
  ...
  if ( v3 - *((uint32_t *)off_12BE1C + 4) - 2000 - *((unsigned __int16 *)off_12BE24 + 92) - v4 < 0 )
  {
    if ( **(__int16 **)off_12BE30 < 0 && v3 - *((uint32_t *)off_12BE1C + 4) + 5000 < 0 )
    {
  ...
  else
  {
    if ( **(uint8_t **)off_12BE2C != 1 )
      return 1;
    if ( **(__int16 **)off_12BE30 < 0 && v3 - *((uint32_t *)off_12BE1C + 4) - v4 < 0 )
    {
