...
int  sub_10A9A8(unsigned int a1, unsigned int a2, int a3, unsigned int a4, unsigned __int8 a5, char a6)
{
  unsigned int v8; // s17
  int v9; // r3
  uint32_t *v10; // r2
...
LABEL_28:
  ...
  *(v35 - 6224) &= 0xCFFFFFFF;
  if ( a6 )
  {
    ...
    *(uint32_t *)off_10B004 = *(uint32_t *)off_10B004 & 0xFE01FFFF | ((unsigned __int8)v38 << 17);
