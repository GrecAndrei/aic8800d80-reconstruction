...
extern uint32_t off_120534;
extern uint32_t off_120538;
extern uint32_t off_12053C;
...
int sub_1204A8()
{
  ...
  if ( (uint16_t)(*(uint32_t *)off_120534 >> 12) && (uint16_t)(*(uint32_t *)off_120534 >> 12) <= 0x96u )
    result = (uint16_t)(*(uint32_t *)off_120534 >> 12);
  else
    result = 150;
  v1 = off_120538;
  v2 = off_12053C;
