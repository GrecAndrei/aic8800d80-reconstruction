...
LABEL_12:
  ...
  {
    result = off_126424;
    v74 = *(uint32_t *)(dword_126420 + 696 * *(unsigned __int8 *)(v71 + 116) + 8);
    v6 = *(unsigned __int8 *)(v2 + 24);
    v7 = v6 + 1;
    if ( v6 != 2 )
      goto LABEL_12;
...
LABEL_16:
  ...
  do
  {
    while ( 1 )
    {
      ...
      {
        v10 = *(uint32_t *)(dword_126420 + 696 * *(unsigned __int8 *)(v9 + 116) + 8);
      }
      if ( 2 * v74 <= v10 )
        v10 /= v10 / v74;
      v72 = (v10 >> 1) / v68;
    ...
    *v29 = v34;
    ...
    for ( j = 0; j != 4; ++j )
    {
      if ( ((v29[2] >> j) & 1) != 0 )
      {
        ...
        v78 = *(uint32_t *)(v39 + 36);
        v79 = v78 + 10000;
        result = (uint32_t *)sub_125CF4(v29, (unsigned int *)&v78, nullptr, v42);
