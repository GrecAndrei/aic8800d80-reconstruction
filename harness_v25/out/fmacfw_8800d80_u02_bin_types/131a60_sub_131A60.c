...
int  sub_131A60(int a1, int a2, int16_t a3, int16_t a4)
{
  uint8_t *v5; // r4
  int v6; // r0
  int v7; // r9
...
LABEL_8:
  ...
  *(uint8_t *)(v23 + 311) = v24;
  ...
  {
    chan_ctx_lookup_n2b8(*(uint8_t *)(v76 + 35), *(uint8_t *)(a2 + 128) & 3, *(uint8_t *)(a2 + 128) >> 4);
    if ( !v14 )
      goto LABEL_19;
  }
  else if ( !v14 )
  ...
  chan_ctx_lookup_n2b8(*(uint8_t *)(dword_131E30 + 696 * v15 + 35), 255, 0);
LABEL_19:
  v25 = v22 + 1320 * v7;
