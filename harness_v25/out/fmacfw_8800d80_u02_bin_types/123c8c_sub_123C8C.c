...
int  sub_123C8C(unsigned int a1, unsigned __int8 *a2, uint32_t *a3, int a4)
{
  int value; // r0
  int v9; // r1
  __int16 **v11; // r8
...
LABEL_16:
        ...
        *((uint8_t *)off_123F64 + 48) = 0;
        v16 = sub_12BCC0(*(uint32_t *)a2);
        if ( v16 )
        {
          sub_121984(*(uint32_t *)a2);
          v16 = 0;
        }
        else if ( v15[49] )
        {
          ...
          if ( sub_126440(v136) )
            rf_chan_info_copy_n_2d0(
              *(unsigned __int8 *)(*(uint32_t *)v136 + 1225),
              dword_123F68 + 38 * *(unsigned __int8 *)(*(uint32_t *)v136 + 107));
        }
        goto LABEL_10;
      }
      goto LABEL_24;
      ...
      else if ( a1 > 5 )
      {
        ...
        switch ( v65 )
        {
          case 0u:
            ...
            *(uint32_t *)(v124 + 84) = &loc_124476;
            *(uint32_t *)(v125 + 84) = v124;
            *(uint32_t *)(2 * v125 + 0x54) = v114;
            v126 = *(uint32_t *)(*(__int16 *)(v124 + v125) + 4);
            *(uint32_t *)(v125 + 84) = v124;
...
LABEL_24:
    ...
    else if ( a1 > 5 )
    {
      switch ( a1 )
      {
        case 6u:
LABEL_76:
          v63 = (uint8_t *)sub_12C92C(7, a4, a3, 2);
          v15 = off_1242D4;
...
LABEL_63:
          ...
          if ( *(uint8_t *)(v57 + 106) )
            ...
            *(uint32_t *)(dword_1242C0 + 696 * *(unsigned __int8 *)(v57 + 116) + 8) = v56 << 10;
          sub_12CA10(21, a4, a3);
          v15 = off_1242D4;
          v16 = 0;
          goto LABEL_10;
...
LABEL_33:
          ...
          if ( !v33 )
          {
            ...
            if ( v34 )
            {
              ...
              v36 = v132 + 24 + v30;
              timestamp_update(v36, *((uint32_t *)off_1242C4 + 4) + *(uint32_t *)(v35 + 8));
              *(uint16_t *)(v35 + 32) = *(uint16_t *)a2;
              sub_120418();
              feature_guard_check(256, dword_1242C8);
              v37 = off_1242D0;
              *(uint32_t *)off_1242CC = (unsigned __int16)*(uint32_t *)off_1242CC | (*(unsigned __int16 *)a2 << 16);
              if ( (*v37 & 0x8000) != 0 && sub_1019FC() && (*(uint32_t *)(v35 + 4) & 0x20) != 0 )
              {
                sub_101A88(*(uint16_t *)a2);
                sub_11C310();
                ...
                if ( v127 )
                {
                  ...
                  if ( v83 )
                  {
                    ...
                    if ( !*((uint32_t *)off_124954 + 8) )
                    {
                      ...
                      *v86 = (unsigned __int16)(*(uint32_t *)(v85 + 696 * v84 + 8) >> 10) | (HIWORD(*v86) << 16);
                      v129 = v83;
...
LABEL_32:
          v15 = off_123F64;
          *(uint32_t *)off_123F88 = *a2 | (((unsigned __int8)*(uint32_t *)off_123F84 * *a2) << 8);
          sub_12CA10(33, a4, a3);
          v16 = 0;
          goto LABEL_10;
        case 0x28u:
LABEL_27:
          ...
          else
          {
            ...
            v20 = *(uint32_t *)(dword_123F78 + 4 * *(unsigned __int8 *)(dword_123F74 + v18));
            if ( (int)v19 >= v20 )
            {
              if ( v19 > 0x40 )
                LOWORD(v21) = *(uint32_t *)(dword_123F78 + 4 * *(unsigned __int8 *)(dword_123F74 + v18));
              else
                LOWORD(v21) = v20 / 2;
            }
            else
          ...
          v28 = (uint8_t *)sub_12C92C(41, a4, a3, 3);
          *v28 = a2[1];
          v28[1] = a2[2];
          v28[2] = v17;
...
LABEL_25:
    ...
    v16 = 2;
LABEL_10:
    *(uint32_t *)off_123F60 = (unsigned __int8)(16 * v15[19]);
    sub_12CD34(a3);
    return v16;
  }
