...
extern uint32_t off_12F940;
extern uint32_t off_12F944;
extern uint32_t off_12F94C;
extern uint32_t off_12F948;
...
LABEL_11:
  ...
  *(uint32_t *)off_12F940 = a2;
  if ( a3 )
    goto LABEL_11;
LABEL_3:
  v6 = (int *)off_12F944;
  v7 = off_12F948;
  v8 = *(uint32_t *)off_12F944;
  *(uint32_t *)off_12F948 = *(uint32_t *)off_12F944;
  if ( a1 <= 0x17 )
  {
    switch ( a1 )
    {
