...
int  sub_125184(unsigned __int16 *a1)
{
  unsigned int v1; // r2
  int v2; // r3
  int v5; // r0
    ...
    if ( *((uint8_t *)a1 + 2) )
    {
      if ( ((unsigned __int8)v7 & *(uint8_t *)(v6 + v5)) == 0 )
      {
        ...
        *v9 = v10 | v8;
        ...
        if ( v14 > v6 )
        {
          *(uint32_t *)(dword_1253C8 + 40 * v2 + 28) = v5 + (v6 & 0xFE);
      ...
      *(uint16_t *)(v23 + 220) = v24;
      if ( v24 )
      {
        ...
        if ( v25 == (v6 & 0xFE) )
        {
          ...
          v32 = v33;
LABEL_22:
          *(uint32_t *)(dword_1253C8 + 40 * v2 + 28) = v32 + v5;
...
LABEL_28:
          *(uint32_t *)(dword_1253C8 + 40 * v2 + 32) = v5;
        }
        v28 = v22 + 1320 * v2;
  ...
  {
    *(uint8_t *)(dword_1253BC + 1320 * v2 + 230) = 1;
  }
  else
  {
