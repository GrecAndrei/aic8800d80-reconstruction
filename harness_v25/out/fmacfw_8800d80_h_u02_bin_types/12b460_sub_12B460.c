...
unsigned int  sub_12B460(unsigned int result)
{
  uint32_t *v1; // r6
  unsigned int v2; // r5
  int v3; // r2
  ...
  v1 = off_12B688;
  v2 = (unsigned __int8)*(uint32_t *)off_12B688;
  if ( result != v2 )
  {
    v3 = dword_12B68C;
    v4 = dword_12B690;
    ...
    *(uint32_t *)off_12B694 = dword_12B698 & ((v6 * (unsigned __int16)(*(uint32_t *)off_12B694 >> 8) / v2) << 8)
    ...
    *(uint32_t *)off_12B6A8 = dword_12B698 & ((v6 * (unsigned __int16)(*(uint32_t *)off_12B6A8 >> 8) / v2) << 8)
