...
extern uint32_t off_128140;
extern uint32_t dword_128144;
extern uint32_t dword_128158;
extern uint32_t dword_128148;
extern uint32_t off_12814C;
          ...
          if ( v11 - *(uint32_t *)(v6 + 4) - result - 4000 < 0 )
          {
            ...
            *(uint32_t *)(v6 + 4) = v12 - 4000 - result;
            if ( v13 == v6 )
            {
              ...
              {
                __disable_irq();
                *(uint32_t *)off_12814C = 1;
              }
              v14 = (int *)off_128154;
              v15 = *(uint32_t *)(v6 + 4);
              v16 = *(uint32_t *)off_128154;
              v17 = v15 - *((uint32_t *)off_128150 + 4);
              v18 = *(uint32_t *)off_128154 + 1;
