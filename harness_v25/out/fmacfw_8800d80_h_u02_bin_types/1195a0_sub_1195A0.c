...
int  sub_1195A0(int a1, int a2, int a3)
{
  ...
  if ( v3 <= 0xE78 )
  {
    ...
    if ( (v10 & 2) == 0 )
    {
      ...
      if ( v11 )
      {
        if ( *(uint32_t *)(v11 + 16) != dword_119720 || (int)(v3 + *(unsigned __int16 *)(v8 + 10)) <= 3704 )
          return result;
        goto LABEL_16;
      }
      return 0;
...
LABEL_16:
  ...
  else
  {
    ...
    if ( v14 != 1 )
    {
      ...
      {
        if ( (*(uint32_t *)off_119728 & 0x3F) > *(unsigned __int8 *)(*(uint32_t *)off_119724 + 62)
                                            + *(unsigned __int8 *)(*(uint32_t *)off_119724 + 63) )
        {
          v16 = *(uint32_t *)(v15 + 76);
          *(uint8_t *)(v16 + 1) = v14;
          v17 = *(uint32_t *)(v13 + 48);
          ...
          *(uint32_t *)(v8 + 324) = v15;
          sub_11C410(v17);
          v18 = *(unsigned __int8 *)(*(uint32_t *)off_11972C + 1);
