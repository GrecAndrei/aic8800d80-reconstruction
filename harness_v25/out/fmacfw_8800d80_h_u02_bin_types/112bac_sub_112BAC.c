...
extern uint32_t off_112E00;
extern uint32_t dword_112E28;
extern uint32_t off_112E14;
extern uint32_t off_112E18;
extern uint32_t off_112E1C;
extern uint32_t dword_112E20;
extern uint32_t dword_112E24;
extern uint32_t dword_112E04;
extern uint32_t dword_112E08;
extern uint32_t dword_112E10;
...
int sub_112BAC()
{
  ...
  v0 = off_112E00;
  v1 = *((uint32_t *)off_112E00 + 5);
  *((uint32_t *)off_112E00 + 5) = v1;
  v2 = v0[6] & v1;
  LODWORD(v3) = v2 << 19;
  if ( (v2 & 0x1000) != 0 )
  {
  ...
  v22 = *((uint32_t *)off_112E00 + 514);
  if ( (v22 & 6) != 0 && (v22 & 2) != 0 )
    *(uint32_t *)off_112E14 = 1;
  v23 = off_112E00;
  v24 = (uint32_t **)off_112E18;
  v25 = (int *)off_112E1C;
  v26 = dword_112E20;
  *((uint32_t *)off_112E00 + 576) = dword_112E20;
  v23[704] = v26;
  v27 = *v24;
  v28 = *v25;
...
LABEL_3:
  if ( v5 )
  {
    v8 = off_112E00;
    v9 = dword_112E04;
    v5 = *((uint32_t *)off_112E00 + 518);
    v10 = 0;
    v11 = v5 & *((uint32_t *)off_112E00 + 519);
    while ( 1 )
    {
      LODWORD(v3) = 1;
      if ( ((1 << v10) & v11) != 0 )
...
LABEL_14:
  ...
  if ( v6 )
  {
    ...
    v15 = dword_112E0C;
    v16 = dword_112E2C;
    v17 = *((uint32_t *)off_112E00 + 518) & *((uint32_t *)off_112E00 + 519);
    for ( i = 0; ; ++i )
    {
      if ( ((0x10000 << i) & v17) != 0 )
      {
        ...
        *((uint32_t *)v19 + 714) = v5;
        if ( (v14[517] & v5 & 1) != 0 )
        {
          if ( *(uint8_t *)(v15 - 8) )
          {
            ...
            v29 = *(int ( **)(int, int, uint32_t))(4 * i + dword_112E08 + 32);
            if ( v29 )
