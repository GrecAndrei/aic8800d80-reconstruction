...
extern uint32_t off_12B124;
extern uint32_t off_12B128;
extern uint32_t dword_12B12C;
...
int sub_12B064()
{
  ...
  v2 = *(uint32_t *)off_12B124 + 6 * *((uint8_t *)off_12B124 + 10);
  v3 = 6 * *((uint8_t *)off_12B124 + 10);
  v4 = *(uint8_t *)(v2 + 3);
  if ( (v4 & 5) != 0 )
  {
