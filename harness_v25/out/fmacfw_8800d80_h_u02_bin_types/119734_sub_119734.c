...
int  sub_119734(int a1, int *a2, unsigned int a3, unsigned int a4, unsigned __int8 a5)
{
  int *v5; // r4
  int v6; // r5
  int v8; // r6
  ...
  *a2 = v22;
  ...
  if ( v10 )
    *(uint32_t *)(*(uint32_t *)(v8 + 32) - 3) = *((uint32_t *)off_119880 + 43);
