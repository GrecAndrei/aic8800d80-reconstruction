...
uint8_t * sub_130D18(uint8_t *a1, int a2, int a3)
{
  ...
  if ( result )
  {
    ...
    if ( *(uint8_t *)(a3 + 164) )
    {
      if ( v5 == 1 && (unsigned __int16)(*(uint16_t *)(a3 + 166) - 5005) <= 0x370u )
      {
        v5 = (unsigned __int8)((unsigned int)(((unsigned int)dword_130DE4
                                             * (unsigned uint64_t)((unsigned int)*(unsigned __int16 *)(a3 + 166) - 5000)) >> 32) >> 2);
        v7 = 4;
      }
      else
      {
    ...
    else
    {
      ...
      else
      {
        v5 = v6 == 2484
           ? 14
           : (unsigned __int8)((unsigned int)(((unsigned int)dword_130DE4 * (unsigned uint64_t)(unsigned int)(v6 - 2407)) >> 32) >> 2);
        v7 = 1;
      }
    }
    v12[0] += 2;
