...
extern uint32_t off_102DE8;
extern uint32_t dword_102E04;
extern uint32_t dword_102DF8;
extern uint32_t dword_102DEC;
extern uint32_t dword_102DF0;
...
LABEL_10:
  ...
  *(uint32_t *)off_102DE8 = 1;
  if ( v23 )
  {
    v15 = *(uint32_t *)off_102DF4;
    v25 = *(uint64_t *)off_102DF4;
    v26 = *((uint32_t *)off_102DF4 + 2);
    v16 = 3;
  }
  else
  {
    v15 = qword_102DFC;
    v26 = 0;
    HIDWORD(v25) = HIDWORD(qword_102DFC);
    v16 = 2;
  }
  v17 = (char *)&v25 + 4;
  v18 = dword_102DF8;
