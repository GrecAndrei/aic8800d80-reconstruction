...
int  sub_119888(int a1, int *a2, unsigned int a3, unsigned int a4, unsigned __int8 a5)
{
  int v5; // r5
  int v7; // r4
  int v8; // s16
  ...
  if ( !sub_1195A0(a1, v7, a5)
    || (v12 = off_119BA4, *(unsigned __int8 *)(*(uint32_t *)off_119BA4 + 62) > (*(uint32_t *)off_119B8C & 0x3Fu)) )
  {
    sub_12D150(v8, v5);
    return 0;
  }
