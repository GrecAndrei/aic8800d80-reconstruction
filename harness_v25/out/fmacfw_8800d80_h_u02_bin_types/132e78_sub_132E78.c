...
uint8_t * sub_132E78(int a1, int16_t a2, unsigned int a3)
{
  int v4; // r3
  int v5; // r6
  int v6; // r0
  ...
  if ( (v13[374] & 6) != 0 )
  {
    ...
    if ( !*(uint8_t *)(a1 + 106) )
    {
      ...
      if ( v63
        ...
        && (v63[2] & 0x80u) == 0 )
      {
        sub_132C48(*(uint8_t *)(a1 + 116), v63[2] & 3);
      }
      if ( (*(uint32_t *)(a1 + 472) & 8) != 0 )
      {
        v73 = (uint8_t *)sub_12C7EC(109, 0, 5, 2u);
...
LABEL_102:
  ...
  sub_132BD8((int)v14, 0, a1 + 248);
LABEL_7:
  v15 = (uint8_t)sub_130E10(v10, v12, v74, a1 + 1212);
  if ( v15 )
  {
    if ( *(uint8_t *)(a1 + 106) )
    {
    ...
    do
    {
      if ( *(uint16_t *)(a1 + 462) != v7 )
      {
        ...
        *((uint8_t *)v8 + 350) = v26;
        ...
        result = (uint8_t *)sub_13F104(v24, v27);
      }
      v28 = *(uint8_t *)(a1 + 413);
      if ( v28 == v9 )
        goto LABEL_48;
