...
uint8_t * sub_132E78(int a1, __int16 a2, unsigned int a3)
{
  int v4; // r3
  int v5; // r6
  int v6; // r0
...
LABEL_2:
  ...
  {
    v14 = (unsigned __int8 *)(*((uint8_t *)off_1332E8 + 374) & 1);
    v68 = v14;
LABEL_6:
  ...
  if ( (v13[374] & 6) != 0 )
  {
    ...
    if ( !*(uint8_t *)(a1 + 106) )
    {
      ...
      if ( v63
        && (*(uint32_t *)(dword_133454 + 696 * *(unsigned __int8 *)(a1 + 116) + 4) & 0x24) != 0
        && (v63[2] & 0x80u) == 0 )
      {
