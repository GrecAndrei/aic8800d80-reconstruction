...
extern uint32_t dword_13A99C;
extern uint32_t dword_13A9A0;
extern uint32_t off_13A9A8;
extern uint32_t dword_13A9B0;
...
uint16_t * sub_13A840(int a1, uint16_t *a2, int a3)
{
  ...
  if ( v7 )
  {
    v9 = dword_13A9A0 + 1320 * *(uint8_t *)(a1 + 28);
    if ( *(uint32_t *)(v9 + 1200) )
    {
...
LABEL_17:
          ...
          *(uint32_t *)(v13 + 12) = dword_13A9A4 & *(uint32_t *)(v13 + 12) | (uint8_t)v7[98];
        }
      }
    }
  }
