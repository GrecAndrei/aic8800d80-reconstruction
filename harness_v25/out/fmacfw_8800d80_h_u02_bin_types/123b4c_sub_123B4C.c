...
int  sub_123B4C(unsigned int a1, unsigned __int8 *a2, uint32_t *a3, int a4)
{
  int v8; // r0
  int v9; // r1
  __int16 **v11; // r8
...
LABEL_16:
        ...
        *((uint8_t *)off_123E24 + 48) = 0;
        v16 = sub_12BB80(*(uint32_t *)a2);
        if ( v16 )
        {
          sub_121844(*(uint32_t *)a2);
          v16 = 0;
        }
        else if ( v15[49] )
        {
          ...
          if ( sub_126300(v136) )
            sub_12AA90(
              *(unsigned __int8 *)(*(uint32_t *)v136 + 1225),
              dword_123E28 + 38 * *(unsigned __int8 *)(*(uint32_t *)v136 + 107));
        }
        goto LABEL_10;
      }
      goto LABEL_24;
...
LABEL_24:
    ...
    else if ( a1 > 5 )
    {
      switch ( a1 )
      {
        case 6u:
LABEL_76:
          v63 = (uint8_t *)sub_12C7EC(7, a4, a3, 2);
          v15 = off_124194;
...
LABEL_63:
          ...
          if ( *(uint8_t *)(v57 + 106) )
            ...
            *(uint32_t *)(dword_124180 + 696 * *(unsigned __int8 *)(v57 + 116) + 8) = v56 << 10;
          sub_12C8D0(21, a4, a3);
          v15 = off_124194;
          v16 = 0;
          goto LABEL_10;
...
LABEL_33:
          ...
          if ( !v33 )
          {
            ...
            if ( v34 )
            {
              ...
              v36 = v132 + 24 + v30;
              sub_124BFC(v36, *((uint32_t *)off_124184 + 4) + *(uint32_t *)(v35 + 8));
              *(uint16_t *)(v35 + 32) = *(uint16_t *)a2;
              sub_1202D8();
              sub_12EB90(256, dword_124188);
              v37 = off_124190;
              *(uint32_t *)off_12418C = (unsigned __int16)*(uint32_t *)off_12418C | (*(unsigned __int16 *)a2 << 16);
              if ( (*v37 & 0x8000) != 0 && sub_101950() && (*(uint32_t *)(v35 + 4) & 0x20) != 0 )
              {
                sub_1019DC(*(uint16_t *)a2);
                sub_11C1D0();
...
LABEL_32:
          v15 = off_123E24;
          *(uint32_t *)off_123E48 = *a2 | (((unsigned __int8)*(uint32_t *)off_123E44 * *a2) << 8);
          sub_12C8D0(33, a4, a3);
          v16 = 0;
          goto LABEL_10;
        case 0x28u:
LABEL_27:
          ...
          else
          {
            ...
            v20 = *(uint32_t *)(dword_123E38 + 4 * *(unsigned __int8 *)(dword_123E34 + v18));
            if ( (int)v19 >= v20 )
            {
              if ( v19 > 0x40 )
                LOWORD(v21) = *(uint32_t *)(dword_123E38 + 4 * *(unsigned __int8 *)(dword_123E34 + v18));
              else
                LOWORD(v21) = v20 / 2;
            }
            else
          ...
          v28 = (uint8_t *)sub_12C7EC(41, a4, a3, 3);
          *v28 = a2[1];
          v28[1] = a2[2];
          v28[2] = v17;
          sub_12C84C(v28);
...
LABEL_25:
    ...
    v16 = 2;
LABEL_10:
    *(uint32_t *)off_123E20 = (unsigned __int8)(16 * v15[19]);
    sub_12CBF4(a3);
    return v16;
  }
