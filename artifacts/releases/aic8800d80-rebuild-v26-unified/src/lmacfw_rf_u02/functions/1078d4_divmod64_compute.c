...
int * divmod64_compute(int *a1)
{
  ...
  v1 = a1[1];
  v2 = ((unsigned uint64_t)(dword_107940 * (uint64_t)v1) >> 32) - (v1 >> 31);
  v3 = a1[3] - v1 / 2 + v2 + (v1 >> 31) - ((unsigned uint64_t)(dword_10793C * (uint64_t)v1) >> 32);
  v4 = ((unsigned uint64_t)(dword_107940 * (uint64_t)*a1) >> 32) - (*a1 >> 31);
  v5 = (*a1 >> 31) - ((unsigned uint64_t)(dword_10793C * (uint64_t)*a1) >> 32);
  v6 = a1[2] - *a1 / 2 + v4;
  result = a1 + 7;
  for ( i = 0; i != 9; i += 3 )
  {
