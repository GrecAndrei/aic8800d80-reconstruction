...
extern uint32_t dword_1423B4;
extern uint32_t off_1423B8;
extern uint32_t dword_1423D0;
extern uint32_t dword_1423CC;
extern uint32_t dword_1423BC;
extern uint32_t off_1423C0;
extern uint32_t dword_1423C8;
extern uint32_t dword_1423C4;

// bt_hci_cmd_dispatch_n_dc @ 0x14216c, size 582 bytes
// Doc: bt_hci_cmd_dispatch_n_dc [bt]: Dispatch Bluetooth HCI command from IPC message
// bt_hci_cmd_dispatch_n_dc [bt]: Dispatch Bluetooth HCI command from IPC message
unsigned int  bt_hci_cmd_dispatch_n_dc(unsigned int result)
{
  int v1; // r1
  int v2; // r2
  int v3; // r5
  ...
  v4 = result;
  v5 = v2;
  if ( (v1 != 255 || !*(uint8_t *)(dword_1423B4 + 1320 * v2 + 108))
    && (*(uint32_t *)(dword_1423B4 + 1320 * v2 + 472) & 8) != 0 )
  {
    if ( *(uint8_t *)(result + 12) == 22 )
    {
      ...
      if ( v6 == 6 )
      {
        ...
        if ( (v15 & 0xC) == 0 )
        {
          ...
          if ( v19 == 4 )
          {
            if ( (v18 & 1) == 0 )
            {
              ...
              if ( *(uint64_t *)(v26 + 40) )
              {
                ...
                while ( (uint16_t *)(dword_1423BC + 576) != v27 );
                v31 = (char *)off_1423C0;
                *(uint8_t *)(v30 + 47) = v28;
                v32 = *v31;
                *(uint8_t *)(v30 + 46) = v29;
                ...
                *(uint16_t *)v30 = 1;
                *v31 = v33 + 1;
                bt_he_riu_field_write(v17, v20, v15, (int16_t *)v30);
                ipc_msg_send_header(4, v30);
          ...
          {
            bt_he_riu_field_write((uint16_t *)(v4 + 18), v20, v15, v37);
            return ipc_msg_send_header((v18 >> 1) & 7, (int)v37);
          }
        }
      }
      else if ( v6 == 7 )
