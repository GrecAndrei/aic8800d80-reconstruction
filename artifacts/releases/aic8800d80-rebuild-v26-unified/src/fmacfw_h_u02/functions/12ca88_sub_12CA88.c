...
extern uint32_t off_12CB84;
extern uint32_t off_12CB6C;
extern uint32_t dword_12CB7C;
extern uint32_t dword_12CB78;
extern uint32_t off_12CB70;
...
uint32_t * sub_12CA88(char *a1)
{
  ...
  {
    __disable_irq();
    *(uint32_t *)off_12CB70 = 1;
  }
  result = off_12CB74;
  v7 = *(uint32_t *)off_12CB74;
  v8 = *(uint32_t *)off_12CB74 + 1;
  *(uint32_t *)off_12CB74 = v8;
  if ( !v2 )
  {
    MEMORY[0] = v5;
    __und(0xFFu);
