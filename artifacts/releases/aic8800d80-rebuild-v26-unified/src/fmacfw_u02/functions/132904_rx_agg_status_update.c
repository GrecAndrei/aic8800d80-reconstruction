...
extern uint32_t off_132C2C;
extern uint32_t dword_132C30;
extern uint32_t dword_132C34;
extern uint32_t dword_132C38;
extern uint32_t dword_132C48;
extern uint32_t off_132C3C;
extern uint32_t dword_132D00;
extern uint32_t dword_132CFC;
extern uint32_t off_132C40;
extern uint32_t off_132C44;

// rx_agg_status_update @ 0x132904, size 1016 bytes
// Doc: rx_agg_status_update [rx]: Process RX aggregation status with descriptor fetch
// rx_agg_status_update [rx]: Process RX aggregation status with descriptor fetch
uint32_t * rx_agg_status_update(int a1)
{
  char v1; // r3
  uint32_t *v2; // r6
  int *v3; // r4
...
LABEL_23:
  if ( (v1 & 0x20) != 0 )
  {
    ...
    *(uint32_t *)(v28 + 156) = v66 & v33 | v68;
    if ( rf_feature_check(5u, 4u) )
      msg_parse(dword_132C38, *(uint32_t *)(v28 + 156), v29);
  ...
  if ( (v1 & 0x10) != 0 )
  {
    v63 = dword_132C30 + 1320 * *(uint8_t *)(a1 + 34);
    v69 = v2;
    v39 = v77;
    v40 = (unsigned int *)v76;
    v41 = v3;
    v42 = (uint8_t *)off_132C2C;
    do
    {
      v43 = v42[197];
      v45 = *v40++;
  ...
  if ( (v1 & 0x40) != 0 )
  {
    v47 = *(uint32_t *)(dword_132C30 + 1320 * *(uint8_t *)(a1 + 34) + 468);
    v48 = v64 & 0xFC0FFFFF;
    v64 &= 0xFC0FFFFF;
    if ( v47 >= 0 )
  ...
  {
    __disable_irq();
    *(uint32_t *)off_132C40 = 1;
  }
  v49 = off_132C44;
  v50 = *(uint32_t *)off_132C44;
  v2[1] = v61;
  v2[2] = v64;
  *v49 = v50 + 1;
  do
