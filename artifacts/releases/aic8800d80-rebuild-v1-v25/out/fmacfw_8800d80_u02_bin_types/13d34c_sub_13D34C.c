  ...
  switch ( *(uint8_t *)(result + 169) )
  {
    ...
    case 3:
      ...
      do
      {
        --v2;
        v3 += (v1 & 1)
            * (((*(unsigned __int8 *)(result + 179) + 1) << *(uint8_t *)(result + 181))
             + *(unsigned __int8 *)(result + 180)
             * (unsigned __int16)((*(unsigned __int8 *)(result + 179) + 1) << *(uint8_t *)(result + 181)));
        v1 >>= 1;
      }
      while ( v2 );
      result = (unsigned __int16)(((((*(unsigned __int16 *)(result + 174) >> 2) & 1)
                                  + ((*(unsigned __int16 *)(result + 174) >> 1) & 1)) << (1 - *(uint8_t *)(result + 182)))
                                + (*(uint16_t *)(result + 174) & 1)
                                + (((*(unsigned __int16 *)(result + 174) >> 3) & 1) << (1 - *(uint8_t *)(result + 182)))
                                + v3);
      goto LABEL_5;
    case 4:
      v9 = *(unsigned __int8 *)(result + 180);
      v10 = (*(uint16_t *)(result + 170) & 3) - 1;
      v11 = (*(unsigned __int8 *)(result + 179) + 1) << *(uint8_t *)(result + 181);
      if ( v10 <= 1 )
        v12 = 9;
      else
        v12 = 8;
