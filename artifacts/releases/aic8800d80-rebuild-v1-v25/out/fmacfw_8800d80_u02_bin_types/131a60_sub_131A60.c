...
int  sub_131A60(int a1, int a2, __int16 a3, __int16 a4)
{
  ...
  if ( (v8 & 4) != 0 )
  {
    ...
    v60 = sdio_buffer_prepare_n_16c(v59 + dword_131E34, *(uint16_t *)(a2 + 124));
    v8 = *(uint32_t *)(a2 + 120);
    v9 = v60;
    goto LABEL_4;
  }
...
LABEL_8:
  ...
  *(uint8_t *)(v23 + 311) = v24;
  ...
  {
    chan_ctx_lookup_n2b8(*(unsigned __int8 *)(v76 + 35), *(uint8_t *)(a2 + 128) & 3, *(unsigned __int8 *)(a2 + 128) >> 4);
    if ( !v14 )
      goto LABEL_19;
  }
  else if ( !v14 )
        ...
        if ( v34 <= 0x1F )
        {
          ...
          *v62 = v32;
          ...
          else
          {
            ...
            v78 = v5;
            v64 = v33;
            v65 = (uint32_t *)(dword_131F24 - 664 + 8 * (87 * (__int16)v32 + 78));
