// sub_13EC70 @ 0x13ec70, size 1094 bytes
int  sub_13EC70(int a1)
{
  char v1; // r3
  int result; // r0
  int v4; // r5
  ...
  while ( 2 )
  {
    switch ( (char)v4 )
    {
      case 1:
          ...
          HIWORD(v50) = v26
                      | (((uint16_t)v37
                        - (((((unsigned int)dword_13F0B8 * (unsigned uint64_t)(unsigned int)v37) >> 32) & 0xFFFE)
                         + (unsigned __int16)((unsigned int)(((unsigned int)dword_13F0B8
        ...
        goto LABEL_68;
      case 2:
        v35 = sub_13CE78(a1, v26);
        if ( v35 != v26 )
        {
          v49 = v35;
          if ( sub_13D25C(a1, v35) )
            v51 = v49;
        }
        goto LABEL_68;
      case 3:
        v34 = sub_13D54C(a1, v26);
        if ( v34 != v26 )
        {
          v48 = v34;
          if ( sub_13D25C(a1, v34) )
            v52 = v48;
        }
        goto LABEL_68;
      case 4:
        v33 = sub_13CE78(a1, v25);
        if ( v25 != v33 )
        {
          v47 = v33;
          if ( sub_13D25C(a1, v33) )
            v53 = v47;
        }
LABEL_68:
        if ( v23 <= 3 )
        ...
        goto LABEL_71;
      case 5:
        v27 = sub_13D54C(a1, v25);
        if ( v25 != v27 )
        {
          v46 = v27;
          if ( sub_13D25C(a1, v27) )
            v54 = v46;
        }
