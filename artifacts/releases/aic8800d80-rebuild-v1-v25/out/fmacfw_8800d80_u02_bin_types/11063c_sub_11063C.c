...
int  sub_11063C(int a1, int a2)
{
  ...
  v2 = off_110760;
  v3 = (int *)off_110764;
  v21 = *(unsigned __int16 *)(*(uint32_t *)off_11075C + 48);
  log_queue_refill(a2);
...
LABEL_23:
      if ( *(unsigned __int16 *)(a2 + 0xC) >= (unsigned int)*(unsigned __int16 *)(*(uint32_t *)off_11075C + 50) )
        return 1;
LABEL_24:
    ...
    *v2 = 1;
    ...
    {
      if ( **(__int16 **)off_110770 < 0 && *(uint32_t *)off_110774 )
      {
