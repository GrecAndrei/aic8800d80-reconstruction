...
int  sub_1199C8(int a1, int *a2, unsigned int a3, unsigned int a4, unsigned __int8 a5)
{
  int v5; // r5
  int v7; // r4
  int v8; // s16
  ...
  if ( !rx_desc_compare_n6e0(a1, v7, a5)
    || (v12 = off_119CE4, *(unsigned __int8 *)(*(uint32_t *)off_119CE4 + 62) > (*(uint32_t *)off_119CCC & 0x3Fu)) )
  {
    sub_12D290(v8, v5);
    return 0;
  }
...
LABEL_7:
    if ( *(unsigned __int8 *)(*(uint32_t *)v12 + 62) > (*v48 & 0x3Fu) )
      goto LABEL_17;
    if ( *(uint32_t *)(v24 + 28) )
      *(uint32_t *)(*(uint32_t *)(v24 + 32) - 3) = *((uint32_t *)off_119CD0 + 43);
    v21 = *(uint16_t *)(v7 + 80);
    v22 = *(uint16_t *)(v5 + 10);
    *(uint32_t *)(v7 + 68) = v5;
