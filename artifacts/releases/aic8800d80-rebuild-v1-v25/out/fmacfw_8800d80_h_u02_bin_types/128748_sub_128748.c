...
int  sub_128748(int a1, int a2)
{
  ...
  if ( **(__int16 **)off_12898C >= 0
    || *(uint32_t *)(dword_12895C + 1320 * a1 + 72) && (sub_12F32C(dword_128974, dword_128970, 3061), **v2 >= 0) )
  {
    v8 = 8 * a2;
  }
  else
  ...
  *(uint8_t *)(v11 + 85) = 0;
  ...
  v13[86] = -1;
  if ( v14 && *(uint8_t *)(dword_128964 + 140 * (unsigned __int8)v13[1225] + 112) == 1 )
  {
    v13[85] |= 0x10u;
  }
  else
