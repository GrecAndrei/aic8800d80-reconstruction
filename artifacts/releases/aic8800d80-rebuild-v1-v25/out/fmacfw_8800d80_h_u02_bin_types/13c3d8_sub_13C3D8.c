...
unsigned int  sub_13C3D8(unsigned __int8 *a1, int a2, int a3, uint8_t *a4)
{
  int v4; // r6
  int v5; // r11
  int v6; // r9
  ...
  if ( v12 == 255 )
    goto LABEL_9;
  v13 = v10;
  if ( !*(uint32_t *)(dword_13C550 + 1320 * v12 + 1200) )
    return 0;
  if ( (a1[48] & 8) == 0 )
  {
    if ( (*(uint32_t *)(dword_13C554 + 696 * v11 + 4) & 8) != 0 && (v5 & 0x4000) == 0 )
    {
      v27 = v5 & 0xFC;
...
LABEL_9:
  ...
  {
    if ( *(uint32_t *)(dword_13C550 + 1320 * v12 + 1204) )
    {
      if ( v4 + 19 >= v10 )
        goto LABEL_9;
      v15 = sub_12DA60((uint8_t *)(v4 + a2 + 2), (unsigned __int16)(v10 - 2 - v4));
      if ( !v15 )
        goto LABEL_9;
