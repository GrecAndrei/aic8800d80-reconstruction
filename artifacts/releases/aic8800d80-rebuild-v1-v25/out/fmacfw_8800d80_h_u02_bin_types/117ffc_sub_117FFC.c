...
int  sub_117FFC(int a1)
{
  ...
  if ( **(__int16 **)off_1182F0 < 0 && (v2 & *(uint32_t *)off_1187DC) == 0 )
...
LABEL_54:
              ...
              else
              {
                ...
                if ( v30 <= 0x1F )
                {
                  ...
                  if ( v31 <= 8 )
                    *(uint32_t *)(dword_118308 + 4 * (9 * v30 + v31 + 2062)) -= *(unsigned __int16 *)(v4 + 4);
                }
                sub_116D10(v4);
...
LABEL_24:
      ...
      if ( v17 <= 0x1F )
      {
        ...
        if ( v18 <= 8 )
          *(uint32_t *)(dword_118308 + 4 * (9 * v17 + v18 + 2062)) -= *(unsigned __int16 *)(v4 + 4);
      }
      sub_117BF0(v4, (uint32_t *)(v7 + 4));
