...
void sub_12B258()
{
  ...
  v0 = *(uint32_t *)off_12B390;
  v22 = *((unsigned __int8 *)off_12B390 + 10);
  if ( *(uint8_t *)(*(uint32_t *)off_12B390 + 368) )
  {
    v21 = dword_12B394 + 1320 * *(unsigned __int8 *)(*(uint32_t *)off_12B390 + 366);
    v1 = (char *)(v0 + 253);
    v2 = 0;
    do
    {
      ...
      v7 = off_12B39C;
      v8 = *(uint32_t *)(v4 + 72);
      v9 = *((uint16_t *)off_12B39C + 254);
      v10 = (int *)off_12B3A0;
      v11 = *(uint32_t *)(v4 + 76);
      v12 = *((uint16_t *)off_12B3A0 + 2);
