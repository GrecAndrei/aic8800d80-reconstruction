...
int  rf_mem_read_n208(int a1, int a2, __int16 a3, __int16 a4)
{
  uint32_t *v5; // r0
  uint32_t *v6; // r5
  unsigned int v7; // r3
...
LABEL_322:
    ...
    case 7:
      ...
      v48 = off_11FFB0;
      *(uint32_t *)off_11FFAC = *(unsigned __int8 *)(a2 + 8) | (*(unsigned __int8 *)(a2 + 8) << 8);
      *v48 = 1;
      goto LABEL_21;
    case 8:
    ...
    case 0x15:
      v142 = *(uint32_t *)(a2 + 4);
      if ( !v142 || (v143 = *(unsigned __int8 *)(a2 + 8), !*(uint8_t *)(a2 + 8)) )
      {
        v161 = dword_1209D8;
        v162 = dword_120A08;
        v163 = dword_1209FC;
...
LABEL_385:
    ...
    case 0x16:
      v7 = *(uint32_t *)(a2 + 4);
      if ( v7 && (v8 = *(unsigned __int8 *)(a2 + 8), *(uint8_t *)(a2 + 8)) )
      {
        if ( v8 == 1 )
        {
          v211 = off_121150;
    ...
    case 0x18:
      ...
      if ( v75 )
      {
        ...
        else
        {
          ...
          v78 = *(char *)(a2 + 11);
          if ( (unsigned __int8)(*(uint8_t *)(a2 + 11) + 7) <= 0xEu )
          {
...
LABEL_269:
    ...
    case 0x1E:
      ...
      else if ( *(uint8_t *)off_11FF8C )
      {
        ...
        v37 = &v6[(unsigned __int8)(*(uint8_t *)off_11FF8C - 1) + 1];
        v38 = v6;
        do
        {
          *v38 = *v36;
...
LABEL_59:
    ...
    case 0x26:
      ...
      goto LABEL_21;
    case 0x27:
      if ( *(uint32_t *)(a2 + 4) && *(unsigned __int8 *)(a2 + 8) > 1u )
        goto LABEL_295;
      v30 = sub_123020();
      goto LABEL_54;
    case 0x28:
