...
int  fmac_main_task(int a1, int a2)
{
  uint32_t *v2; // r4
  int *v3; // r7
  unsigned int v6; // r2
  ...
  v2 = off_1105B8;
  v3 = (int *)off_1105BC;
  v21 = *(unsigned __int16 *)(*(uint32_t *)off_1105B4 + 48);
  sub_11035C(a2);
...
LABEL_23:
      if ( *(unsigned __int16 *)(a2 + 0xC) >= (unsigned int)*(unsigned __int16 *)(*(uint32_t *)off_1105B4 + 50) )
        return 1;
LABEL_24:
      irq_nesting_or(32);
      return 1;
    }
    v10 = (uint32_t *)log_free_dispatch_n2b4();
    v11 = v10;
    if ( !v10 )
    {
    ...
    *v2 = 1;
    ...
    {
      if ( **(__int16 **)off_1105C8 < 0 && *(uint32_t *)off_1105CC )
      {
