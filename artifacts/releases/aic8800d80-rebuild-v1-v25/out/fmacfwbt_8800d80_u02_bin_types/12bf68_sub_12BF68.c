...
int sub_12BF68()
{
  ...
  if ( v3 - *((uint32_t *)off_12C044 + 4) - 2000 - *((unsigned __int16 *)off_12C04C + 92) - v4 < 0 )
  {
    if ( **(__int16 **)off_12C058 < 0 && v3 - *((uint32_t *)off_12C044 + 4) + 5000 < 0 )
    {
  ...
  else
  {
    if ( **(uint8_t **)off_12C054 != 1 )
      return 1;
    if ( **(__int16 **)off_12C058 < 0 && v3 - *((uint32_t *)off_12C044 + 4) - v4 < 0 )
    {
