...
int  sub_135020(int a1)
{
  ...
  v2 = off_1352A0;
  v3 = dword_1352E8;
  v4 = *(unsigned __int8 *)(*((uint32_t *)off_1352A0 + 4) + 61);
...
LABEL_10:
    ...
    *(uint16_t *)(v5 + 824) = v23;
    if ( v22 == v21 )
    {
      *(uint32_t *)(v5 + 828) = *(unsigned __int16 *)(v16 + 416);
    }
    else if ( v21 )
    {
    ...
    *(uint32_t *)(v5 + 832) = *(unsigned __int16 *)(v26 + 418);
    v28 = v27 & 1;
    *(uint8_t *)(v5 + 12) = v28;
    if ( v28 )
    ...
    *(uint8_t *)(v5 + 8) = (*(uint32_t *)(v9 + 48) & 0x60) != 0;
    if ( *(uint8_t *)(v29 + 1224) )
    {
      *(uint32_t *)off_1352C0 = *(unsigned __int16 *)(v29 + 100) | (*(unsigned __int16 *)(v29 + 102) << 16);
      *(uint32_t *)off_1352C4 = *(unsigned __int16 *)(v29 + 104);
      *(uint32_t *)off_1352C8 = *(unsigned __int16 *)(v29 + 64) | (*(unsigned __int16 *)(v29 + 66) << 16);
      *(uint32_t *)off_1352CC = *(unsigned __int16 *)(v29 + 68);
    }
    v39 = v14;
    sub_12CBB4(v5);
    v30 = v39;
