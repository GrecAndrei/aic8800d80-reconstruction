...
int  sub_1390E8(unsigned int a1, int a2, int a3)
{
  uint16_t *v3; // r6
  char v5; // r5
  int v7; // r10
...
LABEL_7:
    ...
    if ( *((unsigned __int8 *)v10 + 8) != v9 )
      return 0;
    v21 = (unsigned __int16)(*(uint16_t *)(a1 + 48) - *((unsigned __int8 *)v10 + 9));
...
LABEL_30:
  ...
  if ( *(uint8_t *)(v20 + 1227)
    && sub_138BAC((unsigned __int8 *)(v20 + 107), (uint32_t *)(v20 + 1228), *(char **)(*(uint32_t *)(a1 + 28) + 8), a3) == 1 )
  {
    return v9;
  }
  sub_138DB8(a1, 3);
