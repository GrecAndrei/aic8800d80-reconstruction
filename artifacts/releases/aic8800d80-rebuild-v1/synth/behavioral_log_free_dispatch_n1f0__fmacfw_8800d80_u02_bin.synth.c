/* task=behavioral_log_free_dispatch_n1f0 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x12101f8 */

void log_free_dispatch_n1f0(void) {
