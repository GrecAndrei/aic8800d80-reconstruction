/* task=behavioral_idle_processing class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_h_u02_bin addr=0x12159a4 */
...
void idle_processing(void) {
  /* reconstructed_micro_flow: yes */
    ...
    *((volatile uint32_t *)(uintptr_t)0x187f90U) = 0x1U;
    ...
    (void)*((volatile uint32_t *)(uintptr_t)0x0U);
    *((volatile uint32_t *)(uintptr_t)0x2007fee4U) = 0x167620U;
    *((volatile uint32_t *)(uintptr_t)0x2007fee8U) = 0x0U;
    *((volatile uint32_t *)(uintptr_t)0x2007feecU) = 0x1U;
    *((volatile uint32_t *)(uintptr_t)0x2007fee0U) = 0x1215b1dU;
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007feecU) = 0x12159e1U;
