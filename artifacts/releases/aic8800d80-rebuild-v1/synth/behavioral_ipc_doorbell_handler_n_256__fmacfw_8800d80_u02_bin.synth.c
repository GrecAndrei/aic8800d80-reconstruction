/* task=behavioral_ipc_doorbell_handler_n_256 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x1215726 */

void ipc_doorbell_handler_n_256(void) {
