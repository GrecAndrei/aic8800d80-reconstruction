/* task=behavioral_message_dispatch_n4b6 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122ce42 */

void message_dispatch_n4b6(void) {
