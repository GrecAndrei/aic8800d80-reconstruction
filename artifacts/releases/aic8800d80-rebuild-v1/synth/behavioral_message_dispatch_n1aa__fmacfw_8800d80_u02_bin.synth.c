/* task=behavioral_message_dispatch_n1aa class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122cb36 */

void message_dispatch_n1aa(void) {
