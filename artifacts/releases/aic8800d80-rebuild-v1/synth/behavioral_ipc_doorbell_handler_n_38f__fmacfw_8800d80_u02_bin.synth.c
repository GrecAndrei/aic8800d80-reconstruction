/* task=behavioral_ipc_doorbell_handler_n_38f class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x12155ec */

void ipc_doorbell_handler_n_38f(void) {
