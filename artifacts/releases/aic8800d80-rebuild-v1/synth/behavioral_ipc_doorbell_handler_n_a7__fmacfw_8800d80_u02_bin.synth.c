/* task=behavioral_ipc_doorbell_handler_n_a7 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x12158d4 */

void ipc_doorbell_handler_n_a7(void) {
  /* reconstructed_micro_flow: yes */
    (void)*((volatile uint32_t *)(uintptr_t)0x5U);
    (void)*((volatile uint32_t *)(uintptr_t)0x4032011cU);
    (void)*((volatile uint32_t *)(uintptr_t)0x7U);
