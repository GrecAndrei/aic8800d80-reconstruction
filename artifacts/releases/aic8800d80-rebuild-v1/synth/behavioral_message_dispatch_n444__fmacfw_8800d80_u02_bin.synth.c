/* task=behavioral_message_dispatch_n444 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122cdd0 */

void message_dispatch_n444(void) {
