/* task=behavioral_message_dispatch_n_2b9 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122c6d2 */

void message_dispatch_n_2b9(void) {
