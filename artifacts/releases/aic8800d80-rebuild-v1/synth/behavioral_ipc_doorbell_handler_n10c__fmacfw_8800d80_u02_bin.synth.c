/* task=behavioral_ipc_doorbell_handler_n10c class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x1215a88 */

void ipc_doorbell_handler_n10c(void) {
  /* reconstructed_micro_flow: yes */
    *((volatile uint32_t *)(uintptr_t)0x50U) = 0x0U;
    (void)*((volatile uint32_t *)(uintptr_t)0x50U);
    *((volatile uint32_t *)(uintptr_t)0x50U) = 0x37U;
