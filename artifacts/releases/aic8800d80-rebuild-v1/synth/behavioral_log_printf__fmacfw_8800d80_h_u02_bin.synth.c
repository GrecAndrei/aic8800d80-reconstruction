/* task=behavioral_log_printf class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_h_u02_bin addr=0x120dae4 */
...
void log_printf(void) {
  /* reconstructed_micro_flow: yes */
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fedcU) = 0x120daf7U;
}
