/* task=behavioral_ipc_doorbell_handler_n_44 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x1215938 */

void ipc_doorbell_handler_n_44(void) {
  /* reconstructed_micro_flow: yes */
    (void)*((volatile uint32_t *)(uintptr_t)0x1eU);
    *((volatile uint32_t *)(uintptr_t)0x1fU) = 0x0U;
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fef8U) = 0x60U;
