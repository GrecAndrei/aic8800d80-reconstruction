/* task=behavioral_message_dispatch_n_349 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122c642 */

void message_dispatch_n_349(void) {
