/* task=behavioral_ipc_doorbell_handler_nd2 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x1215a4e */

void ipc_doorbell_handler_nd2(void) {
