/* task=behavioral_log_free_dispatch_n4c0 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x12104c8 */

void log_free_dispatch_n4c0(void) {
