/* task=behavioral_message_dispatch_n3aa class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122cd36 */

void message_dispatch_n3aa(void) {
  /* reconstructed_micro_flow: yes */
    (void)*((volatile uint32_t *)(uintptr_t)0x182b60U);
    (void)*((volatile uint32_t *)(uintptr_t)0x0U);
    (void)*((volatile uint32_t *)(uintptr_t)0x16b370U);
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fed8U) = 0x16b368U;
    *((volatile uint32_t *)(uintptr_t)0x2007fedcU) = 0x182b60U;
    *((volatile uint32_t *)(uintptr_t)0x2007fee0U) = 0x0U;
    *((volatile uint32_t *)(uintptr_t)0x2007fee4U) = 0x1fffffeU;
