/* task=behavioral_log_free_dispatch_n4f5 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x12104fc */

void log_free_dispatch_n4f5(void) {
  /* reconstructed_micro_flow: yes */
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fee0U) = 0x60U;
