/* task=behavioral_message_dispatch_nf7 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122ca82 */

void message_dispatch_nf7(void) {
