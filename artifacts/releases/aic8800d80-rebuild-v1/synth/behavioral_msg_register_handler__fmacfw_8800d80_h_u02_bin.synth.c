/* task=behavioral_msg_register_handler class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_h_u02_bin addr=0x122cbf4 */
...
void msg_register_handler(void) {
  /* reconstructed_micro_flow: yes */
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fefcU) = 0xdeadc001U;
    ...
    (void)*((volatile uint32_t *)(uintptr_t)0x16a230U);
    *((volatile uint32_t *)(uintptr_t)0x2007fed0U) = 0x16a1dcU;
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007feb8U) = 0x16a228U;
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007feccU) = 0x122cc25U;
