/* task=behavioral_ipc_doorbell_handler_n_65 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x1215916 */

void ipc_doorbell_handler_n_65(void) {
  /* reconstructed_micro_flow: yes */
    *((volatile uint32_t *)(uintptr_t)0x2007fef0U) = 0x167704U;
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007feecU) = 0x1215921U;
