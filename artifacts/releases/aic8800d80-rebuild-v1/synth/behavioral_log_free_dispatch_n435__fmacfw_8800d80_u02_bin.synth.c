/* task=behavioral_log_free_dispatch_n435 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x121043c */

void log_free_dispatch_n435(void) {
  /* reconstructed_micro_flow: yes */
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fefcU) = 0x1210453U;
    ...
    *((volatile uint32_t *)(uintptr_t)0x187e68U) = 0x0U;
    *((volatile uint32_t *)(uintptr_t)0x187e6cU) = 0x0U;
    *((volatile uint32_t *)(uintptr_t)0x0U) = 0x0U;
    ...
    (void)*((volatile uint32_t *)(uintptr_t)0x182560U);
    (void)*((volatile uint32_t *)(uintptr_t)0x1822c0U);
    *((volatile uint32_t *)(uintptr_t)0x1822c0U) = 0x1U;
