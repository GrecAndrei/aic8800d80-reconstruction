/* task=behavioral_log_free_dispatch_n2c7 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x12102ce */

void log_free_dispatch_n2c7(void) {
