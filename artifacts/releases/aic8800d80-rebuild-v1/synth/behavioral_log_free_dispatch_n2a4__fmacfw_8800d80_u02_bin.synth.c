/* task=behavioral_log_free_dispatch_n2a4 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x12102ac */

void log_free_dispatch_n2a4(void) {
