/* task=behavioral_ipc_doorbell_handler_n_3c5 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x12155b6 */

void ipc_doorbell_handler_n_3c5(void) {
