/* task=behavioral_message_dispatch_n_4f class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122c93c */

void message_dispatch_n_4f(void) {
