/* task=behavioral_message_dispatch_n_4f5 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122c496 */

void message_dispatch_n_4f5(void) {
  /* reconstructed_micro_flow: yes */
    *((volatile uint32_t *)(uintptr_t)0x2007ff07U) = 0x0U;
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fefcU) = 0x122c49fU;
    (void)*((volatile uint32_t *)(uintptr_t)0x1828f8U);
    (void)*((volatile uint32_t *)(uintptr_t)0x1828fcU);
    (void)*((volatile uint32_t *)(uintptr_t)0x1731a1U);
