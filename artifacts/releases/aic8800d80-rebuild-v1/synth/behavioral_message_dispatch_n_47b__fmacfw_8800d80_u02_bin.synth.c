/* task=behavioral_message_dispatch_n_47b class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122c510 */

void message_dispatch_n_47b(void) {
  /* reconstructed_micro_flow: yes */
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fefcU) = 0x122c517U;
    (void)*((volatile uint32_t *)(uintptr_t)0x0U);
    (void)*((volatile uint32_t *)(uintptr_t)0x4U);
    (void)*((volatile uint32_t *)(uintptr_t)0x1731b8U);
    (void)*((volatile uint32_t *)(uintptr_t)0x1719d8U);
    (void)*((volatile uint32_t *)(uintptr_t)0x1828c2U);
    (void)*((volatile uint32_t *)(uintptr_t)0x1821a0U);
    (void)*((volatile uint32_t *)(uintptr_t)0x1730e2U);
