/* task=behavioral_log_pool_alloc2 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_h_u02_bin addr=0x120f9e8 */
...
void log_pool_alloc2(void) {
  /* reconstructed_micro_flow: yes */
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fed8U) = 0x166578U;
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fed4U) = 0x120fb71U;
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fec4U) = 0x120daf7U;
}
