/* task=behavioral_message_dispatch_n_12d class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122c85e */

void message_dispatch_n_12d(void) {
  /* reconstructed_micro_flow: yes */
    *((volatile uint32_t *)(uintptr_t)0x0U) = 0x1U;
    (void)*((volatile uint32_t *)(uintptr_t)0x0U);
    (void)*((volatile uint32_t *)(uintptr_t)0x14U);
    *((volatile uint32_t *)(uintptr_t)0x0U) = 0x2U;
    *((volatile uint32_t *)(uintptr_t)0x0U) = 0x1U;
