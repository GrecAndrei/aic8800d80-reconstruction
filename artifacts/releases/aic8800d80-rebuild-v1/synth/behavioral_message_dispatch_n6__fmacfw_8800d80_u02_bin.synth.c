/* task=behavioral_message_dispatch_n6 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122c992 */

void message_dispatch_n6(void) {
  /* reconstructed_micro_flow: yes */
    (void)*((volatile uint32_t *)(uintptr_t)0x0U);
    *((volatile uint32_t *)(uintptr_t)0x2007fef8U) = 0xfffffffaU;
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fef4U) = 0x122c9b1U;
