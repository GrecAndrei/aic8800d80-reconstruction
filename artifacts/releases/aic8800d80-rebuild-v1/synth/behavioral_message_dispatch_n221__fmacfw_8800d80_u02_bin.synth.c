/* task=behavioral_message_dispatch_n221 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122cbac */

void message_dispatch_n221(void) {
