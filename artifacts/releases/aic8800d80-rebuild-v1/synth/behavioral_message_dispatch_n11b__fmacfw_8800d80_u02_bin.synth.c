/* task=behavioral_message_dispatch_n11b class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122caa6 */

void message_dispatch_n11b(void) {
  /* reconstructed_micro_flow: yes */
    ...
    *((volatile uint32_t *)(uintptr_t)0x4U) = 0x1922a4U;
