/* task=behavioral_log_free_dispatch_n4c3 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x12104ca */

void log_free_dispatch_n4c3(void) {
