/* task=behavioral_message_dispatch_n492 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122ce1e */

void message_dispatch_n492(void) {
