/* task=behavioral_ipc_doorbell_handler_n_270 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x121570c */

void ipc_doorbell_handler_n_270(void) {
  /* reconstructed_micro_flow: yes */
    (void)*((volatile uint32_t *)(uintptr_t)0x403450e0U);
    *((volatile uint32_t *)(uintptr_t)0x403450e0U) = 0x2000000U;
    *((volatile uint32_t *)(uintptr_t)0x2007fef4U) = 0x1676fcU;
    *((volatile uint32_t *)(uintptr_t)0x2007fef8U) = 0x403450e0U;
    *((volatile uint32_t *)(uintptr_t)0x2007fefcU) = 0x2000000U;
