/* task=behavioral_message_dispatch_n4d class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122c9d8 */

void message_dispatch_n4d(void) {
  /* reconstructed_micro_flow: yes */
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007feecU) = 0x122c9ddU;
    ...
    (void)*((volatile uint32_t *)(uintptr_t)0x182749U);
