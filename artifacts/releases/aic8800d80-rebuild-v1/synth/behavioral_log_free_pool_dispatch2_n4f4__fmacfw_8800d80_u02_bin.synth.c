/* task=behavioral_log_free_pool_dispatch2_n4f4 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x12101d4 */

void log_free_pool_dispatch2_n4f4(void) {
