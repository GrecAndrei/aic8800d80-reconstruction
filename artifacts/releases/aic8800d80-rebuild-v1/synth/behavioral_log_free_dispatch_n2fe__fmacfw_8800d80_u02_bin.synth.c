/* task=behavioral_log_free_dispatch_n2fe class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x1210306 */

void log_free_dispatch_n2fe(void) {
  /* reconstructed_micro_flow: yes */
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fefcU) = 0x121031fU;
    (void)*((volatile uint32_t *)(uintptr_t)0x182b60U);
    (void)*((volatile uint32_t *)(uintptr_t)0x0U);
    (void)*((volatile uint32_t *)(uintptr_t)0x187e38U);
    *((volatile uint32_t *)(uintptr_t)0x187e38U) = 0x0U;
    *((volatile uint32_t *)(uintptr_t)0x187e3cU) = 0x0U;
