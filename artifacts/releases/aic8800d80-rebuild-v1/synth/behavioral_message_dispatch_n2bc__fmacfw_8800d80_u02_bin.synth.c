/* task=behavioral_message_dispatch_n2bc class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122cc48 */

void message_dispatch_n2bc(void) {
  /* reconstructed_micro_flow: yes */
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fefcU) = 0x122cc59U;
    *((volatile uint32_t *)(uintptr_t)0x40320038U) = 0x0U;
    *((volatile uint32_t *)(uintptr_t)0x2007fee0U) = 0x16b208U;
    *((volatile uint32_t *)(uintptr_t)0x2007fee4U) = 0x16a268U;
    *((volatile uint32_t *)(uintptr_t)0x2007fee8U) = 0x16a2acU;
    *((volatile uint32_t *)(uintptr_t)0x2007feecU) = 0xdcU;
    *((volatile uint32_t *)(uintptr_t)0x2007fec0U) = 0x16a268U;
