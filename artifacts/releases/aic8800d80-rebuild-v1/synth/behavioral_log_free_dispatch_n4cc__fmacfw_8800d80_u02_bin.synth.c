/* task=behavioral_log_free_dispatch_n4cc class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x12104d4 */

void log_free_dispatch_n4cc(void) {
  /* reconstructed_micro_flow: yes */
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fefcU) = 0x12104e3U;
    (void)*((volatile uint32_t *)(uintptr_t)0x182b60U);
    (void)*((volatile uint32_t *)(uintptr_t)0x0U);
    (void)*((volatile uint32_t *)(uintptr_t)0x187e60U);
    *((volatile uint32_t *)(uintptr_t)0x187e60U) = 0x0U;
    *((volatile uint32_t *)(uintptr_t)0x187e64U) = 0x0U;
