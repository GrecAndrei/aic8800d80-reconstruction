/* task=behavioral_message_dispatch_n4eb class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122ce76 */

void message_dispatch_n4eb(void) {
  /* reconstructed_micro_flow: yes */
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fef0U) = 0x122d224U;
