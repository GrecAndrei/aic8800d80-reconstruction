/* task=behavioral_message_dispatch_n1a7 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122cb32 */

void message_dispatch_n1a7(void) {
