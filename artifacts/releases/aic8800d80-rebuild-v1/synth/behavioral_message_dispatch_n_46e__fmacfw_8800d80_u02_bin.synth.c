/* task=behavioral_message_dispatch_n_46e class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122c51e */

void message_dispatch_n_46e(void) {
  /* reconstructed_micro_flow: yes */
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fee8U) = 0x16a124U;
    *((volatile uint32_t *)(uintptr_t)0x2007feecU) = 0x5cU;
