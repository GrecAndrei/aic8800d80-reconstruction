/* task=behavioral_ipc_doorbell_handler_n4e6 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x1215e62 */

void ipc_doorbell_handler_n4e6(void) {
  /* reconstructed_micro_flow: yes */
    (void)*((volatile uint32_t *)(uintptr_t)0x1732f4U);
    (void)*((volatile uint32_t *)(uintptr_t)0x8U);
    *((volatile uint32_t *)(uintptr_t)0x8U) = 0x2U;
