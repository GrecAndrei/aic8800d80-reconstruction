/* task=behavioral_message_dispatch_n_1ae class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122c7de */

void message_dispatch_n_1ae(void) {
  /* reconstructed_micro_flow: yes */
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fee8U) = 0x10U;
