/* task=behavioral_ipc_doorbell_handler_n_3ef class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x121558c */

void ipc_doorbell_handler_n_3ef(void) {
  /* reconstructed_micro_flow: yes */
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fec0U) = 0x64U;
