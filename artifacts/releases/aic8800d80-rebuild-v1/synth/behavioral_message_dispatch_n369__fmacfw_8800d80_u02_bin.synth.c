/* task=behavioral_message_dispatch_n369 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122ccf4 */

void message_dispatch_n369(void) {
  /* reconstructed_micro_flow: yes */
    (void)*((volatile uint32_t *)(uintptr_t)0x7f8U);
    (void)*((volatile uint32_t *)(uintptr_t)0x7fcU);
