/* task=behavioral_ipc_doorbell_handler_n326 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x1215ca2 */

void ipc_doorbell_handler_n326(void) {
  /* reconstructed_micro_flow: yes */
    *((volatile uint32_t *)(uintptr_t)0x0U) = 0x0U;
    *((volatile uint32_t *)(uintptr_t)0x2007fef0U) = 0x167744U;
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007feecU) = 0x1215cadU;
