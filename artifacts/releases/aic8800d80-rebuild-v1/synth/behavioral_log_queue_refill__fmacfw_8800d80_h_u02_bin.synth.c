/* task=behavioral_log_queue_refill class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_h_u02_bin addr=0x12103c4 */
...
void log_queue_refill(void) {
  /* reconstructed_micro_flow: yes */
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fed4U) = 0x12103e3U;
}
