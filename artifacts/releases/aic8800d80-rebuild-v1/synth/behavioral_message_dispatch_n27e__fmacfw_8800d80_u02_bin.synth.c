/* task=behavioral_message_dispatch_n27e class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122cc0a */

void message_dispatch_n27e(void) {
