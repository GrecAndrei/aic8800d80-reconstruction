/* task=behavioral_message_dispatch_n1d3 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122cb5e */

void message_dispatch_n1d3(void) {
