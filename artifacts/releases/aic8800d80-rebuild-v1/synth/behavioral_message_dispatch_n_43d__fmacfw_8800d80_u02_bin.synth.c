/* task=behavioral_message_dispatch_n_43d class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122c54e */

void message_dispatch_n_43d(void) {
  /* reconstructed_micro_flow: yes */
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fef4U) = 0x122c563U;
