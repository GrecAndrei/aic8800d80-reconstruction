/* task=behavioral_ipc_doorbell_handler_nd6 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x1215a52 */

void ipc_doorbell_handler_nd6(void) {
  /* reconstructed_micro_flow: yes */
    *((volatile uint32_t *)(uintptr_t)0x40035100U) = 0x200U;
