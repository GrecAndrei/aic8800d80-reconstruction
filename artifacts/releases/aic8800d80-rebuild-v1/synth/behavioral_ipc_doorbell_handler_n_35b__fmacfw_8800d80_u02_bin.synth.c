/* task=behavioral_ipc_doorbell_handler_n_35b class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x1215620 */

void ipc_doorbell_handler_n_35b(void) {
  /* reconstructed_micro_flow: yes */
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007feecU) = 0x1215625U;
