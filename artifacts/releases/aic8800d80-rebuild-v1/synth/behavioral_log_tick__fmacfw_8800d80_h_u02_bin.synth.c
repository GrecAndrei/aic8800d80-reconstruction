/* task=behavioral_log_tick class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_h_u02_bin addr=0x120f058 */
...
void log_tick(void) {
  /* reconstructed_micro_flow: yes */
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fefcU) = 0xdeadc001U;
    (void)*((volatile uint32_t *)(uintptr_t)0x4032011cU);
    (void)*((volatile uint32_t *)(uintptr_t)0x182b0dU);
    (void)*((volatile uint32_t *)(uintptr_t)0x182b0fU);
    ...
    *((volatile uint32_t *)(uintptr_t)0x182b0fU) = 0x0U;
    *((volatile uint32_t *)(uintptr_t)0x2007fee0U) = 0x166338U;
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fec8U) = 0x182b08U;
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fedcU) = 0x120f08fU;
    ...
    (void)*((volatile uint32_t *)(uintptr_t)0x182b10U);
