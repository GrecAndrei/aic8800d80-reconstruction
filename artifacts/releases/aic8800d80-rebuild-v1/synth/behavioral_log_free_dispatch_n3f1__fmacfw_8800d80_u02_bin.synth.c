/* task=behavioral_log_free_dispatch_n3f1 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x12103f8 */

void log_free_dispatch_n3f1(void) {
  /* reconstructed_micro_flow: yes */
    ...
    *((volatile uint32_t *)(uintptr_t)0x1822c0U) = 0xffffffffU;
    (void)*((volatile uint32_t *)(uintptr_t)0x0U);
