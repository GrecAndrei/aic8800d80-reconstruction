/* task=behavioral_ipc_doorbell_handler_n49 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x12159c4 */

void ipc_doorbell_handler_n49(void) {
