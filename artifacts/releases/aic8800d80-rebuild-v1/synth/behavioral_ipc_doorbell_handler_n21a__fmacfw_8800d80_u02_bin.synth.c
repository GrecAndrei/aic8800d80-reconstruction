/* task=behavioral_ipc_doorbell_handler_n21a class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x1215b96 */

void ipc_doorbell_handler_n21a(void) {
