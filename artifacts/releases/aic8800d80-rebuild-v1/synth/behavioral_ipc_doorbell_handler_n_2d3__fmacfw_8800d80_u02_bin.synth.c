/* task=behavioral_ipc_doorbell_handler_n_2d3 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x12156a8 */

void ipc_doorbell_handler_n_2d3(void) {
  /* reconstructed_micro_flow: yes */
    (void)*((volatile uint32_t *)(uintptr_t)0x40035084U);
    *((volatile uint32_t *)(uintptr_t)0x40035084U) = 0x0U;
