/* task=behavioral_ipc_doorbell_handler_nff class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x1215a7a */

void ipc_doorbell_handler_nff(void) {
