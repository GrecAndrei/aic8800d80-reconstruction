/* task=behavioral_log_free_pool_dispatch2_n4b2 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x1210192 */

void log_free_pool_dispatch2_n4b2(void) {
