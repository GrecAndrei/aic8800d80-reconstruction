/* task=behavioral_ipc_doorbell_handler_n1a class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x1215996 */

void ipc_doorbell_handler_n1a(void) {
  /* reconstructed_micro_flow: yes */
    (void)*((volatile uint32_t *)(uintptr_t)0x823U);
