/* task=behavioral_ipc_doorbell_handler_n315 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x1215c90 */

void ipc_doorbell_handler_n315(void) {
  /* reconstructed_micro_flow: yes */
    *((volatile uint32_t *)(uintptr_t)0x2007fef4U) = 0x16773cU;
