/* task=behavioral_message_dispatch_n34b class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122ccd6 */

void message_dispatch_n34b(void) {
