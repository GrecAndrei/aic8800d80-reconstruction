/* task=behavioral_message_dispatch_n22a class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122cbb6 */

void message_dispatch_n22a(void) {
  /* reconstructed_micro_flow: yes */
    *((volatile uint32_t *)(uintptr_t)0x2007fee0U) = 0x0U;
    *((volatile uint32_t *)(uintptr_t)0x2007fee4U) = 0x0U;
    *((volatile uint32_t *)(uintptr_t)0x2007fee8U) = 0x60U;
    *((volatile uint32_t *)(uintptr_t)0x2007feecU) = 0x122cc88U;
