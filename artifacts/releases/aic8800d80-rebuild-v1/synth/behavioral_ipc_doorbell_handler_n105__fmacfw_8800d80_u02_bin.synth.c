/* task=behavioral_ipc_doorbell_handler_n105 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x1215a80 */

void ipc_doorbell_handler_n105(void) {
  /* reconstructed_micro_flow: yes */
    *((volatile uint32_t *)(uintptr_t)0x50U) = 0x0U;
    (void)*((volatile uint32_t *)(uintptr_t)0x50U);
    *((volatile uint32_t *)(uintptr_t)0x50U) = 0x10000U;
    (void)*((volatile uint32_t *)(uintptr_t)0x50U);
    *((volatile uint32_t *)(uintptr_t)0x50U) = 0x10037U;
