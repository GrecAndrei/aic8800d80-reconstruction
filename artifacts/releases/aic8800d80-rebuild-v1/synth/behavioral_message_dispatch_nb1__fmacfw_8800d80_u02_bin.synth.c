/* task=behavioral_message_dispatch_nb1 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122ca3c */

void message_dispatch_nb1(void) {
