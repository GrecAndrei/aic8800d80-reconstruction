/* task=behavioral_message_dispatch_n47f class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122ce0a */

void message_dispatch_n47f(void) {
