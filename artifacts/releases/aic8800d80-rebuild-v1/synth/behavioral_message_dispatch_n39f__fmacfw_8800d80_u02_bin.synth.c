/* task=behavioral_message_dispatch_n39f class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122cd2a */

void message_dispatch_n39f(void) {
  /* reconstructed_micro_flow: yes */
    *((volatile uint32_t *)(uintptr_t)0x2007fee0U) = 0x0U;
    *((volatile uint32_t *)(uintptr_t)0x2007fee4U) = 0x122cf10U;
    *((volatile uint32_t *)(uintptr_t)0x2007fee8U) = 0x0U;
    *((volatile uint32_t *)(uintptr_t)0x2007feecU) = 0x122d004U;
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007fed0U) = 0x16a32cU;
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007feb8U) = 0x16a378U;
    *((volatile uint32_t *)(uintptr_t)0x2007febcU) = 0x182b60U;
    ...
    *((volatile uint32_t *)(uintptr_t)0x2007feccU) = 0x122cd65U;
