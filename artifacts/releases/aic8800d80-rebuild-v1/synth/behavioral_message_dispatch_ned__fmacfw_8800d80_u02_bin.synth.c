/* task=behavioral_message_dispatch_ned class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122ca78 */

void message_dispatch_ned(void) {
