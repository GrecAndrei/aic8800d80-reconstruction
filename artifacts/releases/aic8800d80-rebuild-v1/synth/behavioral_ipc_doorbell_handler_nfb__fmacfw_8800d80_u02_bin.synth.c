/* task=behavioral_ipc_doorbell_handler_nfb class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x1215a76 */

void ipc_doorbell_handler_nfb(void) {
  /* reconstructed_micro_flow: yes */
    *((volatile uint32_t *)(uintptr_t)0x50U) = 0x0U;
    (void)*((volatile uint32_t *)(uintptr_t)0x50U);
    *((volatile uint32_t *)(uintptr_t)0x50U) = 0x8000U;
    (void)*((volatile uint32_t *)(uintptr_t)0x50U);
    *((volatile uint32_t *)(uintptr_t)0x50U) = 0x18000U;
    (void)*((volatile uint32_t *)(uintptr_t)0x50U);
    *((volatile uint32_t *)(uintptr_t)0x50U) = 0x18037U;
