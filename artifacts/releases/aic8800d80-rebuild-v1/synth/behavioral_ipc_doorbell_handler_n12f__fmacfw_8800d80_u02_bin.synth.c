/* task=behavioral_ipc_doorbell_handler_n12f class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x1215aaa */

void ipc_doorbell_handler_n12f(void) {
  /* reconstructed_micro_flow: yes */
    *((volatile uint32_t *)(uintptr_t)0x1cU) = 0x0U;
    *((volatile uint32_t *)(uintptr_t)0x2U) = 0x0U;
    *((volatile uint32_t *)(uintptr_t)0x6aU) = 0x0U;
    *((volatile uint32_t *)(uintptr_t)0x2U) = 0x0U;
