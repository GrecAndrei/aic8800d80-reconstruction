/* task=behavioral_message_dispatch_n438 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x122cdc4 */

void message_dispatch_n438(void) {
  /* reconstructed_micro_flow: yes */
    *((volatile uint32_t *)(uintptr_t)0x1eU) = 0x0U;
    (void)*((volatile uint32_t *)(uintptr_t)0x16a386U);
    *((volatile uint32_t *)(uintptr_t)0x2007fef0U) = 0x0U;
    *((volatile uint32_t *)(uintptr_t)0x2007fef4U) = 0x0U;
    *((volatile uint32_t *)(uintptr_t)0x2007fef8U) = 0x16a378U;
    *((volatile uint32_t *)(uintptr_t)0x2007fefcU) = 0x122cdfbU;
    *((volatile uint32_t *)(uintptr_t)0x40320038U) = 0x0U;
    *((volatile uint32_t *)(uintptr_t)0x2007fee0U) = 0x16b208U;
    *((volatile uint32_t *)(uintptr_t)0x2007fee4U) = 0x16a2fcU;
    *((volatile uint32_t *)(uintptr_t)0x2007fee8U) = 0x16a458U;
    *((volatile uint32_t *)(uintptr_t)0x2007feecU) = 0xafU;
    *((volatile uint32_t *)(uintptr_t)0x2007fec0U) = 0x16a2fcU;
