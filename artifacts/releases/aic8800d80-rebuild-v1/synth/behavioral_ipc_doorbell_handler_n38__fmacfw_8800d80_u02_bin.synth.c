/* task=behavioral_ipc_doorbell_handler_n38 class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x12159b4 */

void ipc_doorbell_handler_n38(void) {
  /* reconstructed_micro_flow: yes */
    *((volatile uint32_t *)(uintptr_t)0x40328070U) = 0x4U;
