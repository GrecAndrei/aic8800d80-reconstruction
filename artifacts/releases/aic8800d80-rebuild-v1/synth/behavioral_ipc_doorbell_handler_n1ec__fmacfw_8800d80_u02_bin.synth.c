/* task=behavioral_ipc_doorbell_handler_n1ec class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x1215b68 */

void ipc_doorbell_handler_n1ec(void) {
