/* task=behavioral_ipc_doorbell_handler_n37e class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x1215cfa */

void ipc_doorbell_handler_n37e(void) {
