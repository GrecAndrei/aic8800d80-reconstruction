/* task=behavioral_log_free_dispatch_n45a class=behavioral priority=critical score=25.000 */
/* image=fmacfw_8800d80_u02_bin addr=0x1210462 */

void log_free_dispatch_n45a(void) {
