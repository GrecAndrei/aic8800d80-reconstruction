...
void sdio_wait_busy_clear(void);
void rf_stream_start2_n3f6(void);
...
void crypto_hw_enable_2ca8(void);
...
void panic_loop_06d8(void);
void crypto_engine_clear_sram_regs(void);
void math_round(void);
void feature_guard_check(void);
void rf_bus_mark_n100_d2d0(void);
void list_push_tail(void);
void log_hw_init_d648(void);
...
void log_free_pool_d_3a48(void);
...
void crypto_mac_core_8280(void);
void rf_msg_handler_n22e(void);
void fp_convert_uint(void);
void tx_dequeue(void);
void crypto_hw_power_up_3b6c(void);
