...
extern uint32_t off_139424;
extern uint32_t dword_139428;
extern uint32_t dword_139440;
extern uint32_t off_13942C;
extern uint32_t dword_139430;
extern uint32_t off_139434;
...
int  rf_get_tx_power_cal(int a1, int a2)
{
  ...
  v2 = off_139424;
  v3 = dword_139428 + 1320 * *((uint8_t *)off_139424 + 10);
  v5 = *(uint8_t *)(v3 + 1227);
  if ( !*(uint8_t *)(v3 + 1227) )
  {
    v7 = *((uint8_t *)off_139424 + 7);
    v8 = dword_139440;
    v9 = *((uint16_t *)off_139424 + 2);
