...
// wifi_disable_get @ 0x127990, size 118 bytes
int  wifi_disable_get(int16_t *a1, int a2, char a3)
{
  uint8_t *v3; // r4
  int16_t v7; // r3
  uint8_t *v8; // r2
  ...
  if ( **(int16_t **)off_127A08 < 0 && *((uint8_t *)off_127A0C + 108) != 255 )
    irq_disable_mmio_write(dword_127A18, dword_127A14, 2838);
  v3[108] = 3;
  *((uint16_t *)v3 + 49) = 255;
  v3[88] = *((uint8_t *)a1 + 2);
  v7 = *a1;
