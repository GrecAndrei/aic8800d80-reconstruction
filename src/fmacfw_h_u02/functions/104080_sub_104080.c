...
extern uint32_t off_104158;
extern uint32_t off_10415C;
extern uint32_t off_104160;
extern uint32_t off_104164;
extern uint32_t off_104168;
extern uint32_t off_10416C;
extern uint32_t off_104170;
extern uint32_t off_104174;
extern uint32_t off_104178;
extern uint32_t dword_10417C;

// bt_radio_init @ 0x104080, size 214 bytes
uint32_t *bt_radio_init()
{
  unsigned int *v0; // r4
  unsigned int *v1; // r0
  uint32_t *v2; // r5
