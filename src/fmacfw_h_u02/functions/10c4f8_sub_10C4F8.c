...
extern uint32_t off_10C5A4;
extern uint32_t off_10C5B4;
extern uint32_t dword_10C5B8;
...
int sub_10C4F8()
{
  ...
  *((uint32_t *)off_10C5A4 + 64) = 6;
  ...
  v2 = off_10C5A4;
  v3 = dword_10C5B8;
  v4 = (unsigned int)(((unsigned int)dword_10C5B0 * (unsigned uint64_t)*(unsigned int *)off_10C5AC) >> 32) >> 18;
  v5 = v4 | 0x80140000;
  v4 |= 0x140000u;
  *(uint32_t *)off_10C5B4 = v4;
  *v1 = v5;
  *v1 = v4;
  v0[1] |= 0x18802u;
  v2[81] = 8;
