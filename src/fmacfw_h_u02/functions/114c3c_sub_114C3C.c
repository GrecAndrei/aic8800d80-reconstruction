...
extern uint32_t off_114D20;
extern uint32_t off_114D24;
extern uint32_t dword_114D28;

// patch_apply_ext @ 0x114c3c, size 228 bytes
int  patch_apply_ext(int a1, int a2, unsigned int a3)
{
  unsigned int v6; // r4
