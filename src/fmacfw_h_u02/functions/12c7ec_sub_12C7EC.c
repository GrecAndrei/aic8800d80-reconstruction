...
// tx_send_pdu @ 0x12c7ec, size 82 bytes
int  tx_send_pdu(int16_t a1, int16_t a2, int16_t a3, unsigned int a4)
{
  int v8; // r0
  int v9; // r4
  ...
  if ( **(int16_t **)off_12C840 < 0 && !v8 )
    irq_disable_mmio_write(dword_12C848, dword_12C844, 145);
  *(uint16_t *)(v9 + 4) = a1;
  *(uint16_t *)(v9 + 6) = a2;
  *(uint16_t *)(v9 + 8) = a3;
  *(uint16_t *)(v9 + 10) = a4;
