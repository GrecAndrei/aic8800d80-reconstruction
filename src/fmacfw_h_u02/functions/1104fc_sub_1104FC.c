...
// phy_calibrate @ 0x1104fc, size 286 bytes
...
LABEL_24:
    ...
    v10 = (uint32_t *)mmio_read_0();
    v11 = v10;
    if ( !v10 )
    {
      debug_printf(dword_110644);
    ...
    *v2 = 1;
    ...
    else
    {
      ...
      {
        irq_disable_mmio_write(dword_11063C, dword_110640, 400);
        v13 = (int *)off_11062C;
