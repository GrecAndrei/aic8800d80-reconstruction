...
// rf_path_disable @ 0x104fa8, size 172 bytes
int  rf_path_disable(int16_t a1, int a2, int a3, int a4)
{
  unsigned int *v4; // r4
  int *v5; // r9
  int v6; // r5
  ...
  *v4 = v15;
  result = check_feature_flag(1, v13);
  if ( v14 > 0x3E80 )
    return alloc_tx_event(dword_105064, v17, v18);
  return result;
}
