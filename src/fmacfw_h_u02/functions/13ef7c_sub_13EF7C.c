...
extern uint32_t off_13F024;
extern uint32_t dword_13F028;
extern uint32_t dword_13F030;
extern uint32_t dword_13F02C;
...
int  sub_13EF7C(int a1)
{
  ...
  v1 = (int16_t **)off_13F024;
  v2 = dword_13F028;
  v3 = *(int16_t **)off_13F024;
