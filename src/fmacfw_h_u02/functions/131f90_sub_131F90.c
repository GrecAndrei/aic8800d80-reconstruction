...
// wait_for_event @ 0x131f90, size 96 bytes
int  wait_for_event(int a1, char *a2, int16_t a3, int16_t a4)
{
  uint16_t *v7; // r4
  char v8; // r3
  int v9; // r1
  ...
  *((uint8_t *)off_131FF0 + 375) = v8;
  if ( !v9 )
  {
    v10 = (uint8_t *)tx_send_pdu(49, 0, 5, 1u);
    v11 = *((uint8_t *)v7 + 375);
    v7[4] = 255;
    if ( v11 )
  ...
  mac_write_header_word(5140, a4, a3);
  return 0;
}
