...
extern uint32_t off_11C924;
extern uint32_t off_11C928;
extern uint32_t dword_11C94C;
extern uint32_t dword_11C92C;
extern uint32_t off_11C950;
extern uint32_t dword_11C93C;
extern uint32_t dword_11C938;
extern uint32_t off_11C934;
extern uint32_t off_11C930;
extern uint32_t off_11C940;
...
void dma_clear_interrupt()
{
  ...
  v0 = off_11C920;
  *(uint32_t *)off_11C91C = 0x100000;
  while ( (*v0 & 0x300000) != 0 )
    ;
  v1 = off_11C924;
  v2 = *((uint32_t *)off_11C924 + 52);
  *(uint32_t *)off_11C928 = 0x100000;
  if ( (v2 & 1) != 0 )
  {
    v3 = *((uint8_t *)v1 + 190);
    v4 = dword_11C94C;
    v5 = dword_11C94C + 84 * v3;
    if ( *(uint8_t *)(v5 + 26) )
    {
LABEL_5:
      v6 = v4 + 84 * v3;
  ...
  else
  {
    ...
    {
      __disable_irq();
      *(uint32_t *)off_11C940 = 1;
    }
    v17 = off_11C944;
    v18 = *(uint32_t *)off_11C944;
    v19 = *(uint32_t *)off_11C944 + 1;
    v20 = (*(uint32_t *)off_11C948 & 0x1000) != 0;
    *(uint32_t *)off_11C944 = v19;
    if ( v20 )
      v1[52] |= 4u;
    if ( v19 )
    {
