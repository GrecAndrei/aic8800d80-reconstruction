...
extern uint32_t off_1384B8;
extern uint32_t off_1384D8;
extern uint32_t off_1384BC;
extern uint32_t dword_1384C0;
extern uint32_t off_1384C4;
extern uint32_t dword_1384C8;
extern uint32_t dword_1384CC;
extern uint32_t off_1384E4;
extern uint32_t off_138524;
extern uint32_t off_1384D0;
extern uint32_t off_1384D4;
...
LABEL_59:
  ...
  *(uint32_t *)(v8 + 372) = *(uint32_t *)(v2 + 372);
  ...
  v23 = (uint8_t *)off_1384D8;
  v24 = *(uint16_t *)(*(uint32_t *)v0 + 364);
  v25 = off_1384BC;
  if ( v24 >= 0xC9 )
    v24 = 0;
  v26 = (uint8_t *)off_1384D8;
  if ( v11 == 1 )
  {
