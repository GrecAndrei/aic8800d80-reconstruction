...
// Doc: check_clock_status [util]: Check debug interface status register at 0x40320038 and load status string
// check_clock_status [util]: Check debug interface status register at 0x40320038 and load status string
