...
extern uint32_t off_138E9C;
extern uint32_t off_138EA0;
extern uint32_t dword_138E94;
...
int  rf_handle_command(unsigned int a1, int a2, int a3, int a4)
{
  ...
  if ( a3 )
  {
    bt_packet_parse(
      ...
      (int)off_138E9C + 36,
      (uint16_t *)off_138E9C + 21,
      *((uint8_t *)off_138E9C + 7));
    v11 = *((uint8_t *)v4 + 8);
    v9 = *(uint32_t **)(v5 + 28);
