...
extern uint32_t off_10D624;
extern uint32_t dword_10D628;
...
void kernel_schedule_check()
{
  ...
  v0 = *((uint32_t *)off_10D5F4 + 43);
  if ( v0 >= 0 )
  {
    if ( *(uint32_t *)off_10D5F8 )
    {
      v21 = off_10D620;
      v22 = off_10D624;
      v23 = dword_10D628;
      *(uint32_t *)off_10D600 = 1;
      *(uint32_t *)(v21[2] + 124) = v23;
      *v22 = 0x8000;
    }
  }
  else if ( *(uint32_t *)off_10D5F8 )
  {
    v1 = off_10D600;
    v2 = off_10D604;
    v3 = off_10D608;
    *(uint32_t *)off_10D5FC = 0;
    *v1 = 0;
    *v2 = 1;
    v4 = off_10D60C;
    v5 = off_10D610;
    ...
    *v4 = 3;
    ...
    if ( (v5[20] & 0x20) != 0 )
    {
      v7 = *(uint32_t *)off_10D630;
      if ( v6 < *(uint32_t *)off_10D630 >> 4 )
        goto LABEL_5;
    }
    else
    {
      v7 = 2 * *(uint32_t *)off_10D614;
      if ( v6 < v7 >> 4 )
      {
LABEL_5:
        v8 = v7 / v6;
