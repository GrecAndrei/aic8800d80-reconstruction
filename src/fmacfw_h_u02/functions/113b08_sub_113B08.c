...
// adv_parse_report @ 0x113b08, size 318 bytes
int  adv_parse_report(int a1)
{
  unsigned int v1; // r3
  int v2; // r7
  int v4; // r8
  ...
  {
    alloc_tx_event(dword_113C68, 696, dword_113C48);
    return wait_for_state((uint32_t *)(a1 - *(uint32_t *)off_113C54 - 4));
  }
  v4 = dword_113C6C;
  if ( (*(uint16_t *)(a1 + 26) & 8) == 0 )
  {
    if ( *(uint8_t *)(dword_113C6C + 1320 * v2 + 108) )
    {
      ...
      if ( **(int16_t **)off_113C4C < 0 && v5 > 4 )
        irq_disable_mmio_write(dword_113C64, dword_113C60, 926);
      v6 = rssi_compare();
      if ( v6 )
        goto LABEL_7;
LABEL_13:
      debug_printf(dword_113C5C, *(uint8_t *)(dword_113C50 + v5));
      while ( 1 )
        ;
    }
    return wait_for_state((uint32_t *)(a1 - *(uint32_t *)off_113C54 - 4));
...
LABEL_7:
  ...
  *(uint16_t *)(v6 + 30) = v9 & 0xFFFD;
  if ( (v9 & 8) != 0 )
    return wlan_ioctl_handler_1(v4 + 1320 * v2 + 1312);
  v11 = *(uint8_t *)(v6 + 29);
  if ( v11 <= 0x1F )
  {
    v12 = *(uint8_t *)(v6 + 27);
  ...
  return wlan_ioctl_handler_1(v4 + 8 * (v5 + 165 * v2 + 154));
}
