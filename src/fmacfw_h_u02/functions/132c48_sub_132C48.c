...
extern uint32_t dword_132E58;
extern uint32_t off_132E74;
extern uint32_t off_132E5C;
extern uint32_t dword_132E68;
extern uint32_t dword_132E64;
extern uint32_t dword_132E6C;
...
int  sub_132C48(int a1, unsigned int a2)
{
  ...
  {
    v21 = (uint16_t *)off_132E74;
    v22 = **(int16_t **)off_132E5C;
  ...
  v17 = v16[308];
  v18 = v16[35];
  v19 = *(uint8_t *)(dword_132E60 + 1320 * v6 + 413);
  if ( v17 == 4 )
    v17 = 3;
  if ( v17 >= a2 )
    v17 = a2;
