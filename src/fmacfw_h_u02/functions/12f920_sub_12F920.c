...
int  sub_12F920(int a1, int a2)
{
  ...
  v4 = sub_12F818(*(uint8_t **)(a2 + 4), 0, 0x10u);
  if ( a1 <= 2 )
  {
    v5 = sub_12F8EC(*(uint32_t *)a2);
    if ( v5 >= 0 )
      goto LABEL_3;
LABEL_18:
  ...
  v9 = sub_12F818(*(uint8_t **)(a2 + 8), 0, 0);
  v5 = sub_12F8EC(*(uint32_t *)a2);
  if ( v5 < 0 )
    goto LABEL_18;
  if ( v9 == 1 )
...
LABEL_3:
    ...
    {
      sub_10DAE4(dword_12F9F8, v4, *(uint32_t *)v4);
      return 0;
    }
    else if ( v5 == 2 )
    {
      sub_10DAE4(dword_12F9FC, v4, *(uint16_t *)v4);
      return 0;
    }
    else
    {
      if ( v5 == 1 )
        sub_10DAE4(dword_12FA00, v4, *(uint8_t *)v4);
      return 0;
    }
  }
  v7 = **(uint8_t **)a2 == 82 && v4 < 0x40000000;
  sub_12E9D8(v4, v9, (uint8_t)v5, v7);
  return 0;
}
