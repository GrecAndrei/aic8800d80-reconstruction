...
LABEL_19:
            ...
            if ( v17 == 128 )
            {
              ...
              sub_128E4C(v53, *(uint16_t *)(a1 + 48), v18);
              sub_120104(v18);
              if ( v40 )
            ...
            else
            {
              ...
              {
                sub_12A2B4(v18, *(uint32_t *)(v2 + 8), *(uint16_t *)(a1 + 48), *(uint32_t *)(a1 + 52));
                return v8;
              }
            }
            return 0;
...
LABEL_38:
          if ( v15 == 2 && *(uint8_t *)(v49 + 35) <= 0x23u )
          {
            ...
            *(uint8_t *)(v49 + 689) = sub_142E9C(v26, HIDWORD(v26));
          }
          return 0;
        }
LABEL_36:
        sub_12AD34(*(uint8_t *)(v16 + 1320 * v51 + 107), v11, 1);
        v16 = dword_11D504;
        v8 = 0;
        goto LABEL_37;
      }
