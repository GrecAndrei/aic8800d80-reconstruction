...
extern uint32_t off_11B33C;
extern uint32_t off_11B340;
extern uint32_t off_11B344;
...
int  invalid_instruction_trap(int a1)
{
  ...
  {
    __disable_irq();
    *(uint32_t *)off_11B33C = 1;
  }
  v4 = off_11B340;
  v5 = (int *)off_11B344;
  v6 = (char *)off_11B340 + 28 * a1;
  v7 = (uint8_t)v6[47];
  v8 = *(uint32_t *)off_11B344 + 1;
  *(uint32_t *)off_11B344 = v8;
  if ( v7 )
  {
    v9 = *((uint32_t *)v6 + 10);
    v6[47] = 0;
