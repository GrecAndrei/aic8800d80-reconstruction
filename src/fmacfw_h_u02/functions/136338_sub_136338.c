...
int  sub_136338(int a1, int a2, int16_t a3, int16_t a4)
{
  int v4; // r8
  int v8; // r6
  int v9; // r5
  ...
  v4 = dword_136520;
  sub_12EB90(256, dword_136500, *(uint32_t *)(a2 + 20), *((uint8_t *)off_1364FC + 413));
  v8 = *(uint8_t *)(a2 + 51);
  v9 = v4 + 1320 * v8;
  if ( *(uint8_t *)(v9 + 106) != 2 )
  {
...
LABEL_3:
  ...
  *(uint16_t *)(v20 + 420) = v19;
  ...
  v21 = sub_128748(*(uint8_t *)(a2 + 51), v27);
  ...
  if ( !*(uint8_t *)(a2 + 16) )
  {
    v25 = sub_132654((uint8_t *)(1320 * v8 + 424 + v4), 1) & 0xF;
    if ( v25 )
