...
extern uint32_t off_116AF4;
extern uint32_t dword_116AF8;
extern uint32_t off_116AFC;
extern uint32_t dword_116B08;
...
LABEL_11:
        if ( a4 == 4 )
        {
          v12 = dword_116AF8 + 1320 * *(uint8_t *)(a2 + 28);
          v13 = *(uint8_t *)(v12 + 230);
        ...
        if ( *(uint8_t *)(a2 + 27) == 255 )
        {
          ...
          {
            v16 = *((uint16_t *)off_116AFC + 254);
          }
          else
          {
            v16 = *((uint16_t *)off_116AFC + 254) + 1;
            *((uint16_t *)off_116AFC + 254) = v16;
          }
          v17 = *(uint16_t *)(a2 + 30);
