...
// Doc: is_chip_ready [util]: Allocate a log entry from the log pool if logging is enabled
// is_chip_ready [util]: Allocate a log entry from the log pool if logging is enabled
