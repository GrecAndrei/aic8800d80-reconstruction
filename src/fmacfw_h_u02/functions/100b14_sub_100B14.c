...
// pmu_init @ 0x100b14, size 94 bytes
uint32_t *pmu_init()
{
  uint64_t v0; // r0
  unsigned int *v1; // r5
  ...
  v0 = signed_int_to_double();
  v1 = (unsigned int *)off_100B78;
  v2 = (unsigned int *)off_100B7C;
  v3 = double_compare_core(v0, HIDWORD(v0), 0, dword_100B74);
  v4 = double_exp_check(v3);
  v5 = double_to_float_rounding(v4);
  v6 = off_100B80;
  v7 = off_100B84;
