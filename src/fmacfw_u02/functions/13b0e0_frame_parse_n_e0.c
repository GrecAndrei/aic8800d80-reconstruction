...
// Doc: ll_encrypt_packet [rx]: Parses incoming frame header inspecting type byte and length
// ll_encrypt_packet [rx]: Parses incoming frame header inspecting type byte and length
