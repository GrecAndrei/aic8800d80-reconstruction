...
// Doc: ble_ll_adv_chk_active [mmio]: Read status word from global state at offset 0x1948
// ble_ll_adv_chk_active [mmio]: Read status word from global state at offset 0x1948
