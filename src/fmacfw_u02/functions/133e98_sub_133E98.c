...
// ctrl_event_handler @ 0x133e98, size 416 bytes
int  ctrl_event_handler(int a1, int a2, int16_t a3, int16_t a4)
{
  int v4; // r9
  uint8_t *v8; // r5
  int v9; // r8
  ...
  if ( rx_rate_field_parse(6u) != 10 )
  {
    ...
    else
    {
      if ( !v10[108] )
      {
        ...
        {
          if ( (uint8_t)v10[116] == 255 || (mmio_clear_register(dword_134050, dword_13404C, 102), **v11 < 0) )
          {
            if ( *(uint32_t *)(v9 + 1320 * v4 + 72) )
              mmio_clear_register(dword_134054, dword_13404C, 103);
          }
        }
        v12 = off_134060;
...
LABEL_8:
        ...
        *v13 = v15 | 0x10;
        v16 = *(uint8_t *)(a2 + 59);
        v14[14] = 1;
        if ( v16 == 3 && hci_recv_packet(a2 + 64, *(uint16_t *)(a2 + 54)) > 0 )
          *(uint8_t *)(a2 + 59) = 0;
        v12[4] = a2;
        ...
        if ( v18 )
        {
          memcpy(dword_134044, v9 + 1320 * *(uint8_t *)(a2 + 61) + 64, 6);
          bt_schedule_ack_timeout(v9 + 1320 * *(uint8_t *)(a2 + 61), 0, 0);
        }
        else
        {
          v23 = 0;
          v24 = 0;
          get_controller_state(&v23, &v24);
          if ( v23 && v24 )
            rx_packet_handler(v23, v24, 0);
          else
            send_hci_packet();
        }
        *v8 = 0;
