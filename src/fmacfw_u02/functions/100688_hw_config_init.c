...
// Doc: dispatch_interrupt [mmio]: Initialize hardware configuration from MMIO register field
// dispatch_interrupt [mmio]: Initialize hardware configuration from MMIO register field
