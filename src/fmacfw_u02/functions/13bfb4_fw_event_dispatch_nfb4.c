...
// check_fw_state_byte @ 0x13bfb4, size 222 bytes
// Doc: check_fw_state_byte [ipc]: Dispatch FW event by opcode (table lookup)
// check_fw_state_byte [ipc]: Dispatch FW event by opcode (table lookup)
int  check_fw_state_byte(int a1, int a2, int16_t a3)
{
  int v6; // r0
  char v7; // r11
  uint32_t *v8; // r8
  ...
  *(uint16_t *)(v9 + 12) = a3;
  *(uint8_t *)(v16 + 453) = v7;
  adv_set_params(a1, v9, 2, 0, 0, 39, 0);
  v18 = (v10 << 8) | 8;
