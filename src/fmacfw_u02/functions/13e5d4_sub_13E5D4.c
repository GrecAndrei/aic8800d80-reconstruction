...
extern uint32_t dword_13EA50;
extern uint32_t off_13EA54;
extern uint32_t dword_13EADC;
extern uint32_t dword_13EAD8;
extern uint32_t dword_13EA48;
extern uint32_t dword_13EA44;
extern uint32_t dword_13EA4C;

// ipc_dispatch_cmd @ 0x13e5d4, size 1282 bytes
unsigned int  ipc_dispatch_cmd(int a1, unsigned int a2, unsigned int a3, int a4, int a5)
{
  ...
  *(uint16_t *)(a1 + 30) = v12;
  ...
  if ( v10 == 255 )
    return result;
  v15 = (int16_t **)off_13EA54;
  v16 = *(uint32_t *)(result + 340);
  if ( **(int16_t **)off_13EA54 < 0 )
  {
    if ( v16 )
    {
      if ( !a4 )
    ...
    {
      mmio_clear_register(dword_13EADC, dword_13EAD8, 2470);
      if ( !a4 )
        goto LABEL_26;
      if ( **v15 >= 0 || a5 )
        goto LABEL_9;
    }
    mmio_clear_register(dword_13EA48, dword_13EA44, 2473);
    goto LABEL_9;
  }
  if ( !a4 )
  {
...
LABEL_55:
          ...
          *v60 = v63;
          if ( *v61 < 0 && v63 < v62 )
            return mmio_clear_register(dword_13EA4C, dword_13EA44, 2589);
          return result;
        }
      }
      else
...
LABEL_35:
          ...
          {
            v70 = v30;
            result = mmio_clear_register(v34, v33, 2657);
            v30 = v70;
          }
          goto LABEL_37;
        }
...
LABEL_46:
        ...
        {
          v71 = v45;
          result = mmio_clear_register(v49, v48, 2704);
          v45 = v71;
        }
LABEL_48:
        if ( ++v50 == 4 )
