...
// Doc: hci_event_send [ke]: Allocate a kernel/EMB-msg buffer (id 0x3002, param len 12)
// hci_event_send [ke]: Allocate a kernel/EMB-msg buffer (id 0x3002, param len 12)
