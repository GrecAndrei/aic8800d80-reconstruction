...
// Doc: rf_send_channel_alt [ipc]: Posts firmware event with opcode 0x100b to host message queue
// rf_send_channel_alt [ipc]: Posts firmware event with opcode 0x100b to host message queue
