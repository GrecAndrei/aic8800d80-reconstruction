...
// Doc: rf_scan_init [util]: Large init routine with VFP usage (crypto/phy setup)
// rf_scan_init [util]: Large init routine with VFP usage (crypto/phy setup)
int  rf_scan_init(int a1, int a2, uint32_t *a3, uint32_t *a4, int a5, int a6)
{
  ...
  v60[7] = v17;
  memcpy(v62, v7 + 4, 128);
  inited = alloc_buffer_by_flag(0, 0, a3);
  v55 = a1 + 128;
  v56 = a1 + 384;
  if ( a2 == 1 )
  {
