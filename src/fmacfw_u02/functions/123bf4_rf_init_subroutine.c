...
// Doc: llc_tx_check_status [rf]: Call sub and branch on result == 3 (init/handshake check)
// llc_tx_check_status [rf]: Call sub and branch on result == 3 (init/handshake check)
