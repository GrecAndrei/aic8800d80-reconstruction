...
// Doc: ll_get_access_addr [mac]: Prepare stack argument and call helper at 0x12df38
// ll_get_access_addr [mac]: Prepare stack argument and call helper at 0x12df38
