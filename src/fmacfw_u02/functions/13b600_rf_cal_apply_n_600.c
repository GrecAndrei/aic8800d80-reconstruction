...
// Doc: adv_pdu_conn_req_check [rf]: Applies RF calibration parameter via helper call
// adv_pdu_conn_req_check [rf]: Applies RF calibration parameter via helper call
