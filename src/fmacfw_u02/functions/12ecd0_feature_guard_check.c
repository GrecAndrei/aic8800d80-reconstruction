...
// Doc: check_status_bits [util]: SDIO feature availability guard testing a bitmask against feature word
// check_status_bits [util]: SDIO feature availability guard testing a bitmask against feature word
