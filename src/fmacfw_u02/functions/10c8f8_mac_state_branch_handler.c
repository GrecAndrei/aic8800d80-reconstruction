...
// Doc: zero_buffer_range [mac]: Handles MAC sub-state branch based on register field == 2
// zero_buffer_range [mac]: Handles MAC sub-state branch based on register field == 2
