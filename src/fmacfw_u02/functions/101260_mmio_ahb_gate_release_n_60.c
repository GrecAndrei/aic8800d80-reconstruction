...
// Doc: bb_disable [mmio]: Release AHB clock gate and clear bit in MMIO control register
// bb_disable [mmio]: Release AHB clock gate and clear bit in MMIO control register
