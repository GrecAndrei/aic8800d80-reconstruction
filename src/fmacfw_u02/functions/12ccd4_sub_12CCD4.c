...
// iterate_word_array @ 0x12ccd4, size 82 bytes
...
int  iterate_word_array(int a1, int *a2, int a3)
{
  int v3; // r3
  int v5; // r2
  int v6; // r4
  ...
  {
    mmio_clear_register(message_dispatch_n3a4, message_dispatch_n3a0, 239);
