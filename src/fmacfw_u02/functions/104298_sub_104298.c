...
extern uint32_t off_104374;
extern uint32_t off_104378;
extern uint32_t off_10437C;
extern uint32_t off_104380;
...
unsigned int *mac_irq_disable()
{
  ...
  v0 = (unsigned int *)off_104374;
  v1 = off_104378;
  v2 = (unsigned int *)off_10437C;
  *(uint32_t *)off_104374 &= ~0x10000000u;
  v3 = off_104380;
  v4 = off_104384;
  v5 = off_104388;
  *v1 &= ~0x200u;
