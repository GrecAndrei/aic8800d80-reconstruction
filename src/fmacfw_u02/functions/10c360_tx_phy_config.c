...
// Doc: rx_header_decode [tx]: Configures TX PHY parameters (rate, mode, bandwidth) for a frame.
// rx_header_decode [tx]: Configures TX PHY parameters (rate, mode, bandwidth) for a frame.
