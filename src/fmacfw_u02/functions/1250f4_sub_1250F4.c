...
extern uint32_t dword_1252BC;
extern uint32_t off_1252B8;
extern uint32_t dword_1252A4;
extern uint32_t dword_1252A8;
extern uint32_t off_1252C0;
extern uint32_t dword_1252AC;
...
int  link_env_get(int result)
{
  ...
  *(uint8_t *)off_1252B8 = 1;
LABEL_5:
  v6 = (uint8_t *)dword_1252A4;
  v7 = dword_1252A8;
  v8 = off_1252C0;
...
LABEL_6:
    ...
    *(uint8_t *)(v17 + v16) = v18 | v19;
    ...
    if ( v23 < v17 )
    {
      ...
      *(uint32_t *)(dword_1252B0 + 8 * (v24 + v29) + 32) = v30;
      LOWORD(v23) = v15 >> 3;
    }
