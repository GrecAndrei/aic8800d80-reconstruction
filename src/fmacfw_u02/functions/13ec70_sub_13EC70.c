...
extern uint32_t dword_13F0B8;

// ble_ll_conn_rx_pdu @ 0x13ec70, size 1094 bytes
int  ble_ll_conn_rx_pdu(int a1)
{
  char v1; // r3
  int result; // r0
  int v4; // r5
    ...
    switch ( (char)v4 )
    {
      case 1:
        ...
        else if ( ((v26 >> 11) & 5) == 5 )
        {
          ...
          HIWORD(v50) = v26
                      | (((uint16_t)v37
                        - (((((unsigned int)dword_13F0B8 * (unsigned uint64_t)(unsigned int)v37) >> 32) & 0xFFFE)
                         + (uint16_t)((unsigned int)(((unsigned int)dword_13F0B8
        ...
        goto LABEL_68;
      case 2:
        v35 = ll_pdu_type_get(a1, v26);
        if ( v35 != v26 )
        {
          v49 = v35;
          if ( ll_pdu_dispatch(a1, v35) )
            v51 = v49;
        }
        goto LABEL_68;
      case 3:
        v34 = bt_cmd_handler(a1, v26);
        if ( v34 != v26 )
        {
          v48 = v34;
          if ( ll_pdu_dispatch(a1, v34) )
            v52 = v48;
        }
        goto LABEL_68;
      case 4:
        v33 = ll_pdu_type_get(a1, v25);
        if ( v25 != v33 )
        {
          v47 = v33;
          if ( ll_pdu_dispatch(a1, v33) )
            v53 = v47;
        }
LABEL_68:
        if ( v23 <= 3 )
        ...
        goto LABEL_71;
      case 5:
        v27 = bt_cmd_handler(a1, v25);
        if ( v25 != v27 )
        {
          v46 = v27;
          if ( ll_pdu_dispatch(a1, v27) )
            v54 = v46;
        }
        ...
        goto LABEL_84;
      default:
        LOWORD(v50) = rf_cal_channel_get(a1);
        if ( v23 <= 3 )
        {
LABEL_69:
...
LABEL_92:
                  ...
                  *(uint16_t *)(v32 + 6) = 0;
                  v41[12] = 0;
                  v41[14] = 1;
                  rate_parse_ht_mcs_n_490(a1, v30, v32, v41);
                  v30 = (uint16_t)(v30 + 1);
                  v5 = *(uint16_t *)(a1 + 136);
                  v28 = *(uint16_t *)(a1 + 184);
                }
...
LABEL_6:
        v6 = 12 * v5;
        v7 = rx_header_parse(v6 + 4 + a1);
        v8 = *(uint8_t *)(a1 + 169);
        v44 = v7;
        *(uint16_t *)(a1 + 152) = 10 * *(uint16_t *)(a1 + 150);
        v9 = scale_timer_value(v7);
        v10 = *(uint16_t *)(a1 + 184);
...
LABEL_19:
          v21 = rx_header_parse(12 * v14 + 4 + a1);
