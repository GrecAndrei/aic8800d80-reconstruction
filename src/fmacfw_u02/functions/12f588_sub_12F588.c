...
// check_chip_mode @ 0x12f588, size 82 bytes
    ...
    if ( v2 )
    {
      *(uint32_t *)(a1 + 24) = 49374;
      ...
      while ( !*(uint32_t *)off_12F5E0 )
        ;
      cmd_handler_a(*(uint32_t *)off_12F5E4 + 604, (uint32_t *)(v3 - 4));
      *v4 = 1;
      gpio_set_pin7();
    }
    else
    {
      event_dispatch(dword_12F5E8);
    }
  }
}
