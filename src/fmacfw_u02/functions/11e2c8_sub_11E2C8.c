...
extern uint32_t off_11E55C;
extern uint32_t off_11E56C;
extern uint32_t off_11E570;
extern uint32_t off_11E590;
extern uint32_t dword_11E594;
extern uint32_t dword_11E574;
extern uint32_t off_11E578;
extern uint32_t off_11E57C;
extern uint32_t dword_11E580;
extern uint32_t off_11E564;
extern uint32_t off_11E588;
extern uint32_t off_11E58C;
extern uint32_t dword_11E600;
extern uint32_t dword_11E568;
extern uint32_t off_11E560;
extern uint32_t dword_11E584;
extern uint32_t off_11E5F4;
extern uint32_t off_11E5F8;
extern uint32_t dword_11E5FC;

// sub_11E2C8 @ 0x11e2c8, size 810 bytes
int  sub_11E2C8(int a1, unsigned int a2, int a3, int16_t a4, int a5, int a6)
{
  int v6; // r8
  uint8_t **v7; // r7
  int v8; // r12
  ...
  v7 = (uint8_t **)off_11E55C;
  v8 = *(uint32_t *)(a1 + 28);
  v9 = *(uint8_t **)off_11E55C;
  v58[0] = v8;
  LOWORD(v57) = a4;
  v11 = *v9;
  if ( v11 != 2 )
...
LABEL_25:
      ...
      if ( !*((uint8_t *)off_11E57C + 2) )
        goto LABEL_6;
      v36 = *(uint32_t *)(v6 + 4);
      *(uint32_t *)(v6 + 8) = *(uint16_t *)off_11E57C + 58;
      *(uint8_t *)(v36 + 3) &= 0x3Fu;
      *(uint8_t *)(v6 + 14) = v35[3];
      *(uint32_t *)v6 = 0;
      if ( (__get_CPSR() & 1) == 0 )
