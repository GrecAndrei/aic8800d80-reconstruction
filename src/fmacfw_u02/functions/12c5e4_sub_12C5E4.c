...
int  ke_task_create(int a1, int a2, unsigned int a3)
{
  ...
  if ( **(int16_t **)off_12C730 < 0 )
  {
    ...
    {
      if ( a3 > dword_12C71C )
        mmio_clear_register(dword_12C724, dword_12C720, 148);
    }
    else
    {
      mmio_clear_register(dword_12C728, dword_12C720, 147);
    }
  }
  if ( (__get_CPSR() & 1) == 0 )
  {
  ...
  v10 = pkt_word_get(dword_12C70C, dword_12C708, a2 | (a1 << 16));
  if ( !v10 )
  {
    v17 = pkt_buf_alloc(12);
    v10 = v17;
    if ( **v3 < 0 && !v17 )
      mmio_clear_register(dword_12C72C, dword_12C720, 165);
    *(uint16_t *)(v10 + 4) = a1;
    *(uint16_t *)(v10 + 6) = a2;
  }
  v11 = dword_12C714;
  ...
  *(uint32_t *)(v10 + 8) = v13;
  ...
  if ( v9 )
  {
    ...
    if ( !v10 )
      goto LABEL_10;
LABEL_15:
    result = unknown_worker(dword_12C718, *(uint32_t *)(v10 + 8));
    goto LABEL_10;
  }
  if ( v8[5] == v10 )
    goto LABEL_15;
