...
// Doc: rf_write_cal_param [rf]: Processes RF message body with frequency and channel data
// rf_write_cal_param [rf]: Processes RF message body with frequency and channel data
