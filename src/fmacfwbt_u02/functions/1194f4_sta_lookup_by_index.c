...
// Doc: phy_channel_configure [mac]: Look up station/STA entry by index in sta table
// phy_channel_configure [mac]: Look up station/STA entry by index in sta table
BOOL  phy_channel_configure(
        int a1,
        int a2,
        int a3,
        int a4,
