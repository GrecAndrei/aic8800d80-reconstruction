...
// Doc: rf_config_chan_table [mmio]: Looks up a 0x2b8-byte record by index from a base table
// rf_config_chan_table [mmio]: Looks up a 0x2b8-byte record by index from a base table
