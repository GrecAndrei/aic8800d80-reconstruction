...
extern uint32_t dword_11F47C;
extern uint32_t dword_11F480;
extern uint32_t dword_11F484;
extern uint32_t dword_11F48C;
extern uint32_t dword_11F490;
extern uint32_t dword_11F494;
...
int  wlc_detach(int *a1, uint8_t *a2)
{
  ...
  *(uint32_t *)(v6 + 336) = dword_11F494 + (v21 << 6);
  v23 = off_11F498;
  if ( (v22 & 8) != 0 )
    v24 = v6 + 184;
  else
  ...
  *(uint32_t *)(v6 + 580) = dword_11F49C;
  ...
  {
    __disable_irq();
    *(uint32_t *)off_11F4A0 = 1;
  }
  v28 = off_11F4A4;
  v29 = *(uint32_t *)(v6 + 44);
  v30 = *(uint32_t *)off_11F4A4;
  v31 = *(uint32_t *)off_11F4A4 + 1;
  *(uint32_t *)off_11F4A4 = v31;
  *(uint8_t *)(v6 + 37) = 1;
  if ( v29 )
    *(uint8_t *)(v29 + 37) = 1;
  if ( v31 )
  ...
  v33 = (uint8_t)*a2;
  if ( v33 <= 0x23 )
    *(uint32_t *)(v7 + 696 * v33 + 664) = *((uint32_t *)off_11F498 + 4);
  *(uint8_t *)(v6 + 668) = 0;
  return 0;
}
