...
// Doc: rx_packet_parse [rf]: Process RF message body parsing header byte and sub-id
// rx_packet_parse [rf]: Process RF message body parsing header byte and sub-id
