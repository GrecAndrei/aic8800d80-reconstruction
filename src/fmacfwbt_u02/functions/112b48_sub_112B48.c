...
// mmio_intr_status @ 0x112b48, size 594 bytes
int mmio_intr_status()
{
  uint32_t *v0; // r3
  int v1; // r2
  int v2; // r4
  ...
  v0 = off_112D9C;
  v1 = *((uint32_t *)off_112D9C + 5);
  *((uint32_t *)off_112D9C + 5) = v1;
  v2 = v0[6] & v1;
  LODWORD(v3) = v2 << 19;
  if ( (v2 & 0x1000) != 0 )
  {
    LODWORD(v3) = rf_init_bb();
    v4 = v2 & 0x2000;
    if ( (v2 & 0x2000) == 0 )
      return v3;
    v7 = 0;
  ...
  v22 = *((uint32_t *)off_112D9C + 514);
  if ( (v22 & 6) != 0 && (v22 & 2) != 0 )
    *(uint32_t *)off_112DB0 = 1;
  v23 = off_112D9C;
  v24 = (uint32_t **)off_112DB4;
  v25 = (int *)off_112DB8;
  v26 = dword_112DBC;
  *((uint32_t *)off_112D9C + 576) = dword_112DBC;
  v23[704] = v26;
  v27 = *v24;
  v28 = *v25;
  LODWORD(v3) = dword_112DC0;
  *v27 = dword_112DC0;
  v27[1] = v28;
  v23[709] = v27;
  v23[706] = v23[706];
...
LABEL_3:
  if ( v5 )
  {
    v8 = off_112D9C;
    v9 = dword_112DA0;
    v5 = *((uint32_t *)off_112D9C + 518);
    v10 = 0;
    v11 = v5 & *((uint32_t *)off_112D9C + 519);
    while ( 1 )
    {
      LODWORD(v3) = 1;
      if ( ((1 << v10) & v11) != 0 )
        ...
        *((uint32_t *)v12 + 586) = v5;
        ...
        if ( (v3 & 0x900000000LL) != 0 )
        {
          if ( *(uint8_t *)(v9 - 5) )
          {
            ...
            v31 = (v5 & 1) == 0;
            if ( (v5 & 1) == 0 )
              rf_reg_write((int *)1, (uint8_t)v10);
            LODWORD(v3) = memset_byte((int *)(v9 - 16), 0, 0x10u);
        ...
        {
          LODWORD(v3) = printf_wrapper(dword_112DAC);
        }
      }
      if ( (uint8_t)v10 == 5 )
        break;
LABEL_14:
  ...
  if ( v6 )
  {
    ...
    v15 = dword_112DA8;
    v16 = dword_112DC8;
    v17 = *((uint32_t *)off_112D9C + 518) & *((uint32_t *)off_112D9C + 519);
    for ( i = 0; ; ++i )
    {
      if ( ((0x10000 << i) & v17) != 0 )
      {
        if ( !i )
        {
          ...
          {
            v14[517] &= ~0x10u;
            LODWORD(v3) = tx_desc_hw_config(0, 0x200000, 0);
          }
          else if ( (v20 & 0x29) != 0 )
          {
            LODWORD(v3) = 0;
            LODWORD(v3) = rx_parse_packet(v3);
          }
          goto LABEL_19;
        }
        v19 = (char *)&v14[8 * i - 8];
        ...
        *((uint32_t *)v19 + 714) = v5;
        if ( (v14[517] & v5 & 1) != 0 )
        {
          if ( *(uint8_t *)(v15 - 8) )
          {
            ...
            v32 = *(uint32_t *)(v15 - 12);
            v36 = *(uint32_t *)(v15 - 16);
            LODWORD(v3) = memset_byte((int *)(v15 - 16), 0, 0x10u);
...
LABEL_19:
  ...
  if ( v7 )
  {
    LODWORD(v3) = ke_wait_event_a(v3, SHIDWORD(v3), v5);
    if ( v4 >= 0 )
      return v3;
  }
  else if ( v4 >= 0 )
  ...
  LODWORD(v3) = ke_wait_event_b(v3, SHIDWORD(v3), v5);
  return v3;
}
