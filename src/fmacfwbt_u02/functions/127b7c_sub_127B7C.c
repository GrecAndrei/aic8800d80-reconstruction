...
extern uint32_t dword_127C3C;
extern uint32_t off_127C38;

// get_conn_by_handle @ 0x127b7c, size 186 bytes
int  get_conn_by_handle(int result, int16_t a2)
{
  int v2; // r8
  int v3; // r7
  int v4; // r5
  ...
  {
    v6 = result;
    result = rf_read_state(dword_127C3C + 1320 * v3, *(uint8_t *)(result + 87));
    v8 = *(uint32_t *)(v6 + 92);
