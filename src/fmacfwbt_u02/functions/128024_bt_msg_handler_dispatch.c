...
// Doc: lookup_7byte_channel [bt]: BT message handler dispatch computing index*7 from global state
// lookup_7byte_channel [bt]: BT message handler dispatch computing index*7 from global state
