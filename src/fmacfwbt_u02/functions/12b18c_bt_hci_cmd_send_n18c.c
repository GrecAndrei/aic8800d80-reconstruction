...
// Doc: ke_timer_wait [bt]: Sends HCI command (opcode 2) via bluetooth mailbox interface
// ke_timer_wait [bt]: Sends HCI command (opcode 2) via bluetooth mailbox interface
int ke_timer_wait()
{
  int value; // r0
  int v1; // r2
  ...
  if ( hci_cmd_send_short(2) != 3 )
  {
    ...
    ke_event_schedule(dword_12B218, value, v1);
  }
