...
// Doc: mac_irq_status [mmio]: Read MMIO status registers (0x4032806c/74) and mask with 0x40001
// mac_irq_status [mmio]: Read MMIO status registers (0x4032806c/74) and mask with 0x40001
