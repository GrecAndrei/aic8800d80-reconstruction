...
// Doc: wlc_bsscfg_llc_flush [rf]: Clears/resets a 32-bit PHY field at struct offset 0x23c
// wlc_bsscfg_llc_flush [rf]: Clears/resets a 32-bit PHY field at struct offset 0x23c
