...
// Doc: util_feature_get [bt]: Posts a message; loads shared flag, branches on it then dispatches.
// util_feature_get [bt]: Posts a message; loads shared flag, branches on it then dispatches.
