...
// Doc: write_hw_mmio_word [bt]: Bluetooth firmware initialization entry; sets up stack and calls sub-routine
// write_hw_mmio_word [bt]: Bluetooth firmware initialization entry; sets up stack and calls sub-routine
