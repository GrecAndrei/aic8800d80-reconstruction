...
// Doc: update_connection_stats [tx]: Process BT TX queue entry and update descriptor fields
// update_connection_stats [tx]: Process BT TX queue entry and update descriptor fields
