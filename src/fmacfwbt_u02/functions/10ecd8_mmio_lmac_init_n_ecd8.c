...
// Doc: periph_trigger_write [mmio]: Initialize LMAC MMIO control registers and doorbell
// periph_trigger_write [mmio]: Initialize LMAC MMIO control registers and doorbell
