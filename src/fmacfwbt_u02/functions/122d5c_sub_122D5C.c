...
// copy_fixed_string @ 0x122d5c, size 28 bytes
...
int  copy_fixed_string(int a1, int a2, int a3, int a4)
{
  int v6; // r3

  memcpy_aligned(dword_122D78, a2, 69);
  hci_evt_alloc_send(120, a4, a3, v6);
  return 0;
}
