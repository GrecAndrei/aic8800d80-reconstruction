...
// ll_event_process @ 0x134280, size 162 bytes
int ll_event_process()
{
  ...
  if ( hci_cmd_send_short(6u) == 9 )
  {
    ...
    *(uint16_t *)(v5 + 56) = v7;
    if ( v6 == 2 )
    {
      v8 = (uint8_t *)bt_buf_alloc(5145, 5, 6, 2u);
      *v8 = 0;
      v8[1] = *(uint8_t *)(v1 + 61);
      hci_evt_send((int)v8);
    }
