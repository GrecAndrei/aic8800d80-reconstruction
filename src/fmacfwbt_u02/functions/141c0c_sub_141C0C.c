...
extern uint32_t off_141D0C;
extern uint32_t dword_141D14;
extern uint32_t dword_141D10;
extern uint32_t off_141D18;

// sub_141C0C @ 0x141c0c, size 256 bytes
int  sub_141C0C(int a1, int a2, int a3, int a4, char a5)
{
  int v6; // r1
  int v10; // r3
  BOOL v11; // r0
  ...
  {
    v10 = *(uint8_t *)(v6 + 4);
    if ( **(int16_t **)off_141D0C >= 0 || v10 != 2 )
    {
      v11 = (v10 | *(uint8_t *)(a2 + 1224)) != 0;
      goto LABEL_4;
    }
  }
  else if ( **(int16_t **)off_141D0C >= 0 )
  {
    goto LABEL_16;
  }
