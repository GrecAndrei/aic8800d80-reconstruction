...
int  assert_fail_handler(int result, int a2)
{
  ...
  if ( v2 < 0 )
  {
    ...
    {
      return ke_int_lock(dword_11AD3C, dword_11AD38, 3371, v4);
    }
    else
    {
      ...
      *(uint32_t *)(v3 + 20) = v5;
      return get_cal_item(result, a2, v3, v5);
    }
  }
  return result;
}
