...
extern uint32_t off_119B18;
extern uint32_t dword_119B04;
extern uint32_t dword_119B00;
extern uint32_t dword_119B14;
extern uint32_t dword_119B08;
extern uint32_t dword_119B10;
extern uint32_t dword_119AEC;
extern uint32_t dword_119B0C;
extern uint32_t dword_119AF0;
extern uint32_t dword_119AF4;
extern uint32_t dword_119B1C;
...
unsigned int  sub_1198E8(int a1, int a2, int a3)
{
  ...
  if ( v9 <= 4 )
  {
    ...
    if ( v10 )
    {
      ...
      v34 = dword_119AEC;
      v37 = *(uint32_t *)(dword_119AEC + 696 * v23 + 16);
    }
    else
    {
      if ( **v3 < 0 && (v22 & 0x60) != 0 )
      ...
      v34 = dword_119AEC;
      v26 = *(uint16_t *)(dword_119AEC + 696 * v23 + 20);
      v38 = ((v24 >> 3) & 3) + 1;
      v12 = v22 & 7;
      v37 = v26;
    }
    v14 = (int ( *)(int, uint32_t))dword_119AF0;
    v39 = (int ( *)(int, uint32_t))dword_119AF0;
    v11 = v25 | (8 * v12);
    v40[0] = (int ( *)(int, int))dword_119AF4;
    LOBYTE(v12) = 0;
    goto LABEL_14;
  }
