...
// Doc: hci_send_acl [mac]: MAC state processing with context save and large register frame
// hci_send_acl [mac]: MAC state processing with context save and large register frame
