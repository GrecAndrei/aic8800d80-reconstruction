...
// Doc: periph_enable [rf]: RF initialization block A: setup core with size 0x100/0x108 and enable
// periph_enable [rf]: RF initialization block A: setup core with size 0x100/0x108 and enable
int periph_enable()
{
  int result; // r0
