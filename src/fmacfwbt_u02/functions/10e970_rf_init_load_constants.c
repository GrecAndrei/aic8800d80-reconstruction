...
// Doc: board_init [rf]: Loads RF/board constants and pointers, likely RF init or calibration setup
// board_init [rf]: Loads RF/board constants and pointers, likely RF init or calibration setup
