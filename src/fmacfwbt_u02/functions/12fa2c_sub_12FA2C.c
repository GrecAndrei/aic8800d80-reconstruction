...
extern uint32_t off_12FB5C;
extern uint32_t off_12FB60;
extern uint32_t off_12FB68;
extern uint32_t off_12FB64;
...
LABEL_11:
  ...
  *(uint32_t *)off_12FB5C = a2;
  if ( a3 )
    goto LABEL_11;
LABEL_3:
  v6 = (int *)off_12FB60;
  v7 = off_12FB64;
  v8 = *(uint32_t *)off_12FB60;
  *(uint32_t *)off_12FB64 = *(uint32_t *)off_12FB60;
  if ( a1 <= 0x17 )
  {
    switch ( a1 )
    {
