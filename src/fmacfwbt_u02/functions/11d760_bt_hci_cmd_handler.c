...
// Doc: rx_process_packet [bt]: BT HCI command handler entry, reads opcode offset 0x30
// rx_process_packet [bt]: BT HCI command handler entry, reads opcode offset 0x30
