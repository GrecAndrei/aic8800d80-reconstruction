...
uint8_t * sub_1331D4(int a1, int16_t a2, unsigned int a3)
{
  int v4; // r3
  int v5; // r6
  int v6; // r0
  ...
  if ( (v13[374] & 6) != 0 )
  {
    ...
    if ( !*(uint8_t *)(a1 + 106) )
    {
      ...
      if ( v63
        ...
        && (v63[2] & 0x80u) == 0 )
      {
        idx_record_lookup_n_4d4(*(uint8_t *)(a1 + 116), v63[2] & 3);
      }
...
LABEL_102:
  ...
  sub_132F34((int)v14, 0, a1 + 248);
LABEL_7:
  v15 = (uint8_t)sub_13116C(v10, v12, v74, a1 + 1212);
  if ( v15 )
  {
    if ( *(uint8_t *)(a1 + 106) )
    {
