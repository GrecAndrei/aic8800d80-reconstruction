...
extern uint32_t off_111204;
extern uint32_t off_111208;
extern uint32_t off_11120C;
extern uint32_t off_111200;
...
int timer_set_alarm()
{
  ...
  v0 = *(uint32_t *)off_111204;
  v1 = (int *)off_111208;
  v2 = off_11120C;
  *(uint32_t *)(v0 + 4) = *(uint32_t *)off_111200;
  result = *v1;
  v2[709] = v0;
  v4 = *(uint32_t *)off_111210;
