...
// Doc: sdio_core_set_enable [mmio]: Writes 1 to MMIO reg 0x4010d004 to enable RF block
// sdio_core_set_enable [mmio]: Writes 1 to MMIO reg 0x4010d004 to enable RF block
