...
// Doc: process_queue_message [rf]: RF subsystem initialization entry, sets up context and calls helper
// process_queue_message [rf]: RF subsystem initialization entry, sets up context and calls helper
