...
// Doc: btcoex_update_bt_info [tx]: Acquire or allocate LMAC TX buffer via SDIO prep
// btcoex_update_bt_info [tx]: Acquire or allocate LMAC TX buffer via SDIO prep
