...
extern uint32_t off_107A58;
extern uint32_t off_107A6C;
extern uint32_t dword_107A5C;
extern uint32_t dword_107A60;
...
int  rf_core_set_clock_override(int a1, uint32_t *a2)
{
  ...
  *(uint32_t *)off_107A58 |= 0x1000000u;
  v4 = *v2 & 0xFDFFFFFF;
  v5 = 1;
  *v2 = v4;
  v7 = 1000;
