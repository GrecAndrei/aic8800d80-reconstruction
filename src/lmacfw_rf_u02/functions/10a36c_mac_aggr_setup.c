...
// Doc: validate_packet_length [mac]: MAC aggregation/AMPDU setup with subframe type dispatch
// validate_packet_length [mac]: MAC aggregation/AMPDU setup with subframe type dispatch
