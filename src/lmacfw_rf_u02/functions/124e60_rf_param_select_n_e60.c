...
// Doc: set_scan_params [rf]: Select RF parameter by comparing value against 2 and allocating stack frame
// set_scan_params [rf]: Select RF parameter by comparing value against 2 and allocating stack frame
