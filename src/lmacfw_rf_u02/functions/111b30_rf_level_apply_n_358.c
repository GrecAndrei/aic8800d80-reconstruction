...
// util_check_flags @ 0x111b30, size 1958 bytes
...
int  util_check_flags(uint64_t a1)
{
  int *v1; // r9
  int v3; // r4
  uint8_t *v4; // r5
  ...
  if ( (uint32_t)a1 )
  {
    v4 = (uint8_t *)rf_bus_reset_n_4b4;
    v16 = *(uint8_t *)rf_bus_reset_n_4b4;
    if ( v16 == 2 )
    {
      v5 = rf_bus_write_n_89;
      log_printf(rf_bus_reset_n_49c);
    ...
    if ( v16 == 4 )
    {
      ...
      *((uint16_t *)rf_bus_reset_n_4b4 + 5) = v52;
      if ( HIDWORD(a1) < v52 )
      {
        LODWORD(a1) = log_printf(dword_1122E0);
      ...
      else if ( !v53 )
      {
        ...
        LODWORD(a1) = rf_set_param(0, 0);
        goto rf_bus_setup_n42c;
      }
      LODWORD(a1) = rf_set_param(*((uint32_t *)v4 + 1) + v52, v53);
rf_bus_setup_n42c:
      if ( (v3 & 0x20) == 0 )
        return a1;
LABEL_19:
      if ( *v4 == 6 )
      {
        v28 = *(uint32_t **)rf_bus_write_n_89;
        v29 = *(uint32_t *)rf_bus_reset_n_4a4;
        v30 = off_111E44;
  ...
  else
  {
    ...
    {
      v4 = (uint8_t *)rf_bus_reset_n_4b4;
      v17 = *(uint8_t *)rf_bus_reset_n_4b4;
...
LABEL_46:
        ...
        switch ( v25 )
        {
          case 3:
            if ( !*((uint32_t *)v4 + 1) )
              *((uint32_t *)v4 + 1) = rf_bus_reset_n_490;
            goto LABEL_50;
          case 4:
LABEL_87:
            rf_set_param(*((uint32_t *)v4 + 1), *((uint16_t *)v4 + 4));
            goto LABEL_50;
          case 7:
LABEL_73:
            timer_read_count();
...
LABEL_49:
        *v4 = 0;
        rf_channel_set_flag(0, 0x200000, 0);
          ...
          if ( *(uint8_t *)off_111E64 == 4 )
          {
            ...
            if ( v31 != 1 )
            {
              ...
              if ( v41 <= 5 )
              {
                v15 = (v59 >> 7) & 1;
LABEL_97:
                if ( rf_select_base(v15, v41) )
                {
                  v32 = rf_bus_reset_n_174_217c;
                  *(uint16_t *)rf_bus_reset_n_174_217c = 1;
                  goto LABEL_68;
                }
              }
            }
...
LABEL_59:
                ...
                v32 = rf_bus_reset_n_174_217c;
                *(uint16_t *)rf_bus_reset_n_174_217c = *(uint8_t *)rf_bus_reset_n_178;
LABEL_68:
                *((uint32_t *)v4 + 1) = v32;
                *((uint16_t *)v4 + 4) = 2;
                *v4 = 4;
...
LABEL_45:
        ...
        case 1u:
          ...
          if ( (v4[12] & 0x1F) != 2 || *((uint16_t *)v4 + 7) )
            goto LABEL_79;
          rf_enable_txrx_patch((int *)((*((uint16_t *)v4 + 8) >> 7) & 1), *((uint16_t *)v4 + 8) & 0xF);
          *v4 = 7;
          if ( v14 == 4 )
            goto LABEL_44;
          goto LABEL_73;
...
rf_bus_reset_1e6c:
            ...
            rf_enable_rx_patch((int *)((*((uint16_t *)v4 + 8) >> 7) & 1), *((uint16_t *)v4 + 8) & 0xF);
            *v4 = 7;
            if ( v14 != 4 )
              goto LABEL_73;
          }
...
LABEL_89:
            ...
            *(uint8_t *)rf_bus_reset_22ec = HIBYTE(*((uint16_t *)v4 + 8));
            *v4 = 7;
            if ( v13 != 4 )
              goto LABEL_73;
          }
LABEL_44:
        ...
        case 5u:
          v35 = *((uint16_t *)v4 + 7);
          *((uint32_t *)rf_bus_reset_n_170 + 512) = (16 * v35) & 0x7F0
                                                | *((uint32_t *)rf_bus_reset_n_170 + 512) & 0xFFFFF80F;
          *v4 = 7;
          if ( v35 )
            *v12 = 3;
          else
...
LABEL_211:
        ...
        case 0xBu:
          ...
          *(uint16_t *)rf_bus_reset_n_16c = *((uint16_t *)v4 + 8);
          *v37 = *((uint16_t *)v4 + 7);
          *v4 = 7;
LABEL_72:
          if ( v14 != 4 )
    ...
    v5 = rf_bus_write_n_89;
    v4 = (uint8_t *)rf_bus_reset_n_4b4;
    v21 = *(uint32_t **)rf_bus_write_n_89;
    if ( (*(uint8_t *)(*(uint32_t *)rf_bus_write_n_89 + 3) & 1) == 0 )
    {
      v22 = *(uint8_t *)rf_bus_reset_n_4b4;
      switch ( v22 )
      {
        case 2:
          goto rf_bus_setup_358;
        case 3:
          v43 = *((uint16_t *)rf_bus_reset_n_4b4 + 5);
          v44 = (int *)off_112190;
          v45 = 64 - *(uint16_t *)v21;
          if ( v45 >= (uint16_t)(*((uint16_t *)rf_bus_reset_n_4b4 + 4) - v43) )
            LOWORD(v45) = *((uint16_t *)rf_bus_reset_n_4b4 + 4) - v43;
          memcpy_large(v43 + *((uint32_t *)rf_bus_reset_n_4b4 + 1), *(uint32_t *)off_112190, (uint16_t)v45);
          v46 = *((uint16_t *)v4 + 4);
    ...
    if ( *(uint8_t *)rf_bus_reset_n_4b4 )
      LODWORD(a1) = rf_enable_tx_patch((int *)1, 0);
    *v4 = 1;
  }
  return a1;
}
