...
// Doc: rf_cmd_strobe [mmio]: Initialize MMIO register block at 0x40328050 with value 1
// rf_cmd_strobe [mmio]: Initialize MMIO register block at 0x40328050 with value 1
int rf_cmd_strobe()
{
  uint32_t *v0; // r2
  unsigned int v1; // r0
  ...
  *v3 &= ~0x800u;
  ...
  v7 = off_11D2C0;
  v8 = dword_11D2D4;
  *(uint32_t *)off_11D2C8 = dword_11D2D0;
  *v6 = v8;
  v9 = (int *)off_11D2D8;
  v10 = dword_11D2DC;
  *v7 |= 0x40007C0u;
  ...
  *v19 |= 2u;
  if ( **v20 == 1 )
    *(uint32_t *)off_11D304 &= 0x80FFFFFF;
  v21 = off_11D2C0;
  v22 = off_11D308;
