...
// Doc: ll_event_timer_handler [rf]: Look up handler from RF table and invoke callback
// ll_event_timer_handler [rf]: Look up handler from RF table and invoke callback
