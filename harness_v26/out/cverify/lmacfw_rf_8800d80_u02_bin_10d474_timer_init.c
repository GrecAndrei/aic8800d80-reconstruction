...
#define off_10D4B8 ((uint32_t)0x40501000u)
#define off_10D4C0 ((uint32_t)0xe000e100u)
#define off_10D4BC ((uint32_t)0xe000ed00u)
#define off_10D4C4 ((uint32_t)0x0012d44du)
