...
def main() -> int:
    ...
    if not edges_script.is_file() or not cfg_script.is_file():
    ...
    print({"db_count": len(i64s), "edge_files": len(edge_files), "cfg_files": len(cfg_files), "edge_rows": edge_rows, "cfg_rows": cfg_rows})
    return 0
