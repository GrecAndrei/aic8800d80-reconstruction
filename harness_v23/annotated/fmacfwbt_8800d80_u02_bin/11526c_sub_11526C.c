// v23 annotated: sub_11526C @ 0x11526c
// Original: 11526c_sub_11526C.c
// Primary struct: <unclustered>
//
// sub_11526C @ 0x11526c, size 248 bytes
int __fastcall sub_11526C(int a1, int a2, unsigned int a3)
{
  int v6; // r4
  unsigned int v7; // r5
