// v23 annotated: sub_129FAC @ 0x129fac
// Original: 129fac_sub_129FAC.c
...
int __fastcall sub_129FAC(int result, int a2, unsigned int a3)
{
  int v3; // r8
  int v4; // r9
  int v5; // r5
  ...
  if ( !a2 )
  {
    v24 = (_BYTE *)(dword_12A164 + 140 * result);
  ...
  {
    v11 = (_BYTE *)(dword_12A164 + 140 * result);
        ...
        *(_BYTE *)(v6 + 20) = v20;
        ...
        if ( v20 )
        {
          ...
          if ( v20 <= 1 || v21 )
          {
            ...
            *(_DWORD *)(v6 + 28) = v22;
            *(_BYTE *)(v6 + 19) = v23;
            if ( fw_info_get_or_init(v6, *(unsigned __int8 *)(v28 + 113), *(_DWORD *)(v18 + 9), a3) )
              ++*(_BYTE *)(v28 + 121);
          }
        }
        v18 += 13;
