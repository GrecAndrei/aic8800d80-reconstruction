// v23 annotated: sub_13E670 @ 0x13e670
// Original: 13e670_sub_13E670.c
// Primary struct: <unclustered>
//
// sub_13E670 @ 0x13e670, size 1282 bytes
unsigned int __fastcall sub_13E670(int a1, unsigned int a2, unsigned int a3, int a4, int a5)
{
  ...
  *(_WORD *)(a1 + 30) = v12;
  ...
  if ( v10 == 255 )
    return result;
  v15 = (__int16 **)off_13EAF0;
  v16 = *(_DWORD *)(result + 340);
  if ( **(__int16 **)off_13EAF0 < 0 )
  {
    if ( v16 )
    {
      if ( !a4 )
