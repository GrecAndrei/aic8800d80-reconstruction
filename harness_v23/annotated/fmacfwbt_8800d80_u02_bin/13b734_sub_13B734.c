// v23 annotated: sub_13B734 @ 0x13b734
// Original: 13b734_sub_13B734.c
// Primary struct: <unclustered>
//
// sub_13B734 @ 0x13b734, size 576 bytes
int __fastcall sub_13B734(int a1, int a2, int a3, char a4, __int16 a5, __int16 a6, int a7)
{
  int v7; // r9
  int v8; // r7
  int v9; // r8
  ...
  v13 = *(_DWORD *)(dword_13B974 + 1320 * v9 + 72);
  if ( !v13 )
  {
...
LABEL_4:
  ...
  *(_WORD *)(v17 + 122) = *(_WORD *)(v8 + v20 + 4);
  ...
  v22 = *((_WORD *)off_13B978 + 254) + 1;
  *((_WORD *)off_13B978 + 254) = v22;
