// v23 annotated: rf_msg_handler_n_418 @ 0x112b48
// Original: 112b48_rf_msg_handler_n_418.c
...
int rf_msg_handler_n_418()
{
  ...
  v1 = *((_DWORD *)rf_cmd_send_via_dispatch + 5);
  *((_DWORD *)rf_cmd_send_via_dispatch + 5) = v1;
  v2 = v0[6] & v1;
  LODWORD(v3) = v2 << 19;
  if ( (v2 & 0x1000) != 0 )
  {
  ...
  v22 = *((_DWORD *)rf_cmd_send_via_dispatch + 514);
  if ( (v22 & 6) != 0 && (v22 & 2) != 0 )
    *(_DWORD *)rf_msg_handler_n_1b0 = 1;
  v23 = rf_cmd_send_via_dispatch;
  v24 = (_DWORD **)off_112DB4;
  v25 = (int *)sdio_buffer_prepare_n_432;
  v26 = rf_cmd_send_n_b0_dbc;
  *((_DWORD *)rf_cmd_send_via_dispatch + 576) = rf_cmd_send_n_b0_dbc;
  v23[704] = v26;
  v27 = *v24;
  v28 = *v25;
...
rf_bus_reset_n334_2b78:
  if ( v5 )
  {
    ...
    v5 = *((_DWORD *)rf_cmd_send_via_dispatch + 518);
    v10 = 0;
    v11 = v5 & *((_DWORD *)rf_cmd_send_via_dispatch + 519);
    while ( 1 )
    {
      LODWORD(v3) = 1;
      if ( ((1 << v10) & v11) != 0 )
        ...
        *((_DWORD *)v12 + 586) = v5;
        ...
        if ( (v3 & 0x900000000LL) != 0 )
        {
          if ( *(_BYTE *)(v9 - 5) )
          {
            ...
            v13 = *(int (__fastcall **)(int, int, BOOL))(dword_112DA4 + 4 * v10 + 52);
            if ( v13 )
...
rf_bus_reset_n3b6:
  ...
  if ( v6 )
  {
    ...
    v16 = dword_112DC8;
    v17 = *((_DWORD *)rf_cmd_send_via_dispatch + 518) & *((_DWORD *)rf_cmd_send_via_dispatch + 519);
    for ( i = 0; ; ++i )
    {
      if ( ((0x10000 << i) & v17) != 0 )
      {
        ...
        *((_DWORD *)v19 + 714) = v5;
        if ( (v14[517] & v5 & 1) != 0 )
        {
          if ( *(_BYTE *)(v15 - 8) )
          {
            ...
            v29 = *(int (__fastcall **)(int, int, _DWORD))(4 * i + dword_112DA4 + 32);
            if ( v29 )
