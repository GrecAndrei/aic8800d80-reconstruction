// v23 annotated: sub_127394 @ 0x127394
// Original: 127394_sub_127394.c
// Primary struct: <unclustered>
//
// sub_127394 @ 0x127394, size 266 bytes
int __fastcall sub_127394(int result)
{
  _BYTE *v1; // r5
  __int64 v2; // r6
  int v3; // r4
  ...
  if ( result != dword_1274A4 || (*((_BYTE *)off_1274A8 + 88) & 4) != 0 )
  {
    ...
    *((_QWORD *)v1 + 10) = v2;
    ...
    else
    {
      v1[88] = v4 & 0xBF;
      sub_126A04();
      result = sub_126938(SHIDWORD(v2), 0, 0);
      v5 = *((_DWORD *)v1 + 4);
      if ( v5 )
      {
        v6 = dword_1274BC;
        ...
        while ( 1 )
        {
          ...
          if ( *(_BYTE *)(v12 + 106) )
          {
            ...
            result = sub_1267A8(v12, v11 + v9, 0);
            v5 = *((_DWORD *)v1 + 4);
            if ( !v5 )
              break;
          }
          ...
          {
            result = sub_1267A8(v12, v11 + *(_DWORD *)(v7 + 696 * *(unsigned __int8 *)(v12 + 116) + 8), 0);
            v5 = *((_DWORD *)v1 + 4);
            if ( !v5 )
              break;
          }
