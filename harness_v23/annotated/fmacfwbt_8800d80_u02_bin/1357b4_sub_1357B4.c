// v23 annotated: sub_1357B4 @ 0x1357b4
// Original: 1357b4_sub_1357B4.c
// Primary struct: <unclustered>
//
// sub_1357B4 @ 0x1357b4, size 186 bytes
_DWORD *__fastcall sub_1357B4(char *a1)
{
  int v2; // r8
  unsigned int v3; // r1
  int v4; // r6
  ...
  if ( v3 <= 5 )
  {
    ...
    *(_WORD *)(v2 + 16) = 0;
    ...
    if ( !v4 )
      return rf_msg_process_body_n_102(*((_WORD *)a1 + 8) & 0x3FFF);
  }
  else
  {
