// v23 annotated: bt_dispatch_3arg @ 0x13bb14
// Original: 13bb14_bt_dispatch_3arg.c
...
int __fastcall bt_dispatch_3arg(int **a1)
{
  int *v1; // r6
  int result; // r0
  unsigned int v3; // r4
  ...
  {
    v5 = v4[2];
    v6 = *((_DWORD *)off_13BB5C + 4) - (_DWORD)v5;
    if ( v6 > v3 )
      result = *((unsigned __int8 *)v4 + 26);
    v4 = (int **)*v4;
    if ( v6 > v3 )
      v3 = *((_DWORD *)off_13BB5C + 4) - (_DWORD)v5;
  }
  while ( v4 );
  v7 = dword_13BB60 + 32 * result;
