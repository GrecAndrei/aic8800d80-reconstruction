// v23 annotated: fmac_msg_recv_handler @ 0x1231e4
// Original: 1231e4_fmac_msg_recv_handler.c
...
int __fastcall fmac_msg_recv_handler(int a1, _BYTE *a2, int a3, int a4)
{
  int v5; // r1
  int v6; // r2
  _BYTE *v7; // r5
  ...
  v14[0] = 0;
  v7 = (_BYTE *)rf_bus_setup_n3a8(124, a4, a3, 2);
  if ( *a2 )
  {
  ...
  {
    v9 = off_1232A8;
    *((_BYTE *)off_1232A8 + 188) = (v8 & 0x20) != 0;
    v10 = ((v8 ^ 0x40u) >> 6) & 1;
  }
  else
  {
    ...
    v9 = off_1232A8;
    v10 = ((v13 ^ 0x40u) >> 6) & 1;
    *((_BYTE *)off_1232A8 + 188) = (v13 & 0x20) != 0;
  }
