// v23 annotated: sub_13D730 @ 0x13d730
// Original: 13d730_sub_13D730.c
// Primary struct: <unclustered>
//
// sub_13D730 @ 0x13d730, size 1020 bytes
int __fastcall sub_13D730(int a1)
{
  int v2; // r0
  int v3; // r1
  int v4; // r2
  ...
  v5 = v2;
  result = (unsigned __int16)((_WORD)v3 << 11);
  if ( *(_BYTE *)(a1 + 179) )
  ...
  switch ( *(_BYTE *)(a1 + 169) )
  {
    case 0:
    case 1:
      v10 = (unsigned __int8)(*(_BYTE *)(a1 + 177)
    ...
    case 3:
      ...
      return (unsigned __int16)(result
                              | (8 * v36)
                              | ((((v5 >> 9) & 1) % (v35 + 1)) << 9)
                              | (((_WORD)v7 + (unsigned __int16)((int)((v5 >> 7) & 3) % (v4 - v7 + 1))) << 7))
           | v34;
    case 4:
      v8 = *(unsigned __int8 *)(a1 + 177);
      if ( v8 > 3 || (v5 & 0x800) == 0 )
