// v23 annotated: rf_init_hw_setup @ 0x10a800
// Original: 10a800_rf_init_hw_setup.c
...
int __fastcall rf_init_hw_setup(unsigned int a1, unsigned int a2, int a3, unsigned int a4, unsigned __int8 a5, char a6)
{
  unsigned int v8; // s17
  int v9; // r3
  _DWORD *v10; // r2
...
LABEL_28:
  ...
  else
  {
    ...
    do
    {
      v29 = bt_fmac_sub_a5bc(v8, v28, (unsigned __int8 *)&v58[6] + 3 * v28, (int *)&v58[8 * v28 + 54]);
      v30 = bt_fmac_sub_a5bc(v8, v28, (unsigned __int8 *)&v58[30] + 3 * v28, (int *)&v58[8 * v28 + 182]);
      v31 = v28 - 10;
      if ( v28 > 9 )
        v57[v31] = v29;
      else
