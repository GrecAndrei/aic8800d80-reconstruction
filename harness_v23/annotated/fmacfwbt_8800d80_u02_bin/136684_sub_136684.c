// v23 annotated: sub_136684 @ 0x136684
// Original: 136684_sub_136684.c
// Primary struct: <unclustered>
//
// sub_136684 @ 0x136684, size 388 bytes
int __fastcall sub_136684(int a1, int a2, __int16 a3, __int16 a4)
{
  int v4; // r8
  int v8; // r6
  int v9; // r5
  ...
  v4 = dword_136824;
  feature_guard_sdio(256, dword_13680C, *(_DWORD *)(a2 + 20), *((unsigned __int8 *)off_136808 + 413));
...
LABEL_3:
  ...
  if ( **(__int16 **)off_136810 < 0 && *(_DWORD *)(v9 + 72) )
    sub_12F694(dword_13681C, dword_136818, 105);
  v13 = *(_BYTE *)(a2 + 16);
  *(_DWORD *)off_136814 = a2;
  LOBYTE(v25) = v13;
  v14 = *(_WORD *)(a2 + 14);
  BYTE1(v25) = *(_BYTE *)(a2 + 28);
  HIWORD(v25) = v14;
  v15 = *(_DWORD *)(a2 + 24);
  LOWORD(v26) = *(_DWORD *)(a2 + 20);
  v16 = *(_BYTE *)(a2 + 18);
  HIWORD(v26) = v15;
