// v23 annotated: sub_12064C @ 0x12064c
// Original: 12064c_sub_12064C.c
// Primary struct: group_19 (cluster 19)
//
// sub_12064C @ 0x12064c, size 210 bytes
int __fastcall sub_12064C(int a1)
{
  _BYTE *v2; // r5
  int v3; // r0
  int v4; // r1
  ...
  *(_BYTE *)(a1 + 146) = v7;
  if ( !v5 )
  {
    ...
    sub_128AAC();
    sub_125058(a1 + 48);
    sub_124F60(a1 + 24, *((_DWORD *)off_120724 + 4) + *(_DWORD *)(dword_120720 + 696 * v8 + 8));
    *(_BYTE *)(a1 + 128) = 0;
    *(_BYTE *)(a1 + 147) = 1;
    return sub_12CBB4(v2);
  }
