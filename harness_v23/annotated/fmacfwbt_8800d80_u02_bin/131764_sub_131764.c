// v23 annotated: sub_131764 @ 0x131764
// Original: 131764_sub_131764.c
...
int __fastcall sub_131764(int a1, unsigned __int8 *a2, __int16 a3, __int16 a4)
{
  int v5; // r5
  int v6; // r8
  char v9; // r2
  ...
  if ( a2[1] )
    v9 = *(_BYTE *)(dword_13181C + 696 * v5 + 53) | 4;
  else
    v9 = *(_BYTE *)(dword_13181C + 696 * v5 + 53) & 0xFB;
