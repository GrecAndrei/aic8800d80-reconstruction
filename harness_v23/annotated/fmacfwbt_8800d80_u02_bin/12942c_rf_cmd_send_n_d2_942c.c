// v23 annotated: rf_cmd_send_n_d2_942c @ 0x12942c
// Original: 12942c_rf_cmd_send_n_d2_942c.c
...
void __fastcall rf_cmd_send_n_d2_942c(unsigned __int16 *a1, __int16 a2, int a3)
{
  _BYTE *v3; // r5
