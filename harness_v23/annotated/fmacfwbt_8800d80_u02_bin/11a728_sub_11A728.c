// v23 annotated: sub_11A728 @ 0x11a728
// Original: 11a728_sub_11A728.c
// Primary struct: <unclustered>
//
// sub_11A728 @ 0x11a728, size 354 bytes
int __fastcall sub_11A728(int a1, int a2)
{
  __int64 v2; // r6
  int *v3; // r10
  int v6; // r1
  ...
  *(_DWORD *)(HIDWORD(v2) + 68) = 256;
  if ( (_DWORD)v2 )
  {
    ...
    {
      v10 = *(_DWORD *)(dword_11A890 + 696 * *(unsigned __int8 *)(a1 + 29) + 340);
