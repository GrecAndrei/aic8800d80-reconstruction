// v23 annotated: sub_11B680 @ 0x11b680
// Original: 11b680_sub_11B680.c
...
int __fastcall sub_11B680(int *a1)
{
...
LABEL_3:
      v6 = sub_11B270(v13, a1, *((_DWORD *)v1 + 44), v1[93], *((_BYTE *)v1 + 190));
      if ( v6 )
      {
        if ( v9 )
          scan_chan_entry_alloc_n_54((int)v9, (unsigned __int8)v5);
