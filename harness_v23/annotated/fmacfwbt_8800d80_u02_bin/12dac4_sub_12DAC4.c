// v23 annotated: sub_12DAC4 @ 0x12dac4
// Original: 12dac4_sub_12DAC4.c
// Primary struct: bt_hci_cmd (cluster 4, 22 funcs)
// Fields: ogf=0x0, ocf=0x1
//
// sub_12DAC4 @ 0x12dac4, size 64 bytes
_BYTE *__fastcall sub_12DAC4(_BYTE *result, int a2, _BYTE *a3)
{
  unsigned int v3; // r1
  int v4; // r4
  _BYTE *v5; // r5
