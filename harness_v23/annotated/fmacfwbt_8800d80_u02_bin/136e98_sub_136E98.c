// v23 annotated: sub_136E98 @ 0x136e98
// Original: 136e98_sub_136E98.c
// Primary struct: <unclustered>
//
// sub_136E98 @ 0x136e98, size 246 bytes
int __fastcall sub_136E98(int a1, int a2)
{
  int v2; // r3
  int v5; // r3
  int result; // r0
  ...
  if ( v2 )
  {
    ...
    if ( **(__int16 **)off_136F90 >= 0 || v5 != 2 )
    {
      result = sub_119084((v5 | *(unsigned __int8 *)(a1 + 1224)) != 0, 512);
      v7 = result;
      if ( !result )
        return result;
LABEL_4:
