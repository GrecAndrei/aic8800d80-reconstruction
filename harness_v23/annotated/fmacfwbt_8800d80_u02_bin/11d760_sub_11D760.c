// v23 annotated: sub_11D760 @ 0x11d760
// Original: 11d760_sub_11D760.c
// Primary struct: <unclustered>
//
// sub_11D760 @ 0x11d760, size 1128 bytes
BOOL __fastcall sub_11D760(int a1)
{
  __int16 **v1; // r10
  int v2; // r8
  int v3; // r3
...
LABEL_19:
            ...
            {
              v53 = 0;
              v40 = sub_122830(a1 + 20, v18, v49, &v53);
              sub_1291B0(v53, *(unsigned __int16 *)(a1 + 48), v18);
              sub_12057C(v18);
              if ( v40 )
                sub_12A568(v18, v2, a1 + 20);
              return v40 == 0;
            }
            if ( v17 == 80 )
            {
            ...
            else
            {
              ...
              {
                sub_12A618(v18, *(_DWORD *)(v2 + 8), *(unsigned __int16 *)(a1 + 48), *(_DWORD *)(a1 + 52));
                return v8;
              }
            }
            return 0;
