// v23 annotated: sub_109988 @ 0x109988
// Original: 109988_sub_109988.c
// Primary struct: <unclustered>
//
// sub_109988 @ 0x109988, size 610 bytes
int __fastcall sub_109988(unsigned int a1, float *a2, float *a3, int a4)
{
  float v4; // s13
  float v5; // s14
  float v10; // s15
