// v23 annotated: sub_138E1C @ 0x138e1c
// Original: 138e1c_sub_138E1C.c
// Primary struct: <unclustered>
//
// sub_138E1C @ 0x138e1c, size 132 bytes
_DWORD *__fastcall sub_138E1C(int a1, __int16 a2)
{
  void *v2; // r6
  __int16 v4; // r5
  int v5; // r2
...
LABEL_10:
  ...
  else
  {
    ...
    v7 = (v5 << 8) | (*((unsigned __int8 *)off_138EA4 + 9) << 16) | *(_DWORD *)(a1 + 96);
  }
  v8 = v7 | 0x82;
  if ( !v6 )
    goto LABEL_10;
...
LABEL_7:
  ...
  *((_BYTE *)v2 + 50) = 0;
  ...
  return sub_138AD4(a1, v4, *((_DWORD *)v2 + 16));
}
