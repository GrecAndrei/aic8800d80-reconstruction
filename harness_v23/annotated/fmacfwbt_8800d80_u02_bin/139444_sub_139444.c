...
int __fastcall sub_139444(int a1, int a2)
{
  _WORD *v2; // r6
  int v3; // r7
  int v5; // r4
  ...
  v8 = dword_139684;
  v17 = sub_138BAC((unsigned __int8 *)(v3 + 107), (_DWORD *)(v3 + 1228), *(char **)(*(_DWORD *)(a1 + 28) + 8), 1);
  ...
  *(_BYTE *)(v10 + 288) = 1;
  if ( !*(_DWORD *)(v23 + 16) )
  {
    ...
    *(_BYTE *)(v10 + 11) = v25;
    ...
    if ( v25 == 1 )
      sub_124F60(v10 + 272, *((_DWORD *)off_139670 + 4) + 50000);
    goto LABEL_10;
  }
  return 0;
}
