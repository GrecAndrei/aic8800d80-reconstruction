// v23 annotated: bt_hci_cmd_dispatch_n_dc @ 0x14216c
// Original: 14216c_bt_hci_cmd_dispatch_n_dc.c
...
unsigned int __fastcall bt_hci_cmd_dispatch_n_dc(unsigned int result)
{
  int v1; // r1
  int v2; // r2
  int v3; // r5
