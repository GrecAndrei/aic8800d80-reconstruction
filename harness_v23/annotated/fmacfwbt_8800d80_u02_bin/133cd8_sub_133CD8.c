// v23 annotated: sub_133CD8 @ 0x133cd8
// Original: 133cd8_sub_133CD8.c
...
int sub_133CD8()
{
  ...
  if ( msg_get_value(6u) == 10 )
  {
    ...
    *(_DWORD *)(*((_DWORD *)off_133DE8 + 2) + 472) = 0;
    if ( v5 )
    {
      message_dispatch_n84(6148, 13, 6);
      v4[4] = 0;
    }
    sub_12CBB4(*(_DWORD *)v4 + 12);
