// v23 annotated: rf_level_apply_80c @ 0x12c80c
// Original: 12c80c_rf_level_apply_80c.c
...
int __fastcall rf_level_apply_80c(int a1, int a2, unsigned int a3)
{
  __int16 **v3; // r11
  int *v7; // r8
  _DWORD *v8; // r10
  ...
  {
    __disable_irq();
    *(_DWORD *)message_dispatch_n_288_c92c = 1;
  }
  v7 = (int *)off_12C95C;
  v8 = off_12C960;
...
message_dispatch_n_308:
    result = timestamp_update_4f60(message_dispatch_n_274, *(_DWORD *)(v10 + 8));
    goto LABEL_10;
  }
  if ( v8[5] == v10 )
    goto message_dispatch_n_308;
LABEL_10:
  if ( *v7 && (v15 = *v7 - 1, v16 = *(_DWORD *)message_dispatch_n_288_c92c, (*v7 = v15) == 0) && v16 )
  {
    __enable_irq();
