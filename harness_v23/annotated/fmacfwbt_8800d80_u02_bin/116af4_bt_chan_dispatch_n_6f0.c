// v23 annotated: bt_chan_dispatch_n_6f0 @ 0x116af4
// Original: 116af4_bt_chan_dispatch_n_6f0.c
...
int __fastcall bt_chan_dispatch_n_6f0(int a1, int a2, int a3, int a4)
{
  _DWORD *v5; // r3
  int *v6; // r0
  int *v7; // r3
