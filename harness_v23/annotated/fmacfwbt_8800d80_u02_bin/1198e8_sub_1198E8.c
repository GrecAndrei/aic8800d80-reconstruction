// v23 annotated: sub_1198E8 @ 0x1198e8
// Original: 1198e8_sub_1198E8.c
// Primary struct: <unclustered>
//
// sub_1198E8 @ 0x1198e8, size 514 bytes
unsigned int __fastcall sub_1198E8(int a1, int a2, int a3)
{
  __int16 **v3; // r10
  unsigned int v5; // r3
  int v8; // r4
  ...
  v3 = (__int16 **)off_119B18;
  v5 = *(_DWORD *)(a1 + 4);
  v36 = *(unsigned __int8 *)(a1 + 12);
  v8 = (v5 >> 7) & 3;
  v9 = (v5 >> 11) & 7;
  if ( **(__int16 **)off_119B18 < 0 && ((v5 >> 11) & 6) == 0 )
  ...
  if ( v9 <= 4 )
  {
    ...
    if ( v10 )
    {
      ...
      v34 = dword_119AEC;
      v37 = *(_DWORD *)(dword_119AEC + 696 * v23 + 16);
    }
    else
    {
      if ( **v3 < 0 && (v22 & 0x60) != 0 )
      ...
      v34 = dword_119AEC;
      v26 = *(unsigned __int16 *)(dword_119AEC + 696 * v23 + 20);
      v38 = ((v24 >> 3) & 3) + 1;
      v12 = v22 & 7;
      v37 = v26;
    }
    v14 = (int (__fastcall *)(int, _DWORD))dword_119AF0;
    v39 = (int (__fastcall *)(int, _DWORD))dword_119AF0;
    v11 = v25 | (8 * v12);
    v40[0] = (int (__fastcall *)(int, int))dword_119AF4;
    LOBYTE(v12) = 0;
    goto LABEL_14;
  }
