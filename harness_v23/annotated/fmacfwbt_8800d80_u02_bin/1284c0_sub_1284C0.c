// v23 annotated: sub_1284C0 @ 0x1284c0
// Original: 1284c0_sub_1284C0.c
// Primary struct: <unclustered>
//
// sub_1284C0 @ 0x1284c0, size 300 bytes
int __fastcall sub_1284C0(int result)
{
  void *v1; // r5
  int v2; // r4
  int v3; // r3
  ...
  if ( *((unsigned __int8 *)off_1285EC + 90) <= 1u )
  {
    ...
    if ( (v3 & 2) != 0 )
    {
      ...
      *((_BYTE *)v1 + 91) = v11;
      ...
      {
        result = rf_init_or_attach_n488(*((_DWORD *)v1 + 20));
          ...
          *((_BYTE *)v1 + 91) = v7;
          ...
          if ( (v6 & 8) != 0 )
          {
            ...
            *(_BYTE *)(v2 + 85) = v6 & 0xF7;
            ...
            {
              v10 = *(_DWORD *)(dword_1285F4 + 696 * *(unsigned __int8 *)(v2 + 116) + 8);
            }
            v8 -= v10;
          }
          else
          ...
          {
            if ( !*((_DWORD *)v1 + 11) )
              return mac_state_process_n_1c8(v2, *((_DWORD *)off_1285F0 + 4), *((_DWORD *)off_1285F0 + 4) - v8);
          }
        }
        return result;
      }
