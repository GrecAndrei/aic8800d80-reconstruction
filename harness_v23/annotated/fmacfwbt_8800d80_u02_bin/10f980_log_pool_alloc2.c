// v23 annotated: log_pool_alloc2 @ 0x10f980
// Original: 10f980_log_pool_alloc2.c
...
_DWORD *__fastcall log_pool_alloc2(int a1, unsigned int a2)
{
  unsigned int v2; // r6
  _DWORD *v3; // r5
...
LABEL_12:
  ...
  v6 = (int *)off_10FB10;
  v7 = *v4;
  v3 = *(_DWORD **)off_10FB10;
  v8 = *(_DWORD *)off_10FB10 + 1;
  *(_DWORD *)off_10FB10 = v8;
  if ( !v7 )
  {
    if ( v8 )
    {
  ...
  v3 = *((_DWORD **)v4 + 2);
  v10 = *(_DWORD *)off_10FB14;
  if ( *(_DWORD *)off_10FB14 <= (unsigned int)v3 && (unsigned int)v3 <= *((_DWORD *)off_10FB14 + 1) + v10
    || (unsigned int)v3 >= *(_DWORD *)off_10FB18
    && (unsigned int)v3 <= *(_DWORD *)off_10FB18 + *((_DWORD *)off_10FB18 + 1) )
  {
    *((_DWORD *)v4 + 2) = *v3;
    *v4 = v7 - 1;
  ...
  {
    log_printf(dword_10FB1C, *((_DWORD *)v4 + 2));
    v10 = *v9;
    v14 = *v4 - 1;
...
LABEL_18:
  ...
  v16 = *(_DWORD *)off_10FB18;
  if ( *(_DWORD *)off_10FB18 > (unsigned int)v3 || *((_DWORD *)off_10FB18 + 1) + v16 < (unsigned int)v3 )
  {
...
LABEL_37:
  ...
  {
LABEL_36:
    if ( (unsigned int)v3 > v16 + *((_DWORD *)off_10FB18 + 1) )
      goto LABEL_37;
LABEL_20:
    *((_BYTE *)v3 - 3) = -86;
  }
