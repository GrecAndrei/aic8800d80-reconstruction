// v23 annotated: log_hw_init @ 0x10d4a0
// Original: 10d4a0_log_hw_init.c
...
void log_hw_init()
{
  ...
  v0 = *((_DWORD *)off_10D58C + 43);
  if ( v0 >= 0 )
  {
    if ( *(_DWORD *)off_10D590 )
    {
      v21 = off_10D5B8;
      v22 = off_10D5BC;
      v23 = dword_10D5C0;
  ...
  else if ( *(_DWORD *)off_10D590 )
  {
    ...
    *v4 = 3;
    ...
    if ( (v5[20] & 0x20) != 0 )
    {
      v7 = *(_DWORD *)off_10D5C8;
      if ( v6 < *(_DWORD *)off_10D5C8 >> 4 )
        goto LABEL_5;
    }
    else
    {
      v7 = 2 * *(_DWORD *)off_10D5AC;
      if ( v6 < v7 >> 4 )
      {
LABEL_5:
        v8 = v7 / v6;
