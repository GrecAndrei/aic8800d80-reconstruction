// v23 annotated: rf_chan_state_lookup @ 0x12af44
// Original: 12af44_rf_chan_state_lookup.c
...
int __fastcall rf_chan_state_lookup(int a1)
{
  int v1; // r7
  int v3; // r5
  int v4; // r4
  ...
  *(_DWORD *)(a1 + 16) = 0;
  *(_DWORD *)(a1 + 20) = 0;
  return timestamp_update_4f60(a1, v3 + 102400);
}
