// v23 annotated: sub_10A5BC @ 0x10a5bc
// Original: 10a5bc_sub_10A5BC.c
// Primary struct: <unclustered>
//
// sub_10A5BC @ 0x10a5bc, size 572 bytes
int __fastcall sub_10A5BC(int a1, unsigned int a2, unsigned __int8 *a3, int *a4)
{
  ...
  _BYTE v32[4]; // [sp+18h] [bp-40h] BYREF
  _BYTE var3C[92]; // [sp+1Ch] [bp-3Ch] BYREF
...
LABEL_42:
      v21 = 32 * (9 - a2);
      sub_10DA7C(dword_10A7FC, a2, v15);
      return v21;
    }
    goto LABEL_21;
  }
  ...
  if ( a2 > 9 )
  {
    ...
    v21 = 32 * (9 - a2);
    sub_10DA7C(dword_10A7F8, a2, v20);
    return v21;
  }
  sub_109988(a2, v30, v31, (int)v32);
  v20 = v32[0];
  ...
  {
    v21 = 128;
    sub_10DA7C(dword_10A7F8, a2, v32[0]);
    return v21;
  }
LABEL_26:
  v21 = v32[1];
