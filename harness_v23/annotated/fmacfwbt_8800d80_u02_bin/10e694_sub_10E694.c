// v23 annotated: sub_10E694 @ 0x10e694
// Original: 10e694_sub_10E694.c
// Primary struct: <unclustered>
//
// sub_10E694 @ 0x10e694, size 416 bytes
int __fastcall sub_10E694(unsigned int a1, unsigned int a2, unsigned int *a3)
{
  unsigned int v3; // r4
  unsigned int *v4; // r6
  unsigned int *v5; // r5
  ...
  *(_DWORD *)off_10E834 = *(_DWORD *)off_10E834 & 0xFFFFFFF8 | a1 & 7;
  *v5 = ((_WORD)a1 << 12) & 0x7000 | *v5 & 0xFFFF8FFF;
  *v4 = (8 * a2) & 0x78 | *v4 & 0xFFFFFF87;
  *v5 = (a2 << 15) & 0x78000 | *v5 & 0xFFF87FFF;
  v8 = (__int16 *)off_10E83C;
  v9 = sub_10DF08();
  sub_12ECB0(dword_10E840, a1, a2);
  v10 = *v8;
  if ( v10 > v9 )
  {
    v23 = 1;
  ...
  while ( 1 )
  {
    ...
    *v12 = *v12 & 0xFFF87FFF | (v3 << 15);
    v15 = v9;
    v9 = sub_10DF08();
    sub_12ECB0(dword_10E844, v13, v3);
    v16 = *(__int16 *)off_10E83C;
    v17 = v9 - v16;
    v18 = v15 - v16;
    if ( v18 * v17 <= 0 )
      break;
  ...
  sub_12ECB0(dword_10E848, v20, v13 - v21);
LABEL_9:
  *a3 = v3;
  return v20;
}
