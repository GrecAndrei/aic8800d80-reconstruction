// v23 annotated: extract_top_nibble_flag @ 0x124e48
// Original: 124e48_extract_top_nibble_flag.c
...
int __fastcall extract_top_nibble_flag(unsigned __int8 *a1, void *a2)
{
  int v2; // r3
  unsigned int v3; // r2
