// v23 annotated: rf_entry_lookup_n3a0 @ 0x13f480
// Original: 13f480_rf_entry_lookup_n3a0.c
...
BOOL __fastcall rf_entry_lookup_n3a0(unsigned __int8 *a1, unsigned int a2)
{
  unsigned int v2; // r3
  unsigned int v3; // r2
  unsigned int v4; // r4
