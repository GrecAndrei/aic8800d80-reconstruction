// v23 annotated: patch_apply_n_2f4 @ 0x1151f4
// Original: 1151f4_patch_apply_n_2f4.c
...
int patch_apply_n_2f4()
{
  ...
  {
    __disable_irq();
    *(_DWORD *)patch_apply_n_2bc = 1;
  }
  v0 = (int *)rf_mem_read_and_clr_irq;
  ++*(_DWORD *)rf_mem_read_and_clr_irq;
  result = MEMORY[0x1C8]();
  if ( *v0 )
  {
    v2 = *v0 - 1;
    v3 = *(_DWORD *)patch_apply_n_2bc;
    *v0 = v2;
    if ( !v2 )
    {
      if ( v3 )
