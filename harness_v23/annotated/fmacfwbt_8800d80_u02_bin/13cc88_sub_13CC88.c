// v23 annotated: sub_13CC88 @ 0x13cc88
// Original: 13cc88_sub_13CC88.c
...
__int64 __fastcall sub_13CC88(int a1, _WORD *a2, int a3, int a4, int a5)
{
  char *v9; // r6
  int v10; // r5
  __int16 *v11; // r4
