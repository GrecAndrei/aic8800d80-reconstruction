// v23 annotated: sdio_buffer_prepare_df08 @ 0x12df08
// Original: 12df08_sdio_buffer_prepare_df08.c
...
unsigned __int8 *__fastcall sdio_buffer_prepare_df08(unsigned __int8 *a1, int a2)
{
