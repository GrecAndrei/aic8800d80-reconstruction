// v23 annotated: rf_bus_write_n_25c @ 0x13b734
// Original: 13b734_rf_bus_write_n_25c.c
...
int __fastcall rf_bus_write_n_25c(int a1, int a2, int a3, char a4, __int16 a5, __int16 a6, int a7)
{
  int v7; // r9
  int v8; // r7
  int v9; // r8
