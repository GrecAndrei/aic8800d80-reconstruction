// v23 annotated: fmac_bt_idle_handler @ 0x139e30
// Original: 139e30_fmac_bt_idle_handler.c
// Primary struct: <unclustered>
//
// fmac_bt_idle_handler @ 0x139e30, size 336 bytes
// Doc: fmac_bt_idle_handler [bt]: FMAC Bluetooth idle/state handler
// fmac_bt_idle_handler [bt]: FMAC Bluetooth idle/state handler
int __fastcall fmac_bt_idle_handler(char *a1, char a2, int a3)
{
  char v4; // r3
  int v6; // r4
  char *v7; // r8
