// v23 annotated: sub_13C7AC @ 0x13c7ac
// Original: 13c7ac_sub_13C7AC.c
...
int __fastcall sub_13C7AC(int a1, int a2, int a3, int a4)
{
  int result; // r0
  int v5; // lr
  __int64 v6; // r4
  ...
  result = *(_DWORD *)(dword_13C86C + 1320 * *(unsigned __int8 *)(a1 + 28) + 1204);
  if ( result )
  {
    if ( a4 )
      v5 = a4;
