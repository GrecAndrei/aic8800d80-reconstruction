// v23 annotated: sub_132B20 @ 0x132b20
// Original: 132b20_sub_132B20.c
// Primary struct: <unclustered>
//
// sub_132B20 @ 0x132b20, size 1016 bytes
_DWORD *__fastcall sub_132B20(int a1)
{
  char v1; // r3
  _DWORD *v2; // r6
  int *v3; // r4
  ...
  if ( (v1 & 1) == 0 )
    goto LABEL_23;
  v12 = *(_DWORD *)(a1 + 340);
  v67 = *((unsigned __int8 *)off_132E48 + 359);
  v75 = *(unsigned __int8 *)(a1 + 312);
  v73 = (char *)off_132E48 + 356;
  v74 = v1;
  v65 = 0;
...
LABEL_23:
  if ( (v1 & 0x20) != 0 )
  {
    ...
    v68 = v31;
    if ( *((_BYTE *)off_132E48 + 197) && (v2[5] & 0x387F) != (v31 & 0x387F) )
    {
      v32 = scan_chan_parse_n1bd4(
              (v31 >> 11) & 7,
              v30 & 0x7F,
              (unsigned __int8 *)(*(_DWORD *)(dword_132E4C + 1320 * *(unsigned __int8 *)(a1 + 34) + 72) + 4));
      v30 = *(_WORD *)(v71 + 10);
    ...
    *(_DWORD *)(v28 + 156) = v66 & v33 | v68;
    if ( sub_12EC84(5u, 4u) )
      sub_12ECB0(dword_132E54, *(_DWORD *)(v28 + 156), v29);
    sub_1403D4(v2, *(_DWORD *)(v28 + 156));
    v1 = *(_BYTE *)(a1 + 350);
  }
  if ( (v1 & 2) != 0 )
  {
  ...
  if ( (v1 & 0x10) != 0 )
  {
    v63 = dword_132E4C + 1320 * *(unsigned __int8 *)(a1 + 34);
    v69 = v2;
    v39 = v77;
    v40 = (unsigned int *)v76;
    v41 = v3;
    v42 = (unsigned __int8 *)off_132E48;
    do
    {
      v43 = v42[197];
      v45 = *v40++;
      ...
      *v39++ = v46;
      if ( v43 )
      {
        v58 = scan_chan_parse_n1bd4((v44 >> 11) & 7, v44 & 0x7F, (unsigned __int8 *)(*(_DWORD *)(v63 + 72) + 4));
        *(v39 - 1) = v46 | v58 | (v58 << 8);
      }
      else if ( **(__int16 **)off_132E58 < 0 )
      {
  ...
  if ( (v1 & 0x40) != 0 )
  {
    v47 = *(_DWORD *)(dword_132E4C + 1320 * *(unsigned __int8 *)(a1 + 34) + 468);
    v48 = v64 & 0xFC0FFFFF;
    v64 &= 0xFC0FFFFF;
    if ( v47 >= 0 )
