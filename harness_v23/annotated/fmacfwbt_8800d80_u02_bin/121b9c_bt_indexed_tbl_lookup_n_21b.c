// v23 annotated: bt_indexed_tbl_lookup_n_21b @ 0x121b9c
// Original: 121b9c_bt_indexed_tbl_lookup_n_21b.c
...
BOOL __fastcall bt_indexed_tbl_lookup_n_21b(int a1, int a2)
{
  return *(unsigned __int8 *)(696 * a1 + 12 * a2 + dword_121BBC + 453) != 33;
}
