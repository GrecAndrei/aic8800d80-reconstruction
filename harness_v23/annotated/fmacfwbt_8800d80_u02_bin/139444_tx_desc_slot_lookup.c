// v23 annotated: tx_desc_slot_lookup @ 0x139444
// Original: 139444_tx_desc_slot_lookup.c
...
int __fastcall tx_desc_slot_lookup(int a1, int a2)
{
  _WORD *v2; // r6
  int v3; // r7
  int v5; // r4
  ...
  if ( !*(_BYTE *)(v3 + 1227) )
  {
    ...
    v10 = *(_DWORD *)(dword_139684 + 4 * (v7 + 174 * a2 + 102));
  ...
  v8 = dword_139684;
  v17 = param_parse_setup((unsigned __int8 *)(v3 + 107), (_DWORD *)(v3 + 1228), *(char **)(*(_DWORD *)(a1 + 28) + 8), 1);
...
LABEL_17:
      ...
      *(_WORD *)(v10 + 8) = v21;
      sub_138A5C(v10);
      table_lookup_n_696(a2, *((unsigned __int8 *)v2 + 7));
      return v16;
    }
LABEL_28:
  ...
  *(_BYTE *)(v10 + 288) = 1;
  if ( !*(_DWORD *)(v23 + 16) )
  {
    ...
    *(_BYTE *)(v10 + 11) = v25;
    ...
    if ( v25 == 1 )
      timestamp_update_4f60(v10 + 272, *((_DWORD *)off_139670 + 4) + 50000);
    goto LABEL_10;
  }
  return 0;
}
