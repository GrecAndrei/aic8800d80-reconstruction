// v23 annotated: sub_12BAE4 @ 0x12bae4
// Original: 12bae4_sub_12BAE4.c
...
int sub_12BAE4()
{
  ...
  *(_DWORD *)off_12BCDC = 1;
  ...
  v2 = off_12BCE4;
  *(_DWORD *)off_12BCE0 = dword_12BCE8;
  v3 = off_12BCEC;
  *v2 = 0x80000000;
  v4 = (__int16 **)off_12BCF0;
  *v3 &= ~0x800u;
  if ( **v4 < 0 && *(_DWORD *)off_12BCF4 < 0x2F000000u )
    sub_12F694(dword_12BD40, dword_12BD3C, 284);
  v5 = (char *)off_12BCF4;
  v6 = (int *)off_12BCF8;
  v7 = off_12BCEC;
  v8 = dword_12BD00;
  *(_DWORD *)off_12BCF4 = dword_12BCFC;
  *v6 = v8;
  v9 = (int *)off_12BD04;
  v10 = dword_12BD08;
  *v7 |= 0x40007C0u;
  ...
  *(_DWORD *)off_12BD14 = 12288;
  *v13 = 0;
  bt_fw_init_or_handler(&v26, &v25);
  v16 = off_12BD20;
  *(_DWORD *)off_12BD1C = (v26 << 8) | (v25 << 16) | v26;
  v17 = off_12BD24;
  *v14 |= 0x1000u;
  *v14 |= 0x2000u;
  *v16 |= 0x80000u;
  ...
  *v15 = ((result + 1) << 26) & 0x1C000000 | *v15 & 0xE3FFFFFF;
  v20 = (_BYTE **)off_12BD2C;
  *v14 |= 0x20u;
  *v17 &= ~1u;
  *v19 |= 2u;
  if ( **v20 == 1 )
    *(_DWORD *)off_12BD30 &= 0x80FFFFFF;
  v21 = off_12BCEC;
  v22 = off_12BD34;
  *(_DWORD *)off_12BCEC |= 0x2000000u;
  if ( (*v22 & 0x20000) != 0 )
  {
    ...
    if ( result )
    {
      ...
      result = v23 << 8;
      *(_DWORD *)off_12BD44 = result & 0x700 | *(_DWORD *)off_12BD44 & 0xFFFFF8FF;
      ...
      *v24 |= 1u;
      ...
      if ( (*(_DWORD *)off_12BD34 & 0x20000) != 0 )
      {
        result = sysctl_chip_id_get();
        if ( result )
          *(_DWORD *)off_12BD44 |= 2u;
      }
    }
  }
  *(_DWORD *)off_12BD38 |= 1u;
  return result;
}
