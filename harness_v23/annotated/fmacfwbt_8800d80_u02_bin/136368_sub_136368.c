// v23 annotated: sub_136368 @ 0x136368
// Original: 136368_sub_136368.c
// Primary struct: <unclustered>
//
// sub_136368 @ 0x136368, size 142 bytes
int __fastcall sub_136368(int a1, unsigned __int8 *a2, __int16 a3, __int16 a4)
{
  int v7; // r2
  int v8; // r3
  int v9; // r1
