// v23 annotated: rf_bus_setup_n39a_ea44 @ 0x11ea44
// Original: 11ea44_rf_bus_setup_n39a_ea44.c
...
int __fastcall rf_bus_setup_n39a_ea44(int a1)
{
  int v1; // r8
  int v2; // r10
  int v3; // r11
...
LABEL_17:
      ...
      {
        v52 = (_DWORD *)log_free_dispatch_n2b4();
        v55 = (int)v52;
        if ( v52 )
        {
          if ( *((_BYTE *)v12 + 32) )
...
LABEL_41:
        ...
        while ( !*(_DWORD *)off_11EEB8 )
          ;
        list_push_tail(*(_DWORD *)off_11EEBC + 556);
        *v51 = 1;
