// v23 annotated: sub_11E540 @ 0x11e540
// Original: 11e540_sub_11E540.c
...
int __fastcall sub_11E540(int a1)
{
  int v1; // r4
  int v2; // r3
  int v3; // r2
  ...
  v6 = off_11E600;
  v7 = *((_DWORD *)off_11E600 + 5);
  if ( *((_DWORD *)off_11E600 + 4) == v5 )
    v5 = *((_DWORD *)off_11E600 + 3);
  *(_DWORD *)(a1 + 152) = v5;
