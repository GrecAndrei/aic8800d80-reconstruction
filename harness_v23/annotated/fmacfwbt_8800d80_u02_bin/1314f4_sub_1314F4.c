// v23 annotated: sub_1314F4 @ 0x1314f4
// Original: 1314f4_sub_1314F4.c
// Primary struct: <unclustered>
//
// sub_1314F4 @ 0x1314f4, size 486 bytes
int __fastcall sub_1314F4(int a1, unsigned __int8 *a2, __int16 a3, __int16 a4)
{
  int v7; // r1
  _BYTE *v8; // r3
  _DWORD *v10; // r1
  ...
  sub_12EEF8(2, dword_1316DC, *a2, a2[1]);
  v7 = *a2;
  v8 = off_1316E4;
  **(_BYTE **)off_1316E0 = v7;
  v8[412] = a2[1];
