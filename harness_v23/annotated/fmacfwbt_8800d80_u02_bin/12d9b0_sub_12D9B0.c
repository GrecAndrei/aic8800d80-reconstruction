// v23 annotated: sub_12D9B0 @ 0x12d9b0
// Original: 12d9b0_sub_12D9B0.c
// Primary struct: <unclustered>
//
// sub_12D9B0 @ 0x12d9b0, size 150 bytes
unsigned __int8 *__fastcall sub_12D9B0(unsigned __int8 *a1, int a2, unsigned __int8 *a3, int a4, _WORD *a5)
{
  unsigned int v5; // r9
  unsigned int v6; // r7
  int v7; // lr
