// v23 annotated: sub_12C0B4 @ 0x12c0b4
// Original: 12c0b4_sub_12C0B4.c
...
int __fastcall sub_12C0B4(int a1, int a2)
{
  void *v2; // r2
  int v3; // r4
  int result; // r0
  ...
  v2 = off_12C1CC;
  v3 = *(_DWORD *)off_12C1CC;
  *(_DWORD *)off_12C1D0 = *(_DWORD *)off_12C1CC;
  result = v3 << 21;
  if ( (v3 & 0x400) != 0 )
  {
...
LABEL_4:
  ...
  if ( (v3 & 0x2F) != 0 )
  {
    ...
    {
      v11 = (char *)off_12C1F8;
      rf_power_set(*((_BYTE *)off_12C1F8 + 411));
      v12 = v11[411];
      *((_BYTE *)off_12C1FC + 9) = v12;
      return sub_12ECB0(dword_12C200, v12, v13);
    }
    if ( *(_BYTE *)off_12C1D8 )
    {
      result = *(_DWORD *)off_12C1DC << 28;
      if ( result )
        *((_BYTE *)off_12C1D8 + 6) = 1;
    }
  }
