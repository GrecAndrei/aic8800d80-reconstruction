// v23 annotated: sub_1405DC @ 0x1405dc
// Original: 1405dc_sub_1405DC.c
...
_DWORD *__fastcall sub_1405DC(int a1, int a2, int a3, int a4)
{
  int v4; // r11
  int v5; // r0
  _WORD *v8; // r5
  ...
  v10 = *((_WORD *)off_1408F0 + 254) + 1;
  *((_WORD *)off_1408F0 + 254) = v10;
  *(_WORD *)(v5 + 130) = 16 * v10;
  ...
  *((_BYTE *)v8 + v11) = 5;
  ...
  else
  {
    ...
    do
    {
      ...
      if ( *(_BYTE *)(a4 + 2) == 5 )
      {
        v32 = *(_DWORD *)off_140B68;
        if ( *(_DWORD *)off_140B68 )
        {
          if ( v21 <= 0x19 )
            break;
...
LABEL_90:
      ...
      *(_BYTE *)(v13 + 4) = v22;
      if ( v22 == 5 )
      {
        ...
        *(_BYTE *)(v13 + 18) = sub_12E328(*(char *)(v25 + 20));
        *(_BYTE *)(v13 + 19) = -1;
        v27 = (char *)(v25 + 6);
        do
        {
...
LABEL_29:
              v31 = off_140904;
              *(_WORD *)(v25 + 4) = 3;
              list_remove_node_d510((int)v31, (_DWORD *)v25);
              goto LABEL_30;
            }
            if ( v47 )
            {
