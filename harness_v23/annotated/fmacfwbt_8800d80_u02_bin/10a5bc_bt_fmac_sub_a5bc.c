// v23 annotated: bt_fmac_sub_a5bc @ 0x10a5bc
// Original: 10a5bc_bt_fmac_sub_a5bc.c
...
int __fastcall bt_fmac_sub_a5bc(int a1, unsigned int a2, unsigned __int8 *a3, int *a4)
{
