// v23 annotated: sub_112B48 @ 0x112b48
// Original: 112b48_sub_112B48.c
...
int sub_112B48()
{
  ...
  v0 = off_112D9C;
  v1 = *((_DWORD *)off_112D9C + 5);
  *((_DWORD *)off_112D9C + 5) = v1;
  v2 = v0[6] & v1;
  LODWORD(v3) = v2 << 19;
  if ( (v2 & 0x1000) != 0 )
  {
    LODWORD(v3) = sub_112844();
    v4 = v2 & 0x2000;
    if ( (v2 & 0x2000) == 0 )
      return v3;
    v7 = 0;
  ...
  v25 = (int *)off_112DB8;
  v26 = dword_112DBC;
  *((_DWORD *)off_112D9C + 576) = dword_112DBC;
  v23[704] = v26;
  v27 = *v24;
  v28 = *v25;
...
LABEL_3:
  if ( v5 )
  {
    v8 = off_112D9C;
    v9 = dword_112DA0;
    v5 = *((_DWORD *)off_112D9C + 518);
    v10 = 0;
    v11 = v5 & *((_DWORD *)off_112D9C + 519);
    while ( 1 )
    {
      LODWORD(v3) = 1;
      if ( ((1 << v10) & v11) != 0 )
...
LABEL_14:
  ...
  if ( v6 )
  {
    ...
    v15 = dword_112DA8;
    v16 = dword_112DC8;
    v17 = *((_DWORD *)off_112D9C + 518) & *((_DWORD *)off_112D9C + 519);
    for ( i = 0; ; ++i )
    {
      if ( ((0x10000 << i) & v17) != 0 )
      {
...
LABEL_19:
  ...
  if ( v7 )
  {
    LODWORD(v3) = sub_112AC0(v3, SHIDWORD(v3), v5);
    if ( v4 >= 0 )
      return v3;
  }
  else if ( v4 >= 0 )
  ...
  LODWORD(v3) = sub_112B04(v3, SHIDWORD(v3), v5);
  return v3;
}
