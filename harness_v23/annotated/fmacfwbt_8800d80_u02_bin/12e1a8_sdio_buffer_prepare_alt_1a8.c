// v23 annotated: sdio_buffer_prepare_alt_1a8 @ 0x12e1a8
// Original: 12e1a8_sdio_buffer_prepare_alt_1a8.c
...
unsigned __int8 *__fastcall sdio_buffer_prepare_alt_1a8(unsigned __int8 *a1, int a2)
{
