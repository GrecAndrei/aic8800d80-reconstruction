// v23 annotated: crypto_key_load @ 0x1009dc
// Original: 1009dc_crypto_key_load.c
...
int __fastcall crypto_key_load(int a1, int a2)
{
  unsigned int *v2; // r3
  int v3; // r7
  unsigned int *v5; // r8
  ...
  *v14 |= 0x1000000u;
  ...
  for ( i = 0; i != 12; ++i )
  {
    crypto_hw_write32((2 * i) & 0xFE, *(_DWORD *)(a2 + 8 * i));
    v17 = *(_DWORD *)(a2 + 4 + 8 * i);
