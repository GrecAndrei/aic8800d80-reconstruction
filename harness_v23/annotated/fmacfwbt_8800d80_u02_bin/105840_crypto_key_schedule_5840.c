// v23 annotated: crypto_key_schedule_5840 @ 0x105840
// Original: 105840_crypto_key_schedule_5840.c
...
int __fastcall crypto_key_schedule_5840(unsigned int a1, _DWORD *a2)
{
  int v4; // r1
  int result; // r0
  int v6; // r7
