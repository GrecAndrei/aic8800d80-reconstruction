// v23 annotated: patch_apply_n3a @ 0x119e08
// Original: 119e08_patch_apply_n3a.c
...
int __fastcall patch_apply_n3a(int a1, int *a2, unsigned int a3, unsigned int a4, unsigned __int8 a5)
{
  int v5; // r5
  int v7; // r4
  int v8; // s16
