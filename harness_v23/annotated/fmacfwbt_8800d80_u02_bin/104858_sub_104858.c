// v23 annotated: sub_104858 @ 0x104858
// Original: 104858_sub_104858.c
...
int __fastcall sub_104858(int a1, int a2, _DWORD *a3, _DWORD *a4, int a5, int a6)
{
  int *v7; // r6
  int v11; // r0
  int v12; // r1
  ...
  v20 = ((int)((unsigned __int64)(dword_104B8C * (__int64)(0x2000 - v18)) >> 32) >> 9) - ((0x2000 - v18) >> 31);
  if ( a6 )
  {
    if ( v20 >= 5 )
      v20 = 5;
