// v23 annotated: sub_12A568 @ 0x12a568
// Original: 12a568_sub_12A568.c
// Primary struct: <unclustered>
//
// sub_12A568 @ 0x12a568, size 164 bytes
unsigned int __fastcall sub_12A568(_BYTE *a1, int a2, int a3)
{
  unsigned int v3; // r4
  unsigned int v5; // r0
  int v8; // r7
