// v23 annotated: sub_131A40 @ 0x131a40
// Original: 131a40_sub_131A40.c
...
int __fastcall sub_131A40(int a1, unsigned __int8 *a2, __int16 a3, __int16 a4)
{
  int v5; // r0
  int v6; // r2
  int v7; // r6
  ...
  v6 = *a2;
  v7 = v5;
  v8 = *(_DWORD *)(dword_131B30 + 696 * v6 + 340);
  *(_BYTE *)v5 = v6;
  if ( v8 )
  {
    v9 = *(_WORD *)(v8 + 184);
    ...
    *(_BYTE *)(v7 + 13) = *(_WORD *)(v8 + 152);
    ...
    if ( *(_WORD *)(v8 + 184) )
    {
      ...
      do
      {
        v13 = sub_13F54C(v8, (unsigned __int8)v12, 0);
