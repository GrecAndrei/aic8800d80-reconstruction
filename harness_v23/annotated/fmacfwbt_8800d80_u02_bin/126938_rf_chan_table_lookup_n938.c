// v23 annotated: rf_chan_table_lookup_n938 @ 0x126938
// Original: 126938_rf_chan_table_lookup_n938.c
...
int __fastcall rf_chan_table_lookup_n938(int a1, int a2, int a3)
{
  int v6; // r0
  _DWORD *v7; // r4
  _DWORD *v8; // r5
  ...
  if ( !v10 )
  {
    ...
    v12 = (int *)off_1269FC;
    v13 = v7[1];
    v14 = *(_DWORD *)off_1269FC;
    v15 = v13 - *((_DWORD *)off_1269F8 + 4);
    v16 = *(_DWORD *)off_1269FC + 1;
    *(_DWORD *)off_1269FC = v16;
    if ( v15 - 64 >= 0 )
    {
      result = timestamp_update_4f60(dword_126A00, v13);
      if ( *v12 )
      {
        v19 = *v12 - 1;
        v20 = *(_DWORD *)off_1269F4;
        *v12 = v19;
        if ( !v19 )
        {
          if ( v20 )
