// v23 annotated: sub_142554 @ 0x142554
// Original: 142554_sub_142554.c
// Primary struct: <unclustered>
//
// sub_142554 @ 0x142554, size 266 bytes
int __fastcall sub_142554(int a1, unsigned __int8 *a2, __int16 a3, __int16 a4)
{
  int v4; // r8
  int v5; // r9
  _BYTE *v6; // r5
  ...
  v4 = dword_142664;
  v5 = *a2;
  v6 = (_BYTE *)(dword_142664 + 1320 * v5);
  if ( !v6[108] || v6[106] || *(unsigned __int8 *)off_142660 > 7u )
  {
    v19 = 1;
  }
  else
  {
    ...
    if ( (unsigned int)(v17 - 1) <= 1 )
    {
      ...
      v17 = a2[1];
      v27 = *(_QWORD *)(v4 + 1320 * v5 + 40) + (unsigned int)dword_14266C + v22;
    }
    v19 = sub_141FDC(v4 + 1320 * v5, v11 + 696 * v10, (int)v24, v17) == 0;
  }
  v20 = (bool *)rf_bus_setup_n3a8(12289, a4, a3, 1u);
  *v20 = v19;
  sub_12CBB4((int)v20);
  return 0;
}
