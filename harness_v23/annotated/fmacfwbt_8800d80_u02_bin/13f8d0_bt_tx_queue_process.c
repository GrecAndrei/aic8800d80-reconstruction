// v23 annotated: bt_tx_queue_process @ 0x13f8d0
// Original: 13f8d0_bt_tx_queue_process.c
// Primary struct: <unclustered>
//
// bt_tx_queue_process @ 0x13f8d0, size 2470 bytes
// Doc: bt_tx_queue_process [tx]: Process BT TX queue entry and update descriptor fields
// bt_tx_queue_process [tx]: Process BT TX queue entry and update descriptor fields
int __fastcall bt_tx_queue_process(int a1)
{
  __int16 **v1; // r11
  unsigned int v2; // r7
  int *v3; // r8
  ...
  v1 = (__int16 **)off_13FC80;
  v2 = *(unsigned __int8 *)(a1 + 35);
  v3 = *(int **)(a1 + 336);
  v86 = (unsigned __int8)(v2 + 16);
  if ( **(__int16 **)off_13FC80 < 0 && v2 > 0x1F )
  {
    sub_12F694(dword_13FC78, dword_13FC70, 2825);
    v2 = *(unsigned __int8 *)(a1 + 35);
  }
  v5 = dword_13FC50;
  ...
  *(_DWORD *)(a1 + 340) = v7;
  v85 = sub_101954() << 14;
  v8 = sdio_buffer_prepare_n_32a();
  memset_thunk((int *)(v5 + 200 * v2), 0, 0xC8u);
  v9 = 200 * v2;
  if ( (*(_DWORD *)(a1 + 4) & 2) != 0 )
  {
    v10 = sub_1329B0((unsigned __int8 *)(a1 + 192), 0);
    v11 = *(_DWORD *)(a1 + 4);
    v12 = v5 + 200 * v2;
    *(_WORD *)(v12 + 174) = v10;
    if ( (v11 & 0x20) == 0 )
    {
      if ( (v11 & 4) != 0 )
      {
        ...
        *(_BYTE *)(v12 + 169) = 4;
        v87 = sub_1327E8(v13);
        v14 = sub_1327E8((unsigned __int16)v96[28]);
        if ( v14 >= v87 )
          v14 = v87;
        v15 = *v1;
        *(_BYTE *)(v5 + 200 * v2 + 180) = v14;
        if ( *v15 < 0 && v14 > 7 )
          sub_12F694(dword_140298, dword_140278, 2992);
        v16 = sub_132A3C(*(unsigned __int16 *)(a1 + 244), (unsigned __int16)v96[28]);
        v17 = *(_WORD *)(a1 + 244);
        *(_WORD *)(v5 + 200 * v2 + 170) = v16;
        v88 = sub_1327B8(v17);
        v18 = sub_1327B8(v96[28]);
        if ( v18 >= v88 )
          v18 = v88;
        v19 = *v1;
        *(_BYTE *)(v5 + 200 * v2 + 176) = v18;
        if ( *v19 < 0 && v18 > 9 )
          sub_12F694(dword_140294, dword_140278, 2998);
        v89 = v5 + 200 * v2;
        ...
        *(_BYTE *)(v89 + 177) = v21;
        if ( *v22 < 0 && v21 > 3 && v21 != 12 )
          sub_12F694(dword_14028C, dword_140278, 3010);
        v90 = v5 + 200 * v2;
        v23 = sub_132848(*(unsigned __int16 *)(v90 + 174));
        v24 = *v1;
        *(_BYTE *)(v90 + 178) = v23;
        if ( *v24 < 0 && v23 > 3 && v23 != 12 )
          sub_12F694(dword_140288, dword_140278, 3012);
      ...
      {
        *(_BYTE *)(v12 + 169) = 2;
        v94 = sub_132810((unsigned __int8 *)(a1 + 211));
        v43 = sub_132810((unsigned __int8 *)dword_140004);
        v44 = a1 + 211;
        if ( v43 >= v94 )
          v43 = v94;
        v45 = *v1;
        *(_BYTE *)(v5 + 200 * v2 + 180) = v43;
        if ( *v45 < 0 && v43 > 3 )
        {
          sub_12F694(dword_140290, dword_140278, 3054);
          v44 = a1 + 211;
        }
        sub_14380C(v9 + 170 + v5, v44, 4);
        v46 = v5 + 200 * v2;
        v47 = *(_WORD *)(v46 + 174);
        *(_BYTE *)(v46 + 170) = -1;
        v48 = v47 & 0xF00F;
        ...
        *(_BYTE *)(v5 + 200 * v2 + 177) = v49;
        if ( *v50 < 0 && v49 > 3 && v49 != 12 )
          sub_12F694(dword_14028C, dword_140278, 3065);
        v95 = v5 + 200 * v2;
        v51 = sub_132848(*(unsigned __int16 *)(v95 + 174));
        v52 = *v1;
        *(_BYTE *)(v95 + 178) = v51;
        if ( *v52 < 0 && v51 > 3 && v51 != 12 )
          sub_12F694(dword_140288, dword_140278, 3067);
        *(_BYTE *)(v5 + 200 * v2 + 182) = (*(_WORD *)(a1 + 348) & 0x400) != 0;
        if ( sub_1018B4() )
        {
          v53 = *(_WORD *)(a1 + 208);
          if ( (*((_WORD *)off_140284 + 6) & 1) != 0 && (v53 & 1) != 0 )
            v85 |= 0x40u;
        }
        else
        {
    ...
    *(_BYTE *)(v12 + 169) = 5;
    v97 = v56;
    v98 = sub_1327E8(v57);
    v58 = sub_1327E8(*((unsigned __int16 *)off_140008 + 40));
    if ( v58 >= v98 )
      v58 = v98;
    v59 = *v1;
    *(_BYTE *)(v5 + 200 * v2 + 180) = v58;
    if ( *v59 < 0 && v58 > 7 )
      sub_12F694(dword_140298, dword_140278, 2869);
    v60 = sub_132A3C(*(unsigned __int16 *)(a1 + 270), *((unsigned __int16 *)off_140008 + 40));
    v61 = *(_WORD *)(a1 + 270);
    *(_WORD *)(v5 + 200 * v2 + 170) = v60;
    v99 = sub_1327D0(v61);
    v62 = sub_1327D0(*((_WORD *)off_140008 + 40));
    if ( v62 >= v99 )
      v62 = v99;
    v63 = *v1;
    *(_BYTE *)(v5 + 200 * v2 + 176) = v62;
    if ( *v63 < 0 && v62 > 0xB )
      sub_12F694(dword_14029C, dword_140278, 2875);
    v100 = v5 + 200 * v2;
    ...
    *(_BYTE *)(v100 + 177) = v65;
    if ( *v66 < 0 && v65 > 3 && v65 != 12 )
      sub_12F694(dword_14028C, dword_140278, 2879);
    v101 = v5 + 200 * v2;
    v67 = sub_132848(*(unsigned __int16 *)(v101 + 174));
    v68 = *v1;
    *(_BYTE *)(v101 + 178) = v67;
    if ( *v68 < 0 && v67 > 3 && v67 != 12 )
      sub_12F694(dword_140288, dword_140278, 2881);
    *(_BYTE *)(v5 + 200 * v2 + 182) = (*(_WORD *)(a1 + 348) & 0x400) != 0;
    if ( sub_1018B4()
      && (*((_BYTE *)off_140008 + 67) & 0x20) != 0
...
LABEL_73:
        if ( v71 == 2 )
        {
          v8 |= 0x10020000u;
LABEL_75:
          v75 = *((unsigned __int8 *)off_140008 + 69);
          ...
          *(_BYTE *)(v77 + 194) = 1;
          switch ( v76 )
          {
            ...
            case 0u:
              *(_BYTE *)(v77 + 194) = 0;
LABEL_84:
              *(_BYTE *)(v5 + 200 * v2 + 183) = (*((_BYTE *)off_140008 + 72) & *(_BYTE *)(a1 + 264) & 0x20) != 0;
LABEL_53:
              ...
              *(_BYTE *)(v5 + 200 * v2 + 179) = v55;
              if ( *v31 < 0 && v55 > 3 )
              {
                sub_12F694(dword_14027C, dword_140278, 3099);
                v55 = *(unsigned __int8 *)(a1 + 309);
                v31 = *v1;
              }
              switch ( v55 )
...
LABEL_86:
          ...
          v78 = *((_BYTE *)off_140008 + 75);
          v79 = *((unsigned __int8 *)off_140008 + 74);
          v80 = v75 >> 2;
          v81 = v5 + 200 * v2;
...
LABEL_74:
  ...
  v27 = sub_1329B0((unsigned __int8 *)(a1 + 192), 0);
  v91 = v5 + 200 * v2;
  *(_WORD *)(v91 + 174) = v27;
  v28 = sub_13282C(v27);
  v29 = *v1;
  *(_BYTE *)(v91 + 177) = v28;
  if ( *v29 < 0 && v28 > 0xB )
    sub_12F694(dword_13FC7C, dword_13FC70, 3130);
  v92 = v5 + 200 * v2;
  v30 = sub_132848(*(unsigned __int16 *)(v92 + 174));
  v31 = *v1;
  *(_BYTE *)(v92 + 178) = v30;
  if ( *v31 < 0 && v30 > 0xB )
  {
    sub_12F694(dword_140000, dword_13FFF8, 3132);
    v31 = *v1;
  }
  v32 = v5 + 200 * v2;
  *(_BYTE *)(v32 + 176) = -1;
  ...
  *(_BYTE *)(v32 + 179) = v33;
  if ( *v31 < 0 && v33 )
  {
    sub_12F694(dword_13FFFC, dword_13FFF8, 3135);
    v31 = *v1;
  }
  *(_BYTE *)(v5 + 200 * v2 + 182) = (*(_WORD *)(a1 + 348) & 0x400) != 0;
LABEL_25:
  ...
  *(_WORD *)(v5 + 200 * v2 + 184) = v34;
  if ( *v93 < 0 )
  {
    if ( !v34 )
    {
      sub_12F694(dword_140280, dword_140278, 3141);
      if ( **v1 >= 0 )
        goto LABEL_26;
      v34 = *(unsigned __int16 *)(v5 + 200 * v2 + 184);
    }
    if ( v34 > 0xA )
      sub_12F694(dword_13FC74, dword_13FC70, 3142);
  }
LABEL_26:
  v35 = 200 * v2;
  feature_guard_sdio(
  ...
  bt_chan_offset_get(*(unsigned __int8 *)(a1 + 35));
  ...
  *(_WORD *)(v5 + v35 + 192) = 0;
  sub_13D518(v7);
  v39 = dword_13FC68;
  *(_DWORD *)(v5 + v35) = *((_DWORD *)off_13FC64 + 4);
  v40 = dword_13FC6C;
  *v3 = v39;
  v3[3] = v86 << 10;
  v3[4] = v40;
