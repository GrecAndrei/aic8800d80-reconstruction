// v23 annotated: msg_alloc_and_send_n0cc @ 0x1110cc
// Original: 1110cc_msg_alloc_and_send_n0cc.c
...
int __fastcall msg_alloc_and_send_n0cc(char a1, int a2, int a3)
{
  _DWORD *v6; // r0
  _DWORD *v7; // r4
  _DWORD *v8; // r6
  ...
  v7 = v6;
  v8 = (_DWORD *)log_free_dispatch_n2b4();
  if ( v8 )
  {
    *(_BYTE *)v7 = a3;
