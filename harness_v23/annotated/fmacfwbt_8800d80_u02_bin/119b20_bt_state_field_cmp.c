// v23 annotated: bt_state_field_cmp @ 0x119b20
// Original: 119b20_bt_state_field_cmp.c
...
int __fastcall bt_state_field_cmp(int a1, int a2, int a3)
{
  unsigned int v3; // r7
  int result; // r0
  int v7; // r3
  ...
  if ( v3 <= 0xE78 )
  {
    ...
    if ( (v10 & 2) == 0 )
    {
      ...
      if ( v11 )
      {
        if ( *(_DWORD *)(v11 + 16) != dword_119CA0 || (int)(v3 + *(unsigned __int16 *)(v8 + 10)) <= 3704 )
          return result;
        goto LABEL_16;
      }
      return 0;
...
LABEL_16:
  ...
  else
  {
    ...
    if ( v14 != 1 )
    {
      ...
      if ( (*(_WORD *)(v15 + 82) & 1) != 0 )
      {
        if ( (*(_DWORD *)off_119CA8 & 0x3F) > *(unsigned __int8 *)(*(_DWORD *)off_119CA4 + 62)
                                            + *(unsigned __int8 *)(*(_DWORD *)off_119CA4 + 63) )
        {
          v16 = *(_DWORD *)(v15 + 76);
          *(_BYTE *)(v16 + 1) = v14;
          v17 = *(_DWORD *)(v13 + 48);
          ...
          *(_DWORD *)(v8 + 324) = v15;
          sub_11C990(v17);
          v18 = *(unsigned __int8 *)(*(_DWORD *)off_119CAC + 1);
          if ( *(_BYTE *)(*(_DWORD *)off_119CAC + 1) )
          {
            sub_1197FC(
              v8,
              *(_WORD *)(v15 + 34),
