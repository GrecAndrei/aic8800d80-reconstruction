// v23 annotated: mmio_reg_read_sum_n1e6c @ 0x141e6c
// Original: 141e6c_mmio_reg_read_sum_n1e6c.c
...
int __fastcall mmio_reg_read_sum_n1e6c(int a1)
{
  int v1; // r2
  int v3; // r3
  __int64 v4; // r0
  ...
  v1 = *(_DWORD *)(a1 + 12);
  v3 = *((_DWORD *)off_141ED4 + 4) + 100;
  v4 = *(_QWORD *)(a1 + 24) + *(unsigned int *)(a1 + 16);
  *(_DWORD *)(a1 + 56) = dword_141ED8;
  *(_QWORD *)(a1 + 24) = v4;
