// v23 annotated: sub_1208F4 @ 0x1208f4
// Original: 1208f4_sub_1208F4.c
...
_DWORD *sub_1208F4()
{
  ...
  *(v6 - 205) = *(v6 - 205) & 0xFFFF00FF | 0xDA00;
  ...
  if ( (v10 & 0x10) != 0 )
    ...
    *(_DWORD *)off_120A54 |= 0x80000000;
  v11 = (v10 & 1) == 0;
  v12 = *(_DWORD *)off_120A2C;
  if ( v11 )
    v13 = v12 & 0xFFFBFFFF;
  else
    v13 = v12 | 0x40000;
  *(_DWORD *)off_120A2C = v13;
  v14 = off_120A30;
  *(_DWORD *)off_120A30 = dword_120A34;
  if ( *(_BYTE *)(v9 + 1) )
    *(v14 - 215) |= 0x40u;
  v15 = off_120A3C;
  v16 = off_120A40;
