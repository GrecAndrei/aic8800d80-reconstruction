// v23 annotated: sub_143108 @ 0x143108
// Original: 143108_sub_143108.c
// Primary struct: <unclustered>
//
// sub_143108 @ 0x143108, size 158 bytes
unsigned int __fastcall sub_143108(unsigned int a1, int a2)
{
  unsigned int v2; // r12
  bool v3; // cf
  bool v4; // cc
