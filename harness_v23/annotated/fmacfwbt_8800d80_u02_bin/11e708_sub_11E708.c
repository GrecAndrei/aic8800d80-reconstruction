// v23 annotated: sub_11E708 @ 0x11e708
// Original: 11e708_sub_11E708.c
...
int __fastcall sub_11E708(int a1, unsigned int a2, int a3, __int16 a4, int a5, int a6)
{
  int v6; // r8
  ...
  if ( *((_DWORD *)off_11E9AC + 2057) )
  {
    ...
    if ( v24 )
      v21[4122] = 0;
    v26 = sub_12D4F8(v25);
    v27 = *(_DWORD *)off_11E9B8;
    v28 = (unsigned __int16)v21[4122];
    v6 = v26;
    v29 = *(_DWORD *)off_11E9B8 + 8 * v28;
    *(_WORD *)(v6 + 12) = v28;
    *(_DWORD *)(v29 + 4) = a1 + 48;
...
LABEL_25:
      v35 = off_11E9BC;
      if ( !*((_BYTE *)off_11E9BC + 2) )
        goto LABEL_6;
      v36 = *(_DWORD *)(v6 + 4);
      *(_DWORD *)(v6 + 8) = *(unsigned __int16 *)off_11E9BC + 58;
      *(_BYTE *)(v36 + 3) &= 0x3Fu;
      *(_BYTE *)(v6 + 14) = v35[3];
      *(_DWORD *)v6 = 0;
      if ( (__get_CPSR() & 1) == 0 )
...
LABEL_5:
      ...
      {
        v18 = (int *)off_11E9A4;
        if ( *((_BYTE *)off_11E9A4 + 32) )
        {
          v43 = (_DWORD *)log_free_dispatch_n2b4();
          v46 = (int)v43;
          if ( v43 )
          {
            if ( *((_BYTE *)v18 + 32) )
