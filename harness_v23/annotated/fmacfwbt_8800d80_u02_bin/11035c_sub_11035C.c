// v23 annotated: sub_11035C @ 0x11035c
// Original: 11035c_sub_11035C.c
...
int __fastcall sub_11035C(int result)
{
  _DWORD *v1; // r4
  unsigned int v2; // r3
  int *v3; // r6
...
LABEL_2:
  ...
  while ( v2 <= 1 )
  {
    ...
    if ( !v8 )
    {
      result = log_printf(dword_110484, *(_DWORD *)off_110480);
