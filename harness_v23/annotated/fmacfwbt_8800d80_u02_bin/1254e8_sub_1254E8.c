// v23 annotated: sub_1254E8 @ 0x1254e8
// Original: 1254e8_sub_1254E8.c
...
int __fastcall sub_1254E8(unsigned __int16 *a1)
{
  unsigned int v1; // r2
  int v2; // r3
  int v5; // r0
    ...
    if ( *((_BYTE *)a1 + 2) )
    {
      if ( ((unsigned __int8)v7 & *(_BYTE *)(v6 + v5)) == 0 )
      {
        ...
        *v9 = v10 | v8;
        ...
        if ( v14 > v6 )
        {
          *(_DWORD *)(dword_12572C + 40 * v2 + 28) = v5 + (v6 & 0xFE);
      ...
      *(_WORD *)(v23 + 220) = v24;
      if ( v24 )
      {
        ...
        if ( v25 == (v6 & 0xFE) )
        {
          ...
          v31 = v32;
LABEL_22:
          *(_DWORD *)(dword_12572C + 40 * v2 + 28) = v31 + v5;
          *(_BYTE *)(v22 + 1320 * v2 + 228) = v32;
        }
        v26 = v22 + 1320 * v2;
...
LABEL_28:
          *(_DWORD *)(dword_12572C + 40 * v2 + 32) = v5;
        }
        v2 = v22 + 1320 * v2;
      ...
      else
      {
        ...
        *(_DWORD *)(v2 + 32) = v5 + *(unsigned __int8 *)(v23 + 229);
        *(_DWORD *)(v2 + 4) = v37;
      }
    }
  }
