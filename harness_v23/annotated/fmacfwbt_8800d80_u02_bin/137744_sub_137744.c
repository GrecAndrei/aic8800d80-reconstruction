// v23 annotated: sub_137744 @ 0x137744
// Original: 137744_sub_137744.c
// Primary struct: <unclustered>
//
// sub_137744 @ 0x137744, size 1714 bytes
int __fastcall sub_137744(int a1)
{
  _BYTE *v1; // r11
  char v3; // r3
  char v4; // r1
  ...
  {
    if ( !*((_BYTE *)off_137B78 + 408) || *((_BYTE *)off_137B88 + 3850) )
      return 0;
    v9 = v143;
    LOWORD(v10) = v144;
    v139 = 1;
...
LABEL_57:
  ...
  if ( *(unsigned __int16 *)(a1 + 4) != v46 )
    *(_WORD *)(a1 + 4) = v46;
  sub_137358(v140, v138, *(_WORD *)(a1 + 46), (int)&v147);
  ...
  if ( *(_BYTE *)inited )
  {
    ...
    {
      if ( *(_BYTE *)(inited + 8) && !(_BYTE)v149 )
      {
        LOBYTE(v50) = *(_BYTE *)(inited + 56);
        v51 = *(unsigned __int16 **)(inited + 44);
      }
      goto LABEL_63;
    }
    v87 = sub_1437AC(*(_DWORD *)(inited + 44), v158, 6);
...
LABEL_63:
  ...
  else
  {
    ...
    *(_DWORD *)(inited + 4) = v74;
    *(_DWORD *)(inited + 8) = v75;
    *(_DWORD *)(inited + 12) = v76;
    v77 = v152;
    v78 = v153;
    v79 = v154;
    *(_DWORD *)(inited + 16) = v151;
    *(_DWORD *)(inited + 20) = v77;
    *(_DWORD *)(inited + 24) = v78;
    *(_DWORD *)(inited + 28) = v79;
    v80 = v156;
    v81 = v157;
    v82 = v158;
    *(_DWORD *)(inited + 32) = v155;
    *(_DWORD *)(inited + 36) = v80;
    *(_DWORD *)(inited + 40) = v81;
    *(_DWORD *)(inited + 44) = v82;
    v83 = v160;
    v84 = v161;
    *(_DWORD *)(inited + 48) = v159;
    *(_DWORD *)(inited + 52) = v83;
    *(_DWORD *)(inited + 56) = v84;
    *(_BYTE *)(inited + 56) = v50;
    *(_DWORD *)(inited + 44) = v51;
    ++*((_WORD *)v1 + 2);
    *(_BYTE *)inited = 1;
    ...
    if ( v85 <= 1 )
    {
      ...
      if ( !*(_BYTE *)(inited + 8) )
      {
        if ( (**(_WORD **)off_137DFC & 8) == 0 )
          goto LABEL_68;
        v64 = dword_137E00;
        goto LABEL_67;
      }
      v86 = *(_WORD **)off_137DFC;
      ++*(_WORD *)(dword_137DF8 + 2 * v85 + 4);
      if ( (*v86 & 8) == 0 )
        goto LABEL_68;
      goto LABEL_83;
    }
