// v23 annotated: sub_10AE68 @ 0x10ae68
// Original: 10ae68_sub_10AE68.c
...
int __fastcall sub_10AE68(unsigned int *a1, _BYTE *a2, int a3)
{
  int v3; // r9
  int v4; // r10
  int v5; // r11
  ...
  _DWORD v85[14]; // [sp+44h] [bp-188h] BYREF
  int v86; // [sp+7Ch] [bp-150h]
  _BYTE v87[128]; // [sp+88h] [bp-144h] BYREF
  _BYTE v88[196]; // [sp+108h] [bp-C4h] BYREF
  ...
  v7 = *(_DWORD *)off_10B194;
  v8 = *(_DWORD *)off_10B194 & 0xFFFFFFFE;
  v82 = 0;
  v83 = 0;
  v84 = 0;
  *(_DWORD *)off_10B194 = v8;
  v78 = v7 & 1;
  crypto_hw_enable(0);
  v9 = dword_10B1B0;
  v10 = dword_10B1B8;
    ...
    *v24 &= ~0x400u;
    if ( v25 == 1 )
    {
      ...
      if ( v26 > 0x1388 )
      {
        ...
        LOWORD(v83) = v26;
        HIWORD(v83) = v26;
        sub_102898((unsigned __int16 *)&v82, 0);
        v72 = sub_102984(v26);
...
LABEL_15:
  ...
  crypto_hw_disable(0);
  v39 = dword_10B1C0;
  *(_DWORD *)off_10B194 = *(_DWORD *)off_10B194 & 0xFFFFFFFE | v78;
