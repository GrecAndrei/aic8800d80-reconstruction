// v23 annotated: sub_128F14 @ 0x128f14
// Original: 128f14_sub_128F14.c
// Primary struct: <unclustered>
//
// sub_128F14 @ 0x128f14, size 96 bytes
unsigned __int16 *__fastcall sub_128F14(int a1, int a2, int a3, int a4)
{
  ...
  if ( result )
  {
    ...
    if ( !*((_BYTE *)off_128F80 + 8)
      || (v8 = (unsigned __int8)(*((_BYTE *)off_128F80 + 8) - 1), *((_BYTE *)off_128F80 + 8) = v8, !v8) )
    {
