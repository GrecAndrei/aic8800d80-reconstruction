// v23 annotated: sub_126A48 @ 0x126a48
// Original: 126a48_sub_126A48.c
// Primary struct: <unclustered>
//
// sub_126A48 @ 0x126a48, size 1096 bytes
int __fastcall sub_126A48(int a1, int a2, unsigned int a3)
{
  int v3; // r7
  int v4; // r5
  int v5; // r8
...
LABEL_6:
        if ( a2 != v14 )
          return sub_126938(v14, *(_DWORD *)(v3 + 1320 * v6 + 72), v4);
LABEL_31:
        sub_126A04();
        v14 = a2;
        return sub_126938(v14, *(_DWORD *)(v3 + 1320 * v6 + 72), v4);
      ...
      if ( !v31 )
      {
        ...
        {
          sub_126938(v14, *(_DWORD *)(v30 + 72), 0);
          v14 = v58;
...
LABEL_26:
    ...
    if ( sub_12A364(v16, &v64, v65) )
    {
      ...
      if ( v58 - v65[0] >= 0 )
      {
        ...
        if ( v18 > sub_10186C() + 9000 )
        {
          ...
          v14 = v58;
          sub_126938(v20, *(_DWORD *)(v16 + 72), 0);
          goto LABEL_6;
        }
      }
    }
    else
    {
      ...
      if ( v32 > sub_10186C() + 9000 )
      {
        ...
        v44 = v64;
        v45 = sub_10186C();
        sub_126938(v44 - 4000 - v45, *(_DWORD *)(v16 + 72), 0);
      }
      v14 = v65[0];
      if ( v58 - v65[0] >= 0 )
        goto LABEL_6;
...
LABEL_70:
      ...
      sub_126938(v47, *(_DWORD *)(v3 + 1320 * v62 + 72), 0);
      v28 = v65[0];
      goto LABEL_51;
    }
LABEL_77:
