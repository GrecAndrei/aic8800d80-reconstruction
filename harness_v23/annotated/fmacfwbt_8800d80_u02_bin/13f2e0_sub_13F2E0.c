// v23 annotated: sub_13F2E0 @ 0x13f2e0
// Original: 13f2e0_sub_13F2E0.c
// Primary struct: <unclustered>
//
// sub_13F2E0 @ 0x13f2e0, size 354 bytes
int __fastcall sub_13F2E0(int a1, int a2)
{
  int result; // r0
  unsigned int v4; // r11
  char v6; // r3
  ...
  result = dword_13F448;
  v4 = *(_DWORD *)(dword_13F448 + 696 * a1 + 340);
...
LABEL_18:
  ...
  *(_BYTE *)(dword_13F448 + 696 * a1 + 350) |= 1u;
  return result;
}
