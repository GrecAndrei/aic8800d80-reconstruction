// v23 annotated: sub_1434E0 @ 0x1434e0
// Original: 1434e0_sub_1434E0.c
// Primary struct: <unclustered>
//
// sub_1434E0 @ 0x1434e0, size 702 bytes
int __fastcall sub_1434E0(unsigned int a1, unsigned int a2, __int64 a3, unsigned int *a4)
{
  unsigned int v5; // r4
  unsigned int v6; // lr
  unsigned int v7; // r7
  ...
  if ( HIDWORD(a3) )
  {
    if ( HIDWORD(a3) <= a2 )
    {
      ...
      if ( v30 )
      {
        ...
        result = v48 | (v42 << 16);
        v51 = v49 - v50;
        v52 = (unsigned int)result * (unsigned __int64)v45;
        v53 = v52;
