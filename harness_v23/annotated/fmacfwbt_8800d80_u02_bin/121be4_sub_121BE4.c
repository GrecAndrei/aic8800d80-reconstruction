// v23 annotated: sub_121BE4 @ 0x121be4
// Original: 121be4_sub_121BE4.c
...
int __fastcall sub_121BE4(int a1)
{
  _DWORD *v1; // r2
  unsigned int v2; // r3
  unsigned int v3; // r6
  ...
  v1 = off_121CB8;
  if ( !*((_BYTE *)off_121CB8 + 48) )
  {
    if ( !a1 )
      return 0;
    v2 = (unsigned __int16)*(_DWORD *)off_121CBC << 10;
    *((_BYTE *)off_121CB8 + 48) = 1;
    v3 = abs32(a1);
    if ( a1 <= 0 )
    {
      if ( v3 <= v2 >> 1 )
