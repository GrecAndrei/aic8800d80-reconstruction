// v23 annotated: sub_139688 @ 0x139688
// Original: 139688_sub_139688.c
// Primary struct: <unclustered>
//
// sub_139688 @ 0x139688, size 1192 bytes
int __fastcall sub_139688(char a1, int a2, int a3, int a4, _BYTE *a5, unsigned int a6, _WORD *a7, _BYTE *a8)
{
  int v9; // r12
  unsigned int v11; // r5
  int v12; // r8
...
LABEL_65:
          ...
          if ( v39 == 1 )
          {
            sub_1018E4((_DWORD *)(v15 + 2), (_DWORD *)(v15 + 10));
          }
          else
          {
            if ( v39 != 2 )
