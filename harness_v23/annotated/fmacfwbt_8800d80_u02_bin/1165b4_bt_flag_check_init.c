// v23 annotated: bt_flag_check_init @ 0x1165b4
// Original: 1165b4_bt_flag_check_init.c
...
int *__fastcall bt_flag_check_init(int a1, int a2, int a3, int a4)
{
  int *result; // r0
  char *v7; // r4
  int v8; // r5
  ...
  v7 = v10;
  rf_msg_dispatch_3800(v10, a2, a1 + 12, a1 + 18, *(unsigned __int8 *)(a1 + 27));
