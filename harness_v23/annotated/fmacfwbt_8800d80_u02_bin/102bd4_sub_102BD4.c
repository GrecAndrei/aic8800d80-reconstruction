// v23 annotated: sub_102BD4 @ 0x102bd4
// Original: 102bd4_sub_102BD4.c
// Primary struct: <unclustered>
//
// sub_102BD4 @ 0x102bd4, size 282 bytes
int __fastcall sub_102BD4(int a1, unsigned __int16 *a2)
{
  unsigned int v4; // r11
  int v5; // r9
  int v6; // r8
...
LABEL_10:
  ...
  *(_DWORD *)off_102CF0 = 1;
  if ( v23 )
  {
    v15 = *(_DWORD *)off_102CFC;
    v25 = *(_QWORD *)off_102CFC;
    v26 = *((_DWORD *)off_102CFC + 2);
    v16 = 3;
  }
  else
  {
