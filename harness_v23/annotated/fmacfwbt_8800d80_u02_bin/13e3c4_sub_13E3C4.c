// v23 annotated: sub_13E3C4 @ 0x13e3c4
// Original: 13e3c4_sub_13E3C4.c
// Primary struct: <unclustered>
//
// sub_13E3C4 @ 0x13e3c4, size 440 bytes
int __fastcall sub_13E3C4(int a1)
{
  int v1; // r4
  int v3; // r8
  int v4; // r3
  ...
  result = sub_13E35C((unsigned __int8 *)a1);
...
LABEL_25:
  ...
  do
  {
    result = bt_chan_parse(a1, (unsigned __int16)v13, v7, v10);
