// v23 annotated: sub_128160 @ 0x128160
// Original: 128160_sub_128160.c
...
BOOL __fastcall sub_128160(int a1, int a2, int a3)
{
  _BYTE *v3; // r11
  int *v4; // r4
  int v8; // r3
...
LABEL_13:
  ...
  if ( *(_BYTE *)(dword_128330 + 140 * v16 + 112) != 1 )
  {
    if ( v13 )
    {
      v17 = *(_BYTE *)(a1 + 85);
...
LABEL_19:
  ...
  if ( (v17 & 0x10) != 0 )
  {
    sub_12609C((_DWORD *)a1);
    *(_BYTE *)(a1 + 85) &= ~0x10u;
    if ( v13 )
      goto LABEL_31;
LABEL_25:
    if ( !*(_BYTE *)(a1 + 1224) || *(_BYTE *)(dword_128330 + 140 * *(unsigned __int8 *)(a1 + 1225) + 112) != 1 )
    {
LABEL_26:
