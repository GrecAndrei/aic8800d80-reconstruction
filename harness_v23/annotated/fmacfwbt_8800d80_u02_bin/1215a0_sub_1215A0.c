// v23 annotated: sub_1215A0 @ 0x1215a0
// Original: 1215a0_sub_1215A0.c
...
int __fastcall sub_1215A0(int a1, int a2)
{
  int v2; // r6
  _DWORD *v3; // r3
  _DWORD *v4; // lr
  ...
  *(_DWORD *)off_12165C = v7[19] | (v7[20] << 16);
  v8 = off_121664;
  v3[1] = v7[21];
  v9 = (int *)off_121668;
  *v4 = 0;
  ...
  *v9 = 0x20000000;
  ...
  if ( (*v9 & 0x10000000) == 0 )
  {
    ...
    if ( (unsigned __int8)BYTE2(*v9) != v10 )
    {
      ...
      *(_DWORD *)off_12165C = v14[19] | (v14[20] << 16);
      *(_DWORD *)off_12166C = v14[21];
    }
  }
  v15 = off_121668;
  *(_DWORD *)off_121668 = (16 * a2) | (v10 << 16) | 0x40000002;
