// v23 annotated: sub_114FD8 @ 0x114fd8
// Original: 114fd8_sub_114FD8.c
...
int __fastcall sub_114FD8(int a1, int a2)
{
  int v3; // r1
  int v4; // r2
  int v5; // r7
  ...
  v3 = *(_DWORD *)(patch_apply_n_474 + 4);
  v4 = *(_DWORD *)(patch_apply_n_474 + 8);
  v18[0] = *(_DWORD *)patch_apply_n_474;
  v18[1] = v3;
  v18[2] = v4;
  v5 = v18[a1];
  v16 = MEMORY[0x1FC](v5);
