// v23 annotated: sub_11B270 @ 0x11b270
// Original: 11b270_sub_11B270.c
// Primary struct: <unclustered>
//
// sub_11B270 @ 0x11b270, size 638 bytes
int __fastcall sub_11B270(int a1, int *a2, unsigned int a3, unsigned int a4, unsigned __int8 a5)
{
  int v5; // r7
  _DWORD *v6; // r10
  _DWORD *v8; // r9
        ...
        *(_BYTE *)(a1 + 51) = v27;
        ...
        if ( v29 <= a3 )
        {
          ...
          if ( !*(_WORD *)(a1 + 4) || (*(_WORD *)(a1 + 30) & 8) != 0 )
            goto LABEL_32;
LABEL_31:
          *(_DWORD *)(v30 - 3) = *((_DWORD *)off_11B504 + 43);
LABEL_32:
          v14 = *(_DWORD *)a1;
          *a2 = *(_DWORD *)a1;
          if ( !v14 )
...
LABEL_20:
  ...
  v12 = *(_DWORD *)(a1 + 68);
  if ( (*(_WORD *)(v12 + 8) & 3) != 3
    || *(unsigned __int8 *)(*(_DWORD *)off_11B4F4 + 62) > (*(_DWORD *)off_11B4F0 & 0x3Fu) )
  {
    return 0;
  }
  if ( *(_DWORD *)(v12 + 40) > a3 )
