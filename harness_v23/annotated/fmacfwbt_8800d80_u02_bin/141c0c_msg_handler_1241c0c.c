// v23 annotated: msg_handler_1241c0c @ 0x141c0c
// Original: 141c0c_msg_handler_1241c0c.c
...
int __fastcall msg_handler_1241c0c(int a1, int a2, int a3, int a4, char a5)
{
  int v6; // r1
  int v10; // r3
  BOOL v11; // r0
  ...
  if ( v6 )
  {
    ...
    if ( **(__int16 **)off_141D0C >= 0 || v10 != 2 )
    {
      v11 = (v10 | *(unsigned __int8 *)(a2 + 1224)) != 0;
      goto LABEL_4;
    }
  }
  else if ( **(__int16 **)off_141D0C >= 0 )
  {
    goto LABEL_16;
  }
  ...
  if ( result )
  {
    ...
    *(_BYTE *)(result + 28) = v14;
    if ( a3 )
      ...
      v15 = v14 + 32;
    v16 = off_141D18;
    *(_BYTE *)(*(_DWORD *)a1 + 29) = v15;
    *(_BYTE *)(*(_DWORD *)a1 + 51) = 0;
    *(_BYTE *)(*(_DWORD *)a1 + 53) = 0;
    v17 = v16[254];
    v18 = a3 + 38;
    v19 = *(_DWORD *)(a3 + 38);
    *(_BYTE *)(v13 + 109) = 0;
    v20 = *(_WORD *)(v18 + 4);
    LOWORD(v18) = *(_WORD *)(a2 + 104);
    *(_BYTE *)(v13 + 110) = 0;
    *(_BYTE *)(v13 + 111) = 0;
    v21 = v17 + 1;
    *(_DWORD *)(v13 + 118) = *(_DWORD *)(a2 + 100);
    *(_WORD *)(v13 + 116) = v20;
    result = *(_DWORD *)(a2 + 100);
    v22 = *(_WORD *)(a2 + 104);
    *(_DWORD *)(v13 + 112) = v19;
    *(_WORD *)(v13 + 122) = v18;
    *(_DWORD *)(v13 + 124) = result;
    *(_WORD *)(v13 + 128) = v22;
    *(_BYTE *)(v13 + 108) = -48;
    if ( a4 == 6 )
      result = 27;
