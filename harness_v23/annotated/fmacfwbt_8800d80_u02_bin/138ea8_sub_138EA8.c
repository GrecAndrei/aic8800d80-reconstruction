// v23 annotated: sub_138EA8 @ 0x138ea8
// Original: 138ea8_sub_138EA8.c
// Primary struct: <unclustered>
//
// sub_138EA8 @ 0x138ea8, size 554 bytes
int __fastcall sub_138EA8(unsigned int a1, int a2, int a3, int a4)
{
  _DWORD *v4; // r8
  unsigned int v5; // r4
  int v8; // r5
  ...
  if ( a3 )
  {
    sub_133800(
      a2,
      (_DWORD *)(*((_DWORD *)off_1390E0 + 8) + 88),
      (int)off_1390E0 + 36,
      (unsigned __int16 *)off_1390E0 + 21,
      *((_BYTE *)off_1390E0 + 7));
  ...
  {
    v8 = *((unsigned __int8 *)off_1390E0 + 8);
    v9 = *(_DWORD **)(a1 + 28);
...
LABEL_11:
    sub_13384C((_DWORD *)a2, v17, v14);
  }
  else
  {
    v18 = (__int16 **)off_1390E4;
    while ( 1 )
    {
      v14 = (unsigned __int16)(v14 + v12 - v15);
      sub_13384C((_DWORD *)a2, v17, (unsigned __int16)(v15 - v12));
      v12 = 0;
      if ( !(_WORD)v14 )
        break;
      v9 = (_DWORD *)v9[1];
...
LABEL_36:
  ...
  if ( v45 == *(_QWORD *)a2 )
    return 1;
  v39 = sub_12CB54(5126, 13, 5, 0x18u);
  v40 = v4[6];
  v41 = dword_1390DC + 696 * *((unsigned __int8 *)v4 + 9);
  v42 = *((_QWORD *)v4 + 2);
  v43 = *(_DWORD *)(v41 + 38);
