// v23 annotated: bt_rx_pkt_process_1390e8 @ 0x1390e8
// Original: 1390e8_bt_rx_pkt_process_1390e8.c
...
int __fastcall bt_rx_pkt_process_1390e8(unsigned int a1, int a2, int a3)
{
  _WORD *v3; // r6
  char v5; // r5
  int v7; // r10
