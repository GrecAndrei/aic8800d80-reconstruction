// v23 annotated: sub_11E184 @ 0x11e184
// Original: 11e184_sub_11E184.c
...
_DWORD *__fastcall sub_11E184(_DWORD *a1, int a2, _WORD *a3)
{
  int *v3; // r7
  int v4; // r10
  _DWORD *v5; // r6
  ...
  v5 = (_DWORD *)*a1;
  v6 = (__int16 **)off_11E2A0;
  v7 = nullptr;
  *((_BYTE *)off_11E290 + 32) = 1;
  v9 = 0;
  v25 = nullptr;
  while ( 1 )
  {
