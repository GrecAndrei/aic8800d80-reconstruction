// v23 annotated: sub_122BF0 @ 0x122bf0
// Original: 122bf0_sub_122BF0.c
// Primary struct: <unclustered>
//
// sub_122BF0 @ 0x122bf0, size 148 bytes
int __fastcall sub_122BF0(int a1, int a2, int a3, int a4)
{
  int v4; // r9
  int v6; // r5
  int v9; // r8
  ...
  if ( **(__int16 **)off_122C84 < 0 && *(_BYTE *)(dword_122C94 + 1320 * v6 + 106) )
