// v23 annotated: sub_134B30 @ 0x134b30
// Original: 134b30_sub_134B30.c
...
LABEL_13:
        v5 = *(int **)off_134C78;
        if ( *(int *)off_134C78 < 0 && v4 == (_DWORD *)1 )
        {
          v4 = off_134C80;
          *((_BYTE *)off_134C7C + 2) = (_BYTE)v6;
          v5 = (int *)off_134C84;
          *v4 |= 0x80000000;
...
LABEL_8:
  ...
  {
    v9 = off_134C80;
    *((_BYTE *)off_134C7C + 2) = 0;
    v10 = (int *)off_134C84;
    *v9 |= 0x80000000;
    v11 = (HIWORD(*v10) << 16) | 0x5DC;
    *v10 = v11;
    sub_10D054(v7 | (*((unsigned __int8 *)v6 + 413) << 16) | 0x80000000, v11, v7);
  }
  else
  {
    sub_10D054(v7 | (*((unsigned __int8 *)v6 + 413) << 16) | 0x80000000, (int)v4, v7);
  }
LABEL_15:
