// v23 annotated: sub_11C4BC @ 0x11c4bc
// Original: 11c4bc_sub_11C4BC.c
// Primary struct: <unclustered>
//
// sub_11C4BC @ 0x11c4bc, size 560 bytes
int __fastcall sub_11C4BC(int result)
{
  _DWORD *v1; // r2
  __int16 *v2; // r1
  unsigned int v3; // r3
  ...
  v1 = off_11C6F0;
  v2 = *(__int16 **)off_11C6EC;
  v3 = *(_DWORD *)(result + 84);
  v4 = *(_DWORD *)(result + 28);
  *((_BYTE *)off_11C6F0 + 200) = 0;
  v5 = *v2;
  if ( v5 < 0 )
  {
  ...
  if ( *(_BYTE *)(v9 + 37) )
  {
    ...
    v1[45] = *(_DWORD *)(v9 + 38);
    v11 = dword_11C6FC;
    *((_WORD *)off_11C6F8 + 2) = *(_WORD *)(v9 + 42);
    result = v1[4];
    if ( result == v11 + 1320 * v10 )
    {
      result = *(_DWORD *)off_11C704 & 0x3F;
      if ( *(unsigned __int8 *)(*(_DWORD *)off_11C700 + 62) + 3 < result )
      {
        v12 = *(_DWORD *)off_11C70C;
        v13 = v1[42];
        v14 = *(_DWORD *)off_11C708 & 0xF;
        v15 = HIWORD(*(_DWORD *)off_11C708) & 3;
        v16 = (*(_DWORD *)off_11C708 & 0x80000) != 0;
        v35 = (unsigned __int16)*(_DWORD *)off_11C708 >> 4;
        *((_WORD *)v1 + 94) = v35;
        *((_BYTE *)v1 + 191) = v14;
        *((_BYTE *)v1 + 195) = v15;
        ...
        *((_BYTE *)v1 + 196) = v18;
        ...
        else
        {
          v34 = v12 >> 30;
          v20 = HIBYTE(v12) & 3;
          *((_BYTE *)v1 + 197) = *(_BYTE *)(dword_11C72C + v34);
          *((_BYTE *)v1 + 198) = v20;
        }
        while ( *(int *)off_11C724 >= 0 )
          ;
        v21 = *(_DWORD *)off_11C724 & dword_11C710;
        if ( v18 > 2 )
          v22 = *(unsigned __int16 *)(dword_11C730 + 2 * (3 * ((unsigned __int8)(v18 - 3) >> 1) + v32 + 6 * v17)) << ((v18 - 3) & 1);
        else
          v22 = *(_WORD *)(*(_DWORD *)(dword_11C714 + 4 * v18) + 2 * (3 * v17 + v32));
