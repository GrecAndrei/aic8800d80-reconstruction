// v23 annotated: sub_13AA1C @ 0x13aa1c
// Original: 13aa1c_sub_13AA1C.c
// Primary struct: <unclustered>
//
// sub_13AA1C @ 0x13aa1c, size 346 bytes
_WORD *__fastcall sub_13AA1C(int a1, _WORD *a2, int a3)
{
  int v4; // r5
  int v5; // r3
  _WORD *v6; // r9
  ...
  if ( v7 )
  {
    v9 = dword_13AB7C + 1320 * *(unsigned __int8 *)(a1 + 28);
    if ( *(_DWORD *)(v9 + 1200) )
    {
...
LABEL_17:
            v13 = *(_DWORD *)(a1 + 72) + 44;
          *(_DWORD *)(v13 + 12) = dword_13AB80 & *(_DWORD *)(v13 + 12) | (unsigned __int8)v7[98];
        }
      }
    }
  }
