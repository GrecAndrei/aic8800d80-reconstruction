// v23 annotated: sub_10A800 @ 0x10a800
// Original: 10a800_sub_10A800.c
// Primary struct: <unclustered>
//
// sub_10A800 @ 0x10a800, size 1610 bytes
int __fastcall sub_10A800(unsigned int a1, unsigned int a2, int a3, unsigned int a4, unsigned __int8 a5, char a6)
{
  unsigned int v8; // s17
  int v9; // r3
  _DWORD *v10; // r2
  ...
  do
  {
    ...
    do
    {
      if ( a4 <= a5 )
      {
        ...
        do
        {
          *v16 = dword_10AB30 & (((__int16)v49 | (4 * v20) | 1) << 8) | *v16 & 0xFFFE00FF;
          *v16 |= 0x20000u;
          *v16 |= 0x40000u;
          sub_100644(1);
          if ( v43 )
          ...
          sub_109370((unsigned __int8)v45, v55, &v58[20 * v21 + 310]);
          sub_109370((unsigned __int8)v45, v56, &v58[20 * v20 + 630]);
    ...
    if ( a4 <= a5 )
    {
      ...
      do
      {
        ...
        if ( v25 >= 6 )
          ...
          v26 = 50;
        v44 = v26;
        *(_DWORD *)&v58[2 * v27 + 54] = sub_1093D4(v48, v26, (int *)&v58[20 * v25 + 310]);
        *(_DWORD *)&v58[2 * v27 + 182] = sub_1093D4(v48, v44, (int *)&v58[20 * v25 + 630]);
        v25 = (unsigned __int8)(v25 + 1);
      }
      while ( a5 >= v25 );
    }
LABEL_28:
  ...
  else
  {
    ...
    do
    {
      v29 = sub_10A5BC(v8, v28, (unsigned __int8 *)&v58[6] + 3 * v28, (int *)&v58[8 * v28 + 54]);
      v30 = sub_10A5BC(v8, v28, (unsigned __int8 *)&v58[30] + 3 * v28, (int *)&v58[8 * v28 + 182]);
      v31 = v28 - 10;
      if ( v28 > 9 )
        v57[v31] = v29;
      else
  ...
  *(v35 - 6224) &= 0xCFFFFFFF;
  if ( a6 )
  {
    ...
    v38 = *(_WORD *)(a2 + 2 * a4);
    *(_DWORD *)off_10AE5C = *(_DWORD *)off_10AE5C & 0xFE01FFFF | ((unsigned __int8)v38 << 17);
    *v37 = v38 & 0xFF00 | *v37 & 0xFFFF00FF;
  }
  else
  {
    v42 = (unsigned int *)off_10AE5C;
    *(_DWORD *)off_10AE5C &= ~0x2000000u;
    *v42 &= ~0x10000u;
