// v23 annotated: sub_1093D4 @ 0x1093d4
// Original: 1093d4_sub_1093D4.c
// Primary struct: <unclustered>
//
// sub_1093D4 @ 0x1093d4, size 476 bytes
int __fastcall sub_1093D4(unsigned int a1, int a2, int *a3)
{
  int v3; // r12
  int v4; // r4
  int *v5; // r6
...
LABEL_14:
  if ( v6 <= 2 )
  {
    ...
    if ( v26 != 128 )
    {
      ...
      {
        v29 = a3[v28];
        if ( v29 >= dword_1095B0 && (v27 >= 1000 || v29 <= -1000) )
          v3 = 2;
      }
      if ( v28 < v3 + v26 )
      {
