// v23 annotated: sub_13C5B4 @ 0x13c5b4
// Original: 13c5b4_sub_13C5B4.c
// Primary struct: <unclustered>
//
// sub_13C5B4 @ 0x13c5b4, size 374 bytes
unsigned int __fastcall sub_13C5B4(unsigned __int8 *a1, int a2, int a3, _BYTE *a4)
{
  int v4; // r6
  int v5; // r11
  int v6; // r9
  ...
  if ( v12 == 255 )
    goto LABEL_9;
  v13 = v10;
  if ( !*(_DWORD *)(dword_13C72C + 1320 * v12 + 1200) )
    return 0;
  if ( (a1[48] & 8) == 0 )
  {
    if ( (*(_DWORD *)(dword_13C730 + 696 * v11 + 4) & 8) != 0 && (v5 & 0x4000) == 0 )
    {
      v27 = v5 & 0xFC;
...
LABEL_9:
  ...
  {
    if ( *(_DWORD *)(dword_13C72C + 1320 * v12 + 1204) )
    {
      if ( v4 + 19 >= v10 )
        goto LABEL_9;
      v15 = sub_12DDC8((_BYTE *)(v4 + a2 + 2), (unsigned __int16)(v10 - 2 - v4));
      if ( !v15 )
        goto LABEL_9;
