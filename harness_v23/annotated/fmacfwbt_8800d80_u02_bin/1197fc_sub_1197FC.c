// v23 annotated: sub_1197FC @ 0x1197fc
// Original: 1197fc_sub_1197FC.c
...
int __fastcall sub_1197FC(int a1, __int16 a2, int a3, __int16 a4, unsigned __int8 a5)
{
  int *v5; // r7
  int v6; // r6
  int v7; // r4
  ...
  v7 = dword_119880 + 1320 * *(unsigned __int8 *)(v6 + 34);
  v8 = *(_DWORD *)(v6 + 38);
  v9 = *(_WORD *)(v7 + 104);
  v11 = *(_DWORD *)(v7 + 100);
