// v23 annotated: bt_check_flag_n_3c0 @ 0x11838c
// Original: 11838c_bt_check_flag_n_3c0.c
...
int __fastcall bt_check_flag_n_3c0(int a1, int a2, int a3, int a4)
{
  int v4; // r2
  int v6; // r0
  __int16 *v7; // r1
