// v23 annotated: rf_state_check_n2c6 @ 0x13144c
// Original: 13144c_rf_state_check_n2c6.c
...
unsigned __int8 *__fastcall rf_state_check_n2c6(unsigned __int8 *a1, int a2, int a3)
{
