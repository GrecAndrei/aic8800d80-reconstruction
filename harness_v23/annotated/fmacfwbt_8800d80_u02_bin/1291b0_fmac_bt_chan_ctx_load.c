// v23 annotated: fmac_bt_chan_ctx_load @ 0x1291b0
// Original: 1291b0_fmac_bt_chan_ctx_load.c
...
unsigned int __fastcall fmac_bt_chan_ctx_load(unsigned int result, int a2, int a3)
{
  int v3; // r3
  _DWORD *v4; // r7
  int v6; // r2
  ...
  v4 = off_12937C;
  v6 = *(_DWORD *)(a3 + 4);
  v7 = *(unsigned __int8 *)off_12937C;
  v8 = *(unsigned __int16 *)(dword_129378 + 696 * v3 + 32);
  *(_DWORD *)(a3 + 4) = v6 & 0xFFFFFFFE;
  ...
  if ( v7 )
  {
    if ( result )
    {
      ...
      else
      {
            ...
            & 1) != 0 )
        {
          ...
          *(_DWORD *)(a3 + 4) = v6 & 0xFFFFFFFC | 2;
          ...
          if ( !*((_BYTE *)v4 + 29) )
          {
            v17 = *((_DWORD *)off_129394 + 4);
            v18 = *(unsigned __int16 *)(*(_DWORD *)off_129390 + 56);
            v19 = dword_129398;
            v4[5] = a3;
            *((_BYTE *)v4 + 29) = 5;
      ...
      {
        if ( (*(_DWORD *)off_129380 & 0x200) != 0 )
          *(_DWORD *)off_129380 &= ~0x200u;
        if ( !*(_BYTE *)off_129384 )
        {
          bt_msg_post_n2cc();
          if ( !*((_BYTE *)v4 + 28) || (*(_DWORD *)off_12938C & 4) != 0 )
          {
            *(_BYTE *)off_129388 = 0;
          }
          else
          {
            v20 = off_129388;
            if ( *(_BYTE *)off_129388 && (sub_122B1C() != 1 || !*((_DWORD *)off_12939C + 126)) )
              fmacfwbt_phy_chan_init(*(unsigned __int8 *)(a3 + 116), 0, 0);
            *v20 = 1;
          }
          v21 = off_129394;
          v22 = *(unsigned __int16 *)(*(_DWORD *)off_129390 + 58);
          v23 = dword_129398;
          *(_DWORD *)(a3 + 4) |= 4u;
          v24 = v21[4];
          v4[5] = a3;
         ...
         && (*(unsigned __int8 *)(result + v14 - v13 + 5) & (1 << (v8 & 7))) != 0 )
  {
    ...
    {
      result = sub_122B1C();
      if ( result != 1 || !*((_DWORD *)off_12939C + 126) )
        result = fmacfwbt_phy_chan_init(*(unsigned __int8 *)(a3 + 116), 0, 0);
    }
    *v15 = 1;
  }
  else
