// v23 annotated: sub_1402A0 @ 0x1402a0
// Original: 1402a0_sub_1402A0.c
...
int __fastcall sub_1402A0(int result)
{
  unsigned int v1; // r6
  int v2; // r4
  int v3; // r7
  ...
  {
    v3 = dword_1403C0;
    v4 = *(_DWORD *)(dword_1403C0 + 696 * v1 + 340);
    ...
    v7 = off_1403D0;
    *(_BYTE *)(v4 + 166) = v6;
    if ( v7[4] - *(_DWORD *)v4 > (unsigned int)dword_1403C4 )
    {
      v14 = sub_13F66C(v4, 0);
