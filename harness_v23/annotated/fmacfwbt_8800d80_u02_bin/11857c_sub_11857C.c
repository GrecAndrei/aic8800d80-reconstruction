// v23 annotated: sub_11857C @ 0x11857c
// Original: 11857c_sub_11857C.c
// Primary struct: <unclustered>
//
// sub_11857C @ 0x11857c, size 2000 bytes
int __fastcall sub_11857C(int a1)
{
  int v1; // s16
  int v2; // r4
  int result; // r0
  ...
  v2 = *(_DWORD *)(dword_118878 + 4 * a1);
  if ( **(__int16 **)off_118870 < 0 && (v2 & *(_DWORD *)off_118D5C) == 0 )
    sub_12F694(dword_118D64, dword_118D60, 612);
  sub_12D374(v2);
  result = bt_xtal_init_check(v68);
  v4 = *(_DWORD *)(dword_118874 + 8 * a1);
  if ( v4 )
  {
    v5 = (int *)off_11887C;
    v61 = 0;
    ...
    do
    {
      ...
      if ( *((_BYTE *)off_118880 + 512) == 1 )
      {
        *((_BYTE *)off_118880 + 512) = 0;
...
LABEL_39:
          ...
          v25 = *(_DWORD *)(v7 + 4);
          v63 = v25;
          if ( *(_BYTE *)(dword_11888C + 696 * v9 + 36) != 1 || (v25 & 0x810000) != 0x10000 )
            sub_13EB7C(v4);
          v26 = dword_118898;
          ...
          if ( *(unsigned __int8 *)(v4 + 29) > 0x1Fu
            ...
            || !*(_BYTE *)(dword_118898 + 1320 * v24 + 108) )
          {
LABEL_53:
...
LABEL_54:
              ...
              else
              {
                ...
                if ( v30 <= 0x1F )
                {
                  ...
                  if ( v31 <= 8 )
                    *(_DWORD *)(dword_118888 + 4 * (9 * v30 + v31 + 2062)) -= *(unsigned __int16 *)(v4 + 4);
                }
                sub_117290(v4);
                flag_check_1218170(v4, (_DWORD *)(v7 + 4));
                if ( (*(_WORD *)(v4 + 30) & 1) != 0 )
                  irq_nesting_or(512);
...
LABEL_94:
          ...
          if ( *(_BYTE *)(dword_118D68 + 696 * v9 + 36) != 1 )
          {
            if ( (v29 & 2) == 0 )
              goto LABEL_132;
...
LABEL_132:
          ...
          v57 = *(_DWORD *)(v4 + 76);
          v58 = off_118D4C;
          *(_WORD *)(v4 + 64) = *((_WORD *)off_118D74 + 22) + (*((_DWORD *)off_118D70 + 4) >> 10);
          *(_DWORD *)(v4 + 68) = 0;
          *(_DWORD *)(v57 + 72) = 0;
          *(_DWORD *)(v57 + 4) = 0;
          *(_WORD *)(v4 + 82) = 0;
      ...
      *(_DWORD *)(v7 + 4) = v10;
      ...
      if ( (*(_DWORD *)(v4 + 36) & 0x380000) == 0x380000 )
      {
        ...
        if ( *(_BYTE *)(dword_118B38 + 696 * v9 + 36) != 1 || v11 )
...
LABEL_24:
      ...
      if ( v17 <= 0x1F )
      {
        ...
        if ( v18 <= 8 )
          *(_DWORD *)(dword_118888 + 4 * (9 * v17 + v18 + 2062)) -= *(unsigned __int16 *)(v4 + 4);
      }
      flag_check_1218170(v4, (_DWORD *)(v7 + 4));
...
LABEL_31:
      ...
      if ( v12 )
      {
        ...
        {
LABEL_117:
          if ( bt_sub_121733C(v67) && !*((_BYTE *)off_118D50 + 511) )
          {
            do
            {
