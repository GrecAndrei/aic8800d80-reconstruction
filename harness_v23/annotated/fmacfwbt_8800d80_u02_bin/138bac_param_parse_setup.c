// v23 annotated: param_parse_setup @ 0x138bac
// Original: 138bac_param_parse_setup.c
...
int __fastcall param_parse_setup(unsigned __int8 *a1, _DWORD *a2, char *a3, int a4)
{
  char v5; // r2
  int v6; // r4
  char *v7; // r3
