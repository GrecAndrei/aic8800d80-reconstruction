// v23 annotated: sub_119CB4 @ 0x119cb4
// Original: 119cb4_sub_119CB4.c
...
int __fastcall sub_119CB4(int a1, int *a2, unsigned int a3, unsigned int a4, unsigned __int8 a5)
{
  int *v5; // r4
  int v6; // r5
  int v8; // r6
  ...
  *a2 = v22;
  ...
  if ( v10 )
    *(_DWORD *)(*(_DWORD *)(v8 + 32) - 3) = *((_DWORD *)off_119E00 + 43);
