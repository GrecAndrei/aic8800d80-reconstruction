// v23 annotated: sub_10624C @ 0x10624c
// Original: 10624c_sub_10624C.c
// Primary struct: <unclustered>
//
// sub_10624C @ 0x10624c, size 188 bytes
int __fastcall sub_10624C(int a1, int a2, int a3, int a4, int a5)
{
  int v9; // r4
  unsigned int v10; // r4
  int v11; // r8
  ...
  if ( *(_DWORD *)(a4 + 132) <= a2 )
  {
    sub_105088(*(float *)(a4 + 4 * a2 + 148), (unsigned __int8)a1, a4);
