// v23 annotated: sub_1431B4 @ 0x1431b4
// Original: 1431b4_sub_1431B4.c
// Primary struct: <unclustered>
//
// sub_1431B4 @ 0x1431b4, size 352 bytes
int __fastcall sub_1431B4(int result, int a2, int a3, int a4)
{
  bool v4; // zf
  int v5; // r2
  int v6; // r2
