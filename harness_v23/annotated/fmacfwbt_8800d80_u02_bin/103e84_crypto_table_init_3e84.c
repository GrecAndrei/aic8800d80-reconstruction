// v23 annotated: crypto_table_init_3e84 @ 0x103e84
// Original: 103e84_crypto_table_init_3e84.c
...
int __fastcall crypto_table_init_3e84(int a1, int a2, int a3)
{
  int v3; // r1
  int v4; // r2
  unsigned int *v5; // r3
