// v23 annotated: sub_131BEC @ 0x131bec
// Original: 131bec_sub_131BEC.c
// Primary struct: <unclustered>
//
// sub_131BEC @ 0x131bec, size 138 bytes
int __fastcall sub_131BEC(int a1, _BYTE *a2, unsigned int a3, __int16 a4)
{
  _DWORD *v5; // r5
  int v6; // r7
  int v8; // r0
...
LABEL_7:
  ...
  v12 = (_BYTE *)sub_12CB54(49, 0, v15, 1u);
  v13 = v5[1];
  *((_WORD *)v5 + 4) = a4;
  if ( v13 )
    v14 = 0;
