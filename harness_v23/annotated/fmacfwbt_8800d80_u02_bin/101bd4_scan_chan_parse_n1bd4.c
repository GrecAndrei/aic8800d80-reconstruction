// v23 annotated: scan_chan_parse_n1bd4 @ 0x101bd4
// Original: 101bd4_scan_chan_parse_n1bd4.c
...
int __fastcall scan_chan_parse_n1bd4(unsigned int a1, signed int a2, unsigned __int8 *a3)
{
  int v3; // r6
  unsigned int v4; // r7
  bool v5; // cc
