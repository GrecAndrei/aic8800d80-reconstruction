// v23 annotated: sub_11FAF8 @ 0x11faf8
// Original: 11faf8_sub_11FAF8.c
// Primary struct: <unclustered>
//
// sub_11FAF8 @ 0x11faf8, size 1000 bytes
int __fastcall sub_11FAF8(int *a1, int a2, int a3, _BYTE *a4)
{
  _BYTE *v4; // r9
  int **v5; // r4
  int result; // r0
  ...
  v4 = off_11FE34;
  if ( !*(_DWORD *)off_11FE34 )
    return 1;
  if ( a3 )
  {
    if ( a2 == 2 && *(_BYTE *)off_11FE90 )
      return 1;
    v5 = *((int ***)off_11FE34 + 2);
    if ( v5 )
    {
      if ( *((_BYTE *)off_11FE34 + 19) == 2 )
        return 1;
      goto LABEL_8;
    }
LABEL_52:
  ...
  *(_BYTE *)(v17 + 140) = 0;
  ...
  else if ( a2 == 4 )
  {
    ...
    if ( v41 )
    {
      ...
      *(_DWORD *)off_11FE4C = dword_11FE84;
      if ( v44 < 0 && *(_DWORD *)off_11FEE0 << 28 )
      {
        sub_12F6C4(dword_11FEE8, dword_11FEE4, 472);
        v43 = *v42;
      }
      v45 = *(_DWORD *)(v41 + 72);
      *(_DWORD *)off_11FE50 = v43 | v42[1];
      if ( v45 )
  ...
  if ( v24 > 1 || v4[18] )
  {
    ...
    v27 = *((_DWORD *)off_11FE4C + 1) | 0x100;
    *((_DWORD *)off_11FE4C + 1) = v27;
    if ( v26 < 0 && *(_DWORD *)off_11FE70 << 28 )
    {
      sub_12F6C4(dword_11FE78, dword_11FE74, 472);
      v27 = v25[1];
      v24 = (unsigned __int8)v4[17] + (unsigned __int8)v4[18];
    }
    *(_DWORD *)off_11FE50 = v27 | *v25;
  }
  if ( v24 == 1 )
    *(_DWORD *)off_11FE54 |= 1u;
  if ( a3 )
  {
