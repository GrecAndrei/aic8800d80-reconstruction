// v23 annotated: rx_frame_handler @ 0x11e2a4
// Original: 11e2a4_rx_frame_handler.c
...
_DWORD *__fastcall rx_frame_handler(_DWORD *a1, unsigned int a2, int a3, _DWORD *a4, int a5)
{
  ...
  v5 = (unsigned __int8 **)off_11E3B4;
  v6 = (_DWORD *)*a1;
  v7 = *(unsigned __int16 *)a4;
  v8 = **(unsigned __int8 **)off_11E3B4;
  v9 = (__int16 **)off_11E3B8;
  v22 = a4;
  if ( a2 >= 0x640 )
    a2 = 1600;
  if ( v8 == 3 )
