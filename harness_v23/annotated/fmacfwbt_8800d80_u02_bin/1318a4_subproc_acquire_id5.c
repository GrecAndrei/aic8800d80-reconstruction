// v23 annotated: subproc_acquire_id5 @ 0x1318a4
// Original: 1318a4_subproc_acquire_id5.c
...
int __fastcall subproc_acquire_id5(int a1, int *a2, __int16 a3, __int16 a4)
{
  int v7; // r5
  int v8; // r4
  int v9; // r7
  ...
  if ( v10 )
  {
    *(_BYTE *)v7 = *(_BYTE *)(v10 + 24);
    if ( *((_BYTE *)a2 + 10) )
    {
      if ( list_count_d594((_DWORD **)dword_13199C) == 1 )
      {
