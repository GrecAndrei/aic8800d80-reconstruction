// v23 annotated: bt_hci_cmd_dispatch @ 0x1285f8
// Original: 1285f8_bt_hci_cmd_dispatch.c
...
int __fastcall bt_hci_cmd_dispatch(int result)
{
  int v1; // r7
  int v2; // r5
  _BYTE *v3; // r6
  ...
  if ( (*((_BYTE *)off_12869C + 88) & 0x20) == 0 && *((unsigned __int8 *)off_12869C + 90) > 1u )
  {
    ...
    v5 = rf_bus_setup_n3a8(70, *((_BYTE *)off_12869C + 88) & 0x20, *((_BYTE *)off_12869C + 88) & 0x20, 20);
    *(_BYTE *)v5 = 0;
