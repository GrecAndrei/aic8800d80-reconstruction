// v23 annotated: sub_11B9B8 @ 0x11b9b8
// Original: 11b9b8_sub_11B9B8.c
// Primary struct: <unclustered>
//
// sub_11B9B8 @ 0x11b9b8, size 562 bytes
int __fastcall sub_11B9B8(int a1)
{
  _DWORD *v1; // r8
  char *v2; // r6
  int v3; // r2
  ...
  v1 = off_11BC04;
  v2 = (char *)off_11BBEC;
  v3 = *((_DWORD *)off_11BC04 + 4);
  v5 = *(_DWORD *)a1 + 38;
  *((_DWORD *)off_11BBEC + 18) = *(_DWORD *)v5;
  v6 = *(_WORD *)(v5 + 4);
  v7 = *(_DWORD *)(v3 + 100);
  ...
  *((_DWORD *)v2 + 6) = 0;
  ...
  v15 = (unsigned int *)(36 * *(unsigned __int8 *)(*(_DWORD *)a1 + 35) + 8248 + dword_11BBF0);
  v36 = v11 << 9;
  v16 = v13 + 92;
  v17 = v13;
  v18 = 2621440;
