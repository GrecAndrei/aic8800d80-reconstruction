// v23 annotated: sub_13876C @ 0x13876c
// Original: 13876c_sub_13876C.c
...
_DWORD *sub_13876C()
{
  ...
  if ( *(_BYTE *)off_1388A8 )
    rf_power_set(0xC2u);
  if ( **(_BYTE **)off_1388AC == 1 )
    *(_DWORD *)off_1388B0 &= ~0x200000u;
  v0 = off_1388B4;
  v1 = off_1388B8;
  v2 = off_1388BC;
  if ( (*(_DWORD *)off_1388B4 & 4) != 0 )
  {
    v15 = *(unsigned __int16 *)(*(_DWORD *)off_1388E0 + 54);
    v16 = off_1388E8;
    v17 = dword_1388E4 + 1320 * *(unsigned __int8 *)(*(_DWORD *)off_1388B8 + 366);
    *((_BYTE *)off_1388BC + 29) = 3;
    v18 = v16[4];
    v2[5] = v17;
