// v23 annotated: bt_link_state_get_n2c4 @ 0x12a924
// Original: 12a924_bt_link_state_get_n2c4.c
...
int __fastcall bt_link_state_get_n2c4(int a1, unsigned int a2, int a3)
{
  int v3; // r6
  int v4; // r5
  int result; // r0
