// v23 annotated: sub_121678 @ 0x121678
// Original: 121678_sub_121678.c
// Primary struct: <unclustered>
//
// sub_121678 @ 0x121678, size 534 bytes
int __fastcall sub_121678(unsigned __int8 *a1)
{
  unsigned int v1; // r7
  int v2; // r5
  int v4; // r6
  ...
  if ( v1 == 255 )
  {
    if ( a1[40] == 5 )
    {
      v23 = HIBYTE(*(_DWORD *)off_1218C8) - 3 + *a1 + 2 * v2;
  ...
  else
  {
    ...
    *(_DWORD *)off_12189C = v6[19] | (v6[20] << 16);
    *v5 = v6[21];
  }
  switch ( a1[40] )
  {
    ...
    case 1u:
      ...
      *(_DWORD *)off_1218AC = *((_DWORD *)a1 + 2);
      ...
      v7[2] = *((_DWORD *)a1 + 4);
      v8 = *(_BYTE **)off_1218B0;
      *(_DWORD *)off_1218B4 = *((_DWORD *)a1 + 5);
      if ( (*v8 & 1) != 0 )
      {
        v9 = off_1218B8;
        *(_DWORD *)off_1218B8 = *((_DWORD *)a1 + 6);
        v9[1] = *((_DWORD *)a1 + 7);
        v9[2] = *((_DWORD *)a1 + 8);
        v9[3] = *((_DWORD *)a1 + 9);
      }
...
LABEL_22:
  ...
  v13 = off_1218BC;
  *(_DWORD *)off_1218BC = (16 * v2) | (4 * a1[42]) | v10 | (v4 << 16) | v11 | 0x40000000;
