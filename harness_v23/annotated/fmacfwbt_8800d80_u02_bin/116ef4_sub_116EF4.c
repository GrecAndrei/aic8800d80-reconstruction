// v23 annotated: sub_116EF4 @ 0x116ef4
// Original: 116ef4_sub_116EF4.c
// Primary struct: <unclustered>
//
// sub_116EF4 @ 0x116ef4, size 384 bytes
int __fastcall sub_116EF4(int a1, int a2, int a3, int a4)
{
  int v5; // r6
  int result; // r0
  int v9; // r8
...
LABEL_11:
        ...
        if ( *(unsigned __int8 *)(a2 + 27) == 255 )
        {
          ...
          {
            v16 = *((_WORD *)off_11707C + 254);
          }
          else
          {
            v16 = *((_WORD *)off_11707C + 254) + 1;
            *((_WORD *)off_11707C + 254) = v16;
          }
          v17 = *(_WORD *)(a2 + 30);
...
LABEL_4:
  if ( (*(_DWORD *)(a1 + 36) & 0x200000) == 0 )
    return sub_116DE0(*(_DWORD *)(a1 + 76) + 12, *(_DWORD *)(a1 + 76) + 12, a4);
