// v23 annotated: sub_110C80 @ 0x110c80
// Original: 110c80_sub_110C80.c
...
int sub_110C80()
{
  ...
  v0 = (int *)off_110E24;
  *(_DWORD *)off_110E20 = 16;
  v1 = *v0;
  if ( (v1 & 4) != 0 )
  {
    v21 = (unsigned int *)off_110E54;
    v22 = (unsigned int *)off_110E38;
    *(_DWORD *)off_110E54 = *(_DWORD *)off_110E54 & 0x8000FFFF | 0x4E200000;
  ...
  else
  {
    ...
    do
    {
      while ( (*(_DWORD *)off_110E2C & 0x20000000) != 0 )
        ;
    }
    while ( *(int *)off_110E2C < 0 );
    v2 = off_110E2C;
    *(_DWORD *)off_110E2C = dword_110E30;
    while ( (*v2 & 0x20000000) != 0 )
      ;
    if ( (*v2 & 2) == 0 )
    {
      while ( (*(_DWORD *)off_110E24 & 1) == 0 )
        ;
    }
    v3 = (int *)off_110E34;
    ...
    *v11 = v13;
    ...
    while ( *(int *)off_110E2C < 0 );
    v18 = off_110E2C;
    *(_DWORD *)off_110E2C = dword_110E64;
    while ( (*v18 & 0x20000000) != 0 )
      ;
    result = sub_12ECB0(dword_110E68, v18, v17);
    *(_DWORD *)off_110E38 = *(_DWORD *)off_110E38 & 0xFFFFF000 | 0x960;
  }
  v20 = off_110E70;
  *(_DWORD *)(*((_DWORD *)off_110E6C + 2) + 324) = dword_110E74;
  v20[2] = 2;
  return result;
}
