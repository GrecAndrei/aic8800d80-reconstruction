// v23 annotated: sub_141D1C @ 0x141d1c
// Original: 141d1c_sub_141D1C.c
// Primary struct: <unclustered>
//
// sub_141D1C @ 0x141d1c, size 184 bytes
int __fastcall sub_141D1C(unsigned __int16 *a1, unsigned int a2, unsigned int a3, __int16 *a4)
{
  unsigned int v4; // r5
  __int16 v5; // r6
  __int16 **v6; // r4
  ...
  *((_BYTE *)a4 + 41) = *((_BYTE *)a1 + 13);
  ...
  v16 = dword_141DDC;
  v17 = v14 << v7;
  v18 = *((unsigned __int16 *)off_141DD8 + 14) + 20;
  *((_DWORD *)a4 + 4) = v17;
  if ( v15 )
    v19 = v12 << 10;
  else
