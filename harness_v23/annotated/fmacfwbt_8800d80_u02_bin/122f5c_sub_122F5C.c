// v23 annotated: sub_122F5C @ 0x122f5c
// Original: 122f5c_sub_122F5C.c
// Primary struct: <unclustered>
//
// sub_122F5C @ 0x122f5c, size 472 bytes
void __fastcall __noreturn sub_122F5C(int a1, int *a2, int a3, int a4)
{
  int v5; // r2
  int v6; // r3
  unsigned int v7; // r3
  ...
  v15 = 0;
  if ( (*(_DWORD *)off_123134 & 0x2000000) != 0 )
  {
    sub_114EA4(&v15);
    sub_114ED0((_BYTE *)&v15 + 1);
...
LABEL_18:
  ...
  v13 = off_123154;
  v14 = dword_123158;
  *(_DWORD *)off_123154 = *(_DWORD *)off_123154 & 0xFF03FFFF | v12;
