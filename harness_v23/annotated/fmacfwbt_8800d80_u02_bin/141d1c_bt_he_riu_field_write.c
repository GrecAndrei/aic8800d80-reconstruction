// v23 annotated: bt_he_riu_field_write @ 0x141d1c
// Original: 141d1c_bt_he_riu_field_write.c
...
int __fastcall bt_he_riu_field_write(unsigned __int16 *a1, unsigned int a2, unsigned int a3, __int16 *a4)
{
  unsigned int v4; // r5
  __int16 v5; // r6
  __int16 **v6; // r4
