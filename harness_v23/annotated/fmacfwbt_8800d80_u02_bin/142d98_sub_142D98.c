// v23 annotated: sub_142D98 @ 0x142d98
// Original: 142d98_sub_142D98.c
// Primary struct: <unclustered>
//
// sub_142D98 @ 0x142d98, size 360 bytes
unsigned int __fastcall sub_142D98(unsigned int result, unsigned int a2, unsigned int a3, unsigned int a4)
{
  int v4; // r5
  unsigned int v5; // r12
  bool v6; // zf
