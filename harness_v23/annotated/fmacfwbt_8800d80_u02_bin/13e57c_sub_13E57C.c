// v23 annotated: sub_13E57C @ 0x13e57c
// Original: 13e57c_sub_13E57C.c
...
int __fastcall sub_13E57C(int a1)
{
  char v1; // r6
  int v2; // r5
  int v3; // r4
...
LABEL_7:
  ...
  sub_13E30C((unsigned __int16 *)(a1 + 12 * *(unsigned __int8 *)(a1 + 136) + 4));
  if ( !*(_WORD *)(v3 + 184) )
    return v2;
