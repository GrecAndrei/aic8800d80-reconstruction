// v23 annotated: sub_13CC18 @ 0x13cc18
// Original: 13cc18_sub_13CC18.c
...
unsigned int *__fastcall sub_13CC18(unsigned int *result)
{
  __int64 v1; // r2
  int v2; // r1
  unsigned int v3; // r5
  ...
  v3 = *result;
  v4 = result[3];
  *result = dword_13CC84 & (*result >> 15) | ((_DWORD)v1 << 17) & 0x1000000 | (2 * *result) & 0xFEFEFEFE;
