// v23 annotated: rf_buf_setup_check @ 0x1164c4
// Original: 1164c4_rf_buf_setup_check.c
...
int __fastcall rf_buf_setup_check(int a1, int a2, int a3)
{
  __int64 v3; // kr00_8
  int v6; // r1
  int v7; // r7
  ...
  if ( a3 > 4096 )
  {
    ...
    *(_DWORD *)(HIDWORD(v3) + 32) = patch_ctrl_write_magic(HIDWORD(v3) + 8, a3, HIDWORD(v12) >> 12) + 4;
  }
  else
  {
