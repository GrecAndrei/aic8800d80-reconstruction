// v23 annotated: rf_table_lookup_n360 @ 0x11898c
// Original: 11898c_rf_table_lookup_n360.c
...
int __fastcall rf_table_lookup_n360(int a1, int a2)
{
  int v2; // r6
  _DWORD *v3; // r3
  _DWORD *v4; // lr
  ...
  *(_DWORD *)off_118A44 = v7[18] | (v7[19] << 16);
  v8 = off_118A4C;
  v3[1] = v7[20];
  v9 = (int *)off_118A50;
  *v4 = 0;
  ...
  *v9 = 0x20000000;
  ...
  if ( (*v9 & 0x10000000) == 0 )
  {
    ...
    if ( (unsigned __int8)BYTE2(*v9) != v10 )
    {
      ...
      *(_DWORD *)off_118A44 = v14[18] | (v14[19] << 16);
      *(_DWORD *)off_118A54 = v14[20];
    }
  }
  v15 = off_118A50;
  *(_DWORD *)off_118A50 = (16 * a2) | (v10 << 16) | 0x40000002;
