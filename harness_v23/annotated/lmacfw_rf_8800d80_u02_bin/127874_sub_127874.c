// v23 annotated: sub_127874 @ 0x127874
// Original: 127874_sub_127874.c
// Primary struct: <unclustered>
//
// sub_127874 @ 0x127874, size 360 bytes
unsigned int __fastcall sub_127874(unsigned int result, unsigned int a2, unsigned int a3, unsigned int a4)
{
  int v4; // r5
  unsigned int v5; // r12
  bool v6; // zf
