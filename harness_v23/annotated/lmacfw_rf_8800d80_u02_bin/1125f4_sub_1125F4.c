// v23 annotated: sub_1125F4 @ 0x1125f4
// Original: 1125f4_sub_1125F4.c
...
int sub_1125F4()
{
  ...
  char *v12; // r3
  int v13; // r2
  int (__fastcall *v14)(int, int, BOOL); // r3
  _DWORD *v15; // r5
  int v16; // r6
  int v17; // r9
  int v18; // r7
  ...
  _DWORD *v29; // r1
  int v30; // r4
  int (__fastcall *v31)(int, int, _DWORD); // r3
  ...
  v0 = off_112848;
  v1 = *((_DWORD *)off_112848 + 5);
  *((_DWORD *)off_112848 + 5) = v1;
  v2 = v0[6] & v1;
  LODWORD(v3) = v2 << 19;
  if ( (v2 & 0x1000) != 0 )
  {
  ...
  v24 = *((_DWORD *)off_112848 + 514);
  if ( (v24 & 6) != 0 && (v24 & 2) != 0 )
    *(_DWORD *)rf_cmd_send_n_bc = 1;
  v25 = off_112848;
  v26 = (_DWORD **)rf_cmd_send_n_b8;
  v27 = (int *)rf_cmd_send_n_b4;
  v28 = rf_cmd_send_n_b0;
  *((_DWORD *)off_112848 + 576) = rf_cmd_send_n_b0;
  v25[704] = v28;
  v29 = *v26;
  v30 = *v27;
...
rf_bus_reset_n334:
  if ( v5 )
  {
    ...
    v9 = rf_cmd_send_n_cc;
    v10 = 0;
    v11 = *((_DWORD *)off_112848 + 518) & *((_DWORD *)off_112848 + 519);
    while ( 1 )
    {
      LODWORD(v3) = 1;
      if ( ((1 << v10) & v11) != 0 )
        ...
        *((_DWORD *)v12 + 586) = v13;
        ...
        if ( (v3 & 0x900000000LL) != 0 )
        {
          if ( *(_BYTE *)(v9 - 5) )
          {
            ...
            v14 = *(int (__fastcall **)(int, int, BOOL))(rf_cmd_send_n_c8 + 4 * v10 + 52);
            if ( v14 )
...
rf_cmd_send_n_272:
  ...
  if ( v6 )
  {
    ...
    v17 = dword_112874;
    v18 = *((_DWORD *)off_112848 + 518) & *((_DWORD *)off_112848 + 519);
    for ( i = 0; ; ++i )
    {
      if ( ((0x10000 << i) & v18) != 0 )
      {
        ...
        *((_DWORD *)v20 + 714) = v21;
        if ( (v15[517] & v21 & 1) != 0 )
        {
          if ( *(_BYTE *)(v16 - 8) )
          {
            ...
            v31 = *(int (__fastcall **)(int, int, _DWORD))(4 * i + rf_cmd_send_n_c8 + 32);
            if ( v31 )
