// v23 annotated: sub_10EA74 @ 0x10ea74
// Original: 10ea74_sub_10EA74.c
// Primary struct: <unclustered>
//
// sub_10EA74 @ 0x10ea74, size 416 bytes
int __fastcall sub_10EA74(unsigned int a1, unsigned int a2, unsigned int *a3)
{
  unsigned int v3; // r4
  unsigned int *v4; // r6
  unsigned int *v5; // r5
  ...
  *(_DWORD *)off_10EC14 = *(_DWORD *)off_10EC14 & 0xFFFFFFF8 | a1 & 7;
