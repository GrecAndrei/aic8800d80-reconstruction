// v23 annotated: sub_111A24 @ 0x111a24
// Original: 111a24_sub_111A24.c
...
int __fastcall sub_111A24(int a1, int a2, unsigned int a3)
{
  int v3; // r4
  int v4; // r12
  int v5; // r3
