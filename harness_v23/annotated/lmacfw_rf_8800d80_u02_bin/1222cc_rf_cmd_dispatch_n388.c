// v23 annotated: rf_cmd_dispatch_n388 @ 0x1222cc
// Original: 1222cc_rf_cmd_dispatch_n388.c
...
int __fastcall rf_cmd_dispatch_n388(int a1, int a2)
{
  ...
  v3[8] = 0;
  v27 = 0;
  v4 = parse_int(v3, nullptr, 0x10u);
  v5 = parse_int(v26, nullptr, 0x10u);
  v6 = *(unsigned __int8 **)(a2 + 8);
  v7 = v5;
  sub_1282E8(v26, v6 + 8, 4);
  v6[8] = 0;
  v27 = 0;
  v8 = parse_int(v6, nullptr, 0x10u);
  LOWORD(v6) = parse_int(v26, nullptr, 0x10u);
