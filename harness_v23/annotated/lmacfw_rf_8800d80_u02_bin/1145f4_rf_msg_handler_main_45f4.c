// v23 annotated: rf_msg_handler_main_45f4 @ 0x1145f4
// Original: 1145f4_rf_msg_handler_main_45f4.c
...
int __fastcall rf_msg_handler_main_45f4(int a1, int a2, unsigned int a3)
{
  unsigned int v6; // r4
