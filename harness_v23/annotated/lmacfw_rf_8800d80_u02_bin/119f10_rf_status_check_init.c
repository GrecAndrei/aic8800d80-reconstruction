// v23 annotated: rf_status_check_init @ 0x119f10
// Original: 119f10_rf_status_check_init.c
...
int __fastcall rf_status_check_init(int a1, void (__fastcall **a2)(int), int a3)
{
  __int16 **v3; // r5
  int result; // r0
  int v7; // r0
