// v23 annotated: rf_mem_read_n208 @ 0x11f79c
// Original: 11f79c_rf_mem_read_n208.c
...
int __fastcall rf_mem_read_n208(int a1, int a2, __int16 a3, __int16 a4)
{
  _DWORD *v5; // r0
  _DWORD *v6; // r5
  unsigned int v7; // r3
  ...
  v5 = (_DWORD *)rf_setup_dispatch(1044, a4, a3, 0x48u);
  v6 = v5;
  switch ( *(_DWORD *)a2 )
  {
    case 0:
    ...
    case 1:
      ...
      *(_DWORD *)off_120658 = 0;
      ...
      rf_bus_write_60fc(v237, dword_120668 + 28 * (__int16)v237 + 12);
      if ( *v103 )
      {
        v104 = *v103 - 1;
...
LABEL_322:
    ...
    case 6:
      ...
      goto LABEL_21;
    case 7:
      msg_parse(dword_11FFA8, *(unsigned __int8 *)(a2 + 8));
      v48 = off_11FFB0;
    ...
    case 8:
      ...
      sub_10F170(v44);
      v45 = (unsigned __int8)mmio_bit_extract_n();
      v46 = sub_126E54();
      rf_level_apply_n200(v45);
      if ( !v43 )
        msg_parse(dword_120DC0, *((unsigned __int8 *)off_120DBC + 4), *((char *)off_120DBC + 2));
      v47 = dword_11FFA4;
      *v6 = v45;
    ...
    case 0x11:
      ...
      *v6 = v50;
      ...
      goto LABEL_21;
    case 0x12:
      msg_parse(dword_11FFB8, *(unsigned __int8 *)(a2 + 8));
    ...
    case 0x14:
      ...
      {
        v150 = off_1209DC;
        msg_parse(dword_1209E0, *(_DWORD *)off_1209DC);
      }
      *v6 = *v150;
      goto LABEL_21;
    case 0x15:
      ...
      if ( v143 == 1 )
      {
        if ( v142 > 3 )
        {
          ...
          if ( v144 <= 2 )
          {
            ...
            v229 = dword_1212CC;
            msg_parse(dword_1212C4, *(unsigned __int8 *)(a2 + 9));
            v230 = a2 + 9;
...
LABEL_385:
            ...
            v223 = dword_1212CC;
            msg_parse(dword_1212B8, *(unsigned __int8 *)(a2 + 9));
            v224 = a2 + 9;
...
LABEL_269:
    ...
    case 0x1E:
      if ( is_flag_set_n645c() )
        msg_parse(dword_120DA8, *(unsigned __int8 *)off_120DA4);
...
LABEL_59:
    ...
    case 0x26:
      if ( !*(_DWORD *)(a2 + 4) )
        goto LABEL_243;
      rf_level_apply_6d60(*(unsigned __int8 *)(a2 + 8));
      goto LABEL_21;
    case 0x27:
    ...
    case 0x50:
      ...
      if ( *(_DWORD *)(a2 + 4) != 2 )
      {
        msg_parse(dword_120D88, *(_DWORD *)(a2 + 4));
        goto LABEL_21;
      }
      if ( !*(_BYTE *)(a2 + 8) )
        goto LABEL_21;
...
LABEL_163:
    ...
    case 0x61:
      ...
      {
        msg_parse(dword_120DB4, *(_DWORD *)off_120318 << 6);
      }
      else
      {
        v93 = *(_DWORD *)(a2 + 4);
        *v5 = 0xFFFF;
        ...
        else
        {
          ...
          {
            msg_parse(dword_120D98, (unsigned __int16)v244, WORD1(v244), WORD2(v244), HIWORD(v244), v245);
