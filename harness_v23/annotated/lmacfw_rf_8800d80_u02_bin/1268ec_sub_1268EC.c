// v23 annotated: sub_1268EC @ 0x1268ec
// Original: 1268ec_sub_1268EC.c
// Primary struct: <unclustered>
//
// sub_1268EC @ 0x1268ec, size 1078 bytes
unsigned int *__fastcall sub_1268EC(int a1)
{
  ...
  if ( a1 )
  {
    if ( a1 != 1 )
    {
      ...
      v5 = off_126BD4;
      v6 = off_126BD8;
      *(_DWORD *)off_126BD0 = *(_DWORD *)off_126BCC & 0xFFFFBFFF;
      *v5 |= 0x80000000;
      *v6 |= 0x8000u;
      if ( a1 == 3 )
      {
          ...
          if ( v3 == 1 )
          {
            ...
            *result &= ~0x80000000;
            ...
            else if ( v4 == 2472 )
            {
              ...
              v48 = dword_126D54;
              *(_DWORD *)off_126D2C = dword_126D50;
              REG_4034_2088 = v48;
            }
          }
          else
        ...
        else
        {
          ...
          *result &= ~0x80000000;
          ...
          else if ( v4 == 2472 )
          {
            ...
            v20 = dword_126C18;
            *(_DWORD *)off_126BE4 = dword_126C14;
            REG_4034_2088 = v20;
          }
        }
      }
        ...
        *v7 &= ~0x80000000;
        if ( v3 )
        {
          if ( v3 == 1 )
          {
            ...
            v32 = dword_126C3C;
            *(_DWORD *)off_126BE4 = dword_126C38;
            *v31 = v32;
          }
        }
        else
        {
          ...
          v9 = dword_126BF0;
          *(_DWORD *)off_126BE4 = dword_126BEC;
          *v8 = v9;
        }
      }
      v10 = off_126BF4;
LABEL_10:
    ...
    v21 = off_126C40;
    v22 = (*(_DWORD *)off_126C1C >> 11) & 7;
    v23 = *(_DWORD *)off_126C1C & 0x7F;
    v24 = (*(_DWORD *)off_126C1C >> 7) & 3;
    ...
    if ( !*(_BYTE *)off_126C24 && *(_DWORD *)off_126C28 )
    {
      v25 = off_126BD8;
      v26 = off_126BFC;
      v27 = (unsigned int *)off_126C2C;
      v28 = dword_126C30;
      *(_DWORD *)off_126BD8 |= 0x4000u;
      *v26 |= 0x10000u;
  ...
  else
  {
    ...
    v11 = off_126BFC;
    if ( (*(_DWORD *)off_126BFC & 0x10000) != 0 )
    {
      v29 = off_126C2C;
      v30 = off_126C34;
      *(_DWORD *)off_126BD8 &= ~0x4000u;
