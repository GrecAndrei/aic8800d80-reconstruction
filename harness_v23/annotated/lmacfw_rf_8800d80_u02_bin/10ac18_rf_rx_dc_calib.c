// v23 annotated: rf_rx_dc_calib @ 0x10ac18
// Original: 10ac18_rf_rx_dc_calib.c
...
int __fastcall rf_rx_dc_calib(unsigned int *a1, _BYTE *a2, int a3)
{
  int v3; // r9
  int v4; // r10
  int v5; // r11
      ...
      *v83 = 1;
      ...
      for ( i = 0; i != 3; ++i )
      {
        ...
        *v83 &= (v82[v60] & 0x20000) != 0;
        ...
        crypto_key_schedule(v82[v60], v92);
        if ( v63 < v62 )
        {
          v65 = v93;
          v66 = v92[10];
...
LABEL_18:
  ...
  *(_DWORD *)off_10AF50 = v45;
  ...
  return msg_parse(dword_10AF84, v46);
}
