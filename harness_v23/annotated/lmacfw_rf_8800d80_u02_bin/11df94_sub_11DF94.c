// v23 annotated: sub_11DF94 @ 0x11df94
// Original: 11df94_sub_11DF94.c
...
int __fastcall sub_11DF94(int a1)
{
  __int16 **v1; // r7
  unsigned int v2; // r4
  unsigned int v3; // r6
  ...
  v5 = (int *)off_11E068;
  v6 = *(_DWORD *)off_11E068 + 1;
  *(_DWORD *)off_11E068 = v6;
  if ( v4 )
  {
    v7 = nullptr;
    while ( 1 )
