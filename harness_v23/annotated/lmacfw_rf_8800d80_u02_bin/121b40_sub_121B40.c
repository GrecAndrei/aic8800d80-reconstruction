// v23 annotated: sub_121B40 @ 0x121b40
// Original: 121b40_sub_121B40.c
...
unsigned int __fastcall sub_121B40(unsigned int a1, int a2, int a3)
{
  unsigned int v3; // r7
  int *v4; // r5
  _BYTE *v8; // r9
  ...
  {
    v4 = (int *)off_121BD0;
    if ( a3 < *(_DWORD *)off_121BD0 )
    {
      v8 = (_BYTE *)dword_121BD8;
      do
      {
        uart_puts(v8);
        v9 = *v4 - 1;
