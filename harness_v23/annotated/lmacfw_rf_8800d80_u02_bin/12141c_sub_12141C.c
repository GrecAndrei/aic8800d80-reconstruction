// v23 annotated: sub_12141C @ 0x12141c
// Original: 12141c_sub_12141C.c
// Primary struct: <unclustered>
//
// sub_12141C @ 0x12141c, size 112 bytes
int __fastcall sub_12141C(int a1, int *a2, __int16 a3, __int16 a4)
{
  int *v5; // r5
  int v6; // r2
  int v7; // r0
