// v23 annotated: sub_10A5B0 @ 0x10a5b0
// Original: 10a5b0_sub_10A5B0.c
...
int __fastcall sub_10A5B0(unsigned int a1, unsigned int a2, int a3, unsigned int a4, unsigned __int8 a5, char a6)
{
  unsigned int v8; // s17
  int v9; // r3
  _DWORD *v10; // r2
  ...
  sub_11F74C(0x2000, dword_10A8C0, (*(_DWORD *)off_10A8E4 >> 3) & 7, *(_DWORD *)off_10A8B0);
  v8 = ((a1 >> 1) & 1) + 3;
  if ( (a1 & 0xC) != 0 )
  {
    if ( ((a1 >> 2) & 3) == 1 )
    ...
    if ( a4 <= a5 )
    {
      ...
      do
      {
        while ( 1 )
        {
          ...
          if ( v50 != 1 )
            break;
          *(_DWORD *)&v60[2 * v27 + 54] = *(_DWORD *)&v60[20 * v25 + 310];
          *(_DWORD *)&v60[2 * v27 + 182] = *(_DWORD *)&v60[20 * v25 + 630];
        ...
        if ( v25 >= 6 )
          ...
          v26 = 50;
        v46 = v26;
        *(_DWORD *)&v60[2 * v27 + 54] = sub_109184(v50, v26, (int *)&v60[20 * v25 + 310]);
        *(_DWORD *)&v60[2 * v27 + 182] = sub_109184(v50, v46, (int *)&v60[20 * v25 + 630]);
        v25 = (unsigned __int8)(v25 + 1);
      }
      while ( a5 >= v25 );
    }
LABEL_28:
  ...
  else
  {
    ...
    {
      if ( i > 9 )
        *(_WORD *)(a2 + 2 * (__int16)i) = LOBYTE(v59[i - 10]) | (unsigned __int16)(v60[i - 10] << 8);
      if ( a5 == i )
        break;
    }
    v34 = a4;
  ...
  *(v36 - 6224) &= 0xCFFFFFFF;
  if ( a6 )
  {
    ...
    v39 = *(_WORD *)(a2 + 2 * a4);
    *(_DWORD *)off_10AC0C = *(_DWORD *)off_10AC0C & 0xFE01FFFF | ((unsigned __int8)v39 << 17);
    *v38 = v39 & 0xFF00 | *v38 & 0xFFFF00FF;
  }
  else
  {
    v44 = (unsigned int *)off_10AC0C;
    *(_DWORD *)off_10AC0C &= ~0x2000000u;
    *v44 &= ~0x10000u;
