// v23 annotated: rf_chan_lookup @ 0x11bec0
// Original: 11bec0_rf_chan_lookup.c
// Primary struct: <unclustered>
//
// rf_chan_lookup @ 0x11bec0, size 102 bytes
// Doc: rf_chan_lookup [rf]: Look up RF channel entry from global table indexed by byte at offset 1
// rf_chan_lookup [rf]: Look up RF channel entry from global table indexed by byte at offset 1
int __fastcall rf_chan_lookup(int result, int a2)
{
  int v2; // r4
  int v3; // r5
  int v5; // r7
  ...
  if ( **(__int16 **)off_11BF28 < 0 )
  {
    ...
    if ( !*(_BYTE *)(v7 + 16) )
    {
      result = rf_cmd_send_n264(dword_11BF34, dword_11BF30, 3289);
