// v23 annotated: sub_112EF4 @ 0x112ef4
// Original: 112ef4_sub_112EF4.c
...
_DWORD *__fastcall sub_112EF4(int a1)
{
  _DWORD *v2; // r4
  int v3; // r0
  unsigned int v4; // r0
  ...
  switch ( a1 )
  {
    case 1:
      ...
      if ( *((_BYTE *)off_112F54 + 370) && sub_113B30(v3) )
      {
    ...
    case 6:
      return (_DWORD *)dword_112F48;
    case 15:
      return (_DWORD *)dword_112F44;
    default:
      return nullptr;
  }
}
