// v23 annotated: patch_ctrl_write_magic @ 0x123b30
// Original: 123b30_patch_ctrl_write_magic.c
...
int __fastcall patch_ctrl_write_magic(_DWORD *a1, int a2, int a3)
{
  int v3; // r2
  int v4; // r4
  int v5; // r7
  ...
  v5 = dword_123BB8;
  v6 = a1[4];
  *(_DWORD *)(dword_123BB4 + v3) = dword_123BB8;
  if ( a2 >= 0x10000 )
    a2 = 0x10000;
  v7 = (int *)(v4 + v3);
  v8 = a2 - 4096;
