// v23 annotated: rf_cmd_send_nf4 @ 0x112a0c
// Original: 112a0c_rf_cmd_send_nf4.c
...
int __fastcall rf_cmd_send_nf4(unsigned __int8 *a1, unsigned int a2, int a3)
{
  ...
  v3 = (unsigned __int16 *)rf_cmd_send_2b40;
  v4 = (unsigned __int8 *)off_112B44;
  v5 = rf_cmd_send_n230;
  ++*(_WORD *)rf_cmd_send_2b40;
  if ( a3 )
    v6 = 3;
  else
    v6 = 2;
  ...
  *v4 = 0;
  ...
  else
  {
    ...
    v11 = *a1 | v10;
    if ( *(_BYTE *)off_112B4C )
      a1 = (unsigned __int8 *)sub_11F74C(512, rf_cmd_send_n254, a2, v10);
    if ( v9 == 17 )
    {
      v12 = off_112B78;
