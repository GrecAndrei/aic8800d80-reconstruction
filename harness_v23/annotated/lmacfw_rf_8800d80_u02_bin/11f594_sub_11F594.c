// v23 annotated: sub_11F594 @ 0x11f594
// Original: 11f594_sub_11F594.c
...
unsigned int __fastcall sub_11F594(unsigned int result, int a2, int a3, int a4)
{
  int v4; // r4
  int v5; // r9
  unsigned int v6; // r5
  ...
  while ( 1 )
  {
    ...
    {
      if ( !v24 )
        return (unsigned int)sub_10D654((_BYTE *)dword_11F734);
      v21 = dword_11F72C;
      v22 = 0;
      while ( 1 )
      {
...
LABEL_31:
    result = (unsigned int)sub_10D654((_BYTE *)dword_11F734);
    v24 -= v7;
    if ( !v24 )
      return result;
  }
  ...
  do
  {
    while ( 1 )
    {
      ...
      if ( v4 != 4 )
        break;
      v11 += 4;
      sub_11F504(dword_11F72C, *(_DWORD *)v10);
      v10 += 2;
      if ( v7 <= v11 )
        goto LABEL_18;
    }
...
LABEL_18:
  ...
  if ( v24 > 0xF )
  {
    sub_10D654((_BYTE *)dword_11F730);
    goto LABEL_26;
  }
LABEL_20:
  v14 = v4 - 1;
  v26 = v4;
  v15 = (_BYTE *)dword_11F748;
  v16 = 0;
  v17 = 16 - v7;
  do
  {
