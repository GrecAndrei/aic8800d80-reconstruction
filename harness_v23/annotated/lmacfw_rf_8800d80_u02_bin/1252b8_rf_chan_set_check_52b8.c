// v23 annotated: rf_chan_set_check_52b8 @ 0x1252b8
// Original: 1252b8_rf_chan_set_check_52b8.c
...
int __fastcall rf_chan_set_check_52b8(int a1, unsigned __int8 **a2)
{
  int v4; // r0
  unsigned int v6; // r4
  int v7; // r0
  ...
  if ( v4 == 1 )
  {
    if ( a1 > 3 )
    {
      v8 = parse_int(a2[2], nullptr, 0);
      v9 = parse_int(a2[3], nullptr, 0x10u);
  ...
  else
  {
    ...
    if ( v6 <= 0x1F )
    {
      if ( a1 > 3 )
      {
        v10 = parse_int(a2[3], nullptr, 0) + v6;
        if ( v10 >= 0x20 )
          v10 = 32;
