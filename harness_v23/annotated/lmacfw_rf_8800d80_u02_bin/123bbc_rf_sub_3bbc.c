// v23 annotated: rf_sub_3bbc @ 0x123bbc
// Original: 123bbc_rf_sub_3bbc.c
...
int rf_sub_3bbc()
{
  ...
  __int64 v38; // [sp+10h] [bp-Ch] BYREF

  v0 = (int *)off_123EAC;
  if ( *(_DWORD *)off_123EAC <= 0x17u )
    *(_DWORD *)off_123EAC = 1000;
  ...
  if ( v3 )
  {
    v5 = *(_DWORD **)(v3 + 28);
    v6 = v5[20];
    v7 = *(_DWORD *)off_123EB4;
    v8 = *(_DWORD *)off_123EB0;
    v5[16] = *(_DWORD *)off_123EB0;
    v9 = v6 >> 19 << 19;
    v5[20] = v9;
    if ( v7 )
    {
      v10 = *(_DWORD *)off_123EB8;
      v11 = v5;
LABEL_8:
      v12 = *(_DWORD *)off_123EC0;
      v5[12] = *(_DWORD *)off_123EBC;
      v5[20] = v10 | v9;
      v5[13] = v12;
    ...
    if ( v1 )
    {
      ...
      v27 = *(_BYTE *)(v7 + *(_DWORD *)off_123EF8 + v23)
          + *((_BYTE *)off_123F00 + 1)
          + *(_BYTE *)(dword_123ED8 + v37 + 11);
      v28 = v27;
      if ( *((_BYTE *)off_123EDC + 396) )
        v21 = (char)(v21 + *(_BYTE *)(*(_DWORD *)off_123EFC + v23));
LABEL_45:
      ...
      if ( v17 > 4 )
      {
        ...
        if ( (v5[16] & 0x600) == 0x400 )
          *(_DWORD *)off_123EB8 = *(_DWORD *)off_123EB8 & 0xFFFCFFFF | 0x20000;
      }
      else
      {
        v31 = off_123EB8;
...
LABEL_39:
    ...
    v27 = *(_BYTE *)(*(_DWORD *)off_123ED4 + v23 + v24) + *(_BYTE *)off_123F00 + *(_BYTE *)(dword_123ED8 + v37 + 8);
    v28 = v27;
    if ( *((_BYTE *)off_123EDC + 396) )
      v21 = (char)(v21 + *(_BYTE *)(*(_DWORD *)off_123EE0 + v23));
    goto LABEL_45;
  }
  return 1;
}
