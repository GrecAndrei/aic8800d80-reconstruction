// v23 annotated: sub_117164 @ 0x117164
// Original: 117164_sub_117164.c
// Primary struct: group_13 (cluster 13)
//
// sub_117164 @ 0x117164, size 266 bytes
_DWORD *__fastcall sub_117164(_DWORD *a1, int a2, _WORD *a3)
{
  int *v3; // r7
  int v4; // r10
  _DWORD *v5; // r6
  ...
  v5 = (_DWORD *)*a1;
  v6 = (__int16 **)off_117280;
  v7 = nullptr;
  *((_BYTE *)off_117270 + 32) = 1;
  v9 = 0;
  v25 = nullptr;
  while ( 1 )
  {
