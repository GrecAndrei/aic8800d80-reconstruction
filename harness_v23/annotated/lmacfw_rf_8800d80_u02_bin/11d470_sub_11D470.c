// v23 annotated: sub_11D470 @ 0x11d470
// Original: 11d470_sub_11D470.c
...
int sub_11D470()
{
  ...
  v0 = *(_DWORD *)off_11D59C;
  *(_DWORD *)off_11D5A0 = *(_DWORD *)off_11D59C;
  if ( (v0 & 0x400) != 0 )
    sub_126588();
  result = v0 << 23;
  if ( (v0 & 0x100) != 0 )
...
LABEL_9:
  ...
  {
    v6 = (char *)off_11D5C0;
    sub_1029DC(*((_BYTE *)off_11D5C0 + 411));
    v7 = v6[411];
    *((_BYTE *)off_11D5C4 + 9) = v7;
    return msg_parse(dword_11D5C8, v7);
  }
  if ( *(_BYTE *)off_11D5A8 )
  {
    result = *(_DWORD *)off_11D5AC << 28;
    if ( result )
      *((_BYTE *)off_11D5A8 + 6) = 1;
  }
LABEL_13:
