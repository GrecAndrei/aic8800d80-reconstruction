// v23 annotated: rf_init_handler_1 @ 0x11e66c
// Original: 11e66c_rf_init_handler_1.c
...
void rf_init_handler_1()
{
  ...
  v0 = (unsigned int *)sdio_buffer_prepare_split;
  v1 = *(_DWORD *)sdio_buffer_prepare_split;
  if ( *(_DWORD *)sdio_buffer_prepare_split )
  {
