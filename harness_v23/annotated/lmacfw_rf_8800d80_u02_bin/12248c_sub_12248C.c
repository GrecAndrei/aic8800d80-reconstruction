// v23 annotated: sub_12248C @ 0x12248c
// Original: 12248c_sub_12248C.c
...
int __fastcall sub_12248C(int a1, int a2)
{
  int v4; // r0
  int n_c8; // r0
  unsigned int v7; // r4

  if ( a1 <= 1 || (v4 = parse_int(*(unsigned __int8 **)(a2 + 4), nullptr, 0)) == 0 )
  {
  ...
  if ( v4 == 1 )
  {
    ...
    {
      v7 = parse_int(*(unsigned __int8 **)(a2 + 8), nullptr, 0);
      if ( v7 > 5 )
      {
