// v23 annotated: rf_msg_handler_n0ec @ 0x11c26c
// Original: 11c26c_rf_msg_handler_n0ec.c
...
int __fastcall rf_msg_handler_n0ec(int result)
{
  int v1; // r7
  int v2; // r5
  _BYTE *v3; // r6
  ...
  if ( (*((_BYTE *)off_11C310 + 88) & 0x20) == 0 && *((unsigned __int8 *)off_11C310 + 90) > 1u )
  {
    ...
    v5 = rf_setup_dispatch(70, *((_BYTE *)off_11C310 + 88) & 0x20, *((_BYTE *)off_11C310 + 88) & 0x20, 20);
    *(_BYTE *)v5 = 0;
