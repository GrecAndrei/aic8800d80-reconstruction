// v23 annotated: rf_calib_setup_n3d8 @ 0x1043d8
// Original: 1043d8_rf_calib_setup_n3d8.c
...
int __fastcall rf_calib_setup_n3d8(int a1, int a2, _DWORD *a3, _DWORD *a4, int a5, int a6)
{
  int *v7; // r6
  int v11; // r0
  int v12; // r1
