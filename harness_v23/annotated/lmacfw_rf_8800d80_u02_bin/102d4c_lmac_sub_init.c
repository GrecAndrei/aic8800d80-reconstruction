// v23 annotated: lmac_sub_init @ 0x102d4c
// Original: 102d4c_lmac_sub_init.c
...
int __fastcall lmac_sub_init(int a1, int a2, unsigned int a3, int a4)
{
  int v6; // r6
  int v7; // r4
  int v8; // r10
