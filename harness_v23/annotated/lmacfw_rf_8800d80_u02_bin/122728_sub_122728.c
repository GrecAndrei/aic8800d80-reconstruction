// v23 annotated: sub_122728 @ 0x122728
// Original: 122728_sub_122728.c
// Primary struct: <unclustered>
//
// sub_122728 @ 0x122728, size 1314 bytes
int __fastcall sub_122728(int a1, unsigned int a2, unsigned int a3, int a4)
{
  int v4; // r4
  int v5; // r5
  _DWORD *v6; // r6
        ...
        if ( (unsigned __int8)(a4 + 7) <= 0xEu )
        {
          if ( v4 )
          {
            ...
            else
            {
              ...
              *(_BYTE *)(*(_DWORD *)off_122C60 + 3 * a2 + a3) = a4;
            ...
            *(_BYTE *)(dword_122C5C + a2 + v61 + a3) = v59;
          }
          else
          {
            v68 = 0;
        ...
        if ( (unsigned __int8)(a4 + 7) <= 0xEu )
        {
          if ( v4 )
          {
            ...
            else
            {
              ...
              *(_BYTE *)(*(_DWORD *)off_122A64 + 6 * a2 + a3) = a4;
            ...
            *(_BYTE *)(dword_122A58 + 2 * (a2 + v28) + a3) = v26;
          }
          else
          {
            v68 = 0;
          ...
          if ( *((_BYTE *)off_122A74 + 36) == 1 && v30 == a3 )
  ...
  if ( !v4 )
  {
    ...
    else
    {
      ...
      do
      {
        ...
        {
          v56 = *v53++;
          *(_BYTE *)(*v49 + i + 3 * v51) = v56;
          v57 = *v49 + i;
          *v54++ = 15;
          msg_parse(v50, *(char *)(v57 + 3 * v51));
        }
        ++v51;
        v65 = (_DWORD *)((char *)v65 + 3);
        v52 += 3;
      }
      while ( v51 != 3 );
