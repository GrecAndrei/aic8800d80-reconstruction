// v23 annotated: sub_11E8B4 @ 0x11e8b4
// Original: 11e8b4_sub_11E8B4.c
...
unsigned int __fastcall sub_11E8B4(unsigned __int8 *a1, int a2, unsigned int a3)
{
  ...
  {
    v4 = *a1++;
    a3 = *(_DWORD *)(dword_11E8DC + 4 * (v4 ^ HIBYTE(a3))) ^ (a3 << 8);
  }
  while ( v3 != a1 );
  return a3;
}
