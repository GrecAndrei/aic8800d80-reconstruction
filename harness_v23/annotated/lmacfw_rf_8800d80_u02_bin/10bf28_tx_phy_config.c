// v23 annotated: tx_phy_config @ 0x10bf28
// Original: 10bf28_tx_phy_config.c
...
_DWORD *__fastcall tx_phy_config(_DWORD *result, unsigned int a2, int a3, int a4)
{
  int v4; // r6
  int v7; // r7
  int v8; // r3
...
LABEL_3:
      ...
      || (v8 = *(_DWORD *)off_10C174 << 21, (*(_DWORD *)off_10C174 & 0x400) != 0) )
    {
      if ( !v7 )
      {
        ...
        *((_BYTE *)v33 + 44) = 0;
        *((_BYTE *)v33 + 52) = 0;
        rf_rx_dc_calib((unsigned int *)v40, (_BYTE *)(a2 + 125), (int)v33);
