// v23 annotated: sub_11CDB8 @ 0x11cdb8
// Original: 11cdb8_sub_11CDB8.c
...
unsigned int __fastcall sub_11CDB8(unsigned int result)
{
  _DWORD *v1; // r6
  unsigned int v2; // r5
  int v3; // r2
  ...
  v1 = off_11CFE0;
  v2 = (unsigned __int8)*(_DWORD *)off_11CFE0;
  if ( result != v2 )
  {
    v3 = dword_11CFE4;
    v4 = dword_11CFE8;
    v5 = dword_11D018;
    *(_DWORD *)off_11D014 = ((0xF0 / result) << 8) & 0xF00 | *(_DWORD *)off_11D014 & 0xFFFFF0FF;
    ...
    *(_DWORD *)off_11CFEC = dword_11CFF0 & ((v6 * (unsigned __int16)(*(_DWORD *)off_11CFEC >> 8) / v2) << 8)
                          | *(_DWORD *)off_11CFEC & 0xFF0000FF;
    ...
    *v12 = (v6 * (*v12 & 0x3FF) / v2) & 0x3FF | *v12 & 0xFFFFFC00;
    ...
    {
      v13 = *(_DWORD *)off_11CFFC & 0xFFFFFFFC;
      if ( v6 > 0x3B )
        v14 = v13 | 1;
      else
        v14 = v13 | 2;
      *(_DWORD *)off_11CFFC = v14;
    }
    v15 = off_11D000;
    v16 = dword_11CFF0;
    v17 = dword_11D004;
    v18 = (unsigned int *)off_11D008;
    *(_DWORD *)off_11D000 = dword_11CFF0 & ((v6 * (unsigned __int16)(*(_DWORD *)off_11D000 >> 8) / v2) << 8)
                          | *(_DWORD *)off_11D000 & dword_11D004;
