// v23 annotated: rf_bus_init_n3fa @ 0x1103f4
// Original: 1103f4_rf_bus_init_n3fa.c
...
int __fastcall rf_bus_init_n3fa(int result)
{
  _DWORD *v1; // r4
  unsigned int v2; // r3
  int *v3; // r6
...
LABEL_2:
  ...
  while ( v2 <= 1 )
  {
    ...
    if ( !v8 )
    {
      result = sub_10DA6C(dword_11051C, *(_DWORD *)off_110518);
