// v23 annotated: mmio_clock_setup @ 0x100e00
// Original: 100e00_mmio_clock_setup.c
...
int __fastcall mmio_clock_setup(unsigned int a1, int a2)
{
  _DWORD *v2; // r3
  _DWORD *v3; // r2
  _DWORD *v4; // r5
  ...
  *(v6 - 1903) |= 8u;
  ...
  lmac_sub_init(1, 16, 16, *(_DWORD *)off_101098);
  ...
  v15 = *(_BYTE *)off_10109C & 0xC0;
  if ( v15 == 192 )
    v12 = dword_1010A0;
  *(_DWORD *)off_1010A8 = *(_DWORD *)off_1010A8 & 0xFE01FFFF | (*(unsigned __int8 *)(v12 + v11) << 17);
  v16 = v11 + v12;
  ...
  *(_DWORD *)((char *)v24 + 0xFFFFFFEC) = *(_DWORD *)((char *)v24 + 0xFFFFFFEC) & 0xFFFFE3FF | 0x800;
