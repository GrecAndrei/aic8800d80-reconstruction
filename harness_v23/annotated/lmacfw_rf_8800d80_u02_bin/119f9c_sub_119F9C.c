// v23 annotated: sub_119F9C @ 0x119f9c
// Original: 119f9c_sub_119F9C.c
// Primary struct: <unclustered>
//
// sub_119F9C @ 0x119f9c, size 130 bytes
int __fastcall sub_119F9C(int a1, unsigned __int8 *a2, int a3, int a4)
{
  int v7; // r2
  _WORD *v8; // r5
  int result; // r0
