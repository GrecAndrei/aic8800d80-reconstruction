// v23 annotated: rf_bus_reset2_0 @ 0x111304
// Original: 111304_rf_bus_reset2_0.c
...
int rf_bus_reset2_0()
{
  ...
  v0 = rf_bus_setup_3f8;
  *((_DWORD *)rf_bus_setup_3f8 + 4) |= 1u;
  while ( (v0[4] & 1) != 0 )
    ;
  v1 = rf_bus_setup_3f8;
  while ( *((int *)rf_bus_setup_3f8 + 4) >= 0 )
    ;
  v2 = rf_bus_setup_3f8;
  *((_DWORD *)rf_bus_setup_3f8 + 3) |= 0x40000007u;
...
LABEL_11:
  ...
  if ( v5 != 6 )
    goto LABEL_11;
  v4[6] = rf_bus_write2_n_127;
  v7 = rf_bus_write_n_6b;
  v4[513] &= ~2u;
  v4[513] |= 0x8000u;
  v4[2] = 46;
  v4[2] |= 1u;
