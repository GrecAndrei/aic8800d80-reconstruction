// v23 annotated: log_pool_alloc2_a18 @ 0x10fa18
// Original: 10fa18_log_pool_alloc2_a18.c
...
_DWORD *__fastcall log_pool_alloc2_a18(int a1, unsigned int a2)
{
  unsigned int v2; // r6
  _DWORD *v3; // r5
...
LABEL_12:
  ...
  v6 = (int *)off_10FBA8;
  v7 = *v4;
  v3 = *(_DWORD **)off_10FBA8;
  v8 = *(_DWORD *)off_10FBA8 + 1;
  *(_DWORD *)off_10FBA8 = v8;
  if ( !v7 )
  {
    if ( v8 )
    {
  ...
  v3 = *((_DWORD **)v4 + 2);
  v10 = *(_DWORD *)off_10FBAC;
  if ( *(_DWORD *)off_10FBAC <= (unsigned int)v3 && (unsigned int)v3 <= *((_DWORD *)off_10FBAC + 1) + v10
    || (unsigned int)v3 >= *(_DWORD *)off_10FBB0
    && (unsigned int)v3 <= *(_DWORD *)off_10FBB0 + *((_DWORD *)off_10FBB0 + 1) )
  {
    *((_DWORD *)v4 + 2) = *v3;
    *v4 = v7 - 1;
  ...
  {
    sub_10DA6C(dword_10FBB4, *((_DWORD *)v4 + 2));
    v10 = *v9;
    v14 = *v4 - 1;
...
LABEL_18:
  ...
  v16 = *(_DWORD *)off_10FBB0;
  if ( *(_DWORD *)off_10FBB0 > (unsigned int)v3 || *((_DWORD *)off_10FBB0 + 1) + v16 < (unsigned int)v3 )
  {
...
LABEL_37:
  ...
  {
LABEL_36:
    if ( (unsigned int)v3 > v16 + *((_DWORD *)off_10FBB0 + 1) )
      goto LABEL_37;
LABEL_20:
    *((_BYTE *)v3 - 3) = -86;
  }
