// v23 annotated: rf_bus_write_60fc @ 0x1160fc
// Original: 1160fc_rf_bus_write_60fc.c
// Primary struct: <unclustered>
//
// rf_bus_write_60fc @ 0x1160fc, size 502 bytes
// Doc: rf_bus_write_60fc [rf]: Writes value to RF bus register
// rf_bus_write_60fc [rf]: Writes value to RF bus register
int __fastcall rf_bus_write_60fc(int a1, int a2)
{
    ...
    if ( v12 < 0 )
    {
      ...
      switch ( v14 )
      {
          ...
          if ( v15 )
          {
            if ( *(_DWORD *)off_1162F8 )
            {
              ...
              *(_DWORD *)(v18 + 8) = 12;
              ...
              ++*(_DWORD *)off_116324;
              msg_parse(v3, v8);
              v27 = list_push_tail(dword_11630C);
        ...
        case 1:
          v32 = v11 & 0xF;
          v33 = v12 & 0x3FFFFFFF;
          rf_chan_setup_init(18, (int)&v32, 8);
          msg_parse(v3, v8);
          break;
        case 3:
          **(_DWORD **)off_1162F4 = v11 & 0xF;
          mmio_write0x40035100_set0x100();
          break;
      }
    }
    sub_115314(v8);
