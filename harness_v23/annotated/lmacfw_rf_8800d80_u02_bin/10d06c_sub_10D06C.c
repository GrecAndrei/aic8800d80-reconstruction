// v23 annotated: sub_10D06C @ 0x10d06c
// Original: 10d06c_sub_10D06C.c
...
int __fastcall sub_10D06C(unsigned __int16 *a1)
{
  ...
  v41 = off_10D340;
  while ( !*(_DWORD *)off_10D340 )
    ;
  if ( !*(_DWORD *)(*(_DWORD *)off_10D344 + 516) )
  {
  ...
  v42 = sub_11E7AC(*(_DWORD *)off_10D344 + 516);
...
LABEL_3:
  if ( v3 == 1 )
  {
    if ( a1[5] <= 0x6Cu )
      ...
      v6 = (*(int (__fastcall **)(_DWORD))(*(_DWORD *)(*(_DWORD *)off_10D360 + 8) + 16))(*(_DWORD *)(*(_DWORD *)off_10D360 + 4));
    if ( !v6 )
      goto LABEL_59;
    v34 = a1[3];
    v35 = a1[4];
    *(_DWORD *)(v6 + 12) = dword_10D364;
    v36 = *v1;
    *(_WORD *)(v6 + 6) = v34;
    *(_WORD *)(v6 + 8) = v35;
    v5 = v6 + 4;
...
LABEL_5:
  ...
  if ( a1[5] <= 0x6Cu )
    ...
    v6 = (*(int (__fastcall **)(_DWORD))(*(_DWORD *)(*(_DWORD *)off_10D360 + 8) + 16))(*(_DWORD *)(*(_DWORD *)off_10D360
                                                                                                 + 4));
  if ( !v6 )
  {
LABEL_59:
...
LABEL_16:
  ...
  while ( !*(_DWORD *)off_10D340 )
    ;
  list_push_tail(*(_DWORD *)off_10D344 + 524);
  v11 = off_10D348;
  *v10 = 1;
  *v11 = 2;
  v9 = **v1;
