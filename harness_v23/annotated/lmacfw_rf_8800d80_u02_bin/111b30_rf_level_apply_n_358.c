// v23 annotated: rf_level_apply_n_358 @ 0x111b30
// Original: 111b30_rf_level_apply_n_358.c
// Primary struct: <unclustered>
//
// rf_level_apply_n_358 @ 0x111b30, size 1958 bytes
// Doc: rf_cmd_wait_n308 [rf]: Wait for RF command completion, poll status registers
// rf_cmd_wait_n308 [rf]: Wait for RF command completion, poll status registers
int __fastcall rf_level_apply_n_358(__int64 a1)
{
  int *v1; // r9
  int v3; // r4
  ...
  int v34; // r3
  int v35; // r1
  int (__fastcall *v36)(_DWORD, _DWORD); // r3
  _BYTE *v37; // r3
  _WORD *v38; // r3
  void *v39; // r2
  int v40; // r4
  ...
  unsigned int v53; // r1
  _DWORD *v54; // r2
  void (__fastcall *v55)(unsigned __int8 *); // r3
  _DWORD *v56; // r2
  int v57; // r0
  _DWORD *v58; // r3
  unsigned int v59; // r0
  ...
  if ( (_DWORD)a1 )
  {
    v4 = (unsigned __int8 *)rf_bus_reset_n_4b4;
    v16 = *(unsigned __int8 *)rf_bus_reset_n_4b4;
    if ( v16 == 2 )
    {
    ...
    if ( v16 == 4 )
    {
      ...
      v50 = *((_WORD *)rf_bus_reset_n_4b4 + 5);
      ...
      *((_WORD *)rf_bus_reset_n_4b4 + 5) = v52;
      if ( HIDWORD(a1) < v52 )
      {
      ...
      LODWORD(a1) = rf_bus_reset2_n101(*((_DWORD *)v4 + 1) + v52, v53);
rf_bus_setup_n42c:
      if ( (v3 & 0x20) == 0 )
        return a1;
LABEL_19:
      if ( *v4 == 6 )
      {
        v28 = *(_DWORD **)rf_bus_write_n_89;
        v29 = *(_DWORD *)rf_bus_reset_n_4a4;
        v30 = off_111E44;
        *v28 = rf_bus_reset_n_4a0;
        v28[1] = v29;
        v30[709] = v28;
        v30[706] = v30[706];
        v30[704] |= 0x84000000;
    ...
    *(_BYTE *)rf_bus_reset_n_4b4 = 0;
    ...
    if ( *(_BYTE *)HIDWORD(a1) )
    {
      v24[513] = (16 * (unsigned __int8)*(_BYTE *)HIDWORD(a1)) & 0x70 | v24[513] & 0xFFFFFF8F;
      *(_BYTE *)HIDWORD(a1) = 0;
    }
  }
  else
  {
    ...
    {
      v18 = off_111E44;
      if ( (*((_DWORD *)off_111E44 + 708) & 0x7F) == 0x40 )
      {
        v19 = *((_DWORD *)off_111E44 + 708);
        LODWORD(a1) = v19 << 12;
        if ( (v19 & 0x80000) != 0 )
        {
          LODWORD(a1) = *(_DWORD *)rf_bus_reset_n_4a4;
          v20 = *(_DWORD **)rf_bus_write_n_89;
    ...
    {
      v4 = (unsigned __int8 *)rf_bus_reset_n_4b4;
      v17 = *(unsigned __int8 *)rf_bus_reset_n_4b4;
...
rf_bus_setup_358:
      if ( (v3 & 0x40) != 0 )
        v6 = (unsigned __int8 *)(*((_DWORD *)off_111E44 + 709) - 8);
      else
        v6 = *(unsigned __int8 **)(*(_DWORD *)v5 + 4);
      *((_DWORD *)v4 + 1) = 0;
      *((_DWORD *)v4 + 2) = 0;
      *v4 = 2;
      ...
      v4[13] = v6[1];
      *((_WORD *)v4 + 7) = v6[2] | (v6[3] << 8);
      *((_WORD *)v4 + 8) = v6[4] | (v6[5] << 8);
      v8 = v6[6] | (v6[7] << 8);
      *((_WORD *)v4 + 9) = v8;
      if ( !v8 && (v4[12] & 0x80u) != 0 )
      ...
      v11 = *((int (__fastcall **)(void *))rf_bus_reset_1e48 + 3);
      *((_DWORD *)off_111E44 + 517) &= ~0x10u;
      v9[516] &= ~0x10u;
      if ( v11 && v11(rf_bus_reset_n_4b4) )
      {
LABEL_46:
        v25 = *v4;
        switch ( v25 )
        {
          case 3:
            if ( !*((_DWORD *)v4 + 1) )
              *((_DWORD *)v4 + 1) = rf_bus_reset_n_490;
            goto LABEL_50;
          case 4:
LABEL_87:
            rf_bus_reset2_n101(*((_DWORD *)v4 + 1), *((unsigned __int16 *)v4 + 4));
            goto LABEL_50;
          case 7:
LABEL_73:
            sub_111218();
...
LABEL_56:
      ...
      {
        case 0u:
          if ( *(_BYTE *)off_111E64 == 4 )
          {
            v31 = v4[12] & 0x1F;
            if ( v31 != 1 )
            {
              if ( v31 != 2 )
                goto rf_bus_reset_e98;
...
LABEL_97:
                ...
                {
                  v32 = rf_bus_reset_n_174_217c;
                  *(_WORD *)rf_bus_reset_n_174_217c = 1;
                  goto LABEL_68;
                }
              }
            }
...
LABEL_59:
                  if ( v13 != 4 )
                    goto LABEL_49;
                  goto rf_bus_reset_1e6c;
                }
                v32 = rf_bus_reset_n_174_217c;
                *(_WORD *)rf_bus_reset_n_174_217c = *(unsigned __int8 *)rf_bus_reset_n_178;
LABEL_68:
                *((_DWORD *)v4 + 1) = v32;
                *((_WORD *)v4 + 4) = 2;
                *v4 = 4;
...
LABEL_45:
          ...
          v32 = rf_bus_reset_n_8;
          *(_WORD *)rf_bus_reset_n_8 = 0;
          goto LABEL_68;
        case 1u:
          if ( *(_BYTE *)off_111E64 != 4 && *((_WORD *)v4 + 8) )
            goto LABEL_54;
          if ( (v4[12] & 0x1F) != 2 || *((_WORD *)v4 + 7) )
            goto LABEL_79;
          sub_111694((int *)((*((unsigned __int16 *)v4 + 8) >> 7) & 1), *((_WORD *)v4 + 8) & 0xF);
          *v4 = 7;
          if ( v14 == 4 )
            goto LABEL_44;
          goto LABEL_73;
...
rf_bus_reset_1e6c:
            ...
            sub_111670((int *)((*((unsigned __int16 *)v4 + 8) >> 7) & 1), *((_WORD *)v4 + 8) & 0xF);
            *v4 = 7;
            if ( v14 != 4 )
              goto LABEL_73;
          }
...
LABEL_89:
            ...
            *(_BYTE *)rf_bus_reset_22ec = HIBYTE(*((_WORD *)v4 + 8));
            *v4 = 7;
            if ( v13 != 4 )
              goto LABEL_73;
          }
LABEL_44:
        ...
        case 5u:
          ...
          *((_DWORD *)rf_bus_reset_n_170 + 512) = (16 * v35) & 0x7F0
                                                | *((_DWORD *)rf_bus_reset_n_170 + 512) & 0xFFFFF80F;
          *v4 = 7;
          if ( v35 )
            *v12 = 3;
          else
...
LABEL_156:
          v61 = MEMORY[0x3C];
LABEL_157:
          v62 = *(_DWORD *)(*(_DWORD *)(v61 + 8) + 8);
          v63 = *(_DWORD *)(*(_DWORD *)(v61 + 8) + 12);
          v64 = *(int **)v62;
          v65 = *(signed int **)(v62 + 8);
          v66 = *(int ***)(*(_DWORD *)(v62 + 28) + 12);
          v67 = *v66;
          v68 = v66[1];
          v69 = v66[2];
          v71 = v66 + 3;
          ...
          *v76 = v67;
          ...
          v76[3] = v75;
          v76[4] = (int *)v63;
          v77 = (int *)(8 * (_DWORD)(v76 + 5));
          *v77 = v73;
          v77[1] = (int)_R2;
          v77[2] = (int)v70;
          v77[3] = v63;
          v78 = (int *)(8 * (_DWORD)(v77 + 4));
          *v78 = v73;
          v78[1] = (int)v75;
          v78[2] = (int)v70;
          v78[3] = v63;
...
LABEL_164:
                      ...
                      *v95 = v70;
                      ...
                      v96 = (signed int **)(8 * (_DWORD)(v95 + 2));
                      *v96 = _R2;
                      v96[1] = v65;
                      v96[2] = v70;
                      v96[3] = (signed int *)v63;
                      v97 = (signed int *)(8 * (_DWORD)(v96 + 4));
                      *v97 = v85;
                          ...
                          if ( !_VF )
                          {
                            *(signed int *)((char *)v65 + MEMORY[0x18]) = 0;
                            ...
                            if ( (v219 & 0x8000) == 0 )
                            {
                              ...
                              {
                                *(_DWORD *)(v222 + MEMORY[0x8B0002E1]) = v221;
                                if ( v222 >= 0 )
                                {
                                  __asm { LDCL            p3, c0, [LR,#-0x168] }
                                  *(_DWORD *)(v222 + *(unsigned __int16 *)((v223 >> 16 << 11) + 0x18)) = *(unsigned __int16 *)((v223 >> 16 << 11) + 0x18);
                                  __asm { LDCL            p3, c0, [LR,#-0x168] }
                                  JUMPOUT(0x13440E);
                                }
                              }
...
LABEL_354:
                        ...
                        else
                        {
                          if ( v185 != 0 && v184 )
                          {
                            v154 = *(_DWORD **)(*(_DWORD *)(*(_DWORD *)(v75[1] + 24) + 12) + 12);
...
LABEL_258:
                            ...
                            v63 = *(_DWORD *)(v63 + 12);
LABEL_259:
                            v155 = *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(v63 + 4) + 4) + 4) + 4);
                            v70 = *(signed int **)v155;
                            v156 = v155 + 4;
                            v63 = *(_DWORD *)(v155 + 4);
                            v157 = 8 * *(_DWORD *)(v156 + 4);
                            *_R2 = v85;
...
LABEL_213:
                    ...
                    __mcr(0, 7, v85, 0, 15, 7);
LABEL_334:
                    v203 = *(signed int **)(*(_DWORD *)(*(_DWORD *)v63 + 16) + 16);
                    v204 = *v203;
                    v205 = v203[1];
                    v206 = v203[2];
                    v207 = v203[3];
                ...
                else
                {
                  if ( v116 != 0 && _CF )
                  {
                    v63 = *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(v75[1] + 24) + 4) + 12) + 12);
LABEL_159:
...
LABEL_160:
                    ...
                    v73 = *(_DWORD *)(v63 + 4);
                    v65 = *(signed int **)(v63 + 8);
                    v86 = *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)(v63 + 12) + 4) + 4) + 4);
                    v70 = *(signed int **)v86;
                    v87 = v86 + 4;
                    v63 = *(_DWORD *)(v86 + 4);
                    v88 = 8 * *(_DWORD *)(v87 + 4);
            ...
            else
            {
              if ( v149 != 0 && v148 )
              {
                v63 = **(_DWORD **)(*(_DWORD *)(*(_DWORD *)(v75[2] + 16) + 12) + 28);
LABEL_199:
                v65 = *(signed int **)(v63 + 8);
                v70 = *(signed int **)(v63 + 12);
                v63 += 20;
LABEL_200:
                v118 = *(signed int **)(*(_DWORD *)(*(_DWORD *)(*(_DWORD *)v63 + 16) + 16) + 16);
                v85 = *v118;
...
LABEL_211:
        ...
        case 8u:
          *((_DWORD *)v4 + 1) = rf_bus_reset_n_164;
          *((_WORD *)v4 + 4) = 2;
          *v4 = 4;
          goto LABEL_86;
        case 9u:
        ...
        case 0xAu:
          if ( *(_BYTE *)off_111E64 != 4 )
            goto LABEL_54;
          v38 = rf_bus_reset_n_16c;
          *v4 = *(_BYTE *)off_111E64;
          v39 = rf_bus_reset_n_168;
          *((_WORD *)v4 + 8) = *v38;
          *((_DWORD *)v4 + 1) = v39;
          *((_WORD *)v4 + 4) = 1;
          goto LABEL_86;
        case 0xBu:
          v36 = (int (__fastcall *)(_DWORD, _DWORD))v10[6];
          if ( !v36 || !v36(*((unsigned __int16 *)v4 + 8), *((unsigned __int16 *)v4 + 7)) )
            goto LABEL_54;
          v37 = rf_bus_reset_n_168;
          *(_WORD *)rf_bus_reset_n_16c = *((_WORD *)v4 + 8);
          *v37 = *((_WORD *)v4 + 7);
          *v4 = 7;
LABEL_72:
          if ( v14 != 4 )
            goto LABEL_73;
          goto rf_bus_reset_n_a4;
        default:
          goto LABEL_59;
      }
    }
    ...
    v5 = rf_bus_write_n_89;
    v4 = (unsigned __int8 *)rf_bus_reset_n_4b4;
    v21 = *(_DWORD **)rf_bus_write_n_89;
    if ( (*(_BYTE *)(*(_DWORD *)rf_bus_write_n_89 + 3) & 1) == 0 )
    {
      v22 = *(unsigned __int8 *)rf_bus_reset_n_4b4;
      switch ( v22 )
      {
        case 2:
          goto rf_bus_setup_358;
        case 3:
          v43 = *((unsigned __int16 *)rf_bus_reset_n_4b4 + 5);
          v44 = (int *)off_112190;
          v45 = 64 - *(unsigned __int16 *)v21;
          if ( v45 >= (unsigned __int16)(*((_WORD *)rf_bus_reset_n_4b4 + 4) - v43) )
            LOWORD(v45) = *((_WORD *)rf_bus_reset_n_4b4 + 4) - v43;
          sub_1282E8(v43 + *((_DWORD *)rf_bus_reset_n_4b4 + 1), *(_DWORD *)off_112190, (unsigned __int16)v45);
          v46 = *((unsigned __int16 *)v4 + 4);
          v47 = (unsigned __int16)(v45 + *((_WORD *)v4 + 5));
          *((_WORD *)v4 + 5) = v47;
          if ( v46 == v47 )
          {
            v55 = *((void (__fastcall **)(unsigned __int8 *))off_1122DC + 4);
            if ( v55 )
              v55(v4);
            LODWORD(a1) = v3 << 26;
            if ( (v3 & 0x20) == 0 )
