// v23 annotated: check_param_eq1 @ 0x124244
// Original: 124244_check_param_eq1.c
...
unsigned int __fastcall check_param_eq1(unsigned int result, unsigned int a2, int a3)
{
  int v3; // r2
  int v4; // r3
  int v5; // r2
