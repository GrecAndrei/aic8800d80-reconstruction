// v23 annotated: sub_109738 @ 0x109738
// Original: 109738_sub_109738.c
// Primary struct: <unclustered>
//
// sub_109738 @ 0x109738, size 610 bytes
int __fastcall sub_109738(unsigned int a1, float *a2, float *a3, int a4)
{
  float v4; // s13
  float v5; // s14
  float v10; // s15
  ...
  *(_BYTE *)(a4 + 2) = (unsigned int)(float)(v10 - v5);
  ...
  if ( v16 > 0.0 )
  {
    ...
    if ( !sub_127B04(v17, HIDWORD(v17), dword_1099A0, dword_1099A4) )
      goto LABEL_11;
    v16 = flt_1099A8;
    goto LABEL_10;
  }
  v38 = sub_127570(-v16);
  if ( sub_127B04(v38, HIDWORD(v38), dword_1099A0, dword_1099A4) )
  {
    v16 = flt_1099B8;
LABEL_10:
    v20 = dword_1099AC;
...
LABEL_11:
  ...
  if ( a1 > 0xD && v24 < 20.0
    || (v31 = sub_127570(LODWORD(v24)), (result = sub_127B04(v31, HIDWORD(v31), dword_1099A0, dword_1099A4)) != 0) )
  {
    v26 = dword_1099B0;
    *(_BYTE *)a4 |= 8u;
