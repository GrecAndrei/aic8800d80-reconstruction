// v23 annotated: rf_init_msg_send @ 0x1196ac
// Original: 1196ac_rf_init_msg_send.c
...
int __fastcall rf_init_msg_send(int a1, int a2, int a3, int a4)
{
  _BYTE *v4; // r4
  ...
  v9 = 0;
  v10 = 0;
  v4 = (_BYTE *)rf_setup_dispatch(116, a4, a3, 6);
