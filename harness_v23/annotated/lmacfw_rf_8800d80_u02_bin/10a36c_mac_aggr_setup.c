// v23 annotated: mac_aggr_setup @ 0x10a36c
// Original: 10a36c_mac_aggr_setup.c
// Primary struct: <unclustered>
//
// mac_aggr_setup @ 0x10a36c, size 572 bytes
// Doc: mac_aggr_setup [mac]: MAC aggregation/AMPDU setup with subframe type dispatch
// mac_aggr_setup [mac]: MAC aggregation/AMPDU setup with subframe type dispatch
int __fastcall mac_aggr_setup(int a1, unsigned int a2, unsigned __int8 *a3, int *a4)
{
