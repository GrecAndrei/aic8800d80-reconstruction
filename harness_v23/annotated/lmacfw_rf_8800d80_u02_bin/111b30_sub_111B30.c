// v23 annotated: sub_111B30 @ 0x111b30
// Original: 111b30_sub_111B30.c
...
int __fastcall sub_111B30(__int64 a1)
{
  int *v1; // r9
  int v3; // r4
  ...
  if ( (_DWORD)a1 )
  {
    ...
    if ( v16 == 4 )
    {
      ...
      *((_WORD *)off_111E3C + 5) = v52;
      ...
      LODWORD(a1) = sub_111404(*((_DWORD *)v4 + 1) + v52, v53);
LABEL_18:
      if ( (v3 & 0x20) == 0 )
        return a1;
LABEL_19:
      if ( *v4 == 6 )
      {
        v28 = *(_DWORD **)off_111E40;
        v29 = *(_DWORD *)off_111E4C;
        v30 = off_111E44;
        *v28 = dword_111E50;
        v28[1] = v29;
        v30[709] = v28;
  ...
  else
  {
    if ( (BYTE4(a1) & 0x21) == 0x21 )
    {
      ...
      if ( (*((_DWORD *)off_111E44 + 708) & 0x7F) == 0x40 )
      {
        ...
        if ( (v19 & 0x80000) != 0 )
        {
          LODWORD(a1) = *(_DWORD *)off_111E4C;
          v20 = *(_DWORD **)off_111E40;
          *v20 = dword_111E50;
          v20[1] = a1;
          v18[709] = v20;
          v18[706] = v18[706];
...
LABEL_7:
      ...
      *((_WORD *)v4 + 9) = v8;
      ...
      v9 = off_111E44;
      v10 = off_111E48;
      v11 = *((int (__fastcall **)(void *))off_111E48 + 3);
...
LABEL_46:
        ...
        switch ( v25 )
        {
          case 3:
            if ( !*((_DWORD *)v4 + 1) )
              *((_DWORD *)v4 + 1) = dword_111E60;
            goto LABEL_50;
          case 4:
LABEL_87:
            sub_111404(*((_DWORD *)v4 + 1), *((unsigned __int16 *)v4 + 4));
            goto LABEL_50;
          case 7:
LABEL_73:
            sub_111218();
...
LABEL_59:
                ...
                v32 = off_11217C;
                *(_WORD *)off_11217C = *(unsigned __int8 *)off_112178;
LABEL_68:
                *((_DWORD *)v4 + 1) = v32;
                *((_WORD *)v4 + 4) = 2;
                *v4 = 4;
...
LABEL_89:
            ...
            *(_BYTE *)off_1122EC = HIBYTE(*((_WORD *)v4 + 8));
            *v4 = 7;
            if ( v13 != 4 )
              goto LABEL_73;
          }
LABEL_44:
        ...
        case 5u:
          ...
          *((_DWORD *)off_112180 + 512) = (16 * v35) & 0x7F0 | *((_DWORD *)off_112180 + 512) & 0xFFFFF80F;
          *v4 = 7;
          if ( v35 )
            *v12 = 3;
          else
...
LABEL_72:
    ...
    v5 = off_111E40;
    v4 = (unsigned __int8 *)off_111E3C;
    v21 = *(_DWORD **)off_111E40;
    if ( (*(_BYTE *)(*(_DWORD *)off_111E40 + 3) & 1) == 0 )
    {
      ...
      switch ( v22 )
      {
        ...
        case 3:
          ...
          if ( v45 >= (unsigned __int16)(*((_WORD *)off_111E3C + 4) - v43) )
            LOWORD(v45) = *((_WORD *)off_111E3C + 4) - v43;
          sub_1282E8(v43 + *((_DWORD *)off_111E3C + 1), *(_DWORD *)off_112190, (unsigned __int16)v45);
