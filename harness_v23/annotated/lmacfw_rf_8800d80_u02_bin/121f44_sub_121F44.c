// v23 annotated: sub_121F44 @ 0x121f44
// Original: 121f44_sub_121F44.c
...
int __fastcall sub_121F44(int a1, int a2)
{
  unsigned int v4; // r5
  int v5; // r0
  int v7; // r3
  ...
  if ( a1 <= 2 )
  {
    v5 = rf_cmd_dispatch_n_34(*(_DWORD *)a2);
    if ( v5 >= 0 )
      goto LABEL_3;
LABEL_18:
...
LABEL_3:
    ...
    {
      sub_10DA6C(dword_12201C, v4, *(_DWORD *)v4);
      return 0;
    }
    else if ( v5 == 2 )
    {
