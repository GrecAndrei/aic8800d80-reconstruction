// v23 annotated: sub_12373C @ 0x12373c
// Original: 12373c_sub_12373C.c
...
int sub_12373C()
{
  ...
  _WORD v24[4]; // [sp+18h] [bp-8h] BYREF
  ...
  while ( 1 )
  {
    ...
    *v1 = v9;
    if ( is_flag_set_n645c() || !*(_BYTE *)off_1238C8 )
    {
      v10 = v2[1];
      v17 = *v2;
      v18 = v10;
      v11 = *(_DWORD *)(dword_1238CC + 4);
      v19 = *(_DWORD *)dword_1238CC;
      v20 = v11;
      ...
      if ( v13 == v3 && v22 == v12[3] && v23 == v12[4] && !*(_BYTE *)off_1238C8 )
      {
        if ( *(_BYTE *)off_1238D0 )
        {
          if ( *(_BYTE *)off_1238D0 == 3 && LOBYTE(v12[v14]) == 129 )
