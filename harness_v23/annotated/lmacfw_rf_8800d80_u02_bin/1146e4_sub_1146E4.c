// v23 annotated: sub_1146E4 @ 0x1146e4
// Original: 1146e4_sub_1146E4.c
...
int __fastcall sub_1146E4(int a1, int a2, unsigned int a3)
{
  _DWORD *v6; // r6
  int v7; // r5
  unsigned int v8; // r5
  ...
  _BYTE v14[120]; // [sp+14h] [bp-12Ch] BYREF
  int v15; // [sp+8Ch] [bp-B4h]
  int v16; // [sp+10Ch] [bp-34h]
  _BYTE v17[4]; // [sp+124h] [bp-1Ch] BYREF
  _BYTE v18[8]; // [sp+128h] [bp-18h] BYREF
  _BYTE v19[4]; // [sp+130h] [bp-10h] BYREF
  _BYTE v20[2]; // [sp+134h] [bp-Ch] BYREF
  _BYTE v21[10]; // [sp+136h] [bp-Ah] BYREF

  if ( !*(_DWORD *)off_114810 )
    lmac_state_get_n_e0();
  v6 = off_114814;
  v7 = dword_114818;
  MEMORY[0x1D8](*(_DWORD *)off_114814 + 4096, 320, &v11);
  if ( v11 == v7 )
  {
    v8 = a1 & 2;
    v12 |= a1;
