// v23 annotated: rf_init_or_config_n_318 @ 0x114318
// Original: 114318_rf_init_or_config_n_318.c
// Primary struct: <unclustered>
//
// rf_init_or_config_n_318 @ 0x114318, size 248 bytes
// Doc: rf_init_or_config_n_318 [rf]: RF subsystem initialization/configuration handler
// rf_init_or_config_n_318 [rf]: RF subsystem initialization/configuration handler
int __fastcall rf_init_or_config_n_318(int a1, int a2, unsigned int a3)
{
  int v6; // r4
  unsigned int v7; // r5
