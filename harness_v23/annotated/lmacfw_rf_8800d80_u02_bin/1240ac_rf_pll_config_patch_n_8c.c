// v23 annotated: rf_pll_config_patch_n_8c @ 0x1240ac
// Original: 1240ac_rf_pll_config_patch_n_8c.c
...
int __fastcall rf_pll_config_patch_n_8c(int a1)
{
  unsigned int *v1; // r1
  unsigned int *v2; // r4
  unsigned int v3; // r3
  ...
  v3 = *(_DWORD *)off_124130 & 0xFFFCFFFF;
  v4 = *(_DWORD *)off_124134 & 0xFFFFF9FF;
  *(_DWORD *)off_124134 = v4;
  *v1 = v3;
  switch ( a1 )
  {
    case 0:
