// v23 annotated: rf_init_hw_setup @ 0x1010d4
// Original: 1010d4_rf_init_hw_setup.c
...
unsigned int __fastcall rf_init_hw_setup(unsigned int a1)
{
  _DWORD *v1; // r1
  _DWORD *v2; // r2
  _DWORD *v3; // r3
  ...
  *v6 |= 1u;
  *v6 &= ~2u;
  *(_DWORD *)((char *)v4 + 0xFFFFFFA4) |= 0x40u;
  *v7 = *v7 & 0xFFC01FFF | 0x32000;
  *v8 &= ~0x8000u;
  *v8 |= 0x4000u;
  v9 = *(_BYTE *)off_101398 & 0xC0;
  if ( v9 == 192 )
    *(_DWORD *)((char *)v8 + 0xFFFFFFFC) = *(_DWORD *)((char *)v8 + 0xFFFFFFFC) & 0xFFF9FFFF | 0x40000;
  else
    *(_DWORD *)off_10139C = *(_DWORD *)off_10139C & 0xFFF9FFFF | 0x20000;
  v11 = off_1013A0;
  v12 = (unsigned int *)off_1013A4;
  v13 = off_1013A8;
  v14 = (unsigned int *)off_1013AC;
  *(_DWORD *)off_1013A0 = *(_DWORD *)off_1013A0 & 0xFFFFE3FF | 0x800;
    ...
    if ( a1 > 0x14C8 )
    {
      if ( a1 > 0x15C2 )
      {
        if ( a1 <= 0x1612 )
        {
          ...
          v37 = dword_10176C;
          v86 = off_101700;
          *(_DWORD *)off_101708 = dword_10175C;
          v22 = 0;
          v24 = 1610612736;
        }
        else
      ...
      else
      {
        ...
        v37 = dword_1013D8;
        v86 = off_1013B0;
        *(_DWORD *)off_1013B4 = dword_1013D0;
        v22 = 0x80000000;
        v24 = 1610612736;
      }
      v23 = (int *)v18;
...
LABEL_31:
  ...
  *(_DWORD *)off_10167C = *(_DWORD *)off_10167C & 0xFFFFFF00 | *(unsigned __int8 *)(v36 + v35);
  ...
  *v38 = *v38 & 0xFFFFFF00 | v39;
  ...
  v42 = *(_DWORD *)off_10168C & 0xFF00FFFF;
  if ( v34 <= 1 )
    v42 |= 0x1F0000u;
  v43 = off_101690;
  *(_DWORD *)off_10168C = v42;
  ...
  *v46 = v48;
  if ( a1 <= 0x15E4 )
  {
    ...
    if ( a1 <= 0x14D6 )
    {
      v78 = dword_101714;
      v79 = dword_101718;
      *(_DWORD *)off_10169C = dword_101710;
      v64[1] = v78;
      v80 = dword_10171C;
      v81 = dword_101720;
      v64[2] = v79;
    ...
    else
    {
      v66 = dword_1016DC;
      v67 = dword_1016E0;
      *(_DWORD *)off_10169C = dword_1016D8;
      v64[1] = v66;
      v68 = dword_1016E4;
      v69 = dword_1016E8;
      v64[2] = v67;
  ...
  else
  {
    ...
    v50 = dword_1016A4;
    v51 = dword_1016A8;
    *(_DWORD *)off_10169C = dword_1016A0;
    v49[1] = v50;
    v52 = dword_1016AC;
    v53 = dword_1016B0;
    v54 = off_1016B4;
