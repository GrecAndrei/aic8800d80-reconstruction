// v23 annotated: sub_13819C @ 0x13819c
// Original: 13819c_sub_13819C.c
...
_DWORD *sub_13819C()
{
  ...
  v0 = (unsigned __int8 *)off_1384B8;
  v1 = *((unsigned __int8 *)off_1384B8 + 3851);
  v2 = *(_DWORD *)off_1384B8;
  if ( v1 > 1 )
    return sub_137388(0);
  v3 = 0;
  while ( !*(_BYTE *)(v2 + 367) )
...
LABEL_59:
    ...
    if ( v1 == 1 )
    {
      *((_BYTE *)off_1384B8 + 3851) = 2;
      return sub_137388(0);
    }
    v1 = 1;
  }
  v4 = *(_DWORD *)off_1384B8;
  v5 = 0;
  while ( 1 )
  {
  ...
  *(_DWORD *)(v8 + 372) = *(_DWORD *)(v2 + 372);
  ...
  v23 = (unsigned __int8 *)off_1384D8;
  v24 = *(unsigned __int16 *)(*(_DWORD *)v0 + 364);
  v25 = off_1384BC;
  if ( v24 >= 0xC9 )
    v24 = 0;
  v26 = (unsigned __int8 *)off_1384D8;
  if ( v11 == 1 )
  {
    v27 = (char *)dword_1384C0;
    v11 = 8;
  }
  else
  {
    ...
    if ( *(_BYTE *)(*(_DWORD *)v0 + 369) )
      ...
      v27 = (char *)(dword_1384C0 - 4);
    if ( !*(_BYTE *)(*(_DWORD *)v0 + 369) )
      v11 = 12;
  }
  v28 = (char *)off_1384C4;
  *((_BYTE *)off_1384C4 + 20) = 1;
  v29 = v28 + 21;
  v25[1] = 8;
  v30 = v27 + 8;
  do
...
LABEL_46:
    sub_130580((int)&v65);
LABEL_50:
  v50 = (unsigned __int16 *)off_1384D0;
  sub_143630(v65, (char *)off_1384D0 + 3, *(unsigned __int16 *)off_1384D0);
  v51 = **(__int16 **)off_1384D4;
  v65 += *v50;
  v52 = v65 - (_DWORD)v25;
  if ( v51 < 0 && v52 > 0x12C )
  {
