// v23 annotated: sub_124FB4 @ 0x124fb4
// Original: 124fb4_sub_124FB4.c
// Primary struct: <unclustered>
//
// sub_124FB4 @ 0x124fb4, size 432 bytes
int __fastcall sub_124FB4(int result)
{
  int v1; // r9
  int v2; // r2
  int v3; // r3
  ...
  *(_BYTE *)off_125178 = 1;
LABEL_5:
  v6 = (unsigned __int8 *)dword_125164;
  v7 = dword_125168;
  v8 = off_125180;
...
LABEL_6:
    ...
    *(_BYTE *)(v17 + v16) = v18 | v19;
    ...
    if ( v23 < v17 )
    {
      ...
      *(_DWORD *)(dword_125170 + 8 * (v24 + v29) + 32) = v30;
      LOWORD(v23) = v15 >> 3;
    }
