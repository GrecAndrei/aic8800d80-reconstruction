// v23 annotated: sub_125D38 @ 0x125d38
// Original: 125d38_sub_125D38.c
// Primary struct: <unclustered>
//
// sub_125D38 @ 0x125d38, size 1438 bytes
_DWORD *__fastcall sub_125D38(_DWORD *result)
{
  __int16 **v1; // r9
  int v2; // r3
  int v3; // r2
  ...
  v71 = (int)result;
  if ( *((unsigned __int8 *)off_12604C + 90) <= 1u )
    return result;
  v1 = (__int16 **)off_126060;
  if ( **(__int16 **)off_126060 < 0 )
  {
...
LABEL_12:
  ...
  {
    result = off_1262E4;
    v74 = *(_DWORD *)(dword_1262E0 + 696 * *(unsigned __int8 *)(v71 + 116) + 8);
    v6 = *(unsigned __int8 *)(v2 + 24);
    v7 = v6 + 1;
    if ( v6 != 2 )
      goto LABEL_12;
...
LABEL_16:
  ...
  do
  {
    while ( 1 )
    {
      ...
      {
        v10 = *(_DWORD *)(dword_1262E0 + 696 * *(unsigned __int8 *)(v9 + 116) + 8);
      }
      if ( 2 * v74 <= v10 )
        v10 /= v10 / v74;
      v72 = (v10 >> 1) / v68;
...
LABEL_59:
      if ( **v1 < 0 )
      {
        if ( v11 == 2 )
        {
          result = (_DWORD *)sub_12F32C(dword_1262F8, dword_1262D8, 755);
          v65 = **v1;
          var4[0] = v10;
          var4[1] = v72;
          vars4 = *(_DWORD *)(v9 + 36);
        ...
        if ( v51 <= 0x1F )
          goto LABEL_62;
        result = (_DWORD *)sub_12F32C(dword_1262F0, dword_1262D8, 761);
      }
      else
      {
        result = *(_DWORD **)(v9 + 36);
...
LABEL_39:
  ...
  while ( 2 )
  {
    ...
    if ( !(v31 % v74) )
    {
      v55 = v28[4] + 32 * *(_DWORD *)off_1262F4;
      if ( v31 >= v74 )
        v31 = v74;
      v78 = v28[4] + 32 * *(_DWORD *)off_1262F4;
      v79 = v55 + 10000;
      v56 = sub_125BB4(v29, (unsigned int *)&v78, nullptr, v31);
      v57 = v29[1];
      if ( (int)(*v29 - v78) >= 0 )
        v58 = v31 - v56;
      else
...
LABEL_42:
    ...
    result = (_DWORD *)sub_12A4B4(v71, 1, 0, 255, v36, v37, v34);
    v39 = dword_126058;
    *v29 = v34;
    v29[1] = v34 + v37;
    v40 = (char)result;
    for ( j = 0; j != 4; ++j )
    {
      if ( ((v29[2] >> j) & 1) != 0 )
      {
        ...
        v78 = *(_DWORD *)(v39 + 36);
        v79 = v78 + 10000;
        result = (_DWORD *)sub_125BB4(v29, (unsigned int *)&v78, nullptr, v42);
        if ( **v1 < 0 && *(unsigned __int8 *)(v39 + 86) != 255 )
          result = (_DWORD *)sub_12F32C(dword_1262EC, dword_1262D8, 876);
        v43 = v78;
        v44 = v29[1];
