// v23 annotated: sub_1048E8 @ 0x1048e8
// Original: 1048e8_sub_1048E8.c
// Primary struct: <unclustered>
//
// sub_1048E8 @ 0x1048e8, size 978 bytes
int __fastcall sub_1048E8(int a1, int a2, _DWORD *a3, _DWORD *a4, int a5, int a6)
{
  int *v7; // r6
  int v11; // r0
  int v12; // r1
  ...
  v20 = ((int)((unsigned __int64)(dword_104C1C * (__int64)(0x2000 - v18)) >> 32) >> 9) - ((0x2000 - v18) >> 31);
  if ( a6 )
  {
    if ( v20 >= 5 )
      v20 = 5;
