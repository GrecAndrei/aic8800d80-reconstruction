// v23 annotated: sub_10F410 @ 0x10f410
// Original: 10f410_sub_10F410.c
...
int sub_10F410()
{
  ...
  while ( 2 )
  {
    ...
    if ( *((_BYTE *)off_10F6FC + 511) )
      goto LABEL_4;
    v6 = v26;
    v7 = (__int16 **)off_10F700;
    v8 = dword_10F704;
    v9 = 4;
    if ( !v26[326] )
    {
      ...
      do
      {
        while ( 1 )
        {
          ...
          if ( **v7 < 0 )
          {
            ...
            {
LABEL_54:
              sub_12D108(v8 + 8 * (87 * (__int16)v12 + v25 + 78));
              goto LABEL_23;
            }
          ...
          if ( (*(_WORD *)(v13 + 30) & 1) != 0 )
            goto LABEL_54;
LABEL_23:
          sub_12E948(dword_10F708, *(unsigned __int8 *)(v8 + 696 * v12 + 35), 696);
LABEL_24:
          if ( !v6[326] )
            goto LABEL_25;
        }
        sub_12E948(dword_10F718, *(unsigned __int8 *)(v14 + 35), v14);
...
LABEL_26:
      ...
      while ( 2 )
      {
        ...
        if ( v18[36] == 1 )
        {
          ...
          ++*v1;
          sub_12D190(v6 + 316);
          sub_12E948(dword_10F70C, *(unsigned __int8 *)(v8 + 696 * v17 + 35), v8 + 696 * v17);
          if ( *v1 )
          {
            v19 = *v1 - 1;
            v20 = *(_DWORD *)off_10F6F8;
            *v1 = v19;
            if ( !v19 )
            {
              if ( v20 )
          ...
          sub_12D108(v8 + 8 * (87 * (__int16)v17 + v9 + 73));
          goto LABEL_36;
        }
        if ( sub_13BF64(v17, *(unsigned __int8 *)(v16 + 27)) )
        {
          if ( (__get_CPSR() & 1) == 0 )
          {
            __disable_irq();
