// v23 annotated: sub_132BD8 @ 0x132bd8
// Original: 132bd8_sub_132BD8.c
// Primary struct: <unclustered>
//
// sub_132BD8 @ 0x132bd8, size 106 bytes
int __fastcall sub_132BD8(int result, _BYTE *a2, int a3)
{
  unsigned int v3; // r4
  unsigned int v4; // r2
  int v5; // r1
  ...
  *(_WORD *)(a3 + 170) = 0;
  ...
  if ( a2 )
  {
    if ( *((unsigned __int8 *)off_132C44 + 373) > 1u )
    {
      result = a2[2] & 3;
...
LABEL_29:
                  if ( v5 != 40 )
                  {
                    if ( v5 > 40 && *((_BYTE *)off_13231C + 373) == 4 )
                      goto LABEL_32;
                    goto LABEL_37;
                  }
                  if ( *((unsigned __int8 *)off_13231C + 373) > 2u )
                  {
                    *((_WORD *)v11 + 2) = v4;
                    v11[1] = 3;
                    *((_WORD *)v11 + 3) = 0;
