// v23 annotated: sub_11C498 @ 0x11c498
// Original: 11c498_sub_11C498.c
// Primary struct: <unclustered>
//
// sub_11C498 @ 0x11c498, size 748 bytes
int __fastcall sub_11C498(int a1, int a2)
{
...
LABEL_12:
  ...
  {
    v12 = off_11C788;
    v13 = HIBYTE(*(_DWORD *)off_11C788) & 7;
    v19 = v13 + 1;
    if ( v13 + 1 >= (unsigned int)v2[165] )
      v19 = v2[165];
    *(_DWORD *)off_11C788 = (v19 << 24) & 0x7000000 | *(_DWORD *)off_11C788 & 0xF8FFFFFF;
  }
  if ( BYTE1(v7) <= 4u )
  {
    v20 = *(_DWORD *)(a1 + 72);
    ...
    else
    {
      if ( *(_WORD *)(a1 + 4) )
      {
        ...
        {
          v38 = *(_DWORD *)(dword_11C790 + 696 * *(unsigned __int8 *)(a1 + 29) + 340);
          if ( **(__int16 **)off_11C78C < 0 && !*(_DWORD *)(dword_11C790 + 696 * *(unsigned __int8 *)(a1 + 29) + 340) )
          {
            v39 = v26;
...
LABEL_18:
    ...
    if ( !v2[199] )
      goto LABEL_8;
LABEL_19:
    *(_DWORD *)off_11C788 = (v2[164] << 24) & 0x7000000 | *(_DWORD *)off_11C788 & 0xF8FFFFFF;
    sub_12D190(v16 + 12 + v15);
    if ( !*(_WORD *)(a1 + 4) )
      return sub_118BA0();
    return sub_117DD8(a1, v7, v5);
