// v23 annotated: sub_119734 @ 0x119734
// Original: 119734_sub_119734.c
// Primary struct: <unclustered>
//
// sub_119734 @ 0x119734, size 326 bytes
int __fastcall sub_119734(int a1, int *a2, unsigned int a3, unsigned int a4, unsigned __int8 a5)
{
  int *v5; // r4
  int v6; // r5
  int v8; // r6
  ...
  *a2 = v22;
  ...
  if ( v10 )
    *(_DWORD *)(*(_DWORD *)(v8 + 32) - 3) = *((_DWORD *)off_119880 + 43);
