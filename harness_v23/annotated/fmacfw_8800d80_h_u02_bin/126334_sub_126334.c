// v23 annotated: sub_126334 @ 0x126334
// Original: 126334_sub_126334.c
// Primary struct: <unclustered>
//
// sub_126334 @ 0x126334, size 258 bytes
BOOL __fastcall sub_126334(int a1, int a2, int a3)
{
  int v6; // r5
  int v7; // r3
  int v8; // r9
  ...
  else
  {
    ...
    {
      v9 = *(_DWORD *)(dword_126440 + 696 * *(unsigned __int8 *)(v7 + 116) + 8);
      v8 = v9 >> 1;
    }
    v10 = *(_DWORD *)(a3 + 4);
