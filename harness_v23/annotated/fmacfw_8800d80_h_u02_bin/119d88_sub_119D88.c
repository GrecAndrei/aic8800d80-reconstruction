// v23 annotated: sub_119D88 @ 0x119d88
// Original: 119d88_sub_119D88.c
// Primary struct: <unclustered>
//
// sub_119D88 @ 0x119d88, size 440 bytes
int __fastcall sub_119D88(int a1)
{
  int v1; // r8
  int v2; // r3
  int v3; // r5
    ...
    if ( (v8 & 2) != 0 )
    {
      ...
      *(_WORD *)(v3 + 82) |= 2u;
      if ( v9[197] )
      {
        ...
        if ( v19 )
          *(_BYTE *)(v19 + 36) = sub_101CAC(
                                   (*(_DWORD *)(v19 + 20) >> 11) & 7,
                                   *(_DWORD *)(v19 + 20) & 0x7F,
                                   (unsigned __int8 *)(*(_DWORD *)(dword_119F44
  ...
  else
  {
    ...
    *(_WORD *)(v4 + 8) = v15 | 1;
    if ( (v15 & 2) != 0 )
    {
      ...
      *(_DWORD *)(v16 + 20) = v17;
      if ( v18[197] && v16 )
        *(_BYTE *)(v16 + 36) = sub_101CAC(
                                 (v17 >> 11) & 7,
                                 v17 & 0x7F,
                                 (unsigned __int8 *)(*(_DWORD *)(dword_119F44 + 1320 * *(unsigned __int8 *)(v3 + 28) + 72)
                                                   + 4));
