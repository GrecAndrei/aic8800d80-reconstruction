// v23 annotated: sub_12BEB0 @ 0x12beb0
// Original: 12beb0_sub_12BEB0.c
// Primary struct: <unclustered>
//
// sub_12BEB0 @ 0x12beb0, size 402 bytes
int __fastcall sub_12BEB0(int result, int a2, int a3, int a4)
{
  int v4; // r1
  int v5; // r4
  int v6; // r3
  ...
  v4 = *(_DWORD *)off_12C044;
  v5 = *(_DWORD *)off_12C048 & *(_DWORD *)off_12C044;
  v6 = dword_12C04C & v5;
  *((_DWORD *)off_12C044 + 1) = v5;
  if ( v6 )
  ...
  if ( (v5 & 0x10000000) != 0 )
  {
    v7 = *(_DWORD *)off_12C060;
    *((_BYTE *)off_12C064 + 30) |= *(_BYTE *)off_12C060 & 0x3F;
    result = sub_12CFC4(0x40000);
    *(_DWORD *)off_12C068 = v7;
  }
