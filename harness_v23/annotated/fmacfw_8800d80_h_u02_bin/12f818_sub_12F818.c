// v23 annotated: sub_12F818 @ 0x12f818
// Original: 12f818_sub_12F818.c
// Primary struct: <unclustered>
//
// sub_12F818 @ 0x12f818, size 172 bytes
int __fastcall sub_12F818(unsigned __int8 *a1, _DWORD *a2, unsigned int a3)
{
  int v3; // r5
  int v4; // r7
  int i; // r6
