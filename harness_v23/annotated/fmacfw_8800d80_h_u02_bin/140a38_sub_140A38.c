// v23 annotated: sub_140A38 @ 0x140a38
// Original: 140a38_sub_140A38.c
// Primary struct: <unclustered>
//
// sub_140A38 @ 0x140a38, size 116 bytes
int __fastcall sub_140A38(unsigned __int16 *a1, int a2, int a3)
{
  int result; // r0
  int v6; // r2
    ...
    && *(unsigned __int16 *)(a3 + 56) == a1[2] )
  {
    ...
    return v9 == v6 && !sub_1435D0(a3 + 59, &v10, v6);
  }
  return result;
}
