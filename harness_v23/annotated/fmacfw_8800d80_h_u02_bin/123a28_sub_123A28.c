// v23 annotated: sub_123A28 @ 0x123a28
// Original: 123a28_sub_123A28.c
// Primary struct: <unclustered>
//
// sub_123A28 @ 0x123a28, size 118 bytes
int __fastcall sub_123A28(int a1, void (__fastcall **a2)(int), int a3)
{
  __int16 **v3; // r5
  int result; // r0
  int v7; // r0
