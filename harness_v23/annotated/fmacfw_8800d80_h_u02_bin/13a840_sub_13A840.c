// v23 annotated: sub_13A840 @ 0x13a840
// Original: 13a840_sub_13A840.c
// Primary struct: <unclustered>
//
// sub_13A840 @ 0x13a840, size 346 bytes
_WORD *__fastcall sub_13A840(int a1, _WORD *a2, int a3)
{
  int v4; // r5
  int v5; // r3
  _WORD *v6; // r9
...
LABEL_17:
            v13 = *(_DWORD *)(a1 + 72) + 44;
          *(_DWORD *)(v13 + 12) = dword_13A9A4 & *(_DWORD *)(v13 + 12) | (unsigned __int8)v7[98];
        }
      }
    }
  }
