// v23 annotated: sub_137114 @ 0x137114
// Original: 137114_sub_137114.c
// Primary struct: <unclustered>
//
// sub_137114 @ 0x137114, size 628 bytes
_BYTE *__fastcall sub_137114(_BYTE *result, int a2, char a3, int a4)
{
  ...
  *(_DWORD *)(a4 + 52) = 0;
  ...
  {
    v9 = v37;
    result = (_BYTE *)sub_12DF40(bswap32(*((_DWORD *)v7 + 1)));
    if ( result )
    {
    ...
    {
      result = (_BYTE *)sub_12DF40(bswap32(*i));
      v11 -= 4;
      ++i;
      if ( result )
      {
    ...
    if ( v11 > 1 )
    {
      ...
      if ( v15 && v16 > 3 )
      {
        while ( 1 )
        {
          result = (_BYTE *)sub_12DE94((char *)bswap32(*v13));
          v16 -= 4;
          ++v13;
          if ( result )
          {
...
LABEL_69:
          ...
          result = (_BYTE *)sub_12DF40(bswap32(*v18));
          if ( result )
LABEL_28:
  ...
  else
  {
    ...
    if ( v20 )
    {
      ...
      *(_DWORD *)(a4 + 48) = 2;
      ...
      {
        result = (_BYTE *)sub_12DF40(bswap32(*j));
        v25 -= 4;
        ++j;
        if ( result )
        {
      ...
      if ( v25 > 1 )
      {
        ...
        if ( *(_WORD *)j )
        {
          if ( v25 > 5 )
          {
            ...
            do
            {
              result = (_BYTE *)sub_12DE94((char *)bswap32(*v27++));
              if ( result )
              {
                result = (_BYTE *)((1 << (char)result) | *(_DWORD *)(a4 + 48));
                *(_DWORD *)(a4 + 48) = result;
    ...
    else
    {
      ...
      if ( *((_WORD *)result + 2) && v31 > 3 )
      {
        do
        {
          result = (_BYTE *)sub_12DE94((char *)bswap32(*v32));
          v31 -= 4;
          ++v32;
          if ( result )
          {
      ...
      if ( v31 > 1 )
      {
        ...
        if ( v35 )
        {
          ...
          while ( 1 )
          {
            result = (_BYTE *)sub_12DF40(bswap32(*v33));
            v36 -= 4;
            ++v33;
            if ( result )
            {
