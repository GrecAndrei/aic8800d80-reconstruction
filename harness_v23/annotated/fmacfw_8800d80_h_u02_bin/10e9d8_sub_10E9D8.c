// v23 annotated: sub_10E9D8 @ 0x10e9d8
// Original: 10e9d8_sub_10E9D8.c
// Primary struct: <unclustered>
//
// sub_10E9D8 @ 0x10e9d8, size 260 bytes
int __fastcall sub_10E9D8(unsigned int *a1)
{
  _DWORD *v1; // r2
  int v2; // r7
  int v3; // r3
  ...
  *v4 &= ~1u;
  v16[0] = v6;
  v16[1] = 5610;
  sub_102970((unsigned __int16 *)v16, 0);
  v8 = (int *)off_10EAF4;
  v9 = dword_10EAF8;
  *v5 |= 0x80000000;
  *v8 = v9;
