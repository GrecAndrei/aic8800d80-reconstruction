// v23 annotated: sub_127818 @ 0x127818
// Original: 127818_sub_127818.c
// Primary struct: <unclustered>
//
// sub_127818 @ 0x127818, size 186 bytes
int __fastcall sub_127818(int result, __int16 a2)
{
  int v2; // r8
  int v3; // r7
  int v4; // r5
  ...
  v4 = dword_1278D8 + 1320 * v3;
  v5 = *(_BYTE *)(v4 + 85) & 0x60;
  if ( (*(_BYTE *)(v4 + 85) & 0x60) == 0 )
  {
    v6 = result;
    result = sub_12A058(dword_1278D8 + 1320 * v3, *(unsigned __int8 *)(result + 87));
    v8 = *(_DWORD *)(v6 + 92);
