// v23 annotated: sub_11FA78 @ 0x11fa78
// Original: 11fa78_sub_11FA78.c
// Primary struct: <unclustered>
//
// sub_11FA78 @ 0x11fa78, size 1108 bytes
int __fastcall sub_11FA78(int a1)
{
  int v2; // r6
  int *v3; // r8
  int v4; // r3
  ...
  else
  {
    if ( v4 != 4 )
    {
      ...
      if ( !*(_BYTE *)(v2 + 1320 * a1 + 106) )
      {
        ...
        v39 = (unsigned __int8)(*((_BYTE *)off_11FD88 + 17) - 1);
        *((_BYTE *)off_11FD88 + 17) = v39;
        v7 = v39 + v6;
        if ( v7 != 1 )
          goto LABEL_7;
        goto LABEL_40;
    ...
    *(_DWORD *)(v41 + 4) &= ~0x80u;
    ...
    else
    {
      ...
      *(_DWORD *)off_11FED4 = dword_11FED8;
      if ( v45 < 0 )
      {
        v6 = *(_DWORD *)off_11FEE0 & 0xF;
        if ( v6 )
        {
...
LABEL_40:
  ...
  v32 = *((_DWORD *)v5 + 2);
  v33 = *((_DWORD *)off_11FDB4 + 1) & 0xFFFFFFEF;
  *((_DWORD *)off_11FDB4 + 1) = v33;
  if ( v31 >= 0 || !(*(_DWORD *)off_11FEE0 << 28) )
  {
    v34 = off_11FDB8;
    *(_DWORD *)off_11FDC0 = v33 | *v30;
    v35 = off_11FDBC;
...
LABEL_42:
    ...
    v30[1] = v38;
    if ( v37 >= 0 || !(*(_DWORD *)off_11FEE0 << 28) )
    {
      *(_DWORD *)off_11FDC0 = v38 | *v30;
      goto LABEL_9;
    }
    sub_12F35C(dword_11FEE8, dword_11FEE4, 472);
    v7 = (unsigned __int8)v5[17] + (unsigned __int8)v5[18];
    *(_DWORD *)off_11FEDC = *v30 | v30[1];
    goto LABEL_7;
  }
  sub_12F35C(dword_11FEE8, dword_11FEE4, 472);
