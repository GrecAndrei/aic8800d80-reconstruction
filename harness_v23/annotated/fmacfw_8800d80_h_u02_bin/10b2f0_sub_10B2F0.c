// v23 annotated: sub_10B2F0 @ 0x10b2f0
// Original: 10b2f0_sub_10B2F0.c
// Primary struct: <unclustered>
//
// sub_10B2F0 @ 0x10b2f0, size 3884 bytes
int __fastcall sub_10B2F0(
        _DWORD *a1,
        int a2,
        int a3,
        int a4,
        ...
        __int64 *a11)
{
  ...
  v12 = dword_10B4E0;
  v13 = *(_DWORD *)off_10B4C0;
  v14 = dword_10B4F8;
  v15 = dword_10B4E4;
  *(_DWORD *)off_10B4C0 &= ~1u;
  v193 = v13 & 1;
  v16 = (int *)v201;
  sub_102BF8(0);
  v17 = dword_10B4DC;
...
LABEL_5:
  ...
  *v25 &= ~0x400u;
  ...
  while ( 2 )
  {
    ...
    if ( (*((_BYTE *)off_10C1B4 + 1) & 1) == 0 || (v163 = *(char *)off_10C1B4, v163 >= 0) )
    {
      v164 = dword_10C1CC;
    ...
    while ( 2 )
    {
      ...
      if ( v170 )
      {
        ...
        if ( v171 )
        {
          ...
          {
            v142 = (*(_BYTE *)off_10BE34 & 0xC0) == 192;
            v212 = 6;
            v213 = 6;
            if ( v142 )
              v143 = 768;
...
LABEL_15:
  ...
  sub_102C5C(0);
  v46 = dword_10B4F0;
  *(_DWORD *)off_10B4C0 = *(_DWORD *)off_10B4C0 & 0xFFFFFFFE | v193;
  sub_12EB90(1, v46);
