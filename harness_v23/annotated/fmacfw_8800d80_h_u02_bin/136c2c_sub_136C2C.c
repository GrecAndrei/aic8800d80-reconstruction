// v23 annotated: sub_136C2C @ 0x136c2c
// Original: 136c2c_sub_136C2C.c
// Primary struct: <unclustered>
//
// sub_136C2C @ 0x136c2c, size 246 bytes
int __fastcall sub_136C2C(int a1, int a2)
{
  int v2; // r3
  int v5; // r3
  int result; // r0
