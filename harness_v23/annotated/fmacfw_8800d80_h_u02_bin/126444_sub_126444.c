// v23 annotated: sub_126444 @ 0x126444
// Original: 126444_sub_126444.c
// Primary struct: <unclustered>
//
// sub_126444 @ 0x126444, size 378 bytes
int __fastcall sub_126444(int a1, int a2, int a3)
{
  _DWORD *v3; // r10
  int v4; // r5
  int v7; // r11
...
LABEL_18:
    ...
    v11 = 0;
LABEL_20:
    if ( *(_BYTE *)(a1 + 1224) && *(_BYTE *)(dword_1265C8 + 140 * *(unsigned __int8 *)(a1 + 1225) + 112) == 1 )
    ...
    {
      v21 = *(_DWORD *)(dword_1265CC + 696 * *(unsigned __int8 *)(a1 + 116) + 8);
    }
    a2 += v21;
    if ( !++v23 )
    {
