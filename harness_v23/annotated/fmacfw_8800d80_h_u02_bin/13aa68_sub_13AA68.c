// v23 annotated: sub_13AA68 @ 0x13aa68
// Original: 13aa68_sub_13AA68.c
// Primary struct: <unclustered>
//
// sub_13AA68 @ 0x13aa68, size 882 bytes
int __fastcall sub_13AA68(int a1, int a2)
{
  unsigned int v2; // r6
  int v5; // r3
  int v6; // r7
...
LABEL_11:
    ...
    v41 = 0;
    if ( v12 && (*((_BYTE *)off_13AD74 + 15) & 6) == 2 && (*(_WORD *)(*(_DWORD *)(a1 + 72) + 172) & 0xFC) == 0xB0 )
    {
    ...
    if ( v15 )
    {
      ...
      if ( v33 == 1 )
      {
        ...
        sub_143630(*(_DWORD *)(a1 + 72) + 164, *(_DWORD *)(a1 + 72) + 172, 24);
        v40 = 24;
      }
      else
      {
...
LABEL_22:
      ...
      v31 = sub_101CAC(v22, v21, (unsigned __int8 *)(*(_DWORD *)(v14 + 72) + 4));
...
LABEL_9:
  ...
  v24 = dword_13AD7C;
  v25 = (_BYTE *)(dword_13AD7C + 1320 * v2);
  if ( !v25[108] )
  {
...
LABEL_30:
    ...
    *(_DWORD *)(a1 + 44) = v28;
    if ( v29[197] )
    {
      v36 = sub_101CAC((v28[5] >> 11) & 7, v28[5] & 0x7F, (unsigned __int8 *)(*(_DWORD *)(v27 + 72) + 4));
      v30 = *(_WORD *)(a1 + 30);
      v28[9] = v36 | (v36 << 8);
    }
    else
...
LABEL_36:
  if ( (v30 & 1) == 0 )
    sub_13AA30(a1, (_WORD *)(*(_DWORD *)(a1 + 72) + 172));
  return sub_117424(a1, a2);
}
