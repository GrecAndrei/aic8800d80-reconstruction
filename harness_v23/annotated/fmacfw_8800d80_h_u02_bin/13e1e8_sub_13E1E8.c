// v23 annotated: sub_13E1E8 @ 0x13e1e8
// Original: 13e1e8_sub_13E1E8.c
// Primary struct: <unclustered>
//
// sub_13E1E8 @ 0x13e1e8, size 440 bytes
int __fastcall sub_13E1E8(int a1)
{
  int v1; // r4
  int v3; // r8
  int v4; // r3
  ...
  result = sub_13E180((unsigned __int8 *)a1);
...
LABEL_25:
  ...
  do
  {
    result = sub_13D950(a1, (unsigned __int16)v13, v7, v10);
