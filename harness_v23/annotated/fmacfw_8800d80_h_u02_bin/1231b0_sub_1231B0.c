// v23 annotated: sub_1231B0 @ 0x1231b0
// Original: 1231b0_sub_1231B0.c
// Primary struct: <unclustered>
//
// sub_1231B0 @ 0x1231b0, size 612 bytes
int __fastcall sub_1231B0(int a1, int a2, int a3, int a4)
{
  int v4; // r0
  int v6; // r1
  int v8; // r2
...
LABEL_16:
      ...
      if ( v12 == 6 )
      {
        ...
        sub_12E948(dword_123428, *(_DWORD *)(a2 + 704), *(unsigned __int8 *)(a2 + 668));
        if ( *(_DWORD *)(a2 + 704) )
        {
