// v23 annotated: sub_11A31C @ 0x11a31c
// Original: 11a31c_sub_11A31C.c
// Primary struct: <unclustered>
//
// sub_11A31C @ 0x11a31c, size 576 bytes
int __fastcall sub_11A31C(int a1, int *a2, unsigned int a3, unsigned int a4, unsigned __int8 a5)
{
  int v5; // r6
  int *v6; // r8
  int v7; // r4
...
LABEL_27:
          if ( *(_DWORD *)(dword_11A574 + 84 * a5 + 28) != v5 )
          {
            v35 = v26;
...
LABEL_15:
    ...
    *(_WORD *)(v5 + 10) = v22;
    ...
    if ( *(unsigned __int8 *)(v36 + 62) > (*(_DWORD *)off_11A564 & 0x3Fu) )
    {
      v25 = v16;
      v26 = *(_DWORD *)v7;
      goto LABEL_15;
  ...
  if ( *v11 < 0 && *(_DWORD *)(dword_11A574 + 84 * a5 + 28) != v5 )
    sub_12F32C(dword_11A578, dword_11A56C, 1119);
  v33 = *(_DWORD *)(v7 + 76);
  *a2 = *(_DWORD *)v7;
  *(_DWORD *)(v33 + 20) = 0;
