// v23 annotated: sub_141E00 @ 0x141e00
// Original: 141e00_sub_141E00.c
// Primary struct: <unclustered>
//
// sub_141E00 @ 0x141e00, size 160 bytes
int __fastcall sub_141E00(int a1, int a2, int a3, int a4)
{
  int v6; // r0
  int v7; // r1
  int v8; // r1
  ...
  v6 = sub_141A30((int)&v16, a1, a2, 6, *(_BYTE *)(a3 + 2));
