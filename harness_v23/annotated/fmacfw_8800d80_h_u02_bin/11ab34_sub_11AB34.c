// v23 annotated: sub_11AB34 @ 0x11ab34
// Original: 11ab34_sub_11AB34.c
// Primary struct: <unclustered>
//
// sub_11AB34 @ 0x11ab34, size 406 bytes
int __fastcall sub_11AB34(int result)
{
  _DWORD *v1; // r5
  __int16 **v2; // r6
  _DWORD *v3; // r4
  ...
  if ( result == 5 )
  {
    v1 = (_DWORD *)dword_11ACE4;
  }
  else
  {
    result *= 21;
    v1 = (_DWORD *)(dword_11ACCC + 4 * result);
  }
  ...
  {
    v6 = v3[17];
    v7 = *(int **)(v6 + 4 * ((unsigned __int8)*(_DWORD *)off_11ACD4 + 82));
    v8 = v7[19];
LABEL_10:
    v9 = v7[9];
    goto LABEL_11;
