// v23 annotated: sub_114C3C @ 0x114c3c
// Original: 114c3c_sub_114C3C.c
// Primary struct: <unclustered>
//
// sub_114C3C @ 0x114c3c, size 228 bytes
int __fastcall sub_114C3C(int a1, int a2, unsigned int a3)
{
  unsigned int v6; // r4
  ...
  if ( !*(_DWORD *)off_114D20 )
    sub_114AB8();
  MEMORY[0x1D8](*(_DWORD *)off_114D24 + 4096, 320, &v8);
  if ( v8 != dword_114D28 )
    return -1;
  if ( (v9 & a1) == 0 )
    return 1;
...
LABEL_15:
  sub_143630(a2 + v6, v14, 2);
  v6 += 2;
  if ( (a1 & 0x1000000) != 0 )
  {
LABEL_14:
    sub_143630(a2 + v6, v15, 10);
    v6 += 10;
  }
LABEL_11:
  if ( a3 < v6 )
