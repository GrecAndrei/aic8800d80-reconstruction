// v23 annotated: sub_11C254 @ 0x11c254
// Original: 11c254_sub_11C254.c
// Primary struct: <unclustered>
//
// sub_11C254 @ 0x11c254, size 208 bytes
unsigned int __fastcall sub_11C254(int a1, int a2, _DWORD *a3, _DWORD *a4, _DWORD *a5, int *a6)
{
  unsigned int v6; // r4
  int v7; // r8
  int v8; // r0
...
LABEL_3:
  *a5 = *(_DWORD *)(dword_11C330 + 696 * v7 + 12);
  return v9 + 6 * v11;
}
