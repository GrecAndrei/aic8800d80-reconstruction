// v23 annotated: sub_13E494 @ 0x13e494
// Original: 13e494_sub_13E494.c
// Primary struct: <unclustered>
//
// sub_13E494 @ 0x13e494, size 1282 bytes
unsigned int __fastcall sub_13E494(int a1, unsigned int a2, unsigned int a3, int a4, int a5)
{
  ...
  *(_WORD *)(a1 + 30) = v12;
  ...
  if ( **(__int16 **)off_13E914 < 0 )
  {
    ...
    {
      sub_12F32C(dword_13E99C, dword_13E998, 2470);
      if ( !a4 )
        goto LABEL_26;
      if ( **v15 >= 0 || a5 )
        goto LABEL_9;
    }
    sub_12F32C(dword_13E908, dword_13E904, 2473);
    goto LABEL_9;
  }
  if ( !a4 )
  {
...
LABEL_55:
          ...
          *v60 = v63;
          if ( *v61 < 0 && v63 < v62 )
            return sub_12F32C(dword_13E90C, dword_13E904, 2589);
          return result;
        }
      }
      else
