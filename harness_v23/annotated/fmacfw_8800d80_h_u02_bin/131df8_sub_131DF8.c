// v23 annotated: sub_131DF8 @ 0x131df8
// Original: 131df8_sub_131DF8.c
// Primary struct: <unclustered>
//
// sub_131DF8 @ 0x131df8, size 328 bytes
int __fastcall sub_131DF8(int a1, int a2, __int16 a3, __int16 a4)
{
  _BYTE *v4; // r4
  int v8; // r1
  int v9; // r2
  ...
  *((_WORD *)v4 + 22) = v18;
  ...
  {
    *((_WORD *)v4 + 4) = 255;
    v33 = (_BYTE *)sub_12C7EC(49, 0, 5, 1u);
    *v33 = v4[376];
    sub_12C84C((int)v33);
    sub_12CBF4(5u, 1);
  }
