// v23 annotated: sub_102CCC @ 0x102ccc
// Original: 102ccc_sub_102CCC.c
// Primary struct: <unclustered>
//
// sub_102CCC @ 0x102ccc, size 282 bytes
int __fastcall sub_102CCC(int a1, unsigned __int16 *a2)
{
  unsigned int v4; // r11
  int v5; // r9
  int v6; // r8
...
LABEL_10:
  ...
  *(_DWORD *)off_102DE8 = 1;
  if ( v23 )
  {
    v15 = *(_DWORD *)off_102DF4;
    v25 = *(_QWORD *)off_102DF4;
    v26 = *((_DWORD *)off_102DF4 + 2);
    v16 = 3;
  }
  else
  {
