// v23 annotated: sub_136A90 @ 0x136a90
// Original: 136a90_sub_136A90.c
// Primary struct: <unclustered>
//
// sub_136A90 @ 0x136a90, size 306 bytes
int **__fastcall sub_136A90(int a1, int a2, _DWORD *a3)
{
  int v3; // r7
  int v5; // r2
  int v7; // r8
...
LABEL_26:
  ...
  v11 = v5 == 2;
  v12 = nullptr;
  while ( ((unsigned __int8)(v9 & *(_BYTE *)(dword_136BC4 + *((unsigned __int8 *)v8 + 27))) == 0) == v11 )
  {
    v12 = (int ***)v8;
    if ( !*v8 )
      goto LABEL_24;
