// v23 annotated: sub_11B438 @ 0x11b438
// Original: 11b438_sub_11B438.c
// Primary struct: <unclustered>
//
// sub_11B438 @ 0x11b438, size 562 bytes
int __fastcall sub_11B438(int a1)
{
  _DWORD *v1; // r8
  char *v2; // r6
  int v3; // r2
  ...
  v1 = off_11B684;
  v2 = (char *)off_11B66C;
  v3 = *((_DWORD *)off_11B684 + 4);
  v5 = *(_DWORD *)a1 + 38;
  *((_DWORD *)off_11B66C + 18) = *(_DWORD *)v5;
  v6 = *(_WORD *)(v5 + 4);
  v7 = *(_DWORD *)(v3 + 100);
  ...
  *((_DWORD *)v2 + 6) = 0;
  ...
  v15 = (unsigned int *)(36 * *(unsigned __int8 *)(*(_DWORD *)a1 + 35) + 8248 + dword_11B670);
  v36 = v11 << 9;
  v16 = v13 + 92;
  v17 = v13;
  v18 = 2621440;
