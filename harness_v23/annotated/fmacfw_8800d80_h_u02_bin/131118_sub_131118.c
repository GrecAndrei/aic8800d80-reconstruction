// v23 annotated: sub_131118 @ 0x131118
// Original: 131118_sub_131118.c
// Primary struct: <unclustered>
//
// sub_131118 @ 0x131118, size 88 bytes
int __fastcall sub_131118(unsigned __int8 *a1, int a2, int a3, _BYTE *a4)
{
  int result; // r0
  char v7; // r2
  int v8; // r2
