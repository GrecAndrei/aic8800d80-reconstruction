// v23 annotated: sub_12A4B4 @ 0x12a4b4
// Original: 12a4b4_sub_12A4B4.c
// Primary struct: <unclustered>
//
// sub_12A4B4 @ 0x12a4b4, size 264 bytes
int __fastcall sub_12A4B4(int a1, int a2, char a3, char a4, unsigned int a5, int a6, int a7)
{
  int v7; // r6
  int v8; // r7
  ...
  v9 = (unsigned __int8 *)(dword_12A5BC + 140 * v8);
  if ( v9[112] != 1 )
    return 255;
  v10 = v9[16];
  v11 = (unsigned __int8 *)(dword_12A5BC + 140 * v8);
  if ( v9[16] )
  {
    if ( v9[64] )
      return 255;
  ...
  *(_BYTE *)(v7 + v21 + 48 * v14 + 16) = 1;
  sub_125B98(*(unsigned __int8 *)(v21 + v7 + 113), 3);
