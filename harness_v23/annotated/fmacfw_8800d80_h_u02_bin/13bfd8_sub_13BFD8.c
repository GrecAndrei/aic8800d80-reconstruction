// v23 annotated: sub_13BFD8 @ 0x13bfd8
// Original: 13bfd8_sub_13BFD8.c
// Primary struct: <unclustered>
//
// sub_13BFD8 @ 0x13bfd8, size 344 bytes
unsigned int __fastcall sub_13BFD8(unsigned int result)
{
  int v1; // r1
  int v2; // r2
  int v3; // r5
  ...
  if ( v1 != 255 )
  {
    ...
    if ( (*(_DWORD *)(v5 + 4) & 2) != 0 )
    {
      ...
      if ( v8 == 33 )
      {
        ...
        if ( result > dword_13C14C && v2 - 500000 - *(_DWORD *)(v7 + 448) >= 0 && *(_BYTE *)(v5 + 36) != 1 )
        {
          result = dword_13C13C;
          v9 = *(unsigned __int8 *)(dword_13C138 + v1);
          if ( !*(_DWORD *)(dword_13C13C + 84 * v9)
            && !*(_DWORD *)(dword_13C144 + 8 * v9)
            && !*(_DWORD *)(v4 + 8 * (v9 + 87 * v3 + 78)) )
          {
            result = dword_13C148;
            if ( !*(_DWORD *)(dword_13C148 + 8 * (165 * *(unsigned __int8 *)(v6 + 28) + v9 + 159)) )
              return sub_13BE74(v3, v1, *(_WORD *)(v6 + 32));
          }
        }
      }
      else
        ...
        if ( result == 1 )
        {
          ...
          *(_WORD *)(v6 + 34) = result;
          if ( (v14 & 1) == 0 || (v14 & 3) == 3 )
          {
            ...
            *(_BYTE *)(result + 6) = 1;
            if ( (*(_WORD *)(v6 + 30) & 1) == 0 )
              *(_WORD *)(v6 + 64) = *((_WORD *)off_13C140 + 22) + (*((_DWORD *)off_13C130 + 4) >> 10);
            ++*(_DWORD *)(v12 + v10 + 4);
          }
        }
      }
