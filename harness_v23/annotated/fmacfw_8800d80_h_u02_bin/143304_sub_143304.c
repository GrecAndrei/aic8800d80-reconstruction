// v23 annotated: sub_143304 @ 0x143304
// Original: 143304_sub_143304.c
// Primary struct: <unclustered>
//
// sub_143304 @ 0x143304, size 702 bytes
int __fastcall sub_143304(unsigned int a1, unsigned int a2, __int64 a3, unsigned int *a4)
{
  unsigned int v5; // r4
  unsigned int v6; // lr
  unsigned int v7; // r7
