// v23 annotated: sub_1422A4 @ 0x1422a4
// Original: 1422a4_sub_1422A4.c
// Primary struct: <unclustered>
//
// sub_1422A4 @ 0x1422a4, size 198 bytes
int __fastcall sub_1422A4(int a1, unsigned __int8 *a2, __int16 a3, __int16 a4)
{
  int v6; // r7
  int v8; // r11
  int v9; // r4
...
LABEL_8:
  v12 = (_BYTE *)sub_12C7EC(12292, a4, a3, 1u);
  *v12 = v6;
  sub_12C84C((int)v12);
  return 0;
}
