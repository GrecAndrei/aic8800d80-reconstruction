// v23 annotated: sub_11F158 @ 0x11f158
// Original: 11f158_sub_11F158.c
// Primary struct: <unclustered>
//
// sub_11F158 @ 0x11f158, size 258 bytes
int __fastcall sub_11F158(int a1, unsigned __int8 a2)
{
  int v2; // r4
  int v3; // r8
  ...
  switch ( v4[160] )
  {
    ...
    case 4u:
      ...
      v17 = v3 + 696 * v2;
      *(_QWORD *)(v17 + 136) = *(_QWORD *)&dword_11F260;
      if ( v16 == 2 )
        *(_QWORD *)(v17 + 136) = *(_QWORD *)&dword_11F268;
      break;
    default:
