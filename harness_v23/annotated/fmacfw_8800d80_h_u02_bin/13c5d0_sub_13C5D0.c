// v23 annotated: sub_13C5D0 @ 0x13c5d0
// Original: 13c5d0_sub_13C5D0.c
// Primary struct: <unclustered>
//
// sub_13C5D0 @ 0x13c5d0, size 192 bytes
int __fastcall sub_13C5D0(int a1, int a2, int a3, int a4)
{
  int result; // r0
  int v5; // lr
  __int64 v6; // r4
  ...
  result = *(_DWORD *)(dword_13C690 + 1320 * *(unsigned __int8 *)(a1 + 28) + 1204);
  if ( result )
  {
    if ( a4 )
      v5 = a4;
