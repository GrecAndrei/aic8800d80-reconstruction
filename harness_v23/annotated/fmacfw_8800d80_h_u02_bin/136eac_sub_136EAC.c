// v23 annotated: sub_136EAC @ 0x136eac
// Original: 136eac_sub_136EAC.c
// Primary struct: <unclustered>
//
// sub_136EAC @ 0x136eac, size 202 bytes
int __fastcall sub_136EAC(int a1, int a2, int a3, __int16 a4)
{
  int v4; // r2
  _WORD *v5; // r4
  int v7; // r1
