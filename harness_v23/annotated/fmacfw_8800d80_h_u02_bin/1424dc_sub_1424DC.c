// v23 annotated: sub_1424DC @ 0x1424dc
// Original: 1424dc_sub_1424DC.c
// Primary struct: <unclustered>
//
// sub_1424DC @ 0x1424dc, size 142 bytes
__int64 __fastcall sub_1424DC(__int64 a1)
{
  int v1; // r7
  int v2; // r4
  int v3; // r5
  ...
  else
  {
    ...
    if ( HIDWORD(a1) & (dword_14256C >> ((HIDWORD(a1) >> 20) + 1)) | (unsigned int)a1 )
    {
      v3 = (HIDWORD(a1) + (0x80000 >> ((HIDWORD(a1) >> 20) + 1))) & ~(dword_14256C >> ((HIDWORD(a1) >> 20) + 1));
      v5 = 0;
      return __PAIR64__(v3, v5);
    }
  }
