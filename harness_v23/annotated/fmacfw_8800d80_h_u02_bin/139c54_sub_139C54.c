// v23 annotated: sub_139C54 @ 0x139c54
// Original: 139c54_sub_139C54.c
// Primary struct: <unclustered>
//
// sub_139C54 @ 0x139c54, size 336 bytes
int __fastcall sub_139C54(char *a1, char a2, int a3)
{
  char v4; // r3
  int v6; // r4
  char *v7; // r8
  ...
  else if ( v16 != 56710 )
  {
    if ( v16 == 8 )
    {
      ...
      if ( v10 == 2 )
      {
        sub_12E948(dword_139DA8, (unsigned __int8)v7[10], 2, 8);
        return v8;
      }
      if ( v10 == 17 )
      {
        ...
        {
          sub_12E948(dword_139DA4, (unsigned __int8)v12[3] | ((unsigned __int8)v12[2] << 8));
          return v8;
        }
      }
    }
