// v23 annotated: sub_140400 @ 0x140400
// Original: 140400_sub_140400.c
// Primary struct: <unclustered>
//
// sub_140400 @ 0x140400, size 1418 bytes
_DWORD *__fastcall sub_140400(int a1, int a2, int a3, int a4)
{
  int v4; // r11
  int v5; // r0
  _WORD *v8; // r5
  ...
  v10 = *((_WORD *)off_140714 + 254) + 1;
  *((_WORD *)off_140714 + 254) = v10;
  *(_WORD *)(v5 + 130) = 16 * v10;
  ...
  *((_BYTE *)v8 + v11) = 5;
  ...
  else
  {
    ...
    do
    {
      ...
      if ( *(_BYTE *)(a4 + 2) == 5 )
      {
        v32 = *(_DWORD *)off_14098C;
        if ( *(_DWORD *)off_14098C )
        {
          if ( v21 <= 0x19 )
            break;
...
LABEL_90:
      ...
      *(_BYTE *)(v13 + 4) = v22;
      if ( v22 == 5 )
      {
        ...
        *(_BYTE *)(v13 + 18) = sub_12DFC0(*(char *)(v25 + 20));
        *(_BYTE *)(v13 + 19) = -1;
        v27 = (char *)(v25 + 6);
        do
        {
