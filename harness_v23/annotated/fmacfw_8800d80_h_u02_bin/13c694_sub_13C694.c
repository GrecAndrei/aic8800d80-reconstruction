// v23 annotated: sub_13C694 @ 0x13c694
// Original: 13c694_sub_13C694.c
// Primary struct: <unclustered>
//
// sub_13C694 @ 0x13c694, size 936 bytes
int __fastcall sub_13C694(_DWORD *a1, _DWORD *a2)
{
  int v2; // r3
  int v3; // r4
  int v4; // r8
  ...
  *a2 = v44;
  ...
  do
  {
    ...
    v13 = v11 ^ *(unsigned __int8 *)(v4 + (unsigned __int8)v44) ^ *(unsigned __int8 *)(dword_13C95C + HIBYTE(v45)) ^ v49;
    v14 = ((*(unsigned __int8 *)(v4 + HIBYTE(v45))
          ^ *(unsigned __int8 *)(v3 + (unsigned __int8)v44)
          ^ v49
          ^ *(unsigned __int8 *)(dword_13C95C + BYTE2(v46))) << 16)
        | ((*(unsigned __int8 *)(dword_13C95C + BYTE1(v41))
          ^ *(unsigned __int8 *)(v3 + (unsigned __int8)v44)
          ^ *(unsigned __int8 *)(v3 + HIBYTE(v45))
          ^ *(unsigned __int8 *)(v4 + BYTE2(v46))) << 8)
        | v11
        ^ *(unsigned __int8 *)(v3 + HIBYTE(v45))
        ^ *(unsigned __int8 *)(dword_13C95C + (unsigned __int8)v44)
        ^ *(unsigned __int8 *)(v4 + BYTE1(v41));
    v15 = v12 ^ *(unsigned __int8 *)(dword_13C95C + HIBYTE(v44)) ^ *(unsigned __int8 *)(v4 + (unsigned __int8)v41) ^ v51;
    v16 = ((*(unsigned __int8 *)(dword_13C95C + BYTE2(v45))
          ^ v51
          ^ *(unsigned __int8 *)(v3 + (unsigned __int8)v41)
          ^ *(unsigned __int8 *)(v4 + HIBYTE(v44))) << 16)
        | ((*(unsigned __int8 *)(v3 + HIBYTE(v44))
          ^ *(unsigned __int8 *)(v3 + (unsigned __int8)v41)
          ^ *(unsigned __int8 *)(dword_13C95C + BYTE1(v46))
          ^ *(unsigned __int8 *)(v4 + BYTE2(v45))) << 8)
        | v12
        ^ *(unsigned __int8 *)(v3 + HIBYTE(v44))
        ^ *(unsigned __int8 *)(dword_13C95C + (unsigned __int8)v41)
    ...
    *a2 = v47;
    ...
    v52 = *(unsigned __int8 *)(dword_13C95C + HIBYTE(v41));
    v22 = BYTE2(v41);
    v23 = *(unsigned __int8 *)(v3 + (unsigned __int8)v45);
    v24 = *(unsigned __int8 *)(v4 + HIBYTE(v41)) ^ v21 ^ v19 ^ *(unsigned __int8 *)(dword_13C95C + BYTE2(v44));
    v42 = *(unsigned __int8 *)(v3 + BYTE1(v44));
    v25 = (v24 << 16)
        | ((*(unsigned __int8 *)(dword_13C95C + BYTE1(v45)) ^ v21 ^ v20 ^ *(unsigned __int8 *)(v4 + BYTE2(v44))) << 8)
        | v20
        ^ *(unsigned __int8 *)(dword_13C95C + v17)
        ^ *(unsigned __int8 *)(v4 + BYTE1(v45))
        ^ *(unsigned __int8 *)(v3 + BYTE2(v44))
        | ((v19 ^ *(unsigned __int8 *)(v3 + BYTE2(v44)) ^ *(unsigned __int8 *)(v4 + v17) ^ v52) << 24);
    v26 = ((*(unsigned __int8 *)(v4 + v18) ^ v23 ^ v42 ^ *(unsigned __int8 *)(dword_13C95C + v22)) << 16)
        | ((*(unsigned __int8 *)(dword_13C95C + BYTE1(v44))
          ^ *(unsigned __int8 *)(v3 + v18)
          ^ v23
          ^ *(unsigned __int8 *)(v4 + v22)) << 8)
        | *(unsigned __int8 *)(v3 + v22)
        ^ *(unsigned __int8 *)(v3 + v18)
        ^ *(unsigned __int8 *)(dword_13C95C + (unsigned __int8)v45)
        ^ *(unsigned __int8 *)(v4 + BYTE1(v44))
        | ((v42
          ^ *(unsigned __int8 *)(v3 + v22)
          ^ *(unsigned __int8 *)(v4 + (unsigned __int8)v45)
          ^ *(unsigned __int8 *)(dword_13C95C + v18)) << 24);
    a2[2] = v25;
    a2[3] = v26;
    v27 = v47 ^ v50[4];
    *a2 = v27;
