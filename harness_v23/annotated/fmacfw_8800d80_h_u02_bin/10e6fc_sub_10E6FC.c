// v23 annotated: sub_10E6FC @ 0x10e6fc
// Original: 10e6fc_sub_10E6FC.c
// Primary struct: <unclustered>
//
// sub_10E6FC @ 0x10e6fc, size 416 bytes
int __fastcall sub_10E6FC(unsigned int a1, unsigned int a2, unsigned int *a3)
{
  unsigned int v3; // r4
  unsigned int *v4; // r6
  unsigned int *v5; // r5
  ...
  v4 = (unsigned int *)off_10E89C;
  v5 = (unsigned int *)off_10E8A0;
  *(_DWORD *)off_10E89C = *(_DWORD *)off_10E89C & 0xFFFFFFF8 | a1 & 7;
  *v5 = ((_WORD)a1 << 12) & 0x7000 | *v5 & 0xFFFF8FFF;
  *v4 = (8 * a2) & 0x78 | *v4 & 0xFFFFFF87;
  *v5 = (a2 << 15) & 0x78000 | *v5 & 0xFFF87FFF;
  v8 = (__int16 *)off_10E8A4;
  v9 = sub_10DF70();
  ...
  v3 = a2;
  v11 = (unsigned int *)off_10E89C;
  v12 = (unsigned int *)off_10E8A0;
  v21 = a1;
  v22 = a1 + a2;
  v13 = a1;
  v14 = 7;
