// v23 annotated: sub_11FEF8 @ 0x11fef8
// Original: 11fef8_sub_11FEF8.c
// Primary struct: <unclustered>
//
// sub_11FEF8 @ 0x11fef8, size 326 bytes
__int64 __fastcall sub_11FEF8(unsigned __int8 *a1, char a2)
{
  int v3; // r6
  int v4; // r8
  int v5; // r4
  ...
  v4 = a1[41];
  v5 = dword_120048;
  v6 = (_BYTE *)(1320 * v4 + 120 * v3 + dword_120048);
  v7 = 120 * v3 + 1320 * v4;
  v6[578] = a2;
  v6[576] = a1[40];
  v8 = (int *)(v7 + 480 + v5);
  ...
  switch ( v6[576] )
  {
    case 0:
    case 3:
      *(_QWORD *)(1320 * v4 + 120 * v3 + v5 + 552) = sub_14383C(v9) & 0xFFFFFFLL;
      break;
    case 1:
      ...
      *(_QWORD *)(v15 + 552) = 0;
      break;
    case 4:
      *(_QWORD *)(1320 * v4 + 120 * v3 + v5 + 552) = *(_QWORD *)&dword_120040;
      break;
    case 5:
