// v23 annotated: sub_119888 @ 0x119888
// Original: 119888_sub_119888.c
// Primary struct: <unclustered>
//
// sub_119888 @ 0x119888, size 868 bytes
int __fastcall sub_119888(int a1, int *a2, unsigned int a3, unsigned int a4, unsigned __int8 a5)
{
  int v5; // r5
  int v7; // r4
  int v8; // s16
  ...
  if ( !sub_1195A0(a1, v7, a5)
    || (v12 = off_119BA4, *(unsigned __int8 *)(*(_DWORD *)off_119BA4 + 62) > (*(_DWORD *)off_119B8C & 0x3Fu)) )
  {
    sub_12D150(v8, v5);
    return 0;
  }
...
LABEL_7:
    if ( *(unsigned __int8 *)(*(_DWORD *)v12 + 62) > (*v48 & 0x3Fu) )
      goto LABEL_17;
    if ( *(_DWORD *)(v24 + 28) )
      *(_DWORD *)(*(_DWORD *)(v24 + 32) - 3) = *((_DWORD *)off_119B90 + 43);
    v21 = *(_WORD *)(v7 + 80);
    v22 = *(_WORD *)(v5 + 10);
    *(_DWORD *)(v7 + 68) = v5;
    *(_WORD *)(v5 + 10) = v22 + v21;
