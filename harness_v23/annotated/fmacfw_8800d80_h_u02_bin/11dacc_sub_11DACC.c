// v23 annotated: sub_11DACC @ 0x11dacc
// Original: 11dacc_sub_11DACC.c
// Primary struct: <unclustered>
//
// sub_11DACC @ 0x11dacc, size 278 bytes
int __fastcall sub_11DACC(int *a1, int a2, _WORD *a3)
{
  _BYTE *v3; // r7
  int v4; // r6
  int v5; // r5
