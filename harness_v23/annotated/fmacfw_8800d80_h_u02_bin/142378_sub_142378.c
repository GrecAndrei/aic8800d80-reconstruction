// v23 annotated: sub_142378 @ 0x142378
// Original: 142378_sub_142378.c
// Primary struct: <unclustered>
//
// sub_142378 @ 0x142378, size 266 bytes
int __fastcall sub_142378(int a1, unsigned __int8 *a2, __int16 a3, __int16 a4)
{
  int v4; // r8
  int v5; // r9
  _BYTE *v6; // r5
  ...
  else
  {
    ...
    if ( (unsigned int)(v17 - 1) <= 1 )
    {
      ...
      v17 = a2[1];
      v27 = *(_QWORD *)(v4 + 1320 * v5 + 40) + (unsigned int)dword_142490 + v22;
    }
