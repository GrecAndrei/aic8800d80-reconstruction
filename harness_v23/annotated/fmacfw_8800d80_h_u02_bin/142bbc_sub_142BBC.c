// v23 annotated: sub_142BBC @ 0x142bbc
// Original: 142bbc_sub_142BBC.c
// Primary struct: <unclustered>
//
// sub_142BBC @ 0x142bbc, size 360 bytes
unsigned int __fastcall sub_142BBC(unsigned int result, unsigned int a2, unsigned int a3, unsigned int a4)
{
  int v4; // r5
  unsigned int v5; // r12
  bool v6; // zf
