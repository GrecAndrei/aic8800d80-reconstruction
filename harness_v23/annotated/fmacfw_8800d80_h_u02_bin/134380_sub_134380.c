// v23 annotated: sub_134380 @ 0x134380
// Original: 134380_sub_134380.c
// Primary struct: <unclustered>
//
// sub_134380 @ 0x134380, size 242 bytes
_DWORD *__fastcall sub_134380(int a1, int a2)
{
  int *v4; // r5
  int v5; // r0
  int v6; // r4
...
LABEL_3:
  ...
  {
    v15 = *((_WORD *)off_134478 + 2);
    *(_DWORD *)(v6 + 352) = *(_DWORD *)off_134478;
    *(_WORD *)(v6 + 356) = v15;
    if ( a2 )
      goto LABEL_3;
  }
  v21[0] = off_13447C;
  v16 = *((unsigned __int8 *)off_13447C + 253);
  v17 = *((unsigned __int8 *)off_13447C + 252);
  v21[1] = (char *)off_13447C + 84;
  *(_BYTE *)(v6 + 367) = a2;
  while ( 1 )
  {
    if ( v17 )
