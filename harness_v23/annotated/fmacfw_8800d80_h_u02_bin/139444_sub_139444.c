// v23 annotated: sub_139444 @ 0x139444
// Original: 139444_sub_139444.c
// Primary struct: <unclustered>
//
// sub_139444 @ 0x139444, size 1284 bytes
int __fastcall sub_139444(char a1, int a2, int a3, int a4, _BYTE *a5, unsigned int a6, _WORD *a7, _BYTE *a8)
{
  int v9; // r12
  unsigned int v11; // r5
  int v12; // r8
...
LABEL_12:
      ...
      switch ( *(_BYTE *)(a6 + a3) )
      {
        ...
        case 5:
          v33 = dword_139718;
          if ( *(_BYTE *)(dword_139718 + 1320 * v9 + 106) == 2
...
LABEL_84:
            ...
            if ( *(_BYTE *)(dword_139950 + 1320 * v9 + 106) )
              goto LABEL_46;
            v9 = 255;
          }
          else
...
LABEL_50:
        ...
        case 7:
          ...
          if ( *(_BYTE *)(v15 + 1) )
          {
            if ( v13 != 1 )
              goto LABEL_46;
            if ( (*(_DWORD *)(dword_139730 + 696 * a4 + 4) & 2) != 0 )
            {
              v13 = *(_BYTE *)(v15 + 2) & 1;
              if ( (*(_BYTE *)(v15 + 2) & 1) != 0 )
              {
          ...
          else if ( (*(_DWORD *)(dword_139960 + 696 * a4 + 4) & 2) != 0 )
          {
...
LABEL_65:
          ...
          if ( v40 == 1 )
          {
            sub_1019BC((_DWORD *)(v15 + 2), (_DWORD *)(v15 + 10));
          }
          else
          {
            if ( v40 != 2 )
...
LABEL_46:
            ...
            if ( (*(_DWORD *)(dword_139730 + 696 * a4 + 4) & 0x24) != 0 && *(char *)(v15 + 2) >= 0 )
            {
              sub_132C48(a4, *(_BYTE *)(v15 + 2) & 3);
              v13 = 0;
              v9 = 255;
LABEL_47:
              if ( *a7 == 255 )
