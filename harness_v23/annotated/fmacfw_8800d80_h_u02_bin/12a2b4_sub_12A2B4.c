// v23 annotated: sub_12A2B4 @ 0x12a2b4
// Original: 12a2b4_sub_12A2B4.c
// Primary struct: <unclustered>
//
// sub_12A2B4 @ 0x12a2b4, size 106 bytes
int __fastcall sub_12A2B4(int result, _BYTE *a2, int a3, int a4)
{
  int v4; // r4
  int v5; // r6
  int v6; // r5
  ...
  if ( a2[24] == 127 && !a2[29] && (unsigned __int8)a2[31] == 221 && a2[36] == 9 )
  {
    ...
    if ( a2[37] == 12 )
    {
      ...
      return sub_129C48(v5, v4, *(_DWORD *)(v6 + 132) + a4);
    }
  }
  return result;
}
