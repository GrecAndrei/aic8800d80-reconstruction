// v23 annotated: sub_10A868 @ 0x10a868
// Original: 10a868_sub_10A868.c
// Primary struct: <unclustered>
//
// sub_10A868 @ 0x10a868, size 1610 bytes
int __fastcall sub_10A868(unsigned int a1, unsigned int a2, int a3, unsigned int a4, unsigned __int8 a5, char a6)
{
  unsigned int v8; // s17
  int v9; // r3
  _DWORD *v10; // r2
    ...
    if ( a4 <= a5 )
    {
      ...
      do
      {
        ...
        if ( v25 >= 6 )
          ...
          v26 = 50;
        v44 = v26;
        *(_DWORD *)&v58[2 * v27 + 54] = sub_10943C(v48, v26, (int *)&v58[20 * v25 + 310]);
        *(_DWORD *)&v58[2 * v27 + 182] = sub_10943C(v48, v44, (int *)&v58[20 * v25 + 630]);
        v25 = (unsigned __int8)(v25 + 1);
      }
      while ( a5 >= v25 );
    }
LABEL_28:
  ...
  *(v35 - 6224) &= 0xCFFFFFFF;
  if ( a6 )
  {
    ...
    v38 = *(_WORD *)(a2 + 2 * a4);
    *(_DWORD *)off_10AEC4 = *(_DWORD *)off_10AEC4 & 0xFE01FFFF | ((unsigned __int8)v38 << 17);
    *v37 = v38 & 0xFF00 | *v37 & 0xFFFF00FF;
  }
  else
  {
    v42 = (unsigned int *)off_10AEC4;
    *(_DWORD *)off_10AEC4 &= ~0x2000000u;
    *v42 &= ~0x10000u;
