// v23 annotated: sub_13AE40 @ 0x13ae40
// Original: 13ae40_sub_13AE40.c
// Primary struct: <unclustered>
//
// sub_13AE40 @ 0x13ae40, size 270 bytes
int __fastcall sub_13AE40(int a1, int a2)
{
  int v2; // r5
  int v3; // r3
  __int16 v5; // r0
...
LABEL_7:
      ...
      *(_BYTE *)(dword_13AF54 + 696 * *(unsigned __int8 *)(a1 + 29) + 54) = 0;
    }
LABEL_8:
    if ( !v8 )
      goto LABEL_9;
...
LABEL_11:
  ...
  *(_DWORD *)(v2 + 4) = v11 | 1;
  if ( (v11 & 2) != 0 )
    return *(unsigned __int8 *)(dword_13AF54 + 696 * *(unsigned __int8 *)(a1 + 29) + 48) == 0;
  return result;
}
