// v23 annotated: sub_139E1C @ 0x139e1c
// Original: 139e1c_sub_139E1C.c
// Primary struct: <unclustered>
//
// sub_139E1C @ 0x139e1c, size 1160 bytes
int __fastcall sub_139E1C(unsigned int a1)
{
  unsigned int v1; // r7
  int v3; // r3
  _BYTE *v4; // r4
  ...
  if ( (v1 & 0x2000) == 0 )
  {
    v3 = *((unsigned __int8 *)off_13A0F8 + 16);
    if ( v3 != 255 )
    {
      v4 = off_13A0FC;
LABEL_4:
...
LABEL_22:
  ...
  *((_DWORD *)v4 + 6) = v1;
  ...
  {
    v43 = v15;
    v34 = sub_1386A8((int)v7, *((_DWORD *)v4 + 6));
    v15 = v43;
    v18 = dword_13A2A8;
    if ( !v34 )
      goto LABEL_34;
  }
  v22 = (_BYTE **)off_13A114;
  if ( **(_BYTE **)off_13A114 == 1 && !*((_BYTE *)off_13A2AC + 412) )
  {
    v23 = v8 & 0xC;
    if ( v23 == 8 )
    {
...
LABEL_83:
  v44 = v15;
  sub_139DB8((char *)v7, v1, *(unsigned __int16 *)(a1 + 48));
  v15 = v44;
...
LABEL_34:
    ...
    v5 = sub_139970(a1, (unsigned __int8)v4[9]);
    goto LABEL_57;
  }
LABEL_84:
  if ( (v8 & 0x40) != 0 )
  ...
  if ( (v8 & 0x80) != 0 )
  {
    ...
    {
      v42 = v15;
      v38 = sub_121820(v15, (unsigned __int8)v4[7]);
      v15 = v42;
      v35 = 1;
      if ( v38 )
      {
...
LABEL_57:
  ...
  if ( v3 != 255 && !v5 )
    goto LABEL_4;
LABEL_5:
  sub_12F414((_DWORD **)dword_13A100);
  return v5;
}
