// v23 annotated: sub_13CA3C @ 0x13ca3c
// Original: 13ca3c_sub_13CA3C.c
// Primary struct: <unclustered>
//
// sub_13CA3C @ 0x13ca3c, size 108 bytes
unsigned int *__fastcall sub_13CA3C(unsigned int *result)
{
  __int64 v1; // r2
  int v2; // r1
  unsigned int v3; // r5
  ...
  v3 = *result;
  v4 = result[3];
  *result = dword_13CAA8 & (*result >> 15) | ((_DWORD)v1 << 17) & 0x1000000 | (2 * *result) & 0xFEFEFEFE;
