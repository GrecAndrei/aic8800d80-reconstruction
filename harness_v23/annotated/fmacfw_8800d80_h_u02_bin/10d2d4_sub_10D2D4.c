// v23 annotated: sub_10D2D4 @ 0x10d2d4
// Original: 10d2d4_sub_10D2D4.c
// Primary struct: <unclustered>
//
// sub_10D2D4 @ 0x10d2d4, size 378 bytes
int __fastcall sub_10D2D4(int a1, int a2, int a3)
{
  int *v6; // r1
  int result; // r0
  int v8; // r12
  ...
  *(_DWORD *)(a2 + 32) = 0;
  ...
  v6 = (int *)off_10D458;
  result = *(_DWORD *)off_10D458;
  v8 = *(_DWORD *)off_10D458 + 1;
  dword_40021000[16 * a3] |= 1u;
  *v6 = v8;
  while ( (dword_40021000[16 * a3] & 0x10000) == 0 )
    ;
  v9 = dword_10D464;
  v10 = *(_DWORD *)(dword_10D464 + 4 * a3);
  ...
  {
    dword_40021000[16 * a3 + 2] = dword_10D468;
