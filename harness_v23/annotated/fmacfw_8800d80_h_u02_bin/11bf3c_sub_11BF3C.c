// v23 annotated: sub_11BF3C @ 0x11bf3c
// Original: 11bf3c_sub_11BF3C.c
// Primary struct: <unclustered>
//
// sub_11BF3C @ 0x11bf3c, size 560 bytes
int __fastcall sub_11BF3C(int result)
{
  _DWORD *v1; // r2
  __int16 *v2; // r1
  unsigned int v3; // r3
  ...
  *((_BYTE *)off_11C170 + 200) = 0;
  ...
  if ( *(_BYTE *)(v9 + 37) )
  {
    ...
    v1[45] = *(_DWORD *)(v9 + 38);
    v11 = dword_11C17C;
    *((_WORD *)off_11C178 + 2) = *(_WORD *)(v9 + 42);
    result = v1[4];
    if ( result == v11 + 1320 * v10 )
    {
      result = *(_DWORD *)off_11C184 & 0x3F;
      if ( *(unsigned __int8 *)(*(_DWORD *)off_11C180 + 62) + 3 < result )
      {
        v12 = *(_DWORD *)off_11C18C;
        v13 = v1[42];
        v14 = *(_DWORD *)off_11C188 & 0xF;
        v15 = HIWORD(*(_DWORD *)off_11C188) & 3;
        v16 = (*(_DWORD *)off_11C188 & 0x80000) != 0;
        v35 = (unsigned __int16)*(_DWORD *)off_11C188 >> 4;
        *((_WORD *)v1 + 94) = v35;
        *((_BYTE *)v1 + 191) = v14;
        *((_BYTE *)v1 + 195) = v15;
        ...
        *((_BYTE *)v1 + 196) = v18;
        ...
        else
        {
          v34 = v12 >> 30;
          v20 = HIBYTE(v12) & 3;
          *((_BYTE *)v1 + 197) = *(_BYTE *)(dword_11C1AC + v34);
          *((_BYTE *)v1 + 198) = v20;
        }
        while ( *(int *)off_11C1A4 >= 0 )
          ;
        v21 = *(_DWORD *)off_11C1A4 & dword_11C190;
        if ( v18 > 2 )
          v22 = *(unsigned __int16 *)(dword_11C1B0 + 2 * (3 * ((unsigned __int8)(v18 - 3) >> 1) + v32 + 6 * v17)) << ((v18 - 3) & 1);
        else
          v22 = *(_WORD *)(*(_DWORD *)(dword_11C194 + 4 * v18) + 2 * (3 * v17 + v32));
