// v23 annotated: sub_130D18 @ 0x130d18
// Original: 130d18_sub_130D18.c
// Primary struct: <unclustered>
//
// sub_130D18 @ 0x130d18, size 202 bytes
_BYTE *__fastcall sub_130D18(_BYTE *a1, int a2, int a3)
{
  _BYTE *result; // r0
  int v5; // r5
  int v6; // r3
  ...
  if ( result )
  {
    ...
    else
    {
      ...
      else
      {
        v5 = v6 == 2484
           ? 14
           : (unsigned __int8)((unsigned int)(((unsigned int)dword_130DE4 * (unsigned __int64)(unsigned int)(v6 - 2407)) >> 32) >> 2);
        v7 = 1;
      }
    }
    v12[0] += 2;
