// v23 annotated: sub_127DFC @ 0x127dfc
// Original: 127dfc_sub_127DFC.c
// Primary struct: delay_timer (cluster 0, 24 funcs)
// Fields: us=0x0, ticks=0x4
//
// sub_127DFC @ 0x127dfc, size 464 bytes
BOOL __fastcall sub_127DFC(int a1, int a2, int a3)
{
  _BYTE *v3; // r11
  int *v4; // r4
  int v8; // r3
...
LABEL_13:
  ...
  if ( *(_BYTE *)(dword_127FCC + 140 * v16 + 112) != 1 )
  {
    if ( v13 )
    {
      v17 = *(_BYTE *)(a1 + 85);
...
LABEL_19:
  ...
  if ( (v17 & 0x10) != 0 )
  {
    sub_125D38((_DWORD *)a1);
    *(_BYTE *)(a1 + 85) &= ~0x10u;
    if ( v13 )
      goto LABEL_31;
LABEL_25:
    if ( !*(_BYTE *)(a1 + 1224) || *(_BYTE *)(dword_127FCC + 140 * *(unsigned __int8 *)(a1 + 1225) + 112) != 1 )
    {
LABEL_26:
