// v23 annotated: sub_139200 @ 0x139200
// Original: 139200_sub_139200.c
// Primary struct: <unclustered>
//
// sub_139200 @ 0x139200, size 546 bytes
int __fastcall sub_139200(int a1, int a2)
{
  _WORD *v2; // r6
  int v3; // r7
  int v5; // r4
  ...
  v2 = off_139424;
  v3 = dword_139428 + 1320 * *((unsigned __int8 *)off_139424 + 10);
  v5 = *(unsigned __int8 *)(v3 + 1227);
  if ( !*(_BYTE *)(v3 + 1227) )
  {
    v7 = *((unsigned __int8 *)off_139424 + 7);
    v8 = dword_139440;
    v9 = *((unsigned __int16 *)off_139424 + 2);
    v10 = *(_DWORD *)(dword_139440 + 4 * (v7 + 174 * a2 + 102));
  ...
  v8 = dword_139440;
  v17 = sub_138968((unsigned __int8 *)(v3 + 107), (_DWORD *)(v3 + 1228), *(char **)(*(_DWORD *)(a1 + 28) + 8), 1);
...
LABEL_17:
      ...
      *(_WORD *)(v10 + 8) = v21;
      sub_138818(v10);
      sub_13C2E4(a2, *((unsigned __int8 *)v2 + 7));
      return v16;
    }
LABEL_28:
...
LABEL_10:
    ...
    sub_139168(v10, (unsigned __int16)(v13 - 63));
    v7 = *((unsigned __int8 *)v2 + 7);
    v9 = (unsigned __int16)v2[2];
  ...
  *(_BYTE *)(v10 + 288) = 1;
  if ( !*(_DWORD *)(v23 + 16) )
  {
    ...
    *(_DWORD *)(v23 + 16) = dword_139430;
    v24 = *(__int16 **)off_139434;
    ...
    *(_BYTE *)(v10 + 11) = v25;
    ...
    if ( v25 == 1 )
      sub_124BFC(v10 + 272, *((_DWORD *)off_13942C + 4) + 50000);
    goto LABEL_10;
  }
  return 0;
}
