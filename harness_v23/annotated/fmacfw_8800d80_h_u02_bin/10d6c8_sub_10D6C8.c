// v23 annotated: sub_10D6C8 @ 0x10d6c8
// Original: 10d6c8_sub_10D6C8.c
// Primary struct: <unclustered>
//
// sub_10D6C8 @ 0x10d6c8, size 1016 bytes
int __fastcall sub_10D6C8(int a1, int a2)
{
  int v2; // r4
  ...
  while ( !*(_DWORD *)off_10D998 )
    ;
LABEL_5:
  if ( !*(_DWORD *)off_10D99C )
  {
    do
      v5 = *(_DWORD *)off_10D9A0 << 12;
    while ( (*(_DWORD *)off_10D9A0 & 0x80000) != 0 );
    *(_DWORD *)off_10D9A4 = 95;
  }
  v8 = *((_WORD *)off_10D9A8 + 89) & 0x4000;
  if ( (*((_WORD *)off_10D9A8 + 89) & 0x4000) == 0 )
  {
    v9 = v82;
    v10 = off_10D9A0;
    v11 = off_10D9A4;
  ...
  v16 = **(unsigned __int8 **)off_10D9AC;
  if ( v16 == 1 )
  {
    if ( **(_BYTE **)off_10D9B4 != 3 )
    {
      if ( v7 >= 124 )
        LOWORD(v7) = 124;
      sub_111130(19, v82, (unsigned __int16)v7);
    }
    goto LABEL_13;
  }
  if ( v16 != 2 )
    goto LABEL_13;
  v17 = (_BYTE **)off_10D9B4;
  if ( **(_BYTE **)off_10D9B4 == 3 )
  {
LABEL_19:
    v18 = dword_10D9B0;
...
LABEL_37:
  if ( *v27 )
  {
    ...
    v34 = (unsigned __int16 *)off_10D9F4;
    v35 = *(unsigned __int16 *)off_10D9F4;
    if ( v35 + v7 <= 1720 )
    {
      v81 = (int *)off_10DACC;
      sub_143630(*(_DWORD *)off_10DACC + v35, v82, v7);
  ...
  if ( v7 <= 122 )
    ...
    v43 = (*(int (__fastcall **)(_DWORD))(*(_DWORD *)(*(_DWORD *)off_10DAC8 + 8) + 16))(*(_DWORD *)(*(_DWORD *)off_10DAC8
                                                                                                  + 4));
  if ( v43 )
  {
