// v23 annotated: sub_116B0C @ 0x116b0c
// Original: 116b0c_sub_116B0C.c
// Primary struct: <unclustered>
//
// sub_116B0C @ 0x116b0c, size 474 bytes
int __fastcall sub_116B0C(int a1, int a2, char a3)
{
  int v4; // r0
  int v5; // r8
  int v8; // r3
  ...
  if ( (v4 & 0x200000) == 0 || (v4 & 0x380000) == 0x280000 )
  {
    ...
    {
      v16 = *(_DWORD *)(dword_116CF4 + 696 * *(unsigned __int8 *)(a1 + 29) + 340);
  ...
  *(_BYTE *)(v5 + 36) = a3;
  ...
  if ( *(unsigned __int16 *)(a1 + 24) == 36488 )
    sub_12E948(dword_116CF8, 36488, *(_DWORD *)(*(_DWORD *)(a1 + 76) + 36));
  v8 = *(_DWORD *)(a1 + 8);
  v9 = *(_DWORD *)(a1 + 72);
...
LABEL_8:
  if ( *((_BYTE *)off_116CE8 + 360) && (*(_WORD *)(a1 + 30) & 8) == 0 && (*(_DWORD *)(a1 + 8) & 0x40000000) == 0 )
    *(_BYTE *)(v9 + 61) = *((_BYTE *)off_116CE8 + 360);
  v10[4] = dword_116CEC;
  v10[2] = a1;
  v10[3] = a1;
