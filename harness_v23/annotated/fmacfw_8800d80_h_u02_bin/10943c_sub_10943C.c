// v23 annotated: sub_10943C @ 0x10943c
// Original: 10943c_sub_10943C.c
// Primary struct: <unclustered>
//
// sub_10943C @ 0x10943c, size 476 bytes
int __fastcall sub_10943C(unsigned int a1, int a2, int *a3)
{
  int v3; // r12
  int v4; // r4
  int *v5; // r6
  ...
  _BYTE v34[4]; // [sp+10h] [bp-4h] BYREF
...
LABEL_7:
  ...
  v12 = *((unsigned __int8 *)&v32 + 2 * v6 + 1);
  v22 = a3[v12];
  if ( v22 < dword_109618 || v11 < 1000 && v22 >= dword_10961C )
  {
LABEL_12:
    if ( v12 >= v4 + v3 )
      goto LABEL_13;
...
LABEL_14:
  if ( v6 <= 2 )
  {
    ...
    if ( v26 != 128 )
    {
      ...
      {
        v29 = a3[v28];
        if ( v29 >= dword_109618 && (v27 >= 1000 || v29 <= -1000) )
          v3 = 2;
      }
      if ( v28 < v3 + v26 )
      {
  ...
  if ( (unsigned __int8)v32 != 128 )
  {
    ...
    v31 = (unsigned __int8)(*((_BYTE *)&v32 + 2 * v17)
