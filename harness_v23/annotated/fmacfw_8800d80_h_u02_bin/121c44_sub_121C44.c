// v23 annotated: sub_121C44 @ 0x121c44
// Original: 121c44_sub_121C44.c
// Primary struct: <unclustered>
//
// sub_121C44 @ 0x121c44, size 610 bytes
unsigned int __fastcall sub_121C44(unsigned int a1)
{
  int v1; // r5
  int v2; // r7
  int v3; // r6
  ...
  if ( *(_BYTE *)(v1 + 696 * v4 + 36) == 1 )
  {
    ...
    if ( !v26 )
    {
      ...
      if ( v29[36] )
      {
        ...
        if ( v30 <= 0x1F )
        {
          v32 = (_BYTE *)sub_12C7EC(73, 13, 0, 2);
          *v32 = v27;
          v32[1] = 0;
          sub_12C84C(v32);
            ...
            do
            {
              if ( v36[146] )
              {
                ...
                *v33 = v44;
                ...
                sub_12D100(v37 - 40);
                v33 = (int *)off_121EC4;
                v46 = *(_DWORD *)off_121EC4 - 1;
                if ( *(_DWORD *)off_121EC4 )
                {
                  v34 = off_121EC8;
                  *(_DWORD *)off_121EC4 = v46;
                  if ( !v46 )
                  {
                    if ( *v34 )
                      __enable_irq();
      ...
      v31 = v10 + 1320 * v3;
      sub_136BD4(v31, (unsigned __int8)(*(_BYTE *)(v31 + 107) + 32));
