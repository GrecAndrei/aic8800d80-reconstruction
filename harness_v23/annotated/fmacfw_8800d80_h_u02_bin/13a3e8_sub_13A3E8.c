// v23 annotated: sub_13A3E8 @ 0x13a3e8
// Original: 13a3e8_sub_13A3E8.c
// Primary struct: <unclustered>
//
// sub_13A3E8 @ 0x13a3e8, size 280 bytes
int __fastcall sub_13A3E8(int a1, _DWORD *a2)
{
  int v3; // r7
  int v4; // r0
  int v5; // r3
  ...
  v5 = dword_13A500 + 696 * v4;
  v6 = *(_QWORD *)(v5 + 184);
  v7 = dword_13A504 + 1320 * *(unsigned __int8 *)(a1 + 28);
