// v23 annotated: sub_13C154 @ 0x13c154
// Original: 13c154_sub_13C154.c
// Primary struct: <unclustered>
//
// sub_13C154 @ 0x13c154, size 264 bytes
int __fastcall sub_13C154(int a1, int a2, int a3)
{
  int v4; // r3
  int v5; // r3
  int i; // r4
  ...
  if ( (*(_DWORD *)(dword_13C25C + v4 + 4) & 2) == 0 )
    return 1;
  ...
  if ( v12 < 0 )
  {
    if ( a3 )
    {
      if ( !a2 )
      {
        ...
        if ( ((v14 - (*((_DWORD *)off_13C264 + 4) >> 10)) & 0x8000) == 0 )
          sub_12E948(dword_13C268, 0, ((unsigned int)(v14 - (*((_DWORD *)off_13C264 + 4) >> 10)) >> 15) & 1);
      }
    }
    else if ( !a2 && ((*(unsigned __int16 *)(a1 + 64) - (*((_DWORD *)off_13C264 + 4) >> 10)) & 0x8000) == 0 )
    {
      i = 0;
