// v23 annotated: sub_116974 @ 0x116974
// Original: 116974_sub_116974.c
// Primary struct: <unclustered>
//
// sub_116974 @ 0x116974, size 384 bytes
int __fastcall sub_116974(int a1, int a2, int a3, int a4)
{
  int v5; // r6
  int result; // r0
  int v9; // r8
...
LABEL_11:
        if ( a4 == 4 )
        {
          v12 = dword_116AF8 + 1320 * *(unsigned __int8 *)(a2 + 28);
          v13 = *(_BYTE *)(v12 + 230);
        ...
        if ( *(unsigned __int8 *)(a2 + 27) == 255 )
        {
          ...
          {
            v16 = *((_WORD *)off_116AFC + 254);
          }
          else
          {
            v16 = *((_WORD *)off_116AFC + 254) + 1;
            *((_WORD *)off_116AFC + 254) = v16;
          }
          v17 = *(_WORD *)(a2 + 30);
          *(_WORD *)(v10 + 22) = v15 | (16 * v16);
          if ( (v17 & 8) != 0 )
          {
            ...
            if ( (v17 & 0x80) != 0 )
            {
              ...
              {
                sub_13C5D0(a2, v10, *(unsigned __int16 *)(a2 + 4));
              }
            }
          }
        }
...
LABEL_4:
  if ( (*(_DWORD *)(a1 + 36) & 0x200000) == 0 )
    return sub_116860(*(_DWORD *)(a1 + 76) + 12, *(_DWORD *)(a1 + 76) + 12, a4);
