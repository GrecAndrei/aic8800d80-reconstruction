// v23 annotated: sub_12A144 @ 0x12a144
// Original: 12a144_sub_12A144.c
// Primary struct: <unclustered>
//
// sub_12A144 @ 0x12a144, size 144 bytes
unsigned __int8 *__fastcall sub_12A144(unsigned __int8 *result, int a2)
{
  int v2; // r2
  int v3; // r7
  int v4; // r6
  ...
  if ( result[1224] )
  {
    ...
    *((_DWORD *)result + 1) = v6;
    ...
    v9 = a2 + (v5 << 10);
    if ( *(_BYTE *)(v4 + 112) || (v10 = a2 + 300, *((_DWORD *)off_12A1D8 + 4) - v10 + 50 >= 0) )
    {
