// v23 annotated: sub_111DBC @ 0x111dbc
// Original: 111dbc_sub_111DBC.c
// Primary struct: <unclustered>
//
// sub_111DBC @ 0x111dbc, size 316 bytes
int *__fastcall sub_111DBC(int *result, unsigned int a2, int a3, unsigned int a4)
{
  unsigned int v4; // r6
  unsigned int v7; // r11
  int v8; // r7
  ...
  if ( (unsigned __int8)(a2 - 1) <= 4u )
  {
    ...
    if ( result )
    {
      if ( (a3 & 0xFD) == 1 )
      {
        ...
        if ( a4 > 0x400 )
        {
          ...
          if ( v7 - 1025 < 0x400 )
            ...
            v18 = ((unsigned int)dword_111F00 * (unsigned __int64)v7) >> 32;
          if ( v19 )
            LOWORD(v7) = v18 >> 1;
        }
      }
      ...
      *((_DWORD *)&REG_4020_0900 + 8 * a2) = v7 & 0x7FF | v11 | (a2 << 22) | 0x18008000;
      ...
      v14 = off_111EFC;
      *((_DWORD *)off_111EFC + v4 + 65) = v13 | v10;
      v15 = (1 << a2) | v14[519];
      *v12 = v8 + v13;
      v14[519] = v15;
    }
