// v23 annotated: sub_142968 @ 0x142968
// Original: 142968_sub_142968.c
// Primary struct: <unclustered>
//
// sub_142968 @ 0x142968, size 412 bytes
int __fastcall sub_142968(__int64 a1, unsigned int a2, unsigned int a3)
{
  int v3; // r5
  unsigned int v4; // r12
  bool v5; // zf
