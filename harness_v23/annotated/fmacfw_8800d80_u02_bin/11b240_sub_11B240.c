// v23 annotated: sub_11B240 @ 0x11b240
// Original: 11b240_sub_11B240.c
...
int __fastcall sub_11B240(int *a1)
{
  ...
  v1 = (unsigned __int16 *)off_11B350;
  if ( *((unsigned __int8 *)off_11B350 + 197) > 3u )
    return 0;
  v2 = 3;
  v3 = dword_11B364;
  LOBYTE(v5) = 3;
...
LABEL_13:
      ...
      else
      {
        while ( 1 )
        {
          ...
          sub_11B1A8((int)v9, (unsigned __int8)v5);
          v9 = *(int **)(v10 + 12);
          if ( !v9 )
            goto LABEL_4;
          v11 = v9[9] & 0x200000;
...
LABEL_3:
      v6 = fm_rx_frame_handler(v13, a1, *((_DWORD *)v1 + 44), v1[93], *((_BYTE *)v1 + 190));
      if ( v6 )
      {
        if ( v9 )
          sub_11B1A8((int)v9, (unsigned __int8)v5);
        v16 = *(_DWORD *)(v13 + 68);
        if ( **(__int16 **)off_11B358 < 0 && !v16 )
