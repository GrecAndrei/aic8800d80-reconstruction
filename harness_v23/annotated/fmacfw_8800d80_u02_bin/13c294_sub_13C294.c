// v23 annotated: sub_13C294 @ 0x13c294
// Original: 13c294_sub_13C294.c
// Primary struct: <unclustered>
//
// sub_13C294 @ 0x13c294, size 264 bytes
int __fastcall sub_13C294(int a1, int a2, int a3)
{
  int v4; // r3
  int v5; // r3
  int i; // r4
  ...
  if ( (*(_DWORD *)(dword_13C39C + v4 + 4) & 2) == 0 )
    return 1;
  v5 = v4 + 12 * *(unsigned __int8 *)(a1 + 27) + dword_13C39C;
  --*(_BYTE *)(v5 + 455);
  if ( (*(_WORD *)(a1 + 30) & 2) == 0 )
    return 1;
  ...
  if ( v12 < 0 )
  {
    if ( a3 )
    {
      if ( !a2 )
      {
        ...
        if ( ((v14 - (*((_DWORD *)off_13C3A4 + 4) >> 10)) & 0x8000) == 0 )
          msg_parse(dword_13C3A8, 0, ((unsigned int)(v14 - (*((_DWORD *)off_13C3A4 + 4) >> 10)) >> 15) & 1);
      }
    }
    else if ( !a2 && ((*(unsigned __int16 *)(a1 + 64) - (*((_DWORD *)off_13C3A4 + 4) >> 10)) & 0x8000) == 0 )
    {
      i = 0;
