// v23 annotated: memcpy_aligned_n7c @ 0x143d7c
// Original: 143d7c_memcpy_aligned_n7c.c
...
unsigned int __fastcall memcpy_aligned_n7c(unsigned int result, unsigned int a2)
{
  _BYTE *v2; // r12
  int *v3; // r1
  int v4; // r3
