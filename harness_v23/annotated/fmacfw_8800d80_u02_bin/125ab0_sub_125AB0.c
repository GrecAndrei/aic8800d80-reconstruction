// v23 annotated: sub_125AB0 @ 0x125ab0
// Original: 125ab0_sub_125AB0.c
// Primary struct: <unclustered>
//
// sub_125AB0 @ 0x125ab0, size 496 bytes
int __fastcall sub_125AB0(int result)
{
  int *v1; // r4
  int v2; // r5
  int v3; // r6
  ...
  v1 = (int *)off_125CA4;
  v2 = *((_DWORD *)off_125CA4 + 1);
  v3 = result;
  if ( **(__int16 **)off_125CA0 >= 0 || v2 )
  {
    v4 = v2 - 1;
    *((_DWORD *)off_125CA4 + 1) = v4;
    if ( !v4 )
    {
LABEL_20:
      v16 = off_125CD0;
      ...
      if ( *v16 )
      {
        v25 = (_BYTE *)sub_12C92C(74, 13, v4, 4);
        *v25 = v17;
        v25[1] = v4;
        v25[2] = v4;
      ...
      if ( *(_BYTE *)off_125CD4 )
      {
        ...
        for ( i = 0; i != 4; ++i )
        {
          while ( *(_DWORD *)(v21 + 584) )
          {
            ...
            sub_13ABA8(v23, (unsigned __int8)i, v24);
          }
          if ( *(_DWORD *)(v21 + 624) )
          {
            v27 = rf_bus_mark_n100_d2d0(v5 + 8 * (87 * v17 + 78 + i));
            sub_13ABA8(v27, (unsigned __int8)i, v28);
      ...
      if ( v1[3] )
      {
        ...
        do
        {
          ...
          rf_parse_descriptor_n3f8((unsigned __int16 *)(v20 + 12));
        }
        while ( v1[3] );
      }
      result = *(unsigned __int8 *)(v3 + 107);
      if ( *((_BYTE *)v1 + result + 20) && !v1[1] )
        result = sub_12503C(result, *((unsigned __int8 *)v1 + result + 20));
      if ( *(_BYTE *)(v3 + 231) == 1 )
  ...
  v5 = dword_125CA8;
LABEL_4:
  v6 = (unsigned __int8 *)dword_125CA8;
  v7 = dword_125CAC;
  v8 = off_125CC8;
  v9 = dword_125CCC;
