// v23 annotated: sub_133630 @ 0x133630
// Original: 133630_sub_133630.c
// Primary struct: <unclustered>
//
// sub_133630 @ 0x133630, size 314 bytes
_DWORD *__fastcall sub_133630(_DWORD *result, int a2, unsigned int a3)
{
  unsigned int *v3; // r6
  char v4; // r1
  unsigned int v5; // r7
