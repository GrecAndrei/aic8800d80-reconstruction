// v23 annotated: sub_11DD44 @ 0x11dd44
// Original: 11dd44_sub_11DD44.c
...
_DWORD *__fastcall sub_11DD44(_DWORD *a1, int a2, _WORD *a3)
{
  int *v3; // r7
  int v4; // r10
  _DWORD *v5; // r6
  ...
  v5 = (_DWORD *)*a1;
  v6 = (__int16 **)off_11DE60;
  v7 = nullptr;
  *((_BYTE *)off_11DE50 + 32) = 1;
  v9 = 0;
  v25 = nullptr;
  while ( 1 )
  {
