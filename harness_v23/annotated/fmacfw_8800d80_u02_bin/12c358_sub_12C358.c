// v23 annotated: sub_12C358 @ 0x12c358
// Original: 12c358_sub_12C358.c
// Primary struct: <unclustered>
//
// sub_12C358 @ 0x12c358, size 178 bytes
int __fastcall sub_12C358(int a1)
{
  int v1; // r5
  int *v3; // r7
  int v4; // r8
  ...
  v1 = *(unsigned __int8 *)(dword_12C40C + a1);
  if ( a1 )
  ...
  v7 = v6;
  if ( *v3 && (v8 = *v3 - 1, v9 = *(_DWORD *)off_12C410, (*v3 = v8) == 0) && v9 )
  {
    __enable_irq();
    if ( **(__int16 **)off_12C418 >= 0 )
      goto LABEL_8;
  }
  else if ( **(__int16 **)off_12C418 >= 0 )
  {
    goto LABEL_8;
  }
  if ( !v6 )
