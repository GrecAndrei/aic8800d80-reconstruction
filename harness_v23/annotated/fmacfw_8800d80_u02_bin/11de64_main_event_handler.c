// v23 annotated: main_event_handler @ 0x11de64
// Original: 11de64_main_event_handler.c
...
_DWORD *__fastcall main_event_handler(_DWORD *a1, unsigned int a2, int a3, _DWORD *a4, int a5)
{
  ...
  signed int v19; // r2
  _DWORD *v20; // r3
  _WORD *v22; // [sp+Ch] [bp-8h]

  v5 = (unsigned __int8 **)off_11DF74;
  v6 = (_DWORD *)*a1;
  v7 = *(unsigned __int16 *)a4;
  v8 = **(unsigned __int8 **)off_11DF74;
  v9 = (__int16 **)off_11DF78;
  v22 = a4;
  if ( a2 >= 0x640 )
    a2 = 1600;
  if ( v8 == 3 )
