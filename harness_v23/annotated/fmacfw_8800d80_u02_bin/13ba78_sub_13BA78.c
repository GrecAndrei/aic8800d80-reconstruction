// v23 annotated: sub_13BA78 @ 0x13ba78
// Original: 13ba78_sub_13BA78.c
...
int __fastcall sub_13BA78(int **a1)
{
  int *v1; // r6
  int result; // r0
  unsigned int v3; // r4
  ...
  {
    v5 = v4[2];
    v6 = *((_DWORD *)off_13BAC0 + 4) - (_DWORD)v5;
    if ( v6 > v3 )
      result = *((unsigned __int8 *)v4 + 26);
    v4 = (int **)*v4;
    if ( v6 > v3 )
      v3 = *((_DWORD *)off_13BAC0 + 4) - (_DWORD)v5;
  }
  while ( v4 );
