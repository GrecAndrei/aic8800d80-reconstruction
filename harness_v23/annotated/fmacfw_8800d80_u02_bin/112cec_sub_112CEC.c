// v23 annotated: sub_112CEC @ 0x112cec
// Original: 112cec_sub_112CEC.c
...
int sub_112CEC()
{
  ...
  v0 = off_112F40;
  v1 = *((_DWORD *)off_112F40 + 5);
  *((_DWORD *)off_112F40 + 5) = v1;
  v2 = v0[6] & v1;
  LODWORD(v3) = v2 << 19;
  if ( (v2 & 0x1000) != 0 )
  {
  ...
  v22 = *((_DWORD *)off_112F40 + 514);
  if ( (v22 & 6) != 0 && (v22 & 2) != 0 )
    *(_DWORD *)off_112F54 = 1;
  v23 = off_112F40;
  v24 = (_DWORD **)off_112F58;
  v25 = (int *)off_112F5C;
  v26 = dword_112F60;
  *((_DWORD *)off_112F40 + 576) = dword_112F60;
  v23[704] = v26;
  v27 = *v24;
  v28 = *v25;
...
LABEL_3:
  if ( v5 )
  {
    v8 = off_112F40;
    v9 = dword_112F44;
    v5 = *((_DWORD *)off_112F40 + 518);
    v10 = 0;
    v11 = v5 & *((_DWORD *)off_112F40 + 519);
    while ( 1 )
    {
      LODWORD(v3) = 1;
      if ( ((1 << v10) & v11) != 0 )
        ...
        *((_DWORD *)v12 + 586) = v5;
        ...
        if ( (v3 & 0x900000000LL) != 0 )
        {
          if ( *(_BYTE *)(v9 - 5) )
          {
            ...
            v13 = *(int (__fastcall **)(int, int, BOOL))(dword_112F48 + 4 * v10 + 52);
            if ( v13 )
...
LABEL_14:
  ...
  if ( v6 )
  {
    ...
    v15 = dword_112F4C;
    v16 = dword_112F6C;
    v17 = *((_DWORD *)off_112F40 + 518) & *((_DWORD *)off_112F40 + 519);
    for ( i = 0; ; ++i )
    {
      if ( ((0x10000 << i) & v17) != 0 )
      {
        ...
        *((_DWORD *)v19 + 714) = v5;
        if ( (v14[517] & v5 & 1) != 0 )
        {
          if ( *(_BYTE *)(v15 - 8) )
          {
            ...
            v29 = *(int (__fastcall **)(int, int, _DWORD))(4 * i + dword_112F48 + 32);
            if ( v29 )
