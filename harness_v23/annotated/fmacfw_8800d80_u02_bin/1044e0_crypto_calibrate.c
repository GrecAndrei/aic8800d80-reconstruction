// v23 annotated: crypto_calibrate @ 0x1044e0
// Original: 1044e0_crypto_calibrate.c
...
int crypto_calibrate()
{
  ...
  v1 = off_1045BC;
  v2 = dword_1045C0;
  v3 = *(_DWORD *)off_1045B8;
  *(_DWORD *)off_1045B8 = dword_1045C4;
  *v0 = v2;
  v4 = off_1045C8;
  v5 = (int *)off_1045CC;
  ...
  *(_DWORD *)off_1045B8 = v3;
  crypto_iq_calculate();
  result = feature_guard_check(1, dword_1045E0);
  v8 = off_1045BC;
  v9 = off_1045E4;
  *(_DWORD *)off_1045BC &= 0xF3FFFFFF;
  *v9 |= 0xF0u;
  *v8 &= ~0x10000000u;
  *v8 &= 0x3FFFFFFFu;
  return result;
