// v23 annotated: sub_101D58 @ 0x101d58
// Original: 101d58_sub_101D58.c
...
int __fastcall sub_101D58(unsigned int a1, signed int a2, unsigned __int8 *a3)
{
  int v3; // r6
  unsigned int v4; // r7
  bool v5; // cc
...
LABEL_12:
    ...
    v12 = *(_BYTE *)(*(_DWORD *)off_101F00 + v11 + v9) + *(_BYTE *)(dword_101F04 + v10 + 8) + *(_BYTE *)off_101F08;
    v13 = v12;
    if ( *((_BYTE *)off_101EFC + 396) )
      v8 = (char)(*(_BYTE *)(*(_DWORD *)off_101F0C + v11) + v8);
    goto LABEL_18;
  }
  ...
  v12 = *(_BYTE *)(*(_DWORD *)off_101F10 + v21 + v19) + *(_BYTE *)(dword_101F04 + v20 + 11) + *((_BYTE *)off_101F08 + 1);
  v13 = v12;
  if ( *((_BYTE *)off_101EFC + 396) )
    v8 = (char)(*(_BYTE *)(*(_DWORD *)off_101F14 + v21) + v8);
LABEL_18:
  if ( (*((_DWORD *)off_101EFC + 98) & 2) != 0 )
  {
