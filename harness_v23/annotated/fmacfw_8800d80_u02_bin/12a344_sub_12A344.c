// v23 annotated: sub_12A344 @ 0x12a344
// Original: 12a344_sub_12A344.c
// Primary struct: <unclustered>
//
// sub_12A344 @ 0x12a344, size 164 bytes
unsigned int __fastcall sub_12A344(_BYTE *a1, int a2, int a3)
{
  unsigned int v3; // r4
  unsigned int v5; // r0
  int v8; // r7
...
LABEL_19:
    ...
    sub_129D88(v5, v3, *(_DWORD *)(*(_DWORD *)(*(_DWORD *)(a3 + 8) + 8) + 24));
    return v3;
  }
  return 0;
}
