// v23 annotated: log_free_pool_d_3a48 @ 0x113a48
// Original: 113a48_log_free_pool_d_3a48.c
...
int log_free_pool_d_3a48()
{
  ...
  {
    __disable_irq();
    *(_DWORD *)rf_msg_process_body_n_1c8 = 1;
  }
  v0 = (int *)rf_msg_process_body_n_1c4;
  v1 = rf_msg_process_body_n_1c0;
  ++*(_DWORD *)rf_msg_process_body_n_1c4;
  result = list_push_tail(v1);
  if ( *v0 )
  {
    v3 = *v0 - 1;
    v4 = *(_DWORD *)rf_msg_process_body_n_1c8;
    *v0 = v3;
    if ( !v3 )
    {
      if ( v4 )
