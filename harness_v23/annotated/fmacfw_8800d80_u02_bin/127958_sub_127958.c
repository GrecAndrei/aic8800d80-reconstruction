// v23 annotated: sub_127958 @ 0x127958
// Original: 127958_sub_127958.c
// Primary struct: <unclustered>
//
// sub_127958 @ 0x127958, size 186 bytes
int __fastcall sub_127958(int result, __int16 a2)
{
  int v2; // r8
  int v3; // r7
  int v4; // r5
  ...
  {
    v6 = result;
    result = sub_12A198(dword_127A18 + 1320 * v3, *(unsigned __int8 *)(result + 87));
    v8 = *(_DWORD *)(v6 + 92);
