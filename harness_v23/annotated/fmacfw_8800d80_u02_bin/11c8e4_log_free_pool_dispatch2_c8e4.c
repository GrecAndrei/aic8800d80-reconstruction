// v23 annotated: log_free_pool_dispatch2_c8e4 @ 0x11c8e4
// Original: 11c8e4_log_free_pool_dispatch2_c8e4.c
...
void log_free_pool_dispatch2_c8e4()
{
  _DWORD *v0; // r2
  _DWORD *v1; // r7
  int v2; // r3
...
LABEL_5:
      ...
      *(_WORD *)(*(_DWORD *)(v6 + 36) + 8) |= 0x10u;
      rf_bus_mark_n100_d2d0(v6 + 28);
      irq_nesting_or_d104(*(_DWORD *)(dword_11CA6C + 4 * v3));
      *(_BYTE *)(v6 + 26) = 0;
      *(_DWORD *)(v6 + 36) = 0;
    }
    else
