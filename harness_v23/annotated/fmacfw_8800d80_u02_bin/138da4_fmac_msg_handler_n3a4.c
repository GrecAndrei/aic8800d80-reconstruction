// v23 annotated: fmac_msg_handler_n3a4 @ 0x138da4
// Original: 138da4_fmac_msg_handler_n3a4.c
...
int __fastcall fmac_msg_handler_n3a4(unsigned int a1, int a2, int a3, int a4)
{
  _DWORD *v4; // r8
  unsigned int v5; // r4
  int v8; // r5
  ...
  else
  {
    ...
    if ( a4 && v5 <= 7 )
    {
      v44 = v10;
      v32 = (_BYTE *)(v8 + v9[2]);
      fmac_data_unpack_n_630((_DWORD *)a2, v10, v5);
      v33 = (char *)&v45;
    ...
    fmac_data_unpack_n_630((_DWORD *)a2, v10, 8u);
    v11 = *((unsigned __int8 *)v4 + 8);
    v12 = *((unsigned __int8 *)v4 + 8);
  }
  v13 = v9[2];
...
LABEL_11:
    fmac_data_unpack_n_630((_DWORD *)a2, v17, v14);
  }
  else
  {
    ...
    while ( 1 )
    {
      ...
      fmac_data_unpack_n_630((_DWORD *)a2, v17, (unsigned __int16)(v15 - v12));
      v12 = 0;
      if ( !(_WORD)v14 )
        break;
      v9 = (_DWORD *)v9[1];
