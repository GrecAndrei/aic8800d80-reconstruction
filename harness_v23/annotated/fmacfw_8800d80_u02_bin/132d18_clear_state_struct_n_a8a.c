// v23 annotated: clear_state_struct_n_a8a @ 0x132d18
// Original: 132d18_clear_state_struct_n_a8a.c
...
int __fastcall clear_state_struct_n_a8a(int result, _BYTE *a2, int a3)
{
  unsigned int v3; // r4
  unsigned int v4; // r2
  int v5; // r1
...
LABEL_29:
                  if ( v5 != 40 )
                  {
                    if ( v5 > 40 && *((_BYTE *)off_13245C + 373) == 4 )
                      goto LABEL_32;
                    goto LABEL_37;
                  }
