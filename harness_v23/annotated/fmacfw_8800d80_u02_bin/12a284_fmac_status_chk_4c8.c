// v23 annotated: fmac_status_chk_4c8 @ 0x12a284
// Original: 12a284_fmac_status_chk_4c8.c
...
unsigned __int8 *__fastcall fmac_status_chk_4c8(unsigned __int8 *result, int a2)
{
  int v2; // r2
  int v3; // r7
  int v4; // r6
