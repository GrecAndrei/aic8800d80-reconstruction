// v23 annotated: mmio_status_check_mask_40001 @ 0x12bff0
// Original: 12bff0_mmio_status_check_mask_40001.c
...
int __fastcall mmio_status_check_mask_40001(int result, int a2, int a3, int a4)
{
  int v4; // r1
  int v5; // r4
  int v6; // r3
  ...
  v4 = *(_DWORD *)off_12C184;
  v5 = *(_DWORD *)off_12C188 & *(_DWORD *)off_12C184;
  v6 = dword_12C18C & v5;
  *((_DWORD *)off_12C184 + 1) = v5;
  if ( v6 )
  ...
  if ( (v5 & 0x10000000) != 0 )
  {
    v7 = *(_DWORD *)off_12C1A0;
    *((_BYTE *)off_12C1A4 + 30) |= *(_BYTE *)off_12C1A0 & 0x3F;
    result = irq_nesting_or_d104(0x40000);
    *(_DWORD *)off_12C1A8 = v7;
  }
