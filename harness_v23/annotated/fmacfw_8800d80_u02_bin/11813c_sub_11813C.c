// v23 annotated: sub_11813C @ 0x11813c
// Original: 11813c_sub_11813C.c
// Primary struct: <unclustered>
//
// sub_11813C @ 0x11813c, size 2000 bytes
int __fastcall sub_11813C(int a1)
{
  int v1; // s16
  int v2; // r4
  int result; // r0
  ...
  v2 = *(_DWORD *)(dword_118438 + 4 * a1);
  if ( **(__int16 **)off_118430 < 0 && (v2 & *(_DWORD *)off_11891C) == 0 )
    sub_12F46C(dword_118924, dword_118920, 612);
  clear_flags(v2);
  result = sub_12D240(v68);
  v4 = *(_DWORD *)(dword_118434 + 8 * a1);
  if ( v4 )
  {
    v5 = (int *)off_11843C;
    v61 = 0;
    ...
    do
    {
      ...
      if ( *((_BYTE *)off_118440 + 512) == 1 )
      {
        *((_BYTE *)off_118440 + 512) = 0;
...
LABEL_39:
          ...
          v25 = *(_DWORD *)(v7 + 4);
          v63 = v25;
          if ( *(_BYTE *)(dword_11844C + 696 * v9 + 36) != 1 || (v25 & 0x810000) != 0x10000 )
            sub_13EAE0(v4);
          v26 = dword_118458;
          ...
          if ( *(unsigned __int8 *)(v4 + 29) > 0x1Fu
            ...
            || !*(_BYTE *)(dword_118458 + 1320 * v24 + 108) )
          {
LABEL_53:
...
LABEL_54:
              ...
              else
              {
                ...
                if ( v30 <= 0x1F )
                {
                  ...
                  if ( v31 <= 8 )
                    *(_DWORD *)(dword_118448 + 4 * (9 * v30 + v31 + 2062)) -= *(unsigned __int16 *)(v4 + 4);
                }
                sub_116E50(v4);
                rf_status_check(v4, (_DWORD *)(v7 + 4));
                if ( (*(_WORD *)(v4 + 30) & 1) != 0 )
...
LABEL_94:
          ...
          if ( *(_BYTE *)(dword_118928 + 696 * v9 + 36) != 1 )
          {
            if ( (v29 & 2) == 0 )
              goto LABEL_132;
...
LABEL_132:
          ...
          v57 = *(_DWORD *)(v4 + 76);
          v58 = dword_11890C;
          *(_WORD *)(v4 + 64) = *((_WORD *)off_118934 + 22) + (*((_DWORD *)off_118930 + 4) >> 10);
          *(_DWORD *)(v4 + 68) = 0;
          *(_DWORD *)(v57 + 72) = 0;
          *(_DWORD *)(v57 + 4) = 0;
          *(_WORD *)(v4 + 82) = 0;
      ...
      *(_DWORD *)(v7 + 4) = v10;
      ...
      if ( (*(_DWORD *)(v4 + 36) & 0x380000) == 0x380000 )
      {
        ...
        if ( *(_BYTE *)(dword_1186F8 + 696 * v9 + 36) != 1 || v11 )
...
LABEL_24:
      ...
      if ( v17 <= 0x1F )
      {
        ...
        if ( v18 <= 8 )
          *(_DWORD *)(dword_118448 + 4 * (9 * v17 + v18 + 2062)) -= *(unsigned __int16 *)(v4 + 4);
      }
      rf_status_check(v4, (_DWORD *)(v7 + 4));
...
LABEL_31:
      ...
      if ( v12 )
      {
        ...
        {
LABEL_117:
          if ( scan_chan_setup_n134(v67) && !*((_BYTE *)off_118910 + 511) )
          {
            do
            {
