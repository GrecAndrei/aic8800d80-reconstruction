// v23 annotated: sub_12EB18 @ 0x12eb18
// Original: 12eb18_sub_12EB18.c
// Primary struct: <unclustered>
//
// sub_12EB18 @ 0x12eb18, size 404 bytes
unsigned int __fastcall sub_12EB18(unsigned int result, int a2, int a3, int a4)
{
  int v4; // r4
  int v5; // r9
  unsigned int v6; // r5
  ...
  while ( 1 )
  {
    ...
    {
      if ( !v24 )
        return (unsigned int)sub_10D7B4((_BYTE *)dword_12ECB8);
      v21 = dword_12ECB0;
      v22 = 0;
      while ( 1 )
      {
...
LABEL_31:
    result = (unsigned int)sub_10D7B4((_BYTE *)dword_12ECB8);
    v24 -= v7;
    if ( !v24 )
      return result;
  }
  ...
  do
  {
    while ( 1 )
    {
      ...
      if ( v4 != 4 )
        break;
      v11 += 4;
      sub_12EA88(dword_12ECB0, *(_DWORD *)v10);
      v10 += 2;
      if ( v7 <= v11 )
        goto LABEL_18;
    }
