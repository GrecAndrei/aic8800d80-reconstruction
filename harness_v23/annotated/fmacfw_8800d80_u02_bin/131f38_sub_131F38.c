// v23 annotated: sub_131F38 @ 0x131f38
// Original: 131f38_sub_131F38.c
// Primary struct: <unclustered>
//
// sub_131F38 @ 0x131f38, size 328 bytes
int __fastcall sub_131F38(int a1, int a2, __int16 a3, __int16 a4)
{
  _BYTE *v4; // r4
  int v8; // r1
  int v9; // r2
  ...
  *((_WORD *)v4 + 22) = v18;
  ...
  {
    *((_WORD *)v4 + 4) = 255;
    v33 = (_BYTE *)sub_12C92C(49, 0, 5, 1u);
    *v33 = v4[376];
