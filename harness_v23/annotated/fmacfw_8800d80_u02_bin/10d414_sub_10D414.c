// v23 annotated: sub_10D414 @ 0x10d414
// Original: 10d414_sub_10D414.c
...
int __fastcall sub_10D414(int a1, int a2, int a3)
{
  int *v6; // r1
  int result; // r0
  int v8; // r12
  ...
  *(_DWORD *)(a2 + 32) = 0;
  ...
  v6 = (int *)off_10D598;
  result = *(_DWORD *)off_10D598;
  v8 = *(_DWORD *)off_10D598 + 1;
  dword_40021000[16 * a3] |= 1u;
  *v6 = v8;
  while ( (dword_40021000[16 * a3] & 0x10000) == 0 )
    ;
  v9 = dword_10D5A4;
  v10 = *(_DWORD *)(dword_10D5A4 + 4 * a3);
