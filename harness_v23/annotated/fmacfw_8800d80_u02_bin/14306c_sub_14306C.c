// v23 annotated: sub_14306C @ 0x14306c
// Original: 14306c_sub_14306C.c
// Primary struct: <unclustered>
//
// sub_14306C @ 0x14306c, size 158 bytes
unsigned int __fastcall sub_14306C(unsigned int a1, int a2)
{
  unsigned int v2; // r12
  bool v3; // cf
  bool v4; // cc
