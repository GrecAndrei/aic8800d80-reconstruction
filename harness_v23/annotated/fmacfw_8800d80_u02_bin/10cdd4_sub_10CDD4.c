// v23 annotated: sub_10CDD4 @ 0x10cdd4
// Original: 10cdd4_sub_10CDD4.c
// Primary struct: <unclustered>
//
// sub_10CDD4 @ 0x10cdd4, size 936 bytes
int __fastcall sub_10CDD4(unsigned __int16 *a1)
{
  ...
  v41 = off_10D0AC;
  while ( !*(_DWORD *)off_10D0AC )
    ;
  if ( !*(_DWORD *)(*(_DWORD *)off_10D0B0 + 516) )
  {
  ...
  v42 = sub_12D2D0(*(_DWORD *)off_10D0B0 + 516);
...
LABEL_3:
  if ( v3 == 1 )
  {
    if ( a1[5] <= 0x6Cu )
      ...
      v6 = (*(int (__fastcall **)(_DWORD))(*(_DWORD *)(*(_DWORD *)off_10D0CC + 8) + 16))(*(_DWORD *)(*(_DWORD *)off_10D0CC + 4));
    if ( !v6 )
      goto LABEL_59;
    v34 = a1[3];
    v35 = a1[4];
    *(_DWORD *)(v6 + 12) = dword_10D0D0;
    v36 = *v1;
    *(_WORD *)(v6 + 6) = v34;
    *(_WORD *)(v6 + 8) = v35;
    v5 = v6 + 4;
...
LABEL_5:
  ...
  if ( a1[5] <= 0x6Cu )
    ...
    v6 = (*(int (__fastcall **)(_DWORD))(*(_DWORD *)(*(_DWORD *)off_10D0CC + 8) + 16))(*(_DWORD *)(*(_DWORD *)off_10D0CC
                                                                                                 + 4));
  if ( !v6 )
  {
LABEL_59:
  ...
  if ( !*((_DWORD *)off_10D0B8 + 2057) )
  {
    ...
    v46 = (int *)off_10D184;
    ++*(_DWORD *)off_10D184;
    ((void (*)(void))sub_1134B4)();
    if ( *v46 )
    {
      v48 = *v46 - 1;
      v47 = *(_DWORD *)off_10D180;
      *v46 = v48;
      if ( !v48 )
      {
        if ( v47 )
    ...
    v51 = sub_12D36C(dword_10D188, v47);
    v50 = sub_12D36C(dword_10D18C, v49);
...
LABEL_16:
  ...
  while ( !*(_DWORD *)off_10D0AC )
    ;
  sub_12D248(*(_DWORD *)off_10D0B0 + 524);
  v11 = off_10D0B4;
  *v10 = 1;
  *v11 = 2;
  v9 = **v1;
