// v23 annotated: sub_13C518 @ 0x13c518
// Original: 13c518_sub_13C518.c
...
unsigned int __fastcall sub_13C518(unsigned __int8 *a1, int a2, int a3, _BYTE *a4)
{
  int v4; // r6
  int v5; // r11
  int v6; // r9
  ...
  if ( v12 == 255 )
    goto LABEL_9;
  v13 = v10;
  if ( !*(_DWORD *)(dword_13C690 + 1320 * v12 + 1200) )
    return 0;
  if ( (a1[48] & 8) == 0 )
  {
    if ( (*(_DWORD *)(dword_13C694 + 696 * v11 + 4) & 8) != 0 && (v5 & 0x4000) == 0 )
    {
      v27 = v5 & 0xFC;
...
LABEL_9:
  ...
  {
    if ( *(_DWORD *)(dword_13C690 + 1320 * v12 + 1204) )
    {
      if ( v4 + 19 >= v10 )
        goto LABEL_9;
      v15 = sub_12DBA0((_BYTE *)(v4 + a2 + 2), (unsigned __int16)(v10 - 2 - v4));
      if ( !v15 )
        goto LABEL_9;
