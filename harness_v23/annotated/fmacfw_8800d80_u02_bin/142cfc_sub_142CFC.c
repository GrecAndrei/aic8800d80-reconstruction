// v23 annotated: sub_142CFC @ 0x142cfc
// Original: 142cfc_sub_142CFC.c
// Primary struct: <unclustered>
//
// sub_142CFC @ 0x142cfc, size 360 bytes
unsigned int __fastcall sub_142CFC(unsigned int result, unsigned int a2, unsigned int a3, unsigned int a4)
{
  int v4; // r5
  unsigned int v5; // r12
  bool v6; // zf
