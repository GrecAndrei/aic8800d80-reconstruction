// v23 annotated: sub_12D788 @ 0x12d788
// Original: 12d788_sub_12D788.c
...
unsigned __int8 *__fastcall sub_12D788(unsigned __int8 *a1, int a2, unsigned __int8 *a3, int a4, _WORD *a5)
{
  unsigned int v5; // r9
  unsigned int v6; // r7
  int v7; // lr
  ...
  {
LABEL_15:
    if ( **(__int16 **)off_12D820 < 0 && (unsigned __int8 *)v6 != a1 )
