// v23 annotated: sub_120038 @ 0x120038
// Original: 120038_sub_120038.c
// Primary struct: <unclustered>
//
// sub_120038 @ 0x120038, size 326 bytes
__int64 __fastcall sub_120038(unsigned __int8 *a1, char a2)
{
  int v3; // r6
  int v4; // r8
  int v5; // r4
  ...
  switch ( v6[576] )
  {
    case 0:
    case 3:
      *(_QWORD *)(1320 * v4 + 120 * v3 + v5 + 552) = sub_14397C(v9) & 0xFFFFFFLL;
      break;
    case 1:
