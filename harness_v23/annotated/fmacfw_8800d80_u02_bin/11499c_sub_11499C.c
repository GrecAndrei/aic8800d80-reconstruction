// v23 annotated: sub_11499C @ 0x11499c
// Original: 11499c_sub_11499C.c
...
int __fastcall sub_11499C(int a1, int a2)
{
  int v3; // r1
  int v4; // r2
  int v5; // r7
  ...
  v3 = *(_DWORD *)(rf_fault_dump_4a38 + 4);
  v4 = *(_DWORD *)(rf_fault_dump_4a38 + 8);
  v18[0] = *(_DWORD *)rf_fault_dump_4a38;
  v18[1] = v3;
  v18[2] = v4;
  v5 = v18[a1];
  v16 = MEMORY[0x1FC](v5);
