// v23 annotated: sub_128888 @ 0x128888
// Original: 128888_sub_128888.c
...
int __fastcall sub_128888(int a1, int a2)
{
  __int16 **v2; // r10
  int v3; // r8
  int v4; // r7
  ...
  if ( **(__int16 **)off_128ACC >= 0
    || *(_DWORD *)(dword_128A9C + 1320 * a1 + 72) && (sub_12F46C(dword_128AB4, dword_128AB0, 3061), **v2 >= 0) )
  {
    v8 = 8 * a2;
  }
  else
  ...
  *(_BYTE *)(v11 + 85) = 0;
  ...
  v13[86] = -1;
  if ( v14 && *(_BYTE *)(dword_128AA4 + 140 * (unsigned __int8)v13[1225] + 112) == 1 )
  {
    v13[85] |= 0x10u;
  }
  else
