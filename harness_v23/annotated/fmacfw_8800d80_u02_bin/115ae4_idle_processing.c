// v23 annotated: idle_processing @ 0x115ae4
// Original: 115ae4_idle_processing.c
...
int __fastcall idle_processing(int result)
{
  _BYTE **v1; // r5
  ...
  if ( *(_BYTE *)ipc_doorbell_handler_n37c && (*((_DWORD *)ipc_doorbell_handler_n380 + 4) & 0xFFFF00) == 0x10000 )
  {
    v6 = *(unsigned __int8 *)off_115D1C;
    *(_BYTE *)rf_level_apply_n3aa = 0;
    if ( v6 )
    ...
    if ( !*(_BYTE *)off_115D30
      && !*((_DWORD *)ipc_doorbell_handler_n38c + 126)
      && ((ipc_doorbell_handler_n3bc & *(_DWORD *)off_115D34) == 0
       || (unsigned int)(32 * *(_DWORD *)ipc_doorbell_handler_n3c0) > 0x1387) )
    {
  ...
  if ( *((_BYTE *)ipc_doorbell_handler_n380 + 18) )
  {
    v5 = ipc_doorbell_handler_n398;
    goto ipc_doorbell_handler_n20e;
  }
  v1 = (_BYTE **)ipc_doorbell_handler_n384;
  if ( **(_BYTE **)ipc_doorbell_handler_n384 )
  {
  ...
  v5 = ipc_doorbell_handler_n398;
  *(_BYTE *)ipc_doorbell_handler_n398 = 1;
  if ( !v4 )
  {
ipc_doorbell_handler_n2c8:
    v2 = (unsigned __int8 **)rf_bus_reset2_5d04;
    if ( **(_BYTE **)rf_bus_reset2_5d04 == 3 )
...
ipc_doorbell_handler_n1a0:
    ...
    if ( result )
    {
      if ( !*((_DWORD *)ipc_doorbell_handler_n38c + 126) )
      {
        if ( (*(_DWORD *)ipc_doorbell_handler_n390 >> 25) & 1 | *((unsigned __int8 *)ipc_doorbell_handler_5d10 + 36) )
        {
          if ( !*((_BYTE *)ipc_doorbell_handler_5d10 + 29) )
          {
            result = sub_12BD40();
            if ( result )
            {
              ...
              *(_BYTE *)rf_level_apply_n3aa = result;
              if ( !(_BYTE)result )
              {
