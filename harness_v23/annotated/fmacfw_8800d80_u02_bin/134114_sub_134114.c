// v23 annotated: sub_134114 @ 0x134114
// Original: 134114_sub_134114.c
// Primary struct: <unclustered>
//
// sub_134114 @ 0x134114, size 570 bytes
int __fastcall sub_134114(int a1, unsigned __int8 *a2)
{
  int v3; // r5
  int v4; // r8
  int v5; // r11
  ...
  if ( **(__int16 **)off_134350 < 0 && msg_get_value(6u) != 3 )
  ...
  else
  {
    ...
    v8 = (_DWORD *)(dword_134364 + 1320 * v7);
    v9 = v8[106];
    v10 = v8[107];
    v11 = v8[108];
    v12 = v8[109];
