// v23 annotated: sub_118DC4 @ 0x118dc4
// Original: 118dc4_sub_118DC4.c
// Primary struct: <unclustered>
//
// sub_118DC4 @ 0x118dc4, size 362 bytes
int __fastcall sub_118DC4(int a1, int a2, int a3)
{
  int v3; // r9
  int v4; // r5
  int v6; // r10
  ...
  v8 = *(_DWORD *)(dword_118F30 + 1320 * v6 + 72);
  if ( !v8 )
  {
...
LABEL_4:
  ...
  v20 = *((_WORD *)off_118F38 + 254) + 1;
  *((_WORD *)off_118F38 + 254) = v20;
