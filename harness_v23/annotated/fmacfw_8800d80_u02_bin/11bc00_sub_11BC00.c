// v23 annotated: sub_11BC00 @ 0x11bc00
// Original: 11bc00_sub_11BC00.c
// Primary struct: <unclustered>
//
// sub_11BC00 @ 0x11bc00, size 374 bytes
unsigned __int8 *__fastcall sub_11BC00(unsigned __int8 *result)
{
  unsigned int v1; // r4
  int v2; // r5
  ...
  if ( !result[106] )
  {
    ...
    {
      v24 = result[116];
      v2 = dword_11BD78 + 696 * v24;
      if ( *(_BYTE *)(v2 + 37) )
      {
        if ( (*(_DWORD *)(v2 + 4) & 0x20) != 0 )
        {
          memset_thunk(v25, v1, 0x10u);
          v3 = (unsigned __int8 *)dword_11BD80;
          v23 = v1;
          v4 = 36 * *(unsigned __int8 *)(v2 + 35) + 8244 + dword_11BD7C;
          v5 = dword_11BD80 + 8;
          v6 = v1;
          v7 = v1;
          v8 = v1;
          ...
          do
          {
            ...
            if ( v10 )
            {
              v13 = *(unsigned __int8 *)(dword_11BD84 + *v3);
              v14 = &v25[v13 + 4];
              v15 = *(v14 - 4) + v12;
              if ( v15 > v8 )
              {
                v8 = *(v14 - 4) + v12;
                v23 = *(unsigned __int8 *)(dword_11BD84 + *v3);
              }
          ...
          *(_DWORD *)(dword_11BD78 + 696 * v24 + 580) = (v18 << 24) | (v23 << 12) | v17 | v16 | v20 | (v19 << 16) | 0xF;
