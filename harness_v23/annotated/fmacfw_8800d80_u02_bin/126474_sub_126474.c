// v23 annotated: sub_126474 @ 0x126474
// Original: 126474_sub_126474.c
// Primary struct: <unclustered>
//
// sub_126474 @ 0x126474, size 258 bytes
BOOL __fastcall sub_126474(int a1, int a2, int a3)
{
  int v6; // r5
  int v7; // r3
  int v8; // r9
  ...
  {
    v7 = dword_126578 + 1320 * *(unsigned __int8 *)(a3 + 8);
    if ( *(_BYTE *)(v7 + 106) )
    {
      if ( *(_BYTE *)(v7 + 106) == 2 )
      {
    ...
    {
      v9 = *(_DWORD *)(dword_126580 + 696 * *(unsigned __int8 *)(v7 + 116) + 8);
      v8 = v9 >> 1;
    }
    v10 = *(_DWORD *)(a3 + 4);
    v11 = v10 + 10000 + sub_1019F0();
    v12 = sub_12A198(a1, *(unsigned __int8 *)(a3 + 11));
    v13 = v12 - a2;
    if ( v12 - a2 + v8 < 0 )
    {
      do
