// v23 annotated: rf_stream_start2_ne6 @ 0x1236e8
// Original: 1236e8_rf_stream_start2_ne6.c
...
int __fastcall rf_stream_start2_ne6(int a1, unsigned __int8 *a2, int a3, int a4)
{
  int v5; // r6
  int v6; // r0
  int v7; // r1
