// v23 annotated: sub_1199C8 @ 0x1199c8
// Original: 1199c8_sub_1199C8.c
// Primary struct: <unclustered>
//
// sub_1199C8 @ 0x1199c8, size 868 bytes
int __fastcall sub_1199C8(int a1, int *a2, unsigned int a3, unsigned int a4, unsigned __int8 a5)
{
  int v5; // r5
  int v7; // r4
  int v8; // s16
  ...
  if ( !rx_desc_compare_n6e0(a1, v7, a5)
    || (v12 = off_119CE4, *(unsigned __int8 *)(*(_DWORD *)off_119CE4 + 62) > (*(_DWORD *)off_119CCC & 0x3Fu)) )
  {
    sub_12D290(v8, v5);
    return 0;
  }
...
LABEL_7:
    if ( *(unsigned __int8 *)(*(_DWORD *)v12 + 62) > (*v48 & 0x3Fu) )
      goto LABEL_17;
    if ( *(_DWORD *)(v24 + 28) )
      *(_DWORD *)(*(_DWORD *)(v24 + 32) - 3) = *((_DWORD *)off_119CD0 + 43);
    v21 = *(_WORD *)(v7 + 80);
    v22 = *(_WORD *)(v5 + 10);
    *(_DWORD *)(v7 + 68) = v5;
    *(_WORD *)(v5 + 10) = v22 + v21;
    ...
    *(_DWORD *)(v9 + 40) -= v19;
    ...
    {
      v37 = dword_119CC8 + 84 * a5;
      v38 = *(_BYTE *)(v37 + 80);
      v39 = *(_DWORD *)off_119CD8;
      *(_DWORD *)(v5 + 324) = v7;
      *(_BYTE *)(v37 + 80) = v38 - 1;
      if ( !*(_BYTE *)(v39 + 1) )
