// v23 annotated: mmio_write_status_n_3a4 @ 0x1370cc
// Original: 1370cc_mmio_write_status_n_3a4.c
...
int __fastcall mmio_write_status_n_3a4(int a1, int a2, int a3, int a4)
{
  _WORD *v4; // r2
  __int64 v6; // r0
  _BYTE *v8; // r0
