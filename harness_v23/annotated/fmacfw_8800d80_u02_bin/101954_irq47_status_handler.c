// v23 annotated: irq47_status_handler @ 0x101954
// Original: 101954_irq47_status_handler.c
// Primary struct: irq_status (cluster 11, 1 funcs)
// Fields: prev_ptr=0x-8, status=0x0
//
