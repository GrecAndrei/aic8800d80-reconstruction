// v23 annotated: sub_13EC70 @ 0x13ec70
// Original: 13ec70_sub_13EC70.c
// Primary struct: <unclustered>
//
// sub_13EC70 @ 0x13ec70, size 1094 bytes
int __fastcall sub_13EC70(int a1)
{
  char v1; // r3
  int result; // r0
  int v4; // r5
    ...
    switch ( (char)v4 )
    {
      case 1:
        ...
        else if ( ((v26 >> 11) & 5) == 5 )
        {
          ...
          HIWORD(v50) = v26
                      | (((_WORD)v37
                        - (((((unsigned int)dword_13F0B8 * (unsigned __int64)(unsigned int)v37) >> 32) & 0xFFFE)
