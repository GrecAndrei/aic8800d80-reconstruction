// v23 annotated: sub_13E1D0 @ 0x13e1d0
// Original: 13e1d0_sub_13E1D0.c
// Primary struct: <unclustered>
//
// sub_13E1D0 @ 0x13e1d0, size 160 bytes
int __fastcall sub_13E1D0(int result, int a2)
{
  unsigned int v2; // r11
  int v4; // r9
  int v5; // r5
