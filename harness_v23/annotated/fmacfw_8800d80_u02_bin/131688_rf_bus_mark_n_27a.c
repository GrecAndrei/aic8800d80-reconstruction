// v23 annotated: rf_bus_mark_n_27a @ 0x131688
// Original: 131688_rf_bus_mark_n_27a.c
...
int __fastcall rf_bus_mark_n_27a(int a1, int *a2, __int16 a3, __int16 a4)
{
  int v7; // r5
  int v8; // r4
  int v9; // r7
  ...
  if ( v10 )
  {
    *(_BYTE *)v7 = *(_BYTE *)(v10 + 24);
    if ( *((_BYTE *)a2 + 10) )
    {
      if ( list_count((_DWORD **)dword_131780) == 1 )
      {
