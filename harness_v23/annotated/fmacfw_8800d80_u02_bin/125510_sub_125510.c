// v23 annotated: sub_125510 @ 0x125510
// Original: 125510_sub_125510.c
...
int __fastcall sub_125510(int a1, int a2)
{
  _DWORD *v3; // r5
  int v4; // r1
  int v5; // r3
  ...
  *(_DWORD *)(v17 + 16) = 0;
  ...
  result = dword_1255DC;
  v20[9] = (unsigned __int16)(*(_WORD *)off_1255D8 << 8) | (unsigned __int8)*(_DWORD *)off_1255D8;
  v3[11] = 0;
  v3[12] = v20;
  v3[17] = result;
  v3[6] = dword_1255E0 + 40 * *(unsigned __int8 *)(a1 + 107);
  *(_BYTE *)(a1 + 226) = 1;
