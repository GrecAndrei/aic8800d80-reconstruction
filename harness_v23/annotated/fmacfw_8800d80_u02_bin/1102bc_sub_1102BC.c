// v23 annotated: sub_1102BC @ 0x1102bc
// Original: 1102bc_sub_1102BC.c
...
int sub_1102BC()
{
  ...
  {
    __disable_irq();
    *(_DWORD *)log_free_dispatch_2f0 = 1;
  }
  v0 = (int *)log_free_dispatch_n2ec;
  v1 = dword_1102F8;
  ++*(_DWORD *)log_free_dispatch_n2ec;
  result = rf_bus_mark_n100_d2d0(v1);
  if ( *v0 )
  {
    v3 = *v0 - 1;
    v4 = *(_DWORD *)log_free_dispatch_2f0;
    *v0 = v3;
    if ( !v3 )
    {
      if ( v4 )
