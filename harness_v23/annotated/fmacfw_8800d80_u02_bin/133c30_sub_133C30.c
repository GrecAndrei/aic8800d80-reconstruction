// v23 annotated: sub_133C30 @ 0x133c30
// Original: 133c30_sub_133C30.c
...
int sub_133C30()
{
  ...
  v0 = off_133DD4;
  v1 = *((_DWORD *)off_133DD4 + 4);
  if ( **(__int16 **)off_133DD0 < 0 && msg_get_value(6u) != 2 )
  ...
  if ( *(int *)(v5 + 472) < 0 )
  {
    ...
    else
    {
      ...
      sub_128888(*(unsigned __int8 *)(v1 + 61), LOBYTE(v20[0]));
      *(_DWORD *)v11 = 0;
      ...
      *(_WORD *)(v11 + 22) = v13;
      if ( (v14 & 2) != 0 )
      {
        ...
        if ( (v14 & 8) != 0 )
          v17 = v4 + 292 + v3;
        sub_132658(v4 + 248 + v3, v16, v17, (_WORD *)(v11 + 16), (int *)(v11 + 8), (int *)(v11 + 4), (char *)(v11 + 24));
      }
      *(_DWORD *)(v11 + 12) = v15;
  ...
  v20[0] = v6;
  sub_134474(&v19, v20);
  if ( *(_BYTE *)off_133DD8 != 1 && *((_BYTE *)off_133DDC + 3) != 1 )
  {
    *((_BYTE *)off_133DDC + 32) = 2;
LABEL_7:
    sub_1345C0(v19, v20[0], 1);
    return 0;
  }
  v8 = (unsigned __int8)(*((_BYTE *)off_133DDC + 32) + 1);
  *((_BYTE *)off_133DDC + 32) = v8;
  if ( v8 > 1 )
    goto LABEL_7;
