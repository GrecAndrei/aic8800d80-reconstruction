// v23 annotated: sub_120840 @ 0x120840
// Original: 120840_sub_120840.c
// Primary struct: <unclustered>
//
// sub_120840 @ 0x120840, size 898 bytes
int __fastcall sub_120840(int a1, int a2, int a3, int a4, int a5, int a6)
{
  unsigned int v8; // r9
  int v9; // r3
  unsigned int v10; // r7
  ...
  {
    sub_12AF08(*(unsigned __int8 *)(a4 + 107), v9, (unsigned __int8)v13);
    v47 = v12 * v13;
  }
  else if ( a6 )
  {
    ...
    if ( !*(_BYTE *)(a6 + 2) )
    {
      ...
      sub_12AF08(*(unsigned __int8 *)(a4 + 107), v9, v13);
    }
    v47 = v12 * v13;
  }
  else
  ...
  else
  {
    ...
    v15 = dword_120BA4;
    v16 = (int *)off_120B58;
    *(_DWORD *)off_120B54 = *(_BYTE *)(dword_120BA4 + (*(unsigned __int8 *)(a3 + 44) >> 4)) & 0x7F
                          | *(_DWORD *)off_120B54 & 0xFFFFFF80;
    v17 = v14 + 8;
    ...
    *v17 = 0x80000000;
    ...
    while ( (*v17 & 0xC0000000) != 0x40000000 )
      ;
    v18 = (__int16 **)off_120B5C;
    if ( **(__int16 **)off_120B5C >= 0 || (*v17 & 0x40000000) != 0 )
    {
      v19 = (unsigned __int16)*(_DWORD *)off_120B60;
    }
    else
    {
    ...
    if ( !(*(unsigned __int8 *)(a3 + 40) << 28) )
    {
      v20 = (char *)off_120B54;
      v21 = (int *)off_120B58;
      *(_DWORD *)off_120B54 = *(_BYTE *)(v15 + (*(unsigned __int8 *)(a3 + 44) >> 4)) & 0x7F
                            | *(_DWORD *)off_120B54 & 0xFFFFFF80;
      v22 = v20 + 8;
      ...
      *v22 = 0x80000000;
      ...
      {
        v23 = (unsigned __int16)*(_DWORD *)off_120B60;
        v24 = v19 - v23;
        goto LABEL_15;
      }
...
LABEL_15:
  ...
  *(_QWORD *)(a4 + 40) = v26;
  ...
  if ( v29 < __PAIR64__(v11, v10) - (unsigned int)v23 )
    v43 = v29;
  v30 = v43 + v47;
  if ( (*(_DWORD *)off_120B64 & 0x2000000) != 0 )
    v31 = dword_120B74 - v44 - v26 + v30;
  else
    v31 = v30 - v44 - 400;
  v32 = off_120B68;
  v33 = *((_DWORD *)off_120B68 + 4) - *(_DWORD *)off_120B6C + v31;
  if ( v33 - v32[4] - 4300 - sub_1019F0() < 0 )
    v33 += v12;
  if ( (*(_DWORD *)(a4 + 4) & 1) != 0 )
  {
    v35 = *(unsigned __int8 *)(a4 + 85);
    if ( (v35 & 2) != 0 && v33 - *((_DWORD *)off_120B68 + 4) - 10000 < 0 )
    {
      v33 += v12;
      msg_parse(dword_120BA0, v35 << 30, v34);
    }
  }
  result = v33 - *((_DWORD *)off_120B68 + 4) - 4300 - sub_1019F0();
  if ( result >= 0 && *(_DWORD *)(a4 + 36) != v33 )
  {
    v37 = off_120B70;
    if ( *((_DWORD *)off_120B70 + 8) != a4 || (v38 = off_120B64, *(_DWORD *)(a4 + 36) = v33, (*v38 & 0x2000000) != 0) )
    {
      timestamp_update(a4 + 24, v33);
    }
    else
    {
      v39 = (unsigned __int8 *)off_120B84;
      v40 = (unsigned __int8)v37[36];
      *(_BYTE *)off_120B84 = BYTE2(*(_DWORD *)off_120B80);
      if ( !v40 )
      {
        v41 = *(_BYTE **)off_120B8C;
        v39[1] = *(_DWORD *)off_120B88;
        v37[36] = 1;
        if ( *v41 == 1 )
        {
          v42 = off_120B94;
        ...
        if ( **(__int16 **)off_120B5C < 0 && *v39 >= (unsigned int)v39[1] )
