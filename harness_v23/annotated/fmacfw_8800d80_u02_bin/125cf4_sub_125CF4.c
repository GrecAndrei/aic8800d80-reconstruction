// v23 annotated: sub_125CF4 @ 0x125cf4
// Original: 125cf4_sub_125CF4.c
...
unsigned int __fastcall sub_125CF4(unsigned int *a1, unsigned int *a2, unsigned int *a3, unsigned int a4)
{
  unsigned int v4; // r5
  unsigned int *v5; // lr
  unsigned int v6; // r4
