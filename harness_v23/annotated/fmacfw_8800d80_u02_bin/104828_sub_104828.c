// v23 annotated: sub_104828 @ 0x104828
// Original: 104828_sub_104828.c
// Primary struct: <unclustered>
//
// sub_104828 @ 0x104828, size 466 bytes
int __fastcall sub_104828(int a1, int a2, _DWORD *a3)
{
  int v3; // r3
  int v6; // r10
  int v7; // r6
  ...
  do
  {
    v12 = v10;
    v10 += v8;
    v13 = sub_1045E8(v10, a2, a3);
    v14 = v13 - sub_1045E8(v12, a2, a3);
    if ( (float)v14 < v9 )
    {
      v9 = (float)v14;
      v11 = v12;
  ...
  do
  {
    ...
    *(float *)v17++ = v16;
    ...
    do
    {
      ...
      do
      {
        v20 = sub_1045E8(v18, a2, a3);
        v21 = sub_1045E8(v33 - v34 + v18, a2, a3);
        --v19;
        v18 += v8;
