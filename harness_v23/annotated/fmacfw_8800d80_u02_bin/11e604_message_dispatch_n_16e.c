// v23 annotated: message_dispatch_n_16e @ 0x11e604
// Original: 11e604_message_dispatch_n_16e.c
...
int __fastcall message_dispatch_n_16e(int a1)
{
  int v1; // r8
  int v2; // r10
  int v3; // r11
...
LABEL_7:
      get_cached_1828f8((_QWORD *)(v8 + 88), 0);
      v11 = **v5;
      if ( v11 == 3 )
      {
        v41 = (int *)off_11EA58;
        v42 = *((_DWORD *)off_11EA58 + 1);
        *(_DWORD *)(v8 + 100) = dword_11EA5C;
        *(_DWORD *)(v8 + 104) = v8 + 48;
        v43 = dword_11EA60;
        *(_DWORD *)(v8 + 108) = v2;
...
LABEL_17:
      ...
      v12 = (int *)off_11E844;
      if ( *((_BYTE *)off_11E844 + 32) )
      {
        v52 = (_DWORD *)sub_1102BC();
        v55 = (int)v52;
        if ( v52 )
        {
          if ( *((_BYTE *)v12 + 32) )
...
LABEL_41:
        ...
        while ( (*(_DWORD *)off_11EA64 & 0x800) == 0 )
          ;
        v44 = *(_DWORD *)off_11EA64;
        if ( (*(_DWORD *)off_11EA64 & 0x40000) != 0 )
          *(_DWORD *)off_11EA64 |= 0x4000000u;
        if ( (v44 & 0x800) != 0 )
        {
          CPSR = __get_CPSR();
          *(_DWORD *)(dword_11EA68 + 4428) |= 0x8000000u;
          if ( CPSR )
          {
            *((_DWORD *)off_11EA74 + 5) = 0;
          }
          else
          {
            if ( (__get_CPSR() & 1) == 0 )
            ...
            v46 = off_11EA70;
            v47 = off_11EA74;
            v48 = *(_DWORD *)off_11EA70;
            v49 = *(_DWORD *)off_11EA70 + 1;
            *(_DWORD *)off_11EA70 = v49;
            v47[5] = 0;
            if ( v49 )
            {
              v50 = off_11EA6C;
        ...
        v51 = off_11EA78;
        while ( !*(_DWORD *)off_11EA78 )
          ;
        list_push_tail(*(_DWORD *)off_11EA7C + 620);
        *v51 = 1;
        sub_10CC88();
        return sub_11DF7C(v8, v72[0]);
      }
