// v23 annotated: rf_flag_mask_test @ 0x11a838
// Original: 11a838_rf_flag_mask_test.c
...
unsigned int *__fastcall rf_flag_mask_test(unsigned int *result, unsigned int *a2)
{
  unsigned int v2; // r4
  unsigned int v3; // r5
  int v4; // r2
