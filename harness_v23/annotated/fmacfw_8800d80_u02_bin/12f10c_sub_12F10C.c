// v23 annotated: sub_12F10C @ 0x12f10c
// Original: 12f10c_sub_12F10C.c
// Primary struct: <unclustered>
//
// sub_12F10C @ 0x12f10c, size 116 bytes
int __fastcall sub_12F10C(int a1, int *a2, __int16 a3, __int16 a4)
{
  int v5; // r0
  int v6; // r3
  _DWORD *v7; // r4
  ...
  {
    case 1:
      msg_parse(loc_12F18C, *(_DWORD *)(*a2 + 4));
      break;
    case 2:
