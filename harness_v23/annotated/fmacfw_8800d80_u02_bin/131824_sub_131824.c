// v23 annotated: sub_131824 @ 0x131824
// Original: 131824_sub_131824.c
// Primary struct: <unclustered>
//
// sub_131824 @ 0x131824, size 238 bytes
int __fastcall sub_131824(int a1, unsigned __int8 *a2, __int16 a3, __int16 a4)
{
  int v5; // r0
  int v6; // r2
  int v7; // r6
  ...
  v6 = *a2;
  v7 = v5;
  v8 = *(_DWORD *)(dword_131914 + 696 * v6 + 340);
  *(_BYTE *)v5 = v6;
  if ( v8 )
  {
    v9 = *(_WORD *)(v8 + 184);
    ...
    *(_BYTE *)(v7 + 13) = *(_WORD *)(v8 + 152);
    ...
    if ( *(_WORD *)(v8 + 184) )
    {
      ...
      do
      {
        v13 = sub_13F4B0(v8, (unsigned __int8)v12, 0);
