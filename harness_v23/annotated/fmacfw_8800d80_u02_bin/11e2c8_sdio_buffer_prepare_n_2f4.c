// v23 annotated: sdio_buffer_prepare_n_2f4 @ 0x11e2c8
// Original: 11e2c8_sdio_buffer_prepare_n_2f4.c
...
int __fastcall sdio_buffer_prepare_n_2f4(int a1, unsigned int a2, int a3, __int16 a4, int a5, int a6)
{
  int v6; // r8
