// v23 annotated: sub_11C588 @ 0x11c588
// Original: 11c588_sub_11C588.c
...
unsigned int *__fastcall sub_11C588(unsigned int *result)
{
  int v1; // r2
  int v2; // r5
  unsigned int *v3; // r4
  ...
  if ( v1 != 1023 && *((_BYTE *)off_11C5D4 + 361) != 2 )
  {
    v4 = *((_QWORD *)result + 9);
    ...
    {
      v5 = v3++;
      result = queue_process(v5, *(_DWORD *)(HIDWORD(v4) + 36), v1);
