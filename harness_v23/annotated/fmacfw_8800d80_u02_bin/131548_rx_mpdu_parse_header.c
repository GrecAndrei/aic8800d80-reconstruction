// v23 annotated: rx_mpdu_parse_header @ 0x131548
// Original: 131548_rx_mpdu_parse_header.c
...
int __fastcall rx_mpdu_parse_header(int a1, unsigned __int8 *a2, __int16 a3, __int16 a4)
{
  int v5; // r5
  int v6; // r8
  char v9; // r2
