// v23 annotated: sub_127668 @ 0x127668
// Original: 127668_sub_127668.c
// Primary struct: <unclustered>
//
// sub_127668 @ 0x127668, size 526 bytes
int __fastcall sub_127668(int a1)
{
  __int16 **v1; // r7
  _BYTE *v2; // r6
  int v4; // r0
...
LABEL_32:
  ...
  *(_BYTE *)(v25 + 16) = 4;
  ...
  v29 = off_127898;
  v30 = off_1278A4;
  v31 = *(_DWORD *)off_127898;
  v32 = *(_DWORD *)off_127898 + 1;
  v33 = *((_DWORD *)off_1278A4 + 1) | 2;
  *(_DWORD *)off_127898 = v32;
  v30[1] = v33;
  if ( v32 )
  {
    v34 = (int *)off_127890;
  ...
  v36 = off_1278A8;
  v8 = v7[10];
  *((_BYTE *)v7 + 92) = (*(_DWORD *)off_1278A8 & 4) != 0;
  *v36 &= ~4u;
LABEL_6:
  *(_BYTE *)(v8 + 16) = 1;
  v9 = v7[20];
...
LABEL_14:
  ...
  if ( result )
  {
    ...
    v15 = (int *)off_127898;
    v16 = *(_DWORD *)(result + 4);
    v17 = *(_DWORD *)off_127898;
    v18 = v16 - *((_DWORD *)off_127894 + 4);
    v19 = *(_DWORD *)off_127898 + 1;
    *(_DWORD *)off_127898 = v19;
    if ( v18 - 64 >= 0 )
    {
