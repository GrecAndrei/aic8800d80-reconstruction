// v23 annotated: rf_event_dispatch_n_690 @ 0x123690
// Original: 123690_rf_event_dispatch_n_690.c
...
int __fastcall rf_event_dispatch_n_690(int a1, _BYTE *a2, int a3, int a4)
{
  char v7; // r0
  char v9; // r6
  _BYTE *v10; // r0
