// v23 annotated: sub_139AB0 @ 0x139ab0
// Original: 139ab0_sub_139AB0.c
...
int __fastcall sub_139AB0(int a1, int a2)
{
  int v2; // r7
  __int16 *v3; // r9
  int v4; // r6
...
LABEL_31:
      ...
      else
      {
        ...
        v23 = 0;
        v24 = 255;
        v8 = sub_139584(v11, v10, v19, a2, (_BYTE *)dword_139CE0, v21, &v24, &v23);
        if ( v24 != 255 )
        {
