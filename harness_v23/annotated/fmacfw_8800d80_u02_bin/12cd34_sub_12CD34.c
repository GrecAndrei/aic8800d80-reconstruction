// v23 annotated: sub_12CD34 @ 0x12cd34
// Original: 12cd34_sub_12CD34.c
...
_DWORD *__fastcall sub_12CD34(unsigned int a1, int a2)
{
  __int16 **v2; // r7
  unsigned int v5; // r9
  int v6; // r6
...
message_dispatch_n3c2:
      v7 = (_WORD *)(*(_DWORD *)(dword_12CE50 + 16 * v6 + 8) + 2 * v5);
...
message_dispatch_n3ce:
  result = (_DWORD *)msg_parse(dword_12CE54, a1, a2);
  if ( (unsigned __int16)*v7 != a2 )
  {
    v9 = (int (__fastcall *)(_DWORD *, int))message_dispatch_n4f9;
