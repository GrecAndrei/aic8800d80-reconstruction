// v23 annotated: sub_143118 @ 0x143118
// Original: 143118_sub_143118.c
// Primary struct: <unclustered>
//
// sub_143118 @ 0x143118, size 352 bytes
int __fastcall sub_143118(int result, int a2, int a3, int a4)
{
  bool v4; // zf
  int v5; // r2
  int v6; // r2
