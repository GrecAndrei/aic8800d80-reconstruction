// v23 annotated: sub_114D7C @ 0x114d7c
// Original: 114d7c_sub_114D7C.c
// Primary struct: <unclustered>
//
// sub_114D7C @ 0x114d7c, size 228 bytes
int __fastcall sub_114D7C(int a1, int a2, unsigned int a3)
{
  unsigned int v6; // r4
