// v23 annotated: sub_111390 @ 0x111390
// Original: 111390_sub_111390.c
...
int sub_111390()
{
  ...
  if ( (v0 & 0x2000) != 0 )
  {
    ...
    v49 = *(_DWORD *)rf_bus_write_n_158;
    *(_DWORD *)rf_bus_write_n_158 = *(_DWORD *)rf_bus_write_n_158;
    v50 = dword_11184C;
    *v48 &= ~0x20u;
    ...
    {
      v53 = rf_bus_mark_870;
      *(_BYTE *)rf_bus_reset2_n_1a8_1854 = 1;
      feature_guard_check(2, v53);
    }
    if ( (v49 & 1) != 0 )
    {
      v52 = rf_bus_reset2_n_1a8_1854;
      *(_DWORD *)rf_bus_reset2_n_1ac = 16;
      if ( *v52 )
      {
      ...
      v1 = 0;
      *(_BYTE *)rf_bus_write_n_308 = 0;
    }
    if ( (v49 & 2) != 0 )
    {
      v54 = dword_111874;
      *(_BYTE *)rf_bus_write_n_308 = 1;
  ...
  if ( (v0 & 1) != 0 )
  {
    ...
    *(_DWORD *)rf_bus_reset2_n_3dc = 1;
  }
  v2 = v0 << 26;
  if ( (v0 & 0x20) != 0 )
  {
    reg_field_extract_121130C(*(_DWORD *)rf_bus_reset2_n_3d8);
    v2 = 32;
    *(_DWORD *)rf_bus_reset2_n_3dc = 32;
  }
  if ( (v0 & 0x4000) != 0 )
  {
    v3 = *(_DWORD *)rf_bus_reset2_n_3d4;
    v4 = rf_bus_reset2_n_3cc;
    *(_DWORD *)rf_bus_reset2_n_3d4 = *(_DWORD *)rf_bus_reset2_n_3d4;
    msg_parse(rf_bus_reset2_n_23c, v3, *v4);
  }
  if ( (v0 & 0x8000) == 0 )
    goto rf_bus_write2_n_3a4;
  v42 = rf_bus_mark_n54;
  v43 = *(_DWORD *)rf_bus_reset2_n_1d0;
  *(_DWORD *)rf_bus_reset2_n_1d0 = *(_DWORD *)rf_bus_reset2_n_1d0;
  msg_parse(v42, v43, v2);
  if ( (v43 & 4) != 0 )
  {
    v2 = (int)rf_bus_mark_n_50;
    *(_DWORD *)rf_bus_mark_n_50 &= ~1u;
  }
  if ( (v43 & 8) == 0 )
  {
rf_bus_write2_n_3a4:
...
rf_bus_reset2_1740:
    ...
    v45 = *(_DWORD *)rf_bus_reset2_n_1c4;
    *(_DWORD *)rf_bus_reset2_n_1c4 = *(_DWORD *)rf_bus_reset2_n_1c4;
...
LABEL_61:
  ...
  v47 = *(_DWORD *)rf_bus_mark_n_44;
  *(_DWORD *)rf_bus_mark_n_44 = *(_DWORD *)rf_bus_mark_n_44;
...
rf_bus_mark_n_48d_13f6:
    ...
    else
    {
      ...
      v11 = *((unsigned __int8 *)ipc_doorbell_handler_n_4ac + 1620)
          ...
          * ((unsigned int)(((unsigned int)dword_11163C
                           * (unsigned __int64)((unsigned int)*((unsigned __int8 *)ipc_doorbell_handler_n_4ac + 1620) + 1)) >> 32) >> 6);
      v12 = (char *)ipc_doorbell_handler_n_4ac + 20 * v11;
      v13 = rf_bus_reset2_648;
      *((_DWORD *)v12 + 1) = *(_DWORD *)off_111644;
      v7[1621] = v8 + 1;
      v14 = off_11164C;
      *((_DWORD *)v12 + 2) = *v13;
      v12[12] = v10;
  ...
  if ( (v0 & 0x100) != 0 )
  {
    ...
    if ( v19 < v20 )
    {
      v38 = *(_DWORD *)rf_bus_mark_n_64;
      v39 = *(_DWORD *)off_111818;
      v40 = *((unsigned __int8 *)ipc_doorbell_handler_n_4ac + 2432)
          + 1
          - 40
          * ((unsigned int)(((unsigned int)rf_bus_reset2_n_1e0
                           * (unsigned __int64)((unsigned int)*((unsigned __int8 *)ipc_doorbell_handler_n_4ac + 2432) + 1)) >> 32) >> 5);
      v41 = (char *)ipc_doorbell_handler_n_4ac + 20 * v40;
      *((_BYTE *)ipc_doorbell_handler_n_4ac + 2432) = v40;
    ...
    *(_DWORD *)rf_bus_reset2_n_3dc = 256;
  }
  result = v0 << 19;
  if ( (v0 & 0x1000) != 0 )
  {
    if ( *(_BYTE *)rf_bus_mark_n_224 )
    {
      v22 = off_111664;
      v23 = *((unsigned __int8 *)off_111664 + 369);
      *(_BYTE *)rf_bus_mark_n_224 = 0;
      if ( v23 )
        rf_mem_read_n47e(1);
      else
        sub_10DD14(1);
    ...
    if ( v25 < v26 )
    {
      v35 = *((unsigned __int8 *)rf_bus_write_n_4f7 + 3072)
          ...
          * ((unsigned int)(((unsigned int)rf_bus_mark_n_1ff
                           * (unsigned __int64)((unsigned int)*((unsigned __int8 *)rf_bus_write_n_4f7 + 3072) + 1)) >> 32) >> 7);
      v36 = (char *)rf_bus_write_n_4f7 + 16 * v35;
      *((_DWORD *)v36 + 1) = *(_DWORD *)ipc_doorbell_handler_n376;
    ...
    v27 = off_111674;
    *(_DWORD *)rf_bus_reset2_n_3dc = 4096;
    if ( !*v27 )
      *(_BYTE *)rf_bus_write_n_4ec_1678 &= ~1u;
  }
  if ( (v0 & 0x800) != 0 )
  {
    if ( *(_BYTE *)rf_bus_mark_n_224 )
    ...
    if ( *((unsigned __int8 *)rf_bus_write_n_4f7 + 6161) > v31 )
    {
      v33 = *((unsigned __int8 *)rf_bus_write_n_4f7 + 6160)
          ...
          - 192
          * ((unsigned int)(((unsigned int)rf_bus_mark_n_1ff
                           * (unsigned __int64)((unsigned int)*((unsigned __int8 *)rf_bus_write_n_4f7 + 6160) + 1)) >> 32) >> 7);
      v34 = rf_bus_reset2_n_374_1688;
      *((_BYTE *)rf_bus_write_n_4f7 + 6160) = v33;
      v30[4 * v33 + 773] = *v34;
      LOWORD(v30[4 * v33 + 774]) = *(_DWORD *)off_11168C;
    ...
    *(_DWORD *)rf_bus_reset2_n_3dc = 2048;
    if ( !*v32 )
      *(_BYTE *)rf_bus_write_n_4ec_1678 &= ~2u;
  }
  if ( (v0 & 4) != 0 )
    *(_DWORD *)rf_bus_reset2_n_3dc = 4;
  if ( (v0 & 8) != 0 )
    *(_DWORD *)rf_bus_reset2_n_3dc = 8;
  return result;
}
