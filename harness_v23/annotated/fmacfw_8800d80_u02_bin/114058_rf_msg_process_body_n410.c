// v23 annotated: rf_msg_process_body_n410 @ 0x114058
// Original: 114058_rf_msg_process_body_n410.c
...
int rf_msg_process_body_n410()
{
  ...
  {
    __disable_irq();
    *(_DWORD *)rf_msg_process_body_n448 = 1;
  }
  v0 = (int *)rf_msg_process_body_n44c;
  ++*(_DWORD *)rf_msg_process_body_n44c;
  result = clear_flags(128);
  if ( *v0 )
  {
    v2 = *v0 - 1;
    v3 = *(_DWORD *)rf_msg_process_body_n448;
    *v0 = v2;
    if ( !v2 )
    {
      if ( v3 )
