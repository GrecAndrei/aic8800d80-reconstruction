// v23 annotated: rf_fault_dump_n_1d4 @ 0x114574
// Original: 114574_rf_fault_dump_n_1d4.c
...
int __fastcall rf_fault_dump_n_1d4(int a1, int a2, int a3)
{
  int result; // r0
  _BYTE *v4; // r3
  _DWORD *v5; // r1
  ...
  if ( *((_BYTE *)rf_fault_dump_n_1a8 + 3) )
  {
    v5 = rf_fault_dump_n_1a0;
    *(_DWORD *)rf_fault_dump_n_1a3 &= ~8u;
    *v5 &= 0xFFFFFFF0;
    v4[3] = 0;
    return 0;
  }
