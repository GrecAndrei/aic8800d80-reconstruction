// v23 annotated: sub_143AA8 @ 0x143aa8
// Original: 143aa8_sub_143AA8.c
// Primary struct: <unclustered>
//
// sub_143AA8 @ 0x143aa8, size 724 bytes
int __fastcall sub_143AA8(unsigned int a1, unsigned int *a2)
{
  int v3; // r2
  int v4; // r3
  char v7; // r4
