// v23 annotated: rf_stream_start2_n3f6 @ 0x114114
// Original: 114114_rf_stream_start2_n3f6.c
// Primary struct: rf_stream (cluster 12, 4 funcs)
// Fields: state=0x0, kick=0x2
//
