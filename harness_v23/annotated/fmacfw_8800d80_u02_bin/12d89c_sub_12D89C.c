// v23 annotated: sub_12D89C @ 0x12d89c
// Original: 12d89c_sub_12D89C.c
// Primary struct: <unclustered>
//
// sub_12D89C @ 0x12d89c, size 64 bytes
_BYTE *__fastcall sub_12D89C(_BYTE *result, int a2, _BYTE *a3)
{
  unsigned int v3; // r1
  int v4; // r4
  _BYTE *v5; // r5
