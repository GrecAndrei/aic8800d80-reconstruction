// v23 annotated: rf_chan_cfg_set_n1c4 @ 0x131148
// Original: 131148_rf_chan_cfg_set_n1c4.c
...
unsigned __int8 *__fastcall rf_chan_cfg_set_n1c4(unsigned __int8 *a1, int a2, int a3)
{
