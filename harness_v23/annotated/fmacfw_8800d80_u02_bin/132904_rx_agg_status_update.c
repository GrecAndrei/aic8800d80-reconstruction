// v23 annotated: rx_agg_status_update @ 0x132904
// Original: 132904_rx_agg_status_update.c
...
_DWORD *__fastcall rx_agg_status_update(int a1)
{
  char v1; // r3
  _DWORD *v2; // r6
  int *v3; // r4
  ...
  if ( (v1 & 0x20) != 0 )
  {
    ...
    *(_DWORD *)(v28 + 156) = v66 & v33 | v68;
    if ( rf_feature_check(5u, 4u) )
      msg_parse(dword_132C38, *(_DWORD *)(v28 + 156), v29);
