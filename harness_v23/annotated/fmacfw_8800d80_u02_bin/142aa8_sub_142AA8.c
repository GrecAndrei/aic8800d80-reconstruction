// v23 annotated: sub_142AA8 @ 0x142aa8
// Original: 142aa8_sub_142AA8.c
// Primary struct: <unclustered>
//
// sub_142AA8 @ 0x142aa8, size 412 bytes
int __fastcall sub_142AA8(__int64 a1, unsigned int a2, unsigned int a3)
{
  int v3; // r5
  unsigned int v4; // r12
  bool v5; // zf
  ...
  if ( v21 > -54 )
  {
    ...
    if ( v24 )
    {
      ...
      else
      {
        v32 = 12 - v29;
        v33 = (_DWORD)a1 << v32;
        LODWORD(a1) = (((unsigned int)a1 >> (32 - v32)) | (HIDWORD(a1) << v32)) + ((_DWORD)a1 << v32 >> 31);
        if ( !(v23 | (2 * v33)) )
