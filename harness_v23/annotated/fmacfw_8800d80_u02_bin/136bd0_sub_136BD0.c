// v23 annotated: sub_136BD0 @ 0x136bd0
// Original: 136bd0_sub_136BD0.c
...
int **__fastcall sub_136BD0(int a1, int a2, _DWORD *a3)
{
  int v3; // r7
  int v5; // r2
  int v7; // r8
...
LABEL_26:
  ...
  v11 = v5 == 2;
  v12 = nullptr;
  while ( ((unsigned __int8)(v9 & *(_BYTE *)(dword_136D04 + *((unsigned __int8 *)v8 + 27))) == 0) == v11 )
  {
    v12 = (int ***)v8;
    if ( !*v8 )
      goto LABEL_24;
