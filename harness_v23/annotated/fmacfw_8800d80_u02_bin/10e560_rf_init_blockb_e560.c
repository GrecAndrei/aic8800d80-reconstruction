// v23 annotated: rf_init_blockb_e560 @ 0x10e560
// Original: 10e560_rf_init_blockb_e560.c
...
int rf_init_blockb_e560()
{
  ...
  *((_DWORD *)off_10E810 + 14) = 296;
  ...
  v8 = rf_reg_read_cb(dword_10E820) & 0x1F;
  v9 = v7 - 840;
  ...
  else
  {
    ...
    *((_DWORD *)off_10E814 + 1) = 1;
    ...
    msg_parse(dword_10E828, v14, v15);
    if ( v7 <= 840 )
      v21 = 1;
    else
      v21 = -1;
...
LABEL_33:
  ...
  *((_DWORD *)off_10E814 + 1) = 1;
  ...
  result = *((_DWORD *)off_10E838 + 94);
  if ( result != 0x80000000 )
    return reg_field_extract_121130C();
  return result;
}
