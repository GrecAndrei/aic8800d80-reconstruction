// v23 annotated: sub_12B5A0 @ 0x12b5a0
// Original: 12b5a0_sub_12B5A0.c
// Primary struct: <unclustered>
//
// sub_12B5A0 @ 0x12b5a0, size 530 bytes
unsigned int __fastcall sub_12B5A0(unsigned int result)
{
  _DWORD *v1; // r6
  unsigned int v2; // r5
  int v3; // r2
  ...
  v1 = off_12B7C8;
  v2 = (unsigned __int8)*(_DWORD *)off_12B7C8;
  if ( result != v2 )
  {
    v3 = dword_12B7CC;
    v4 = dword_12B7D0;
    v5 = dword_12B800;
    *(_DWORD *)off_12B7FC = ((0xF0 / result) << 8) & 0xF00 | *(_DWORD *)off_12B7FC & 0xFFFFF0FF;
    ...
    *(_DWORD *)off_12B7D4 = dword_12B7D8 & ((v6 * (unsigned __int16)(*(_DWORD *)off_12B7D4 >> 8) / v2) << 8)
                          | *(_DWORD *)off_12B7D4 & 0xFF0000FF;
    ...
    *v12 = (v6 * (*v12 & 0x3FF) / v2) & 0x3FF | *v12 & 0xFFFFFC00;
    ...
    {
      v13 = *(_DWORD *)off_12B7E4 & 0xFFFFFFFC;
      if ( v6 > 0x3B )
        v14 = v13 | 1;
      else
        v14 = v13 | 2;
      *(_DWORD *)off_12B7E4 = v14;
    }
    v15 = off_12B7E8;
    v16 = dword_12B7D8;
    v17 = dword_12B7EC;
    v18 = (unsigned int *)off_12B7F0;
    *(_DWORD *)off_12B7E8 = dword_12B7D8 & ((v6 * (unsigned __int16)(*(_DWORD *)off_12B7E8 >> 8) / v2) << 8)
                          | *(_DWORD *)off_12B7E8 & dword_12B7EC;
