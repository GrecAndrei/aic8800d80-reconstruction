// v23 annotated: patch_apply_4eac @ 0x114eac
// Original: 114eac_patch_apply_4eac.c
...
void patch_apply_4eac()
{
  ...
  v0 = patch_apply_n70;
  if ( *(_DWORD *)patch_apply_n70 == patch_apply_n74 && *((_DWORD *)patch_apply_n70 + 2) == patch_apply_n74 + 135327480 )
  {
    v1 = *((_DWORD *)patch_apply_n70 + 1);
    v2 = v1 & 3;
    if ( (v1 & 3) == 0 )
    {
      if ( *((_DWORD *)patch_apply_n70 + 3) )
      {
        do
        {
          v3 = *(_DWORD *)(v1 + 4);
