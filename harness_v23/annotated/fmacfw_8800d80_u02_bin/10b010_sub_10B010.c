// v23 annotated: sub_10B010 @ 0x10b010
// Original: 10b010_sub_10B010.c
...
int __fastcall sub_10B010(unsigned int *a1, _BYTE *a2, int a3)
{
  int v3; // r9
  int v4; // r10
  int v5; // r11
  ...
  v7 = *(_DWORD *)off_10B33C;
  v8 = *(_DWORD *)off_10B33C & 0xFFFFFFFE;
  v82 = 0;
  v83 = 0;
  v84 = 0;
  *(_DWORD *)off_10B33C = v8;
  v78 = v7 & 1;
...
LABEL_15:
  ...
  sub_102D0C(0);
  v39 = dword_10B368;
  *(_DWORD *)off_10B33C = *(_DWORD *)off_10B33C & 0xFFFFFFFE | v78;
