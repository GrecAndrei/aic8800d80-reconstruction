// v23 annotated: sub_139D94 @ 0x139d94
// Original: 139d94_sub_139D94.c
// Primary struct: <unclustered>
//
// sub_139D94 @ 0x139d94, size 336 bytes
int __fastcall sub_139D94(char *a1, char a2, int a3)
{
  char v4; // r3
  int v6; // r4
  char *v7; // r8
  ...
  else if ( v16 != 56710 )
  {
    if ( v16 == 8 )
    {
      ...
      if ( v10 == 2 )
      {
        msg_parse(dword_139EE8, (unsigned __int8)v7[10], 2, 8);
        return v8;
      }
      if ( v10 == 17 )
      {
        ...
        {
          msg_parse(dword_139EE4, (unsigned __int8)v12[3] | ((unsigned __int8)v12[2] << 8));
          return v8;
        }
      }
    }
