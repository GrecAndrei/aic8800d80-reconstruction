// v23 annotated: sub_11FBB8 @ 0x11fbb8
// Original: 11fbb8_sub_11FBB8.c
// Primary struct: <unclustered>
//
// sub_11FBB8 @ 0x11fbb8, size 1108 bytes
int __fastcall sub_11FBB8(int a1)
{
  int v2; // r6
  int *v3; // r8
  int v4; // r3
  ...
  else
  {
    if ( v4 != 4 )
    {
      ...
      if ( !*(_BYTE *)(v2 + 1320 * a1 + 106) )
      {
        ...
        v39 = (unsigned __int8)(*((_BYTE *)off_11FEC8 + 17) - 1);
        *((_BYTE *)off_11FEC8 + 17) = v39;
        v7 = v39 + v6;
        if ( v7 != 1 )
          goto LABEL_7;
        goto LABEL_40;
    ...
    *(_DWORD *)(v41 + 4) &= ~0x80u;
    ...
    else
    {
      ...
      *(_DWORD *)off_120014 = dword_120018;
      if ( v45 < 0 )
      {
        v6 = *(_DWORD *)off_120020 & 0xF;
        if ( v6 )
        {
...
LABEL_40:
  ...
  v32 = *((_DWORD *)v5 + 2);
  v33 = *((_DWORD *)off_11FEF4 + 1) & 0xFFFFFFEF;
  *((_DWORD *)off_11FEF4 + 1) = v33;
  if ( v31 >= 0 || !(*(_DWORD *)off_120020 << 28) )
  {
    v34 = off_11FEF8;
    *(_DWORD *)off_11FF00 = v33 | *v30;
    v35 = off_11FEFC;
...
LABEL_42:
    ...
    v30[1] = v38;
    if ( v37 >= 0 || !(*(_DWORD *)off_120020 << 28) )
    {
      *(_DWORD *)off_11FF00 = v38 | *v30;
      goto LABEL_9;
    }
    sub_12F49C(dword_120028, dword_120024, 472);
    v7 = (unsigned __int8)v5[17] + (unsigned __int8)v5[18];
    *(_DWORD *)off_12001C = *v30 | v30[1];
    goto LABEL_7;
  }
  sub_12F49C(dword_120028, dword_120024, 472);
