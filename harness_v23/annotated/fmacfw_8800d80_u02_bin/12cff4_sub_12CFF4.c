// v23 annotated: sub_12CFF4 @ 0x12cff4
// Original: 12cff4_sub_12CFF4.c
...
int sub_12CFF4()
{
  ...
  if ( result )
  {
    v6 = (int (__fastcall *)(_DWORD, unsigned __int16 *, _DWORD, _DWORD))sub_12CF2C(
