// v23 annotated: sub_11B84C @ 0x11b84c
// Original: 11b84c_sub_11B84C.c
// Primary struct: <unclustered>
//
// sub_11B84C @ 0x11b84c, size 382 bytes
int __fastcall sub_11B84C(int a1)
{
  _DWORD *v1; // r5
  int v2; // r6
  int v4; // r3
  ...
  v1 = off_11B9CC;
  v2 = *((unsigned __int8 *)off_11B9CC + 190);
  v22 = nullptr;
  rf_set_bit_flag(v2);
  fmac_txpwr_table_lookup(*((unsigned __int8 *)v1 + 190));
  if ( !a1 )
    goto LABEL_24;
  v4 = *(_DWORD *)(a1 + 36);
  if ( (v4 & 0x200000) != 0 )
...
LABEL_25:
  ...
  {
LABEL_24:
    HIDWORD(v9) = *(unsigned __int8 *)(*(_DWORD *)off_11B9D0 + 1);
    goto LABEL_25;
  }
  v11 = *(_DWORD **)(a1 + 76);
