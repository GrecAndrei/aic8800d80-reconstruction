// v23 annotated: fmac_data_unpack_n_630 @ 0x133630
// Original: 133630_fmac_data_unpack_n_630.c
...
_DWORD *__fastcall fmac_data_unpack_n_630(_DWORD *result, int a2, unsigned int a3)
{
  unsigned int *v3; // r6
  char v4; // r1
  unsigned int v5; // r7
