// v23 annotated: sub_109B30 @ 0x109b30
// Original: 109b30_sub_109B30.c
// Primary struct: <unclustered>
//
// sub_109B30 @ 0x109b30, size 610 bytes
int __fastcall sub_109B30(unsigned int a1, float *a2, float *a3, int a4)
{
  float v4; // s13
  float v5; // s14
  float v10; // s15
  ...
  *(_BYTE *)(a4 + 2) = (unsigned int)(float)(v10 - v5);
  ...
  if ( v16 > 0.0 )
  {
    v17 = sub_1429F8((float)(v14 * 3.0) - (float)(v15 * v15));
...
LABEL_11:
  ...
  if ( a1 > 0xD && v24 < 20.0
    || (v31 = sub_1429F8(LODWORD(v24)), (result = sub_142F8C(v31, HIDWORD(v31), dword_109D98, dword_109D9C)) != 0) )
  {
    v26 = dword_109DA8;
    *(_BYTE *)a4 |= 8u;
    result = sub_10DC24(v26, v18, v19);
    v24 = 1.0;
    v28 = 2.0;
  }
  else
