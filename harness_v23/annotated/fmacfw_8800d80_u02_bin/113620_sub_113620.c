// v23 annotated: sub_113620 @ 0x113620
// Original: 113620_sub_113620.c
...
_DWORD *__fastcall sub_113620(int a1)
{
  _DWORD *result; // r0
  _DWORD *v2; // r4
  int v3; // r0
  ...
  switch ( a1 )
  {
    case 1:
      ...
      if ( *((_BYTE *)off_11369C + 370) && rf_fault_dump_n100(v3) )
      {
      ...
      else
      {
        ...
        v2[2] = *(_DWORD *)off_1136A0;
      }
      break;
    case 6:
      return (_DWORD *)rf_cmd_queue_next_n1dc;
    case 15:
      return (_DWORD *)dword_11368C;
    default:
      return nullptr;
  }
  return result;
