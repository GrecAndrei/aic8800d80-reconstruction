// v23 annotated: rf_level_apply_n_18c @ 0x102d7c
// Original: 102d7c_rf_level_apply_n_18c.c
// Primary struct: <unclustered>
//
// rf_level_apply_n_18c @ 0x102d7c, size 282 bytes
// Doc: rf_level_apply_n_18c [rf]: Applies RF level setting via MMIO register
// rf_level_apply_n_18c [rf]: Applies RF level setting via MMIO register
int __fastcall rf_level_apply_n_18c(int a1, unsigned __int16 *a2)
{
  unsigned int v4; // r11
  int v5; // r9
  int v6; // r8
...
LABEL_4:
  ...
  do
  {
    ...
    *v8 = v11 & v6 | (v12 << 11);
    v8 += 8;
    ++v9;
    feature_guard_check(0x2000, v13);
  }
  while ( v9 != 16 );
  if ( v4 <= 1 )
    goto LABEL_4;
