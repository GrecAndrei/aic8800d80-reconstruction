// v23 annotated: sub_12811C @ 0x12811c
// Original: 12811c_sub_12811C.c
// Primary struct: <unclustered>
//
// sub_12811C @ 0x12811c, size 354 bytes
int __fastcall sub_12811C(int result)
{
  _DWORD *v1; // r5
  int v2; // r2
  int v3; // r4
  ...
  if ( *((unsigned __int8 *)off_128280 + 90) > 1u )
  {
    ...
    if ( (v2 & 0x10) != 0 )
    {
      ...
      sub_125E78((_DWORD *)(dword_128298 + 1320 * v5));
...
LABEL_7:
    ...
    if ( (v2 & 2) == 0 )
    {
      ...
      if ( !v6 || *(_DWORD *)(v6 + 12) != v3 + 76 )
        return sub_126584(v3, *(_DWORD *)(v3 + 36), 0);
      v9 = *(_DWORD *)(v3 + 80);
      v10 = *(_DWORD *)(v3 + 36);
      if ( v9 - v10 < 0 )
      {
...
LABEL_23:
          ...
          if ( v11 - *(_DWORD *)(v6 + 4) - result - 4000 < 0 )
          {
            ...
            *(_DWORD *)(v6 + 4) = v12 - 4000 - result;
            if ( v13 == v6 )
            {
              ...
              v14 = (int *)off_128294;
              v15 = *(_DWORD *)(v6 + 4);
              v16 = *(_DWORD *)off_128294;
              v17 = v15 - *((_DWORD *)off_128290 + 4);
              v18 = *(_DWORD *)off_128294 + 1;
              *(_DWORD *)off_128294 = v18;
              if ( v17 - 64 >= 0 )
              {
      ...
      {
        bt_event_handler();
        sub_126584(v3, *(_DWORD *)(v3 + 36), 0);
        return sub_126824(v3, *((_DWORD *)off_128290 + 4), 0);
      }
      goto LABEL_23;
    }
  }
