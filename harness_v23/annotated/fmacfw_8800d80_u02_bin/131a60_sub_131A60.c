// v23 annotated: sub_131A60 @ 0x131a60
// Original: 131a60_sub_131A60.c
// Primary struct: <unclustered>
//
// sub_131A60 @ 0x131a60, size 1220 bytes
int __fastcall sub_131A60(int a1, int a2, __int16 a3, __int16 a4)
{
  ...
  v83 = 0;
  v84 = 0;
  v5 = (unsigned __int8 *)sub_12C92C(5128, a4, a3, 3u);
  v82 = 0;
  v80 = 0;
  v6 = sub_13A4D8();
  ...
  {
    v10 = a2 + 52;
    v36 = *(unsigned __int8 *)(dword_131E34 + 1320 * v7 + 106);
    if ( v36 == 2 )
    {
      v59 = v74 + 100;
    }
    else
    {
      ...
      if ( *(_BYTE *)(dword_131E34 + 1320 * v7 + 106) )
      {
        v9 = 0;
        goto LABEL_4;
      }
    ...
    v60 = sdio_buffer_prepare_n_16c(v59 + dword_131E34, *(_WORD *)(a2 + 124));
    v8 = *(_DWORD *)(a2 + 120);
    v9 = v60;
    goto LABEL_4;
  }
...
LABEL_4:
  ...
  if ( v11 )
    v11 = a2 + 64;
  sub_132658(a2 + 20, v10, v11, &v82, &v83, &v84, &v80);
  v12 = *(_BYTE *)(a2 + 129);
LABEL_8:
  v87 = *(_DWORD *)a2;
  v13 = *(_WORD *)(a2 + 4);
  ...
  *(_BYTE *)(v20 + 204) = v19;
  if ( (v16 & 0x40) != 0 )
    *(_DWORD *)(v20 + 4) |= 0x40u;
  if ( (v16 & 1) != 0
    && (v21 = (_DWORD *)(dword_131E30 + 696 * v15), v75 = v21[1], v21[1] = v75 | 1, (v16 & 2) != 0)
    && (v79 = *((_BYTE *)off_131E44 + 374), v14 = v79 & 1, (v79 & 1) != 0) )
  {
    v37 = *(_DWORD *)(a2 + 24);
    v38 = *(_DWORD *)(a2 + 28);
    v39 = *(_DWORD *)(a2 + 32);
    ...
    if ( (v16 & 4) != 0 )
    {
      v54 = *(_DWORD *)(dword_131E30 + 696 * v15 + 4);
      if ( (*((_BYTE *)off_131E44 + 374) & 2) != 0 || (v54 & 0x20) != 0 )
      {
        v55 = *(_DWORD *)(a2 + 56);
        v56 = *(_DWORD *)(a2 + 60);
        v57 = (_DWORD *)(dword_131E30 + 696 * v15);
        v57[60] = *(_DWORD *)(a2 + 52);
        v57[61] = v55;
        v57[62] = v56;
        v57[1] = v54 | 4;
    ...
    v22 = dword_131E34;
    v58 = sub_132460(v20, v74 + 248 + dword_131E34);
    v16 = *(_DWORD *)(a2 + 120);
    v14 = v58;
  }
  else
  ...
  if ( (v16 & 8) != 0 )
    *(_DWORD *)(dword_131E30 + 696 * v15 + 4) |= 8u;
  ...
  *(_BYTE *)(v23 + 311) = v24;
  ...
  {
    chan_ctx_lookup_n2b8(*(unsigned __int8 *)(v76 + 35), *(_BYTE *)(a2 + 128) & 3, *(unsigned __int8 *)(a2 + 128) >> 4);
    if ( !v14 )
      goto LABEL_19;
  }
  else if ( !v14 )
  ...
  chan_ctx_lookup_n2b8(*(unsigned __int8 *)(dword_131E30 + 696 * v15 + 35), 255, 0);
LABEL_19:
  v25 = v22 + 1320 * v7;
  ...
  *(_BYTE *)(v27 + 52) = 2 - v28;
  v30 = off_131E3C;
  *(_DWORD *)(v27 + 676) = dword_131E38;
  *(_WORD *)(v27 + 56) = __rev16(v26);
  *(_BYTE *)(v27 + 350) = v29 | 0x10;
  *(_BYTE *)(v27 + 688) = 1;
  v77 = v27;
  timestamp_update(696 * v15 + 672 + dword_131E30, dword_131E40 + v30[4]);
  v5[2] = v73;
  if ( v73 )
  {
    ...
    *(_BYTE *)(v77 + 36) = v73;
    if ( !v31 )
    {
      ...
      v33 = (unsigned __int8 *)(dword_131E30 + 696 * v32);
      if ( v33[36] != 1 )
      {
        v34 = v33[35];
        v33[36] = 1;
        if ( v34 <= 0x1F )
        {
          v62 = (_BYTE *)sub_12C92C(73, 13, 0, 2u);
          *v62 = v32;
          v62[1] = 1;
          ...
          else
          {
            ...
            v78 = v5;
            v64 = v33;
            v65 = (_DWORD *)(dword_131F24 - 664 + 8 * (87 * (__int16)v32 + 78));
            ...
            do
            {
              if ( *((_DWORD *)v64 + 146) )
              {
                ...
                ++*v63;
                msg_parse(v69);
                buf_ptr_deref_n_430(v65 - 10, v66 - 10);
              ...
              if ( v72 )
              {
                msg_parse(dword_131F30);
                buf_ptr_deref_n_430(v66, v65);
                sub_12D240(v65);
              }
              v65 += 2;
              v66 += 2;
    ...
    *(_BYTE *)(v22 + 1320 * v7 + 234) = v31 + 1;
    sub_12A5D0((unsigned __int8 *)(v74 + v22));
  }
LABEL_24:
