// v23 annotated: sub_138DA4 @ 0x138da4
// Original: 138da4_sub_138DA4.c
// Primary struct: <unclustered>
//
// sub_138DA4 @ 0x138da4, size 554 bytes
int __fastcall sub_138DA4(unsigned int a1, int a2, int a3, int a4)
{
  _DWORD *v4; // r8
  unsigned int v5; // r4
  int v8; // r5
...
LABEL_11:
  ...
  else
  {
    ...
    while ( 1 )
    {
      ...
      sub_133630((_DWORD *)a2, v17, (unsigned __int16)(v15 - v12));
      v12 = 0;
      if ( !(_WORD)v14 )
        break;
      v9 = (_DWORD *)v9[1];
