// v23 annotated: sub_1420D0 @ 0x1420d0
// Original: 1420d0_sub_1420D0.c
// Primary struct: <unclustered>
//
// sub_1420D0 @ 0x1420d0, size 582 bytes
unsigned int __fastcall sub_1420D0(unsigned int result)
{
  int v1; // r1
  int v2; // r2
  int v3; // r5
  ...
  v4 = result;
  v5 = v2;
  if ( (v1 != 255 || !*(_BYTE *)(dword_142318 + 1320 * v2 + 108))
    && (*(_DWORD *)(dword_142318 + 1320 * v2 + 472) & 8) != 0 )
  {
    if ( *(_BYTE *)(result + 12) == 22 )
    {
      ...
      if ( v6 == 6 )
      {
        ...
        if ( **(__int16 **)off_14231C < 0 && v2 == 255 )
        {
          ...
          if ( v19 == 4 )
          {
            if ( (v18 & 1) == 0 )
            {
              ...
              if ( *(_QWORD *)(v26 + 40) )
              {
                ...
                while ( (_WORD *)(dword_142320 + 576) != v27 );
                v31 = (char *)off_142324;
                *(_BYTE *)(v30 + 47) = v28;
                v32 = *v31;
                *(_BYTE *)(v30 + 46) = v29;
                ...
                *(_WORD *)v30 = 1;
                *v31 = v33 + 1;
                sub_141C80(v17, v20, v15, (__int16 *)v30);
                ke_msg_alloc_n2e4(4, v30);
                LODWORD(v34) = sub_12BE40();
                v35 = *(_QWORD *)(v30 + 24) - v34 - *(_QWORD *)(v3 + 1320 * v5 + 40);
                v36 = sub_143414(v35, HIDWORD(v35), *(_DWORD *)(v30 + 16), 0);
                return rx_desc_lookup_or_build(v30, v36);
              }
              else
              {
                return sub_141FE0(*(unsigned __int8 *)(v26 + 107), *(unsigned __int8 *)(v4 + 7), (v18 >> 7) & 7);
              }
            }
          }
          else if ( v19 == 7 )
          {
            sub_141C80((unsigned __int16 *)(v4 + 18), v20, v15, v37);
