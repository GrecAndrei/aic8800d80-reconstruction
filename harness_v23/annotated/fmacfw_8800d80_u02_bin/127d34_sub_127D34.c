// v23 annotated: sub_127D34 @ 0x127d34
// Original: 127d34_sub_127D34.c
// Primary struct: <unclustered>
//
// sub_127D34 @ 0x127d34, size 190 bytes
int __fastcall sub_127D34(unsigned __int8 *a1, _BYTE *a2)
{
  int v2; // r6
  int v5; // r3
  int i; // r5
        ...
        if ( v11 < v12 && v11 != 3 )
        {
          ...
          *(_WORD *)(v13 + 8) = v15;
          if ( v16 == v13 && *((_BYTE *)v14 + 90) == 1 )
            sub_102A20((unsigned __int16 *)(v2 + 28 * i + 4), 0);
LABEL_16:
          *a2 = i;
          return 0;
        }
