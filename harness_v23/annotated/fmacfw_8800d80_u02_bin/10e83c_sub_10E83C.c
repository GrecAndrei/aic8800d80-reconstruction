// v23 annotated: sub_10E83C @ 0x10e83c
// Original: 10e83c_sub_10E83C.c
// Primary struct: <unclustered>
//
// sub_10E83C @ 0x10e83c, size 416 bytes
int __fastcall sub_10E83C(unsigned int a1, unsigned int a2, unsigned int *a3)
{
  unsigned int v3; // r4
  unsigned int *v4; // r6
  unsigned int *v5; // r5
  ...
  *(_DWORD *)off_10E9DC = *(_DWORD *)off_10E9DC & 0xFFFFFFF8 | a1 & 7;
