// v23 annotated: sub_11EB34 @ 0x11eb34
// Original: 11eb34_sub_11EB34.c
...
int __fastcall sub_11EB34(int result)
{
  int v1; // r4
  __int16 v2; // r2
  int v3; // r1
  ...
  v1 = result;
  if ( **(__int16 **)off_11EBB0 < 0 && *(_DWORD *)(result + 20) != dword_11EBB8 )
