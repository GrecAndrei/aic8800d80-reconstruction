// v23 annotated: fm_rx_frame_handler @ 0x11ae30
// Original: 11ae30_fm_rx_frame_handler.c
...
int __fastcall fm_rx_frame_handler(int a1, int *a2, unsigned int a3, unsigned int a4, unsigned __int8 a5)
{
  int v5; // r7
  _DWORD *v6; // r10
  _DWORD *v8; // r9
