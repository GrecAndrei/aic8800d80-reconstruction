// v23 annotated: sub_141F40 @ 0x141f40
// Original: 141f40_sub_141F40.c
...
int __fastcall sub_141F40(int a1, int a2, int a3, int a4)
{
  int v6; // r0
  int v7; // r1
  int v8; // r1
  ...
  v6 = sub_141B70((int)&v16, a1, a2, 6, *(_BYTE *)(a3 + 2));
