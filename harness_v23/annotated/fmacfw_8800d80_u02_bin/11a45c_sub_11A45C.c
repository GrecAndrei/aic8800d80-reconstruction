// v23 annotated: sub_11A45C @ 0x11a45c
// Original: 11a45c_sub_11A45C.c
...
int __fastcall sub_11A45C(int a1, int *a2, unsigned int a3, unsigned int a4, unsigned __int8 a5)
{
  int v5; // r6
  int *v6; // r8
  int v7; // r4
...
LABEL_27:
          if ( *(_DWORD *)(dword_11A6B4 + 84 * a5 + 28) != v5 )
          {
            v35 = v26;
...
LABEL_15:
    ...
    *(_WORD *)(v5 + 10) = v22;
    ...
    if ( *(unsigned __int8 *)(v36 + 62) > (*(_DWORD *)off_11A6A4 & 0x3Fu) )
    {
      v25 = v16;
      v26 = *(_DWORD *)v7;
      goto LABEL_15;
  ...
  if ( *v11 < 0 && *(_DWORD *)(dword_11A6B4 + 84 * a5 + 28) != v5 )
    sub_12F46C(dword_11A6B8, dword_11A6AC, 1119);
  v33 = *(_DWORD *)(v7 + 76);
  *a2 = *(_DWORD *)v7;
  *(_DWORD *)(v33 + 20) = 0;
