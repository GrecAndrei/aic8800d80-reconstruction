// v23 annotated: sub_134E04 @ 0x134e04
// Original: 134e04_sub_134E04.c
        ...
        int a13)
{
  ...
  v14 = off_135084;
  v15 = dword_1350CC;
  v16 = *(unsigned __int8 *)(*((_DWORD *)off_135084 + 4) + 61);
  v17 = *((_DWORD *)off_135084 + 5);
  v49 = *((_DWORD *)off_135084 + 4);
...
LABEL_10:
  ...
  *(_BYTE *)(v17 + 8) = (*(_DWORD *)(v20 + 48) & 0x60) != 0;
  if ( *(_BYTE *)(v40 + 1224) )
  {
    *(_DWORD *)off_1350A4 = *(unsigned __int16 *)(v40 + 100) | (*(unsigned __int16 *)(v40 + 102) << 16);
    *(_DWORD *)off_1350A8 = *(unsigned __int16 *)(v40 + 104);
    *(_DWORD *)off_1350AC = *(unsigned __int16 *)(v40 + 64) | (*(unsigned __int16 *)(v40 + 66) << 16);
    *(_DWORD *)off_1350B0 = *(unsigned __int16 *)(v40 + 68);
  }
  v50 = v25;
  sdio_buffer_prepare_n_4e8(v17);
  v41 = v50;
  *(_DWORD *)off_1350B4 = dword_1350B8;
  if ( v50 == (void *)1 )
  {
    v42 = (unsigned __int16 *)(v15 + 1320 * v16);
    v41 = off_1350A4;
    *(_DWORD *)off_1350A4 = v42[50] | (v42[51] << 16);
    *(_DWORD *)off_1350A8 = v42[52];
  }
