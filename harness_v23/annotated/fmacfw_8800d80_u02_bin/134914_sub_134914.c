// v23 annotated: sub_134914 @ 0x134914
// Original: 134914_sub_134914.c
...
LABEL_13:
        v5 = *(int **)off_134A5C;
        if ( *(int *)off_134A5C < 0 && v4 == (_DWORD *)1 )
        {
          v4 = off_134A64;
          *((_BYTE *)off_134A60 + 2) = (_BYTE)v6;
          v5 = (int *)off_134A68;
          *v4 |= 0x80000000;
