// v23 annotated: sub_139F5C @ 0x139f5c
// Original: 139f5c_sub_139F5C.c
// Primary struct: <unclustered>
//
// sub_139F5C @ 0x139f5c, size 1160 bytes
int __fastcall sub_139F5C(unsigned int a1)
{
  unsigned int v1; // r7
  int v3; // r3
  _BYTE *v4; // r4
...
LABEL_22:
  ...
  *((_DWORD *)v4 + 6) = v1;
  ...
  {
    v43 = v15;
    v34 = sub_1387E8((int)v7, *((_DWORD *)v4 + 6));
    v15 = v43;
    v18 = dword_13A3E8;
    if ( !v34 )
      goto LABEL_34;
  }
  v22 = (_BYTE **)off_13A254;
  if ( **(_BYTE **)off_13A254 == 1 && !*((_BYTE *)off_13A3EC + 412) )
  {
    v23 = v8 & 0xC;
    if ( v23 == 8 )
    {
...
LABEL_57:
  ...
  if ( v3 != 255 && !v5 )
    goto LABEL_4;
LABEL_5:
  sub_12F554((_DWORD **)dword_13A240);
  return v5;
}
