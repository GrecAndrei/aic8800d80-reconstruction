// v23 annotated: sub_1345C0 @ 0x1345c0
// Original: 1345c0_sub_1345C0.c
...
void __fastcall sub_1345C0(int a1, int a2, int a3)
{
  _DWORD *v4; // r3
  _BYTE *v7; // r9
  int *v8; // r10
  ...
  if ( !*(_BYTE *)(a2 + 2)
    && *((_BYTE *)off_1346C4 + 1)
    && *(int *)off_1346C8 < 0
    && (*((_DWORD *)off_1346CC + 75) & 0x80) != 0 )
  {
    if ( *((_BYTE *)off_1346C4 + 14) == 1 )
    {
      v18 = off_1346D4;
      *(_DWORD *)off_1346D0 = dword_1346D8;
      v19 = off_1346DC;
      *v18 &= 0xFFFFFFF0;
      *v19 &= ~0x80000000;
      v4[1] = a1;
      ...
      *((_WORD *)v4 + 1) = 257;
      v20 = dword_1346E0;
      v18[35594] = 0;
      timer_set_relative(6155, 6, v20);
      mac_tx_completion_n234();
      return;
    }
    *((_BYTE *)off_1346C4 + 3) = 0;
  }
  else
  {
    *((_BYTE *)off_1346C4 + 14) = 0;
    *((_BYTE *)v4 + 13) = 0;
    *((_BYTE *)v4 + 3) = 0;
  }
  v7 = off_1346E4;
