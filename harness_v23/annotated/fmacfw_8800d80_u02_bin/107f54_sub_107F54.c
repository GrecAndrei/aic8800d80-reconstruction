// v23 annotated: sub_107F54 @ 0x107f54
// Original: 107f54_sub_107F54.c
// Primary struct: <unclustered>
//
// sub_107F54 @ 0x107f54, size 276 bytes
int __fastcall sub_107F54(int a1, _DWORD *a2)
{
  _DWORD *v2; // r6
  unsigned int *v3; // r8
  int v4; // r7
