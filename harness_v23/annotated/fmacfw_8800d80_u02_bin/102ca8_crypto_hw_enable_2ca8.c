// v23 annotated: crypto_hw_enable_2ca8 @ 0x102ca8
// Original: 102ca8_crypto_hw_enable_2ca8.c
...
int *__fastcall crypto_hw_enable_2ca8(int a1)
{
  int v1; // r4
  int v2; // r1
  bool v3; // zf
  ...
  if ( a1 )
    ...
    v4 = -17;
  v5 = v4 & *(_DWORD *)off_102D08;
  if ( !a1 )
    a1 = -33;
  *(_DWORD *)off_102D08 = v5;
  if ( v3 )
    v2 = 64;
  else
    a1 = -3;
  ...
  v8 = v9 | v2;
  *(_DWORD *)off_102D08 = v9;
  LOBYTE(v9) = 50;
  *result = v8;
  do
    v9 = (unsigned __int8)(v9 - 1);
  while ( v9 );
  *(_DWORD *)off_102D08 = v8 | v1;
  return result;
}
