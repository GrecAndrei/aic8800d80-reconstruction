// v23 annotated: sub_13B0E0 @ 0x13b0e0
// Original: 13b0e0_sub_13B0E0.c
// Primary struct: <unclustered>
//
// sub_13B0E0 @ 0x13b0e0, size 636 bytes
int __fastcall sub_13B0E0(int a1, int a2, unsigned int a3)
{
  int v3; // r3
  int v6; // r5
  unsigned int v7; // r6
  ...
  if ( v3 == 1 )
  {
    ...
    {
      sub_13BA24(v7);
      sub_12D248(dword_13B35C, (_DWORD *)(v10 + v12));
      sub_12CD34(a3, 0);
      return 0;
    }
...
LABEL_31:
  ...
  if ( v3 == 2 )
  {
    if ( sub_12CE88(a3) != 4 )
    {
      if ( sub_12CE88(a3) == 1 || sub_12CE88(a3) == 3 )
      {
        ...
        sub_13BDA4(*(unsigned __int8 *)(a2 + 7), v7);
        return 0;
      }
  ...
  if ( !sub_121960(v16, (v13 >> 2) & 0xF) )
  {
    ...
    if ( sub_12D350((_DWORD **)dword_13B384, v31) )
  ...
  if ( sub_12CE88(a3) == 1 )
  {
    ...
    else
    {
      ...
      sub_12D248(dword_13B370, (_DWORD *)v27);
      sub_13BDA4((unsigned __int16)v16, v7);
      v17 = 37;
    }
  }
  else
