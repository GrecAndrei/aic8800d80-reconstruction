// v23 annotated: sub_143D7C @ 0x143d7c
// Original: 143d7c_sub_143D7C.c
// Primary struct: <unclustered>
//
// sub_143D7C @ 0x143d7c, size 186 bytes
unsigned int __fastcall sub_143D7C(unsigned int result, unsigned int a2)
{
  _BYTE *v2; // r12
  int *v3; // r1
  int v4; // r3
