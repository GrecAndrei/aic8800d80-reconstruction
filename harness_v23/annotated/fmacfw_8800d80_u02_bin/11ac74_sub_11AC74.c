// v23 annotated: sub_11AC74 @ 0x11ac74
// Original: 11ac74_sub_11AC74.c
...
int __fastcall sub_11AC74(int result)
{
  _DWORD *v1; // r5
  __int16 **v2; // r6
  _DWORD *v3; // r4
  ...
  if ( result == 5 )
  {
    v1 = (_DWORD *)dword_11AE24;
  }
  else
  {
    result *= 21;
    v1 = (_DWORD *)(dword_11AE0C + 4 * result);
  }
  v2 = (__int16 **)off_11AE10;
  v3 = (_DWORD *)v1[3];
  if ( **(__int16 **)off_11AE10 < 0 && !v3 )
  ...
  {
    v6 = v3[17];
    v7 = *(int **)(v6 + 4 * ((unsigned __int8)*(_DWORD *)off_11AE14 + 82));
    v8 = v7[19];
LABEL_10:
    v9 = v7[9];
    goto LABEL_11;
