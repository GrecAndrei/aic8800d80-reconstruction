// v23 annotated: rf_cmd_queue_next_4b4 @ 0x1134b4
// Original: 1134b4_rf_cmd_queue_next_4b4.c
...
int __fastcall rf_cmd_queue_next_4b4(int a1, int a2)
{
  _BYTE *v2; // r6
  int **v3; // r4
  char v4; // r0
  ...
  v2 = rf_msg_handler_n444;
  if ( *(_BYTE *)rf_msg_handler_n444 )
    return -99;
  v3 = (int **)off_11354C;
