// v23 annotated: sub_12205C @ 0x12205c
// Original: 12205c_sub_12205C.c
...
int __fastcall sub_12205C(int a1, int a2)
{
  int v3; // r3
  int v4; // r2
  _WORD *v5; // r3
  ...
  else
  {
    ...
    *(_BYTE *)(a1 + 115) = v3;
    ...
    {
      if ( *((_BYTE *)off_122108 + 2) )
        *(_DWORD *)off_12210C &= ~0x80000000;
      v5 = off_122110;
      if ( *((_BYTE *)off_122110 + 8) )
        --*((_BYTE *)off_122110 + 8);
      v5[14] = 1;
