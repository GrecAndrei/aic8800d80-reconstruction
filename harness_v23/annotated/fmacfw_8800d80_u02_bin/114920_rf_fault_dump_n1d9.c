// v23 annotated: rf_fault_dump_n1d9 @ 0x114920
// Original: 114920_rf_fault_dump_n1d9.c
...
int __fastcall rf_fault_dump_n1d9(int a1, int a2)
{
  int v3; // r1
  int v4; // r2
  unsigned int v5; // r0
  ...
  v3 = *(_DWORD *)(rf_fault_dump_n250 + 4);
  v4 = *(_DWORD *)(rf_fault_dump_n250 + 8);
  v14[0] = *(_DWORD *)rf_fault_dump_n250;
  v14[1] = v3;
  v14[2] = v4;
