// v23 annotated: sub_132FB8 @ 0x132fb8
// Original: 132fb8_sub_132FB8.c
// Primary struct: <unclustered>
//
// sub_132FB8 @ 0x132fb8, size 1500 bytes
_BYTE *__fastcall sub_132FB8(int a1, __int16 a2, unsigned int a3)
{
  int v4; // r3
  int v5; // r6
  int v6; // r0
...
LABEL_2:
  ...
  v13 = off_133428;
  if ( (*((_BYTE *)off_133428 + 374) & 1) == 0 )
  {
    v14 = (unsigned __int8 *)(*((_BYTE *)off_133428 + 374) & 1);
    v68 = v14;
LABEL_6:
  ...
  if ( (v13[374] & 6) != 0 )
  {
    ...
    if ( !*(_BYTE *)(a1 + 106) )
    {
      ...
      if ( v63
        && (*(_DWORD *)(dword_133594 + 696 * *(unsigned __int8 *)(a1 + 116) + 4) & 0x24) != 0
        && (v63[2] & 0x80u) == 0 )
      {
        chan_ctx_lookup_n2b8(*(unsigned __int8 *)(a1 + 116), v63[2] & 3);
      }
      if ( (*(_DWORD *)(a1 + 472) & 8) != 0 )
      {
        v73 = (_BYTE *)sub_12C92C(109, 0, 5, 2u);
...
LABEL_102:
  ...
  clear_state_struct_n_a8a((int)v14, nullptr, a1 + 248);
LABEL_7:
  v15 = (unsigned __int8)sub_130F50(v10, v12, v74, a1 + 1212);
  if ( v15 )
  {
    if ( *(_BYTE *)(a1 + 106) )
    {
    ...
    else
    {
      ...
      if ( *(_BYTE *)(a1 + 146)
        ...
        && v74[0] == 1
        && (v69 = v15,
            tx_send_msg_n25dc(*(_BYTE *)(a1 + 107), v16),
            v16 = *(unsigned __int8 *)(a1 + 146),
            v15 = v69,
            *(_BYTE *)(a1 + 146)) )
      {
  ...
  if ( *(unsigned __int8 *)(a1 + 464) != v67 )
    result = (_BYTE *)message_dispatch_408(a1);
  if ( *(unsigned __int8 *)(a1 + 413) > v9 )
  {
    ...
    *(_DWORD *)(v18 + 6) = v20;
    *(_WORD *)(v18 + 10) = v21;
    result = (_BYTE *)sdio_buffer_prepare_n_4e8(v18);
  }
  if ( v8 )
  {
    v22 = dword_13342C;
    v23 = (__int16 **)off_13340C;
    do
    {
      if ( *(unsigned __int16 *)(a1 + 462) != v7 )
      {
        ...
        *((_BYTE *)v8 + 350) = v26;
        ...
        result = (_BYTE *)sub_13F244(v24, v27);
      }
...
LABEL_38:
      if ( *((unsigned __int8 *)v8 + 309) != v29 )
      {
        ...
        *((_BYTE *)v8 + 309) = v29;
        result = (_BYTE *)scan_chan_lookup_n2b8(v39);
        *((_BYTE *)v8 + 350) |= 8u;
      }
LABEL_48:
