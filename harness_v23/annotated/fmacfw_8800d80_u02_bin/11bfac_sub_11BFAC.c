// v23 annotated: sub_11BFAC @ 0x11bfac
// Original: 11bfac_sub_11BFAC.c
// Primary struct: <unclustered>
//
// sub_11BFAC @ 0x11bfac, size 198 bytes
int __fastcall sub_11BFAC(int a1, int a2)
{
  int v2; // r2
  int v3; // r5
  int v4; // r3
  ...
  if ( (v2 & 0x200) == 0 || (result = *(_DWORD *)(a1 + 84) & 0x400, (v2 & 0x400) != 0) )
  {
    ...
    if ( v7 <= 1 )
      return 0;
    v9 = dword_11C074 + 696 * *(unsigned __int8 *)(a2 + 12);
    while ( 1 )
    {
      v12 = *v8;
      v13 = v12 & 0x7FF;
      ...
      if ( (v12 & 0x800) == 0 )
      {
        ...
        if ( (v10 & 8) != 0 )
          return result;
        v11 = *(unsigned __int8 *)(dword_11C078 + ((v10 >> 1) & 7)) + 4;
        if ( v11 > v7 )
          return 0;
LABEL_8:
        v7 -= v11;
