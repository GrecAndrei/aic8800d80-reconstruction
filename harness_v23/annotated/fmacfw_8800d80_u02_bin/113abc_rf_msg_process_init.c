// v23 annotated: rf_msg_process_init @ 0x113abc
// Original: 113abc_rf_msg_process_init.c
...
int __fastcall rf_msg_process_init(int a1)
{
  void *v1; // r5
  _DWORD *v2; // r1
  int *v3; // r2
  ...
  v4 = rf_msg_process_body_bd0;
  *(_DWORD *)rf_msg_process_payload = v3;
  *v2 = v3 + 16;
  v5 = rf_msg_process_body_n_74;
  v4[2] = a1;
  *v4 = 0;
  v4[1] = 0;
  v4[4] = 0;
  ...
  *v9 = v6 + 14;
  ...
  v13 = dword_113BF4;
  v14 = off_113BF8;
  *(_DWORD *)rf_msg_process_body_n_4c = *((unsigned __int16 *)rf_msg_process_body_n_5c + 153)
                                      - *(_DWORD *)off_113BF0
                                      - 4;
  v15 = (int *)rf_msg_process_body_n_48;
  v16 = rf_msg_process_body_n_44;
  v17 = v13 * v11;
  v18 = rf_msg_process_body_n_40;
  *v14 = v12 - 4;
  v19 = v17 <= (int)v15;
  if ( v17 > (int)v15 )
    v17 = (int)off_113C0C;
