// v23 annotated: state_check @ 0x10cdd4
// Original: 10cdd4_state_check.c
...
int __fastcall state_check(unsigned __int16 *a1)
{
  ...
  v42 = rf_bus_mark_n100_d2d0(*(_DWORD *)off_10D0B0 + 516);
...
LABEL_16:
  ...
  while ( !*(_DWORD *)off_10D0AC )
    ;
  list_push_tail(*(_DWORD *)off_10D0B0 + 524);
  v11 = off_10D0B4;
  *v10 = 1;
  *v11 = 2;
  v9 = **v1;
