// v23 annotated: sub_103478 @ 0x103478
// Original: 103478_sub_103478.c
// Primary struct: <unclustered>
//
// sub_103478 @ 0x103478, size 1722 bytes
void __noreturn sub_103478()
{
  _BYTE *v0; // r4
  int *v1; // r2
  _DWORD *v2; // r0
  ...
  v0 = off_1035E0;
  *((_DWORD *)off_1035DC + 64) = 8;
  if ( !v0[2] )
    *((_DWORD *)off_1035E4 + 2) = *((_DWORD *)off_1035E4 + 2) & 0xFFF9FFFF | 0x20000;
  v1 = (int *)off_1035E4;
  while ( (*((_DWORD *)off_1035E4 + 12) & 0x22) != 2 )
    ;
  v2 = off_1035E8;
  v3 = dword_1035EC;
  v4 = off_1035DC;
  *((_DWORD *)off_1035E4 + 2) = *((_DWORD *)off_1035E4 + 2) & 0xFFFE73FE | 0x18401;
  *v2 = 6;
  ...
  *v1 = *v1 & 0x37F | 0x80 | *v1 & v3;
  ...
  v8 = off_1035DC;
  v9 = off_103600;
  *(_DWORD *)off_1035E4 = *(_DWORD *)off_1035E4 & 0x3EF | 0x10 | *(_DWORD *)off_1035E4 & dword_1035EC;
  ...
  {
    *(_DWORD *)off_1035F4 = v9[42];
  }
  if ( v0[2] )
  {
    if ( **(_BYTE **)off_1035F8 == 2 )
    {
      v59 = off_103B48;
      v60 = off_103B4C;
      *((_DWORD *)off_103B48 + 20) |= 0x40000u;
      v60[7] &= ~0x100u;
...
LABEL_17:
    ...
    if ( (*v21 & 0x2000000) != 0 )
    {
      ...
      if ( v29 )
      {
        ...
        do
        {
          ...
          v35 = HIDWORD(v36) >> 1;
          if ( !v37 )
            v34 = sub_114A84(HIDWORD(v36) >> 1, v88);
          if ( v34 <= 1 )
          {
            v38 = v88[0];
            *(_BYTE *)(*v27 + v32) = v88[0];
    ...
    if ( *((_BYTE *)v9 + 372) )
    {
      if ( (*(_DWORD *)off_103918 & 0x2000000) != 0 )
      {
        if ( sub_114B70(v42) )
        {
          v56 = sub_114B08();
          v57 = dword_103B40;
          v58 = off_103B44;
          *(_BYTE *)off_103B44 = *(_BYTE *)(dword_103B40 + v56);
          v58[1] = *(_BYTE *)(v57 + sub_114B1C());
          v58[2] = *(_BYTE *)(v57 + sub_114B30());
        }
      }
      else
      {
        *(_DWORD *)v88 = 0;
        ...
        {
          v61 = off_103B44;
          v62 = *(_BYTE *)(dword_103B40 + v88[1]);
          v63 = *(_BYTE *)(dword_103B40 + v88[2]);
          *(_BYTE *)off_103B44 = *(_BYTE *)(dword_103B40 + v88[0]);
          v61[1] = v62;
          v61[2] = v63;
        }
      }
    ...
    *(_DWORD *)off_103930 &= 0xFFFFFFC7;
    ...
    sub_102EB8(1, 0, 0x10u, *(_DWORD *)off_103940);
    sub_102EB8(1, 16, 0x10u, *(_DWORD *)off_103944);
    sub_100EE8();
    sub_1032FC();
  }
LABEL_14:
