// v23 annotated: rf_fault_dump_4748 @ 0x114748
// Original: 114748_rf_fault_dump_4748.c
...
void __noreturn rf_fault_dump_4748()
{
  ...
  v1 = *(_DWORD *)(*(_DWORD *)rf_fault_dump_nc0 + 16);
  msg_parse(rf_fault_dump_ncc, v1, *(_DWORD *)off_114810);
  if ( (v1 & 1) != 0 )
