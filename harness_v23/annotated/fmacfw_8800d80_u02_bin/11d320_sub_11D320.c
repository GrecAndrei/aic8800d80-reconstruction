// v23 annotated: sub_11D320 @ 0x11d320
// Original: 11d320_sub_11D320.c
// Primary struct: <unclustered>
//
// sub_11D320 @ 0x11d320, size 1128 bytes
BOOL __fastcall sub_11D320(int a1)
{
  __int16 **v1; // r10
  int v2; // r8
  int v3; // r3
  ...
  if ( *(_WORD *)(a1 + 48) )
  {
    ...
    {
      v8 = 0;
      sub_12F408(dword_11D64C, dword_11D648, 423, v3);
      return v8;
    }
    v5 = *(__int16 **)(v2 + 8);
    v6 = *v5;
    ...
    else
    {
      ...
      *(_DWORD *)(a1 + 84) = v7 & 0xFEFFFFFF;
      if ( v3 < 0 )
      {
        ...
        if ( !v8 )
        {
          sub_12F408(dword_11D654, dword_11D648, 475, v3);
          return v8;
        }
      }
      v10 = dword_11D63C;
