// v23 annotated: sub_11A7E8 @ 0x11a7e8
// Original: 11a7e8_sub_11A7E8.c
...
int __fastcall sub_11A7E8(int result)
{
  int *v1; // r4
  int v2; // r2
  int v3; // r1
  ...
  v4 = *(_DWORD *)off_11A834 + 1;
  *(_DWORD *)off_11A834 = v4;
  if ( !v3 && *(_DWORD *)(v2 + 44) )
  {
