// v23 annotated: sub_136E9C @ 0x136e9c
// Original: 136e9c_sub_136E9C.c
...
int __fastcall sub_136E9C(int a1, unsigned __int8 *a2, int a3, __int16 a4)
{
  _WORD *v4; // r4
  _BYTE *v6; // r0
  _DWORD *v7; // r6
  ...
  v4 = off_136EF8;
  v6 = (_BYTE *)sub_12C92C(4102, a4, 4, 0x3Cu);
  v7 = v6;
